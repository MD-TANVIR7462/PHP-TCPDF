<?php
$meta_title 	=   "INTAKE FORM I-102";
$page_heading 	=   "INTAKE FORM I-102, Application for Replacement/Initial Nonimmigrant Arrival-Departure Document";
    ...
    <div class="row mt-5 gap-4">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <textarea class="form-control" cols="30" rows="10" maxlength="195" name="i_102_provide_explanation"><?php echo showData('i_102_provide_explanation')?></textarea>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_uscis_form_number_name" maxlength="34" value="<?php echo showData('i_102_uscis_form_number_name')?>">
                </div>
            </div>
    ...
    <div class="row mt-5 gap-4">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <textarea class="form-control" cols="30" rows="7" maxlength="195" name="i_102_provide_detailed_information"><?php echo showData('i_102_provide_detailed_information')?></textarea>
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_applicant_daytime_tel" maxlength="10" value="<?php echo showData('i_102_applicant_daytime_tel')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">2. Applicant's Mobile Telephone Number (if any)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_applicant_mobile" maxlength="10" value="<?php echo showData('i_102_applicant_mobile')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">3. Applicant's Email Address (if any)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_applicant_email" maxlength="39" value="<?php echo showData('i_102_applicant_email')?>">
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7 col-md-offset-5">
                    <input type="date" class="form-control" name="i_102_applicant_sign_date"
                        value="<?php echo showData('i_102_applicant_sign_date')?>" />
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_interpreter_family_last_name" maxlength="39" value="<?php echo showData('i_102_interpreter_family_last_name')?>"/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">Interpreter's Given Name (First Name)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_interpreter_given_first_name" maxlength="39" value="<?php echo showData('i_102_interpreter_given_first_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">2. Interpreter's Business or Organization Name (if any) </label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_interpreter_business_name" maxlength="34" value="<?php echo showData('i_102_interpreter_business_name')?>" />
                </div>
            </div>
            <div class="bg-info">
             ...
             <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_interpreter_daytime_tel" maxlength="10" value="<?php echo showData('i_102_interpreter_daytime_tel')?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_interpreter_mobile" maxlength="10" value="<?php echo showData('i_102_interpreter_mobile')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">5. Interpreter's Email Address (if any)</label>
                <div class="col-md-12">
                    <input type="email" class="form-control" name="i_102_interpreter_email" maxlength="39" value="<?php echo showData('i_102_interpreter_email')?>" />
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_interpreter_certification_language" maxlength="18" value="<?php echo showData('i_102_interpreter_certification_language')?>" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">Date of Signature (mm/dd/yyyy)</label>
                <div class="col-md-7 col-md-offset-5">
                    <input type="date" class="form-control" name="i_102_interpreter_sign_date"
                        value="<?php echo showData('i_102_interpreter_sign_date')?>" />
                </div>
            </div>
        </div>
    </div>
...
<fieldset class="setpage">
    <div class="row">
        <div class="page_number">
            <b>
                <p style="text-align: right; margin-right:2%">Page 4 of 5</p>
            </b>
        </div>
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_preparer_family_last_name" maxlength="39" value="<?php echo showData('i_102_preparer_family_last_name')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">Preparer's Given Name (First Name)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_preparer_given_first_name" maxlength="39" value="<?php echo showData('i_102_preparer_given_first_name')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">2. Preparer's Business or Organization Name (if any) </label>
                <div class="col-md-12">
                    <input type="text" class="form-control" maxlength="34 " name="i_102_preparer_business_name" value="<?php echo showData('i_102_preparer_business_name')?>">
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_preparer_daytime_tel" maxlength="10" value="<?php echo showData('i_102_preparer_daytime_tel')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">4. Preparer's Mobile Telephone Number (if any)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_102_preparer_mobile" maxlength="10" value="<?php echo showData('i_102_preparer_mobile')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">5. Preparer's Email Address (if any)</label>
                <div class="col-md-12">
                    <input type="email" class="form-control" maxlength="39" name="i_102_preparer_email" value="<?php echo showData('i_102_preparer_email')?>">
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">Date of Signature (mm/dd/yyyy)</label>
                <div class="col-md-7 col-md-offset-5">
                    <input type="date" class="form-control" name="i_102_preparer_sign_date" 
                    value="<?php echo showData('i_102_preparer_sign_date')?>">
                </div>
            </div>
        </div>
