    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_864a_sponsor_email" maxlength="41" value="<?php echo showData('i_864a_sponsor_email') ?>">
                </div>
            </div>
            <div class="bg-info">
    ...
    <div class=" row mt-5 gap-4">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_864a_interpreter_email" maxlength="41" value="<?php echo showData('i_864a_interpreter_email') ?>">
                </div>
            </div>
            <div class="bg-info">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" maxlength="41" name="i_864a_preparer_email" value="<?php echo showData('i_864a_preparer_email') ?>">
                </div>
            </div>
        </div>
    </div>
