<?php
$meta_title 	=   "INTAKE FORM I-130A";
$page_heading 	=   "INTAKE FORM I-130A, Petition for Alien Relative ";
        ...
        <table style="border-collapse: collapse; ">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="padding: 5px;"><?php echo createCheckbox("i_130a_g28_checkbox")?> Select this box if Form G-28 is
                        attached.
                    </td>
                    ...
                    <td style="padding: 5px;">
                        <div>
                            <p>Volag Number
                                (if any)</p>
                                <br>
                            <input type="text" class="form-control" disabled  value="<?php echo $attorneyData->volag_number ?>"
                                maxlength="">
                        </div>
                    </td>
                    <td style="padding: 5px;">
                        <div>
                            <p>Attorney State Bar Number
                                (if applicable)</p>
                                <br>
                            <input type="text" class="form-control" disabled value="<?php echo $attorneyData->bar_number ?>"
                                maxlength="">
                        </div>
                    </td>
                    <td style="padding: 5px;">
                        <div>
                            ...
                            <input type="text" class="form-control" disabled value="<?php echo $attorneyData->uscis_online_account_number ?>"
                                maxlength="">
                        </div>
                    </td>
                </tr>
        ...
        <div class="row  mt-3 border-add">
            <div class="col-md-6 container border-add ">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" maxlength="26" class="form-control" name="information_about_you_family_last_name" value="<?php echo showData('information_about_you_family_last_name')?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-5">3.b. Given Name(First Name)</label>
                        <div class="col-md-7">
                            <input type="text" maxlength="26" class="form-control" name="information_about_you_given_first_name" value="<?php echo showData('information_about_you_given_first_name')?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-5">3.c. Middle Name</label>
                        <div class="col-md-7">
                            <input type="text" maxlength="26" class="form-control" name="information_about_you_middle_name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="information_about_you_home_street_number" maxlength="25"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" type="text" class="form-control" name="information_about_you_home_apt_ste_flr_value"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="information_about_you_home_country" maxlength="36"
            ...
            <div class="col-md-6 mt-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="information_about_you_home_street_number2" maxlength="25"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" type="text" class="form-control" name="information_about_you_home_apt_ste_flr_value2" maxlength="6"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="information_about_you_home_country2" maxlength="36"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="information_about_you_outside_us_street_number" maxlength="25"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" type="text" class="form-control" name="information_about_you_outside_us_apt_ste_flr_value" maxlength="6"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="information_about_you_outside_us_province" maxlength="20"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="information_about_you_outside_us_country" maxlength="36"
    ...
    <div class="row mt-5 gap-4">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="parent1_info_family_last_name" value="<?php echo showData('parent1_info_family_last_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">10.b. Given Name(First Name) </label>
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="parent1_info_given_first_name" value="<?php echo showData('parent1_info_given_first_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">10.c. Middle Name </label>
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="parent1_info_middle_name" value="<?php echo showData('parent1_info_middle_name')?>" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="parent1_info_city_of_birth" maxlength="20" value="<?php echo showData('parent1_info_city_of_birth')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">14. Country of Birth</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="parent1_info_country_of_birth" maxlength="20" value="<?php echo showData('parent1_info_country_of_birth')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">15. City/Town/Village of Residence</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="parent1_info_current_city_of_residence" maxlength="20" value="<?php echo showData('parent1_info_current_city_of_residence')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">16. Country of Residence</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="parent1_info_current_country_of_residence" maxlength="20" value="<?php echo showData('parent1_info_current_country_of_residence')?>">
                </div>
            </div>
            <div class="bg-info">
                <h4>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="parent2_info_family_last_name" value="<?php echo showData('parent2_info_family_last_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">17.b. Given Name(First Name) </label>
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="parent2_info_given_first_name" value="<?php echo showData('parent2_info_given_first_name')?>"/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">17.c. Middle Name </label>
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="parent2_info_middle_name" value="<?php echo showData('parent2_info_middle_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-6">18. Date of Birth (mm/dd/yyyy)</label>
                <div class="col-md-6 ">
                    <input type="date" class="form-control" name="parent2_info_date_of_birth" value="<?= showData('parent2_info_date_of_birth')?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control"  name="parent2_info_city_of_birth" maxlength="20" value="<?php echo showData('parent2_info_city_of_birth')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">21. Country of Birth</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="parent2_info_country_of_birth" maxlength="20" value="<?php echo showData('parent2_info_country_of_birth')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">22. City/Town/Village of Residence</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="parent2_info_current_city_of_residence" maxlength="20" value="<?php echo showData('parent2_info_current_city_of_residence')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">23. Country of Residence</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="parent2_info_current_country_of_residence" maxlength="20" value="<?php echo showData('parent2_info_current_country_of_residence')?>">
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer1_name" maxlength="36" value="<?php echo showData('employer1_name')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.a. Street Number and Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="employer1_address" maxlength="25" value="<?php echo showData('employer1_address')?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" type="text" class="form-control" name="employer1_apt_ste_flr_value" maxlength="6"
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="employer1_city_town" maxlength="20" value="<?php echo showData('employer1_city_town')?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="employer1_province" maxlength="20" value="<?php echo showData('employer1_province')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="employer1_postal_code" maxlength="9" value="<?php echo showData('employer1_postal_code')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">2.h. Country</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer1_country" maxlength="36" value="<?php echo showData('employer1_country')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">3. Your Occupation</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer1_occupation" maxlength="36" value="<?php echo showData('employer1_occupation')?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer2_name" maxlength="36" value="<?php echo showData('employer2_name')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">6.a. Street Number and Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="employer2_address" maxlength="26" value="<?php echo showData('employer2_address')?>">
                </div>
            </div>
            <div class="form-group">
                <div class="control-label col-md-6"><b>6.b. </b> &nbsp;
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" type="text" class="form-control" name="employer2_apt_ste_flr_value" maxlength="6"
            ...
            <div class="form-group">
                <label class="control-label col-md-5">6.c. City or Town</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="employer2_city_town" maxlength="20" value="<?php echo showData('employer2_city_town')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">6.d. State</label>
            ...
            <div class="form-group">
                <label class="control-label col-md-5">6.f. Province</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="employer2_province" maxlength="20" value="<?php echo showData('employer2_province')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">6.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="employer2_postal_code" maxlength="9" value="<?php echo showData('employer2_postal_code')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">6.h. Country</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer2_country" maxlength="36" value="<?php echo showData('employer2_country')?>">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5 gap-4">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer2_occupation" maxlength="36" value="<?php echo showData('employer2_occupation')?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">1. Name of Employer/Company</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer_outside_us_name" maxlength="36" value="<?php echo showData('employer_outside_us_name')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.a. Street Number and Name</label>
            ...
            <div class="form-group">
                <label class="control-label col-md-12">2.h. Country</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer_outside_us_country" maxlength="36" value="<?php echo showData('employer_outside_us_country')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">3. Your Occupation</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="employer_outside_us_occupation" maxlength="36" value="<?php echo showData('employer_outside_us_occupation')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-6">4.a. Date From (mm/dd/yyyy)</label>
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-12" style="padding-left:40px;">
                <input type="text" maxlength="26" class="form-control" name="i_130a_spouse_beneficiary_statement_1b_text_value" value="<?php echo showData('i_130a_spouse_beneficiary_statement_1b_text_value')?>" />
            </div>
            ...
            <div class="col-md-12" style="padding-left:40px;">
                <input type="text" maxlength="26" class="form-control" name="i_130a_spouse_beneficiary_statement_2_text_value" value="<?php echo showData('i_130a_spouse_beneficiary_statement_2_text_value')?>" />
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_interpreter_family_last_name" maxlength="36" value="<?php echo showData('i_130a_interpreter_family_last_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">1.b. Interpreter's Given Name (First Name) </label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_interpreter_family_first_name" maxlength="36" value="<?php echo showData('i_130a_interpreter_family_first_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">2.Interpreter's Business or Organization Name (if
                    any) </label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_interpreter_business_name" maxlength="34" value="<?php echo showData('i_130a_interpreter_business_name')?>" />
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_interpreter_address_street_number" maxlength="25" value="<?php echo showData('i_130a_interpreter_address_street_number')?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" type="text" class="form-control" name="i_130a_interpreter_address_apt_ste_flr_value" maxlength="6"
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_interpreter_address_city_town" maxlength="20" value="<?php echo showData('i_130a_interpreter_address_city_town')?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_interpreter_address_zip_code" maxlength="5" value="<?php echo showData('i_130a_interpreter_address_zip_code')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.f. Province</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_interpreter_address_province" maxlength="20" value="<?php echo showData('i_130a_interpreter_address_province')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_interpreter_address_postal_code" maxlength="9" value="<?php echo showData('i_130a_interpreter_address_postal_code')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">3.h. Country</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_interpreter_address_country" maxlength="36" value="<?php echo showData('i_130a_interpreter_address_country')?>">
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_interpreter_daytime_tel" maxlength="15" value="<?php echo showData('i_130a_interpreter_daytime_tel')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">5. Interpreter's Mobile Telephone Number (if any)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_interpreter_mobile" maxlength="15" value="<?php echo showData('i_130a_interpreter_mobile')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">6. Interpreter's Email Address (if any)</label>
                <div class="col-md-12">
                    <input type="email" class="form-control" maxlength="36" name="i_130a_interpreter_email" value="<?php echo showData('i_130a_interpreter_email')?>">
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group" style="display:flex;  align-items: center;">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_interpreter_certification" maxlength="20" value="<?php echo showData('i_130a_interpreter_certification')?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_preparer_family_last_name" maxlength="36" value="<?php echo showData('i_130a_preparer_family_last_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">1.b. Preparer's Given Name (First Name)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_preparer_family_first_name" maxlength="36" value="<?php echo showData('i_130a_preparer_family_first_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">2. Preparer's Business or Organization Name (if any)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_preparer_business_name" maxlength="34" value="<?php echo showData('i_130a_preparer_business_name')?>" />
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                <label class="control-label col-md-5">3.a. Street Number and Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_preparer_address_street_number" maxlength="25" value="<?php echo showData('i_130a_preparer_address_street_number')?>">
                </div>
            </div>
            <div class="form-group">
                <div class="control-label col-md-6"><b>3.b. </b> &nbsp;
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" type="text" class="form-control" name="i_130a_preparer_address_apt_ste_flr_value" maxlength="6"
            ...
            <div class="form-group">
                <label class="control-label col-md-5">3.c. City or Town</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_preparer_address_city_town" maxlength="20" value="<?php echo showData('i_130a_preparer_address_city_town')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.d. State</label>
            ...
            <div class="form-group">
                <label class="control-label col-md-5">3.e. ZIP Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_preparer_address_zip_code" maxlength="5" value="<?php echo showData('i_130a_preparer_address_zip_code')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.f. Province</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_preparer_address_province" maxlength="20" value="<?php echo showData('i_130a_preparer_address_province')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_130a_preparer_address_postal_code" maxlength="9" value="<?php echo showData('i_130a_preparer_address_postal_code')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">3.h. Country</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_preparer_address_country" maxlength="36" value="<?php echo showData('i_130a_preparer_address_country')?>">
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_preparer_daytime_tel" maxlength="15" value="<?php echo showData('i_130a_preparer_daytime_tel')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">5. Preparer's Mobile Telephone Number (if any)</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_130a_preparer_mobile" maxlength="15" value="<?php echo showData('i_130a_preparer_mobile')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">6. Preparer's Email Address (if any)</label>
                <div class="col-md-12">
                    <input type="email" class="form-control" maxlength="36" name="i_130a_preparer_email" value="<?php echo showData('i_130a_preparer_email')?>">
                </div>
            </div>
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7 col-md-offset-5">
                    <input type="date" class="form-control" name="i_130a_preparer_sign_date" value="<?php echo showData('i_130a_preparer_sign_date')?>">
                </div>
            </div>
        </div>
        <!-- left side column end -->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="i_130a_additional_info_last_name" value="<?php echo showData('i_130a_additional_info_last_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">1.b. Given Name(First Name) </label>
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="i_130a_additional_info_first_name" value="<?php echo showData('i_130a_additional_info_first_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">1.c. Middle Name </label>
                <div class="col-md-7">
                    <input type="text" class="form-control" maxlength="26" name="i_130a_additional_info_middle_name" value="<?php echo showData('i_130a_additional_info_middle_name')?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-8 col-md-offset-4">
                    <div class="d-flexible">
                        <span></span><b>A-</b><input type="text" class="form-control"
                            name="i_130a_additional_info_a_number" maxlength="9" value="<?php echo showData('i_130a_additional_info_a_number')?>">
                    </div>
                </div>
            </div>
            <div class="d-flexible">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_3a_page_no" maxlength="2" value="<?php echo showData('i_130a_additional_info_3a_page_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">3.b. Part Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_3b_part_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_3b_part_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">3.c. Item Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_3c_item_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_3c_item_no')?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="d-flexible">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_4a_page_no" maxlength="2" value="<?php echo showData('i_130a_additional_info_4a_page_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">4.b. Part Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_4b_part_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_4b_part_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">4.c. Item Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_4c_item_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_4c_item_no')?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="d-flexible">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_5a_page_no" maxlength="2" value="<?php echo showData('i_130a_additional_info_5a_page_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">5.b. Part Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_5b_part_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_5b_part_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">5.c. Item Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_5c_item_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_5c_item_no')?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="d-flexible">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_6a_page_no" maxlength="2" value="<?php echo showData('i_130a_additional_info_6a_page_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">6.b. Part Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_6b_part_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_6b_part_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">6.c. Item Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_6c_item_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_6c_item_no')?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="d-flexible">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_7a_page_no" maxlength="2" value="<?php echo showData('i_130a_additional_info_7a_page_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">7.b. Part Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_7b_part_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_7b_part_no')?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-12">7.c. Item Number</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="i_130a_additional_info_7c_item_no" maxlength="6" value="<?php echo showData('i_130a_additional_info_7c_item_no')?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-12">
                    <span><b>7.d.</b></span>
                    <textarea class="form-control" name="i_130a_additional_info_7d" maxlength="357" class="form-control" cols="30"
                        rows="10"><?php echo showData('i_130a_additional_info_7d')?></textarea>
                </div>
            </div>
        </div>
        <!-- right side column end -->
