...
<fieldset class="setpage">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">6.a. a. In Care Of Name (if any) </label>
                <div class="col-md-12">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-md-offset-6">
                <input type="date" class="form-control" name="i_290b_appeal_or_motion_unfavorable_decision_date" maxlength="38" value="<?php echo showData('i_290b_appeal_or_motion_unfavorable_decision_date') ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-12">7. Office That Issued the Unfavorable Decision</label>
            <div class="col-md-12">
                <select class="form-control" name="i_290b_appeal_or_motion_unfavorable_decision">
                    <option value=''>Select</option>
...
<fieldset class="setpage">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="text" class="form-control  " name="i_290b_interpreter_daytime_tel" maxlength="10" value="<?php echo showData('i_290b_interpreter_daytime_tel') ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-12">4. Interpreter's Mobile Telephone Number (if any)</label>
            <div class="col-md-12">
                <input type="text" class="form-control  " name="i_290b_interpreter_mobile" maxlength="10" value="<?php echo showData('i_290b_interpreter_mobile') ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-12">5. Interpreter's Email Address (if any)</label>
            <div class="col-md-12">
                <input type="text" class="form-control  " name="i_290b_interpreter_email" maxlength="39" value="<?php echo showData('i_290b_interpreter_email') ?>">
            </div>
        </div>
        <div class="bg-info">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_preparer_daytime_tel" maxlength="10" value="<?php echo showData('i_290b_preparer_daytime_tel') ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-12">4. Preparer's Mobile Telephone Number (if any)</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_preparer_mobile" maxlength="10" value="<?php echo showData('i_290b_preparer_mobile') ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-12">5. Preparer's Email Address (if any)</label>
            <div class="col-md-12">
                <input type="text" class="form-control" maxlength="39" name="i_290b_preparer_email" value="<?php echo showData('i_290b_preparer_email') ?>">
            </div>
        </div>
    </div>
    </div>
