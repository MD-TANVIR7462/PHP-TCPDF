        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-offset-7 col-md-5">
                    <span style="display: flex; justify-content: center; align-items: center;"><b>►A-</b> <input type="text" maxlength="9" style="margin-left: 5px;" class="form-control" name="n_400_a_number" value="<?php echo showData('n_400_a_number') ?>" /></span>
                </div>
            </div>
...
<fieldset class="setpage">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-check">
                    <label class="control-label" style="margin-left: 30px;"> <input class="form-check-input" type="radio" name="other_information_about_you_gender" value="male" <?php echo (showData('other_information_about_you_gender') == 'male') ? 'checked' : '' ?>> Male</label>
                </div>
                <div class="form-check">
                    <label class="control-label" style="margin-left: 30px;"> <input class="form-check-input" type="radio" name="other_information_about_you_gender" value="female" <?php echo (showData('other_information_about_you_gender') == 'female') ? 'checked' : '' ?>> Female</label>
                </div>
                <div class="form-check">
                    <label class="control-label" style="margin-left: 30px;"> <input class="form-check-input" type="radio" name="other_information_about_you_gender" value="another_gender" <?php echo (showData('other_information_about_you_gender') == 'another_gender') ? 'checked' : '' ?>> Another Gender Identity</label>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div style="width:40%; margin-left: 3%;"">
                <input  class=" form-control" type="date" name="other_information_about_you_date_of_birth" value="<?php echo showData('other_information_about_you_date_of_birth') ?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div style="width:40%; margin-left: 3%;"">
                <input  class=" form-control" type="date" name="information_about_you_lawful_permanent_resident_date" value="<?php echo showData('information_about_you_lawful_permanent_resident_date') ?>">
            </div>
        </div>
...
<fieldset class="setpage">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6 ">
            <div class="form-check">
                <label class="control-label" style="margin-left: 30px;"> <input class="form-check-input" type="radio" name="biographic_info_ethnicity" value="hispanic" <?php echo (showData('biographic_info_ethnicity') == 'hispanic') ? 'checked' : '' ?>> Hispanic or Latino</label>
            </div>
            <div class="form-check">
                <label class="control-label" style="margin-left: 30px;"> <input class="form-check-input" type="radio" name="biographic_info_ethnicity" value="nothispanic" <?php echo (showData('biographic_info_ethnicity') == 'nothispanic') ? 'checked' : '' ?>> Not Hispanic or Latino</label>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div style="margin-left:1.5%; margin-right: 1.5%;">
            <div class="row" style="display: flex; flex-wrap: wrap; margin-bottom: 10px;">
                <div class="form-group" style="flex: 3; margin-bottom: 10px;">
                    ...
                    <div style="width: 100%;">
                        <input type="text" maxlength="63" class="form-control" name="information_about_you_residence_street_number_and_name" value="<?php echo showData('information_about_you_residence_street_number_and_name') ?>" style="width: 100%; padding: 5px; margin-bottom: 5px;" />
                    </div>
                </div>
            ...
            <div class="row" style="display: flex; flex-wrap: wrap; margin-bottom: 10px; justify-items:center; align-items: center;">
                <div class="form-group" style="flex: 3; margin-bottom: 10px;">
                    ...
                    <div style="width: 100%;">
                        <input type="text" class="form-control" name="information_about_you_residence_city_or_town" maxlength="63" value="<?php echo showData('information_about_you_residence_city_or_town') ?>" style="width: 100%; padding: 5px; margin-bottom: 5px;" />
                    </div>
                </div>
                ...
                <div class="form-group" style="flex: 1; margin-bottom: 10px;">
                    ...
                    <div style="width: 100%;">
                        <input type="text" class="form-control" name="information_about_you_residence_zip" maxlength="5" value="<?php echo showData('information_about_you_residence_zip') ?>" style="width: 100%; padding: 5px; margin-bottom: 5px;" />
                    </div>
                </div>
            </div>
            <div class="row" style="display: flex; flex-wrap: wrap; margin-bottom: 10px;">
                ...
                <div class="form-group" style="flex: 1; margin-bottom: 10px;">
                    ...
                    <div style="width: 100%;">
                        <input type="text" class="form-control" name="information_about_you_residence_current_country" maxlength="37" value="<?php echo showData('information_about_you_residence_current_country') ?>" style="width: 100%; padding: 5px; margin-bottom: 5px;" />
                    </div>
                </div>
            </div>
            <div class="row" style="display: flex; flex-wrap: wrap; margin-bottom: 10px;">
                <div class="form-group" style="flex: 1; margin-bottom: 10px;">
                    ...
                    <div style="width: 100%;">
                        <input type="date" class="form-control" name="information_about_you_date_of_residence_from_date" value="<?php echo showData('information_about_you_date_of_residence_from_date') ?>" style="width: 100%; padding: 5px; margin-bottom: 5px;" />
                    </div>
                </div>
                <div class="form-group" style="flex: 1; margin-bottom: 10px;">
                    <label class="control-label" style="width: 100%; margin-bottom: 5px;">Dates of Residence: To (mm/dd/yyyy)</label>
                    <div style="width: 100%;">
                        <input type="date" class="form-control" name="information_about_you_date_of_residence_to_date" value="<?php echo showData('information_about_you_date_of_residence_to_date') ?>" style="width: 100%; padding: 5px; margin-bottom: 5px;" />
                    </div>
                </div>
            </div>
        ...
        <table border="1" style="width: 100%;">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="date" maxlength="" style="width: 100%; margin: 0; font-weight: 600;" name="n_400_information_employment_and_school_from_date[]" value="<?php echo showData('n_400_information_employment_and_school_from_date', '0') ?>"></td>
                    <td><input type="text" maxlength="15" style="width: 100%; margin: 0; font-weight: 600;" name="" value="present"></td>
                ...
                <tr>
                    ...
                    <td><input type="date" maxlength="" style="width: 100%; margin: 0; font-weight: 600;" name="n_400_information_employment_and_school_from_date[]" value="<?php echo showData('n_400_information_employment_and_school_from_date', '1') ?>"></td>
                    <td><input type="date" maxlength="" style="width: 100%; margin: 0; font-weight: 600;" name="n_400_information_employment_and_school_to_date[]" value="<?php echo showData('n_400_information_employment_and_school_to_date', '0') ?>"></td>
                ...
                <tr>
                    ...
                    <td><input type="date" maxlength="" style="width: 100%; margin: 0; font-weight: 600;" name="n_400_information_employment_and_school_from_date[]" value="<?php echo showData('n_400_information_employment_and_school_from_date', '2') ?>"></td>
                    <td><input type="date" maxlength="" style="width: 100%; margin: 0; font-weight: 600;" name="n_400_information_employment_and_school_to_date[]" value="<?php echo showData('n_400_information_employment_and_school_to_date', '1') ?>"></td>
    ...
    <table border="1" style="width: 100%;">
        ...
        <tbody>
            <tr>
                ...
                <td><input type="text" maxlength="53" style="width: 100%; margin: 0;font-weight: 600;" name="n_400_outside_the_us_country_traveled[]" value="<?php echo showData('n_400_outside_the_us_country_traveled', '0') ?>"></td>
            </tr>
            <tr>
...
<fieldset class="setpage">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        ...
        <div class=" col-md-6">
            ...
            <div class="col-md-12">
                <input type="email" class="form-control" name="n_400_applicant_email" maxlength="38" value="<?php echo showData('n_400_applicant_email') ?>">
            </div>
        </div>
    </div>
    <div class="bg-info">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        ...
        <div class=" col-md-3">
            ...
            <div class="col-md-12">
                <input type="date" class="form-control" name="n_400_applicant_sign_date" maxlength="" value="<?php echo showData('n_400_applicant_sign_date') ?>">
            </div>
        </div>
    </div>
    <input type="button" name="previous" class="previous btn btn-default" value="Previous" />
...
<fieldset class="setpage">
    ...
    <div class="bg-info">
        <h4><b>Part 12. Interpreter's Contact Information, Certification, and Signature </b></h4>
    </div>
    <div class="bg-info">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        ...
        <div class=" col-md-6">
            ...
            <div class="col-md-12">
                <input type="email" class="form-control" name="n_400_interpreter_email" maxlength="38" value="<?php echo showData('n_400_interpreter_email') ?>">
            </div>
        </div>
    </div>
    <div class="bg-info">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        ...
        <div class=" col-md-6">
            ...
            <div class="col-md-12">
                <input type="email" class="form-control" name="n_400_preparer_email" maxlength="38" value="<?php echo showData('n_400_preparer_email') ?>">
            </div>
        </div>
    </div>
    <div class="bg-info">
