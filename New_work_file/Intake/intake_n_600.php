 ...
 <p style="text-align: right"><b>Page 1 of 15</b></p>
    ...
    <div class="form-group">
        ...
        <div class="col-md-offset-7 col-md-5">
            <span style="display: flex; justify-content: center; align-items: center;"><b>►A-</b> <input type="text" maxlength="9" style="margin-left: 5px;" class="form-control" name="other_information_about_you_alien_registration_number" value="<?php echo showData('other_information_about_you_alien_registration_number') ?>" /></span>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class=" col-md-6" style='margin-bottom:20px'>
        <label class="control-label " >4. U.S. Social Security Number (if any)</label>
        <div class="col-md-12">
    ...
    <div class=" col-md-6" style='margin-bottom:20px'>
        <label class="control-label " >5. USCIS Online Account Number (if any)</label>
        <div class="col-md-12">
    ...
    <div class=" col-md-6" style='margin-bottom:20px'>
        <label class="control-label " >8. Country of Prior Citizenship or Nationality </label>
        <div class="col-md-12">
...
<fieldset class="setpage">
    ...
    <div class=" col-md-4">
        ...
        <div class="col-md-12">
            <input type="date" class="form-control" name="information_about_you_date_became_lpr" value="<?php echo showData('information_about_you_date_became_lpr') ?>">
        </div>
    </div>
    <div class=" col-md-8">
    ...
    <div class=" col-md-4">
        ...
        <div class="col-md-12"><input type="date" class="form-control" name="information_about_you_date_of_adoption"  value="<?php echo showData('information_about_you_date_of_adoption') ?>"></div>
    </div>
    <div class=" col-md-4">
        <label class="control-label " style="margin-left: 15px;">C. Date Legal Custody Began <br>(mm/dd/yyyy)</label>
        <div class="col-md-12"><input type="date" class="form-control" name="information_about_you_date_legal_custody"  value="<?php echo showData('information_about_you_date_legal_custody') ?>"></div>
    </div>
    <div class=" col-md-4" style='margin-bottom:20px'>
        <label class="control-label " style="margin-left: 15px;">D. Date Physical Custody Began <br>(mm/dd/yyyy)</label>
        <div class="col-md-12"> <input type="date" class="form-control" name="information_about_you_date_physical_custody"  value="<?php echo showData('information_about_you_date_physical_custody') ?>"> </div>
    </div>
    <div class="form-group">
...
<fieldset class="setpage">
    ...
    <div class=" col-md-5">
        ...
        <div class="col-md-12">
            <input type="date" class="form-control" name="information_about_you_date_left_us"  value="<?php echo showData('information_about_you_date_left_us') ?>">
        </div>
    </div>
    <div class=" col-md-5">
        <label class="control-label " style="margin-left: 15px;">B. Date You Returned to the <br>United States (mm/dd/yyyy) </label>
        <div class="col-md-12">
            <input type="date" class="form-control" name="information_about_you_date_returned_us"  value="<?php echo showData('information_about_you_date_returned_us') ?>">
        </div>
    </div>
        ...
        <div class="form-group col-md-4">
            ...
            <select class="form-control" name="information_about_you_place_of_entry_state"
                ...
                <?php foreach ($allDataCountry as $record) {
                    if ($record->state_code == showData('information_about_you_place_of_entry_state')) $selected = "selected";
                    else $selected = "";
                    echo "<option value='$record->state_code' $selected>$record->state_code</option>";
                } ?>
            </select>
    ...
    <div class="row form-group">
        ...
        <div class="form-group col-md-4">
            ...
            <select class="form-control" name="information_about_you_place_of_entry_state2"
                ...
                <option value=''>Select</option>
                <?php foreach ($allDataCountry as $record) {
                    if ($record->state_code == showData('information_about_you_place_of_entry_state2')) $selected = "selected";
                    else $selected = "";
                    echo "<option value='$record->state_code' $selected>$record->state_code</option>";
                } ?>
            </select>
    ...
    <div class=" bg-info col-md-12" style="margin-top:10px;">
        <h4><b>Part 4. Information About Your U.S. Citizen Biological Father (or Adoptive Father)</b></h4>
    </div>
    ...
    <div>
        <h5><b>1. Current Legal Name of U.S. Citizen Father</b> </h5>
    </div>
...
<fieldset class="setpage">
    ...
    <div class=" bg-info col-md-12" style="margin-top:10px;">
    <h4><b>Part 4. Information About Your U.S. Citizen Biological Father (or Adoptive Father) (continued)</b></h4>
    </div>
...
<fieldset class="setpage">
    ...
    <div class=" bg-info col-md-12" style="margin-top:10px;">
        <h4><b>Part 5. Information About Your U.S. Citizen Biological Mother (or Adoptive Mother)</b></h4>
    </div>
    ...
    <div class=" col-md-12" style="margin-top:10px;"><b>1. Current Legal Name of U.S. Citizen Mother </b></p>
    </div>
    <div class="row" style="margin-bottom: 20px;">
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 12px;">Family Name (Last Name)</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="biological_mother_family_last_name" maxlength="35" value="<?php echo showData('biological_mother_family_last_name') ?>">
            </div>
        </div>
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 15px;">Given Name (First Name)</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="biological_mother_given_first_name" maxlength="27" value="<?php echo showData('biological_mother_given_first_name') ?>">
            </div>
        </div>
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 15px;">Middle Name</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="biological_mother_family_middle_name" maxlength="22" value="<?php echo showData('biological_mother_family_middle_name') ?>">
            </div>
        </div>
    </div>
    <div class="row" style="margin-bottom: 20px;">
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 12px;">2. Date of Birth (mm/dd/yyyy)</label>
            <div class="col-md-12">
                <input type="date" class="form-control" name="biological_mother_date_of_birth" value="<?php echo showData('biological_mother_date_of_birth') ?>">
            </div>
        </div>
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 15px;">3. Country of Birth </label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="biological_mother_country_of_birth" maxlength="27" value="<?php echo showData('biological_mother_country_of_birth') ?>">
            </div>
        </div>
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 15px;">4. Country of Citizenship or Nationality</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="biological_mother_country_of_citizen" maxlength="27" value="<?php echo showData('biological_mother_country_of_citizen') ?>">
            </div>
        </div>
    </div>
    <input type="button" name="previous" class="previous btn btn-default" value="Previous" />
...
<fieldset class="setpage">
    ...
    <div class=" bg-info col-md-12" style="margin-top:10px;">
    <h4><b>Part 5. Information About Your U.S. Citizen Biological Mother (or Adoptive Mother) (continued)</b></h4>
    </div>
    ...
    <div class=" col-md-12" style="margin-top:10px;"><b>9. Information About U.S. Citizen Mother's Current Spouse </b></p>
    </div>
    <div class="row" style="margin-bottom: 20px;">
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 12px;">A. Family Name (Last Name)</label>
...
<fieldset class="setpage">
    ...
    <div class=" bg-info col-md-12" style="margin-top:10px;">
        <h4><b>Part 6. Physical Presence in the United States From Birth Until Filing of Form N-600</b></h4>
    </div>
...
<fieldset class="setpage">
    ...
    <div class="bg-info col-md-12" style="margin-top:10px;">
    <h4><b>Part 7. Information About Military Service of U. S. Citizen Parents</b></h4>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-12 ">
        <div class="form-group">
            ...
            <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("mlitary_service_parent_served_us_forces_mother_status") ?>U.S. Citizen Mother </label>
        </div>
    </div>
    ...
    <div class=" bg-info col-md-12" style="margin-top:10px;">
        <h4><b>Part 8. Applicant's Statement, Contact Information, Certification, and Signature</b></h4>
    </div>
    ...
    <div class="row col-md-12" style='margin-bottom:10px'>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="n_600_applicant_daytime_tel" maxlength="10" value="<?php echo showData('n_600_applicant_daytime_tel') ?>" />
        </div>
        <div class="col-md-6">
            <label class="control-label ">5. Applicant's Mobile Telephone Number (if any)</label>
            <input type="text" class="form-control" name="n_600_applicant_mobile" maxlength="10" value="<?php echo showData('n_600_applicant_mobile') ?>">
        </div>
        <div class="col-md-6">
            <label class="control-label ">6. Applicant's Email Address (if any)</label>
            <input type="email" class="form-control" name="n_600_applicant_email" maxlength="42" value="<?php echo showData('n_600_applicant_email') ?>">
        </div>
    </div>
    <div class="bg-info col-md-12" style="margin-top:10px;">
        <h4><b><i>Applicant's Certification</i></b></h4>
    </div>
    <p class="form-group">
...
<fieldset class="setpage">
    ...
    <div class=" bg-info col-md-12" style="margin-top:10px;">
    <h4><b>Part 8. Applicant's Statement, Contact Information, Certification, and Signature (continued)</b></h4>
    </div>
...
<fieldset class="setpage">
    ...
    <div class="row col-md-12">
        ...
        <div class=" bg-info col-md-12" style="margin-top:10px;">
            <h4><b>Part 10. Contact Information, Declaration, and Signature of the Person Preparing this Application, if Other Than the Applicant </b></h4>
        </div>
...
<fieldset class="setpage">
    ...
    <div class=" bg-info col-md-12" style="margin-top:10px;">
    <h4><b>Part 10. Contact Information. Declaration, and Signature of the Person Preparing this Application, if Other Than the Applicant (continued)</b></h4>
    </div>
    <div class=" bg-info col-md-12" style="margin-top:10px;">
...
<fieldset class="setpage">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        <div class=" col-md-8">
            ...
            <input type="text" class="form-control" disabled name"  disabled value="<?php echo showData('') ?>">

        </div>
        <div class=" col-md-4">
            <label class="control-label ">Date of Signature (mm/dd/yyyy)</label>
            <input type="date" class="form-control" name=""  disabled value="<?php echo showData('') ?>">
        </div>
    </div>
    <div class="row form-group" style="margin-bottom: 20px;">
        <div class=" col-md-8">
            ...
            <input type="text" class="form-control" name=""  disabled value="<?php echo showData('') ?>">
    ...
    <div class="bg-info">
        <h4><b>Part 13. Officer Report and Recommendation on Application for Certificate of Citizenship (for USCIS use ONLY)</b></h4>
    </div>
...
<fieldset class="setpage">
    ...
    <div class=" col-md-4">
        ...
        <input type="text" class="form-control" name="information_a" 
    ...
    <div class=" col-md-4" style='margin-bottom:20px'>
        ...
        <input type="text" class="form-control" name="informat" 
            disabled value="<?php echo showData('') ?>">
