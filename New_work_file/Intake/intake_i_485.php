...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 1 of 20</b></p>
    </div>
        ...
        <div class="" style="padding:2%">
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <br> <br> <br>
                    <input type="text" maxlength="10" class="form-control" value="<?php echo $attorneyData->volag_number ?>" disabled />
                </div>
                <div class="col-lg-3">
                    <label class=""> <span class="font-weight-bold">Attorney State Bar Number</span> (if
                        applicable)</label>
                    <br> <br>
                    <input type="text" maxlength="15" class="form-control" value="<?php echo $attorneyData->bar_number ?>" disabled />
                </div>
                <div class="col-lg-3">
                    <label class="control-label">Attorney or According Representative USCIS Online
                        Account Number (if any)</label>
                    <input type="text" class="form-control" maxlength="12" value="<?php echo $attorneyData->uscis_online_account_number ?>" disabled />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_a_number" maxlength="9" value="<?php echo showData('i_485_a_number') ?>" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div>
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="date" class="form-control" name="other_information_about_you_date_of_birth" maxlength="28" value="<?php echo showData('other_information_about_you_date_of_birth') ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="other_information_about_you_city_of_birth" maxlength="60" value="<?php echo showData('other_information_about_you_city_of_birth') ?>">
                    </div>
                </div>
            </div>
        </div>
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 2 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" maxlength="35" class="form-control" name="information_about_you_us_mailing_care_of_name" value="<?php echo showData('information_about_you_us_mailing_care_of_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">12.b. Street Number and Name</label>
                <div class="col-md-12">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_us_mailing_street_number" value="<?php echo showData('information_about_you_us_mailing_street_number') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" maxlength="7" class="form-control" name="information_about_you_us_mailing_apt_ste_flr_value" value="<?php echo showData('information_about_you_us_mailing_apt_ste_flr_value') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">12.d. City or Town </label>
                <div class="col-md-7">
                    <input type="text" maxlength="20" class="form-control" name="information_about_you_us_mailing_city_town" value="<?php echo showData('information_about_you_us_mailing_city_town') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" maxlength="7" class="form-control" name="information_about_you_us_mailing_zip_code" value="<?php echo showData('information_about_you_us_mailing_zip_code') ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" maxlength="35" class="form-control" name="information_about_you_mailing_care_of_name" value="<?php echo showData('information_about_you_mailing_care_of_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">13.b. Street Number and Name</label>
                <div class="col-md-12">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_mailing_street_number" value="<?php echo showData('information_about_you_mailing_street_number') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" maxlength="7" class="form-control" name="information_about_you_mailing_apt_ste_flr_value" value="<?php echo showData('information_about_you_mailing_apt_ste_flr_value') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">13.d. City or Town </label>
                <div class="col-md-7">
                    <input type="text" maxlength="20" class="form-control" name="information_about_you_mailing_city_town" value="<?php echo showData('information_about_you_mailing_city_town') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" maxlength="7" class="form-control" name="information_about_you_mailing_zip_code" value="<?php echo showData('information_about_you_mailing_zip_code') ?>" />
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" maxlength="38" class="form-control" name="other_information_about_you_travel_document_number" value="<?php echo showData('other_information_about_you_travel_document_number') ?>" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" maxlength="29" class="form-control" name="i_94_imgt_country_issuance_passport" value="<?php echo showData('i_94_imgt_country_issuance_passport') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">22. Nonimmigrant Visa Number from this Passport (if any)</label>
                <div class="col-md-12">
                    <input type="text" maxlength="38" class="form-control" name="i_94_imgt_nonimmigrant_visa_number" value="<?php echo showData('i_94_imgt_nonimmigrant_visa_number') ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" maxlength="29" class="form-control" name="i_94_imgt_city_town" value="<?php echo showData('i_94_imgt_city_town') ?>" />
                </div>
            </div>
            <div class="form-group">
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 3 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_485_25a_inspected_admited_status_text_value" maxlength="29" value="<?php echo showData('i_485_25a_inspected_admited_status_text_value') ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_485_25b_inspected_port_entry_status_text_value" maxlength="29" value="<?php echo showData('i_485_25b_inspected_port_entry_status_text_value') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_485_25c_admission_parole_status_text_value" maxlength="29" value="<?php echo showData('i_485_25c_admission_parole_status_text_value') ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-md-offset-4">
                    <input type="text" maxlength="29" class="form-control" name="i_94_imgt_arrival_record_number" value="<?php echo showData('i_94_imgt_arrival_record_number') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">26.b. Expiration Date of Authorized Stay Shown on Form I-94 (mm/dd/yyyy)</label>
                <div class="col-md-8 col-md-offset-4">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">26.c. Status on Form I-94 (for example, class of admission, or paroled, if paroled)</label>
                <div class="col-md-8 col-md-offset-4">
                    <input type="text" class="form-control" name="i_94_status_on_form" value="<?php echo showData('i_94_status_on_form') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-8 col-md-offset-4">
                    <input type="text" class="form-control" name="i_94_current_immigration_status_changed" value="<?php echo showData('i_94_current_immigration_status_changed') ?>" />
                </div>
            </div>
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 4 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <input type="text" maxlength="29" class="form-control" name="i_485_part2_1g_other_eligibility_status_text_value" value="<?php echo showData('i_485_part2_1g_other_eligibility_status_text_value') ?>" />
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" maxlength="38" name="i_485_info_about_you_part2_3_receipt_number_underlying" class="form-control" value="<?php echo showData("i_485_info_about_you_part2_3_receipt_number_underlying") ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="date" name="i_485_info_about_you_part2_4_periority_date" class="form-control" value="<?php echo showData("i_485_info_about_you_part2_4_periority_date") ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_principal_applicant_family_last_name" maxlength="29" value="<?php echo showData('i_485_principal_applicant_family_last_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">5.b. Given Name(First Name)</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_principal_applicant_given_first_name" maxlength="29" value="<?php echo showData('i_485_principal_applicant_given_first_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">5.c. Middle Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_principal_applicant_middle_name" maxlength="29" value="<?php echo showData('i_485_principal_applicant_middle_name') ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="date" class="form-control" name="i_485_principal_applicant_a_number" maxlength="29" value="<?php echo showData('i_485_principal_applicant_a_number') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="date" class="form-control" name="i_485_principal_applicant_date_of_birth" maxlength="29" value="<?php echo showData('i_485_principal_applicant_date_of_birth') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_485_principal_applicant_receipt_number" maxlength="29" value="<?php echo showData('i_485_principal_applicant_receipt_number') ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="date" class="form-control" name="i_485_principal_applicant_priority_date" maxlength="29" value="<?php echo showData('i_485_principal_applicant_priority_date') ?>" />
                </div>
            </div>
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 5 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <p>Provide physical addresses for everywhere you have lived during the last five years, whether inside or outside the United States. Provide your current address first. If you need extra space to complete this section, use the space provided in</p>
            <p><b>Part 14. Additional Information.</b></p>
            <p>Physical Address 1 (current address)</p>
            <div class="form-group">
                <label class="control-label col-md-5">5.a. Street Number and Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_home_street_number" maxlength="28" value="<?php echo showData('information_about_you_home_street_number') ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_home_city_town" maxlength="20" value="<?= showData('information_about_you_home_city_town') ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_home_street_number2" maxlength="28" value="<?php echo showData('information_about_you_home_street_number2') ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_home_city_town2" maxlength="20" value="<?= showData('information_about_you_home_city_town2') ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_home_province2" value="<?php echo showData('information_about_you_home_province2') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">7.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_home_postal_code2" value="<?php echo showData('information_about_you_home_postal_code2') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">7.h. Country</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_home_country2" value="<?php echo showData('information_about_you_home_country2') ?>" />
                </div>
            </div>
            <p>Dates of Residence</p>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <p>Provide your most recent address outside the United States where you lived for more than one year (if not already listed above).</p>
            <div class="form-group">
                <label class="control-label col-md-5">9.a. Street Number and Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_outside_us_street_number" maxlength="28" value="<?php echo showData('information_about_you_outside_us_street_number') ?>">
                </div>
            </div>
            <div class="form-group">
                <div class="control-label col-md-6"><b>9.b. </b> &nbsp;
                    <input type="radio" name="information_about_you_outside_us_apt_ste_flr" value="apt" <?php echo (showData('information_about_you_outside_us_apt_ste_flr') == 'apt') ? 'checked' : ''; ?>> Apt. &nbsp;
                    <input type="radio" name="information_about_you_outside_us_apt_ste_flr" value="ste" <?php echo (showData('information_about_you_outside_us_apt_ste_flr') == 'ste') ? 'checked' : ''; ?>> Ste. &nbsp;
                    <input type="radio" name="information_about_you_outside_us_apt_ste_flr" value="flr" <?php echo (showData('information_about_you_outside_us_apt_ste_flr') == 'flr') ? 'checked' : ''; ?>> Flr.:
                </div>
                <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_outside_us_city_town" maxlength="20" value="<?= showData('information_about_you_outside_us_city_town') ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_outside_us_province" value="<?php echo showData('information_about_you_outside_us_province') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">9.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_outside_us_postal_code" value="<?php echo showData('information_about_you_outside_us_postal_code') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">9.h. Country</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_outside_us_country" value="<?php echo showData('information_about_you_outside_us_country') ?>" />
                </div>
            </div>
            <p>Dates of Residence</p>
            <div class="form-group">
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 6 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <p>Provide your most recent employment outside of the United States (if not already listed above).</p>
            <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="bg-info">
                <h4><b>Part 4. Information About Your Parents</b></h4>
            </div>
            <div class="bg-info">
                <h4><b><i>Information About Your Parent 1</i></b></h4>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="date" class="form-control" name="parent1_info_date_of_birth" value="<?= showData('parent1_info_date_of_birth') ?>" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="parent1_info_city_of_birth" maxlength="28" value="<?php echo showData('parent1_info_city_of_birth') ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">6. Country of Birth</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="parent1_info_country_of_birth" maxlength="28" value="<?php echo showData('parent1_info_country_of_birth') ?>">
                </div>
            </div>
        </div>
    </div>
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 07 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="29" class="form-control" name="parent1_info_current_city_of_residence" value="<?php echo showData('parent1_info_current_city_of_residence') ?>"><br>
                <label>8. Current Country of Residence (if living):</label><br>
                <input type="text" maxlength="29" class="form-control" name="parent1_info_current_country_of_residence" value="<?php echo showData('parent1_info_current_country_of_residence') ?>">
            </div>
            <div class="bg-info">
                <h4><b><i>Information About Your Parent 2 </i></b></h4>
            </div>
            <p>Parent 2's Legal Name:</p><br>
            <div class="form-group">
                <label class="control-label col-md-5">9.a. Family Name (Last Name):</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="parent2_info_family_last_name" value="<?php echo showData('parent2_info_family_last_name') ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="parent2_info_middle_name" value="<?php echo showData('parent2_info_middle_name') ?>">
                </div>
            </div>
            <p>Parent 2's Name at Birth (if different than above):</p><br>
            <div class="form-group">
                <label class="control-label col-md-5">10.a. Family Name (Last Name):</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="parent2_info_at_birth_family_last_name" value="<?php echo showData('parent2_info_at_birth_family_last_name') ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">10.b. Given Name (First Name):</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="parent2_info_at_birth_given_first_name" value="<?php echo showData('parent2_info_at_birth_given_first_name') ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">10.c. Middle Name:</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="parent2_info_at_birth_middle_name" value="<?php echo showData('parent2_info_at_birth_middle_name') ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">11. Date of Birth (mm/dd/yyyy):</label>
                <div class="col-md-7">
                    <input type="date" class="form-control" name="parent2_info_date_of_birth" value="<?php echo showData('parent2_info_date_of_birth') ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">12. Sex:</label>
                <div class="col-md-7">
            ...
            <div class="form-group">
                <label class="control-label col-md-5">13. City or Town of Birth:</label>
                <div class="col-md-7">
                    <input type="text" maxlength="20" class="form-control" name="parent2_info_city_of_birth" value="<?php echo showData('parent2_info_city_of_birth') ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">14. Country of Birth:</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="parent2_info_country_of_birth" value="<?php echo showData('parent2_info_country_of_birth') ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">15. Current City or Town of Residence (if living):</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="parent2_info_current_city_of_residence" value="<?php echo showData('parent2_info_current_city_of_residence') ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">16. Current Country of Residence (if living):</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="parent2_info_current_country_of_residence" value="<?php echo showData('parent2_info_current_country_of_residence') ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="other_information_about_you_marital_status" value="single" <?php echo (showData('other_information_about_you_marital_status') == 'single') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="marital-single">Single, Never Married</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="other_information_about_you_marital_status" value="married" <?php echo (showData('other_information_about_you_marital_status') == 'married') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="marital-married">Married</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="other_information_about_you_marital_status" value="divorced" <?php echo (showData('other_information_about_you_marital_status') == 'divorced') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="marital-divorced">Divorced</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="other_information_about_you_marital_status" value="widowed" <?php echo (showData('other_information_about_you_marital_status') == 'widowed') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="marital-widowed">Widowed</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="other_information_about_you_marital_status" value="annulled" <?php echo (showData('other_information_about_you_marital_status') == 'annulled') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="marital-annulled">Marriage Annulled</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="other_information_about_you_marital_status" value="separated" <?php echo (showData('other_information_about_you_marital_status') == 'separated') ? 'checked' : '' ?>>
            ...
            <div class="form-group">
                <label>2. If you are married, is your spouse a current member of the U.S. armed forces or U.S. Coast
                    Guard?</label>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="current_spouse_us_armed_force" value="na" <?php echo (showData('current_spouse_us_armed_force') == 'NA') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="spouse-military-na">N/A</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="current_spouse_us_armed_force" value="yes" <?php echo (showData('current_spouse_us_armed_force') == 'Y') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="spouse-military-yes">Yes</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="current_spouse_us_armed_force" value="no" <?php echo (showData('current_spouse_us_armed_force') == 'N') ? 'checked' : '' ?>>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>3. How many times have you been married (including annulled marriages and marriages to the same
                    person)?</label>
                <input type="number" class="form-control" name="other_information_about_you_total_married" value="<?php echo showData('other_information_about_you_total_married') ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="29" class="form-control" name="current_spouse_a_number" value="<?php echo showData('current_spouse_a_number') ?>">
            </div>
            <div class="form-group">
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 08 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <p class="bg-info"><i>Information About Prior Marriages (if any)</i></p>
            ...
            <section>
                ...
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_family_last_name" value="<?php echo showData('prior_spouse1_family_last_name') ?>"><br>

                <label>11.b. Given Name (First Name):</label><br>
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_given_first_name" value="<?php echo showData('prior_spouse1_given_first_name') ?>"><br>

                <label>11.c. Middle Name:</label><br>
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_middle_name" value="<?php echo showData('prior_spouse1_middle_name') ?>"><br>

                <label>12. Prior Spouse's Date of Birth:</label><br>
                <input type="date" class="form-control" name="prior_spouse1_date_of_birth" value="<?php echo showData('prior_spouse1_date_of_birth') ?>"><br>

                <label>13. Date of Marriage to Prior Spouse:</label><br>
                <input type="date" class="form-control" name="prior_spouse1_date_of_marriage" value="<?php echo showData('prior_spouse1_date_of_marriage') ?>"><br>

                <label>Place of Marriage to Prior Spouse:</label><br>
                <label>14.a. City or Town:</label><br>
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_marriage_place_city_town" value="<?php echo showData('prior_spouse1_marriage_place_city_town') ?>"><br>
                <label>14.b. State or Province:</label><br>
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_marriage_place_province" value="<?php echo showData('prior_spouse1_marriage_place_province') ?>"><br>
                <label>14.c. Country:</label><br>
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_marriage_place_country" value="<?php echo showData('prior_spouse1_marriage_place_country') ?>"><br>

                <label>15. Date Marriage with Prior Spouse Legally Ended:</label><br>
                <input type="date" class="form-control" name="prior_spouse1_marriage_end_date" value="<?php echo showData('prior_spouse1_marriage_end_date') ?>"><br>
                <label>Place Where Marriage with Prior Spouse Legally Ended:</label><br>
                <label>16.a. City or Town:</label><br>
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_marriage_end_city_town" value="<?php echo showData('prior_spouse1_marriage_end_city_town') ?>"><br>
                <label>16.b. State or Province:</label><br>
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_marriage_end_province" value="<?php echo showData('prior_spouse1_marriage_end_province') ?>"><br>
                <label>16.c. Country:</label><br>
                <input type="text" maxlength="29" class="form-control" name="prior_spouse1_marriage_end_country" value="<?php echo showData('prior_spouse1_marriage_end_country') ?>"><br>
        ...
        ******************************************-->
        <div class="col-md-6">
            ...
            <div>
                ...
                <input type="text" maxlength="29" class="form-control" name="total_number_of_all_children" value="<?php echo showData('total_number_of_all_children') ?>">
                ...
                <div>
                    ...
                    <input type="text" maxlength="29" class="form-control" name="child1_family_last_name" value="<?php echo showData('child1_family_last_name') ?>"><br>

                    <label>2.b. Given Name (First Name):</label><br>
                    <input type="text" maxlength="29" class="form-control" name="child1_given_first_name" value="<?php echo showData('child1_given_first_name') ?>"><br>

                    <label>2.c. Middle Name:</label><br>
                    <input type="text" maxlength="29" class="form-control" name="child1_middle_name" value="<?php echo showData('child1_middle_name') ?>"><br>

                    <label>3. A-Number (if any):</label><br>

                    <input type="text" maxlength="29" class="form-control" name="child1_a_number" value="<?php echo showData('child1_a_number') ?>"><br>

                    <label>4. Date of Birth (mm/dd/yyyy):</label><br>
                    <input type="date" class="form-control" name="child1_date_of_birth" value="<?php echo showData('child1_date_of_birth') ?>"><br>

                    <label>5. Country of Birth:</label><br>
                    <input type="text" maxlength="29" class="form-control" name="child1_country_of_birth" value="<?php echo showData('child1_country_of_birth') ?>"><br>
                    ...
                    <span><label>6. Is this child applying with you?</label><br>
                        ...
                        <div>
                            ...
                            <input type="text" maxlength="29" class="form-control" name="child2_family_last_name" value="<?php echo showData('child2_family_last_name') ?>"><br>

                            <label>7.b. Given Name (First Name):</label><br>
                            <input type="text" maxlength="29" class="form-control" name="child2_given_first_name" value="<?php echo showData('child2_given_first_name') ?>"><br>

                            <label>7.c. Middle Name:</label><br>
                            <input type="text" maxlength="29" class="form-control" name="child2_middle_name" value="<?php echo showData('child2_middle_name') ?>"><br>

                            <label>8. A-Number (if any):</label><br>

                            <input type="text" maxlength="9" class="form-control" name="child2_a_number" value="<?php echo showData('child2_a_number') ?>"><br>

                            <label>9. Date of Birth (mm/dd/yyyy):</label><br>
                            <input type="date" class="form-control" name="child2_date_of_birth" value="<?php echo showData('child2_date_of_birth') ?>"><br>

                            <label>10. Country of Birth:</label><br>
                            <input type="text" maxlength="38" class="form-control" name="child2_country_of_birth" value="<?php echo showData('child2_country_of_birth') ?>"><br>
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 09 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
                <h4 class="heading-md"><b>Part 6. Information About Your Children (continued)</b></h4>
            </div>
            <p>Child 3</p>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="9" class="form-control" name="child3_a_number" value="<?php echo showData('child3_a_number') ?>">
            </div>
            <div class="form-group">
            ...
            <h4 class="bg-info" style="padding:7px"><b>Part 7. Biographic Information</b></h4>
            <div class="form-group">
        ...
        <!-- left side end -->
        <div class="col-md-6">
            <h4 class="bg-info" style="padding:7px">Part 8. General Eligibility and Inadmissibility Grounds</h4>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="29" class="form-control" name="organaization1_name" value="<?php echo showData('organaization1_name') ?>">
            </div>
            <div class="form-group">
                <label>3.a. City or Town</label>
                <input type="text" maxlength="29" class="form-control" name="organaization1_city_town" value="<?php echo showData('organaization1_city_town') ?>">
            </div>
            <div class="form-group">
                <label>3.b. State or Province</label>
                <input type="text" maxlength="29" class="form-control" name="organaization1_province" value="<?php echo showData('organaization1_province') ?>">
            </div>
            <div class="form-group">
                <label>3.c. Country</label>
                <input type="text" maxlength="29" class="form-control" name="organaization1_country" value="<?php echo showData('organaization1_country') ?>">
            </div>
            <div class="form-group">
                <label>4. Nature of Group</label>
                <input type="text" maxlength="29" class="form-control" name="organaization1_nature" value="<?php echo showData('organaization1_nature') ?>">
            </div>
            <!-- Dates of Membership or Involvement -->
            <p>Dates of Membership or Dates of Involvement</p> <br>
            <div class="form-group">
                <label>5.a. From (mm/dd/yyyy)</label>
                <input type="date" class="form-control" name="organaization1_from_date" value="<?php echo showData('organaization1_from_date') ?>">
            </div>
            <div class="form-group">
                <label for="endDate">5.b. To (mm/dd/yyyy)</label>
                <input type="date" class="form-control" name="organaization1_to_date" value="<?php echo showData('organaization1_to_date') ?>">
            </div>
            <hr>
            <p>Organization 2</p><br>
            <div class="form-group">
                <label>6. Name of Organization</label>
                <input type="text" maxlength="29" class="form-control" name="organaization2_name" value="<?php echo showData('organaization2_name') ?>">
            </div>
            <div class="form-group">
                <label>7.a. City or Town</label>
                <input type="text" maxlength="29" class="form-control" name="organaization2_city_town" value="<?php echo showData('organaization2_city_town') ?>">
            </div>
            <div class="form-group">
                <label>7.b. State or Province</label>
                <input type="text" maxlength="29" class="form-control" name="organaization2_province" value="<?php echo showData('organaization2_province') ?>">
            </div>
            <div class="form-group">
                <label>7.c. Country</label>
                <input type="text" maxlength="29" class="form-control" name="organaization2_country" value="<?php echo showData('organaization2_country') ?>">
            </div>
            <div class="form-group">
                <label>8. Nature of Group</label>
                <input type="text" maxlength="29" class="form-control" name="organaization2_nature" value="<?php echo showData('organaization2_nature') ?>">
            </div>
        </div>
    </div>
    <input type="button" name="previous" class="previous btn btn-default" value="Previous" />
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 10 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="organaization2_from_date" value="<?php echo showData('organaization2_from_date') ?>">
            </div>
            <div class="form-group">
                <label>9.b. To (mm/dd/yyyy)</label>
                <input type="date" class="form-control" name="organaization2_to_date" value="<?php echo showData('organaization2_to_date') ?>">
            </div>
            <hr>
            <p>Organization 3
            </p> <br>
            <div class="form-group">
                ...
                <input type="text" maxlength="29" class="form-control" name="organaization3_name" value="<?php echo showData('organaization3_name') ?>">
            </div>
            <div class="form-group">
                <label>11.a. City or Town</label>
                <input type="text" maxlength="29" class="form-control" name="organaization3_city_town" value="<?php echo showData('organaization3_city_town') ?>">
            </div>
            <div class="form-group">
                <label>11.b. State or Province</label>
                <input type="text" maxlength="29" class="form-control" name="organaization3_province" value="<?php echo showData('organaization3_province') ?>">
            </div>
            <div class="form-group">
                <label>11.c. Country</label>
                <input type="text" maxlength="29" class="form-control" name="organaization3_country" value="<?php echo showData('organaization3_country') ?>">
            </div>
            <div class="form-group">
                <label>12. Nature of Group</label>
                <input type="text" maxlength="29" class="form-control" name="organaization3_nature" value="<?php echo showData('organaization3_nature') ?>">
            </div>
            <!-- Dates of Membership or Involvement -->
            <p>Dates of Membership or Dates of Involvement</p><br>
            <div class="form-group">
                <label>13. From (mm/dd/yyyy)</label>
                <input type="date" class="form-control" name="organaization3_from_date" value="<?php echo showData('organaization3_from_date') ?>">
            </div>
            <div class="form-group">
                <label>13.b. To (mm/dd/yyyy)</label>
                <input type="date" class="form-control" name="organaization3_to_date" value="<?php echo showData('organaization3_to_date') ?>">
            </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="col-md-12">20. Have you EVER had a prior final order of exclusion, deportation, or removal reinstated?</label>
                <div class="col-md-6 col-md-offset-2">
                    <?php echo createRadio("i_485_20_prior_final_order_status") ?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-12">21. Have you EVER held lawful permanent resident status which was later rescinded?</label>
                <div class="col-md-6 col-md-offset-2">
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 11 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 12 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <div class="bg-info">
                <h4><i>Security and Related </i></h4>
            </div>
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 13 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
                <h4><b>Part 8. General Eligibility and Inadmissibility Grounds </b>(continued)
                </h4>
            </div>
            <h5>Do you intend to : </h5>
            <div class="form-group">
        ...
        <div class="col-md-6 ">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">62. What is the size of your household?</label>
                <div class="col-md-12">
            ...
            <div class="control-label"><b>63. Indicate your annual household income.</b> &nbsp;<br>
                <input type="radio" name="i_485_general_eligibility_household_income" value="a" <?php echo (showData('i_485_general_eligibility_household_income') == 'a') ? 'checked' : '' ?>> $0-27,000 &nbsp; <br>

                <input type="radio" name="i_485_general_eligibility_household_income" value="b" <?php echo (showData('i_485_general_eligibility_household_income') == 'b') ? 'checked' : '' ?>> $27,001-52,000 &nbsp;<br>

                <input type="radio" name="i_485_general_eligibility_household_income" value="c" <?php echo (showData('i_485_general_eligibility_household_income') == 'c') ? 'checked' : '' ?>> $52,001-85,000 &nbsp;<br>

                <input type="radio" name="i_485_general_eligibility_household_income" value="d" <?php echo (showData('i_485_general_eligibility_household_income') == 'd') ? 'checked' : '' ?>> $85,001-141,000<br>

                <input type="radio" name="i_485_general_eligibility_household_income" value="e" <?php echo (showData('i_485_general_eligibility_household_income') == 'e') ? 'checked' : '' ?>> Over $141,000<br>
            </div>
            <div class="control-label"><b>64. Identify the total value of your household assets.</b> &nbsp;<br>
                <input type="radio" name="i_485_general_eligibility_household_assets" value="a" <?php echo (showData('i_485_general_eligibility_household_assets') == 'a') ? 'checked' : '' ?>> $0-18,400 &nbsp; <br>
                <input type="radio" name="i_485_general_eligibility_household_assets" value="b" <?php echo (showData('i_485_general_eligibility_household_assets') == 'b') ? 'checked' : '' ?>> $18,401-136,000 &nbsp;<br>

                <input type="radio" name="i_485_general_eligibility_household_assets" value="c" <?php echo (showData('i_485_general_eligibility_household_assets') == 'c') ? 'checked' : '' ?>> $136,001-321,400 &nbsp;<br>

                <input type="radio" name="i_485_general_eligibility_household_assets" value="d" <?php echo (showData('i_485_general_eligibility_household_assets') == 'd') ? 'checked' : '' ?>> $321,401-707,100<br>

                <input type="radio" name="i_485_general_eligibility_household_assets" value="e" <?php echo (showData('i_485_general_eligibility_household_assets') == 'e') ? 'checked' : '' ?>> Over $707,100<br>
            </div>
        </div>
    </div>
    <input type="button" name="previous" class="previous btn btn-default" value="Previous" />
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 14 of 20</b></p>
    </div>
    <div class="row">
        <div class="bg-info">
            <h4 class="heading-md"><b>Part 8. General Eligibility and Inadmissibility Grounds </b>(continued)</h4>
        </div>
        <div class="control-label" style="margin: 20px;"><b>65. Identify the total value of your household liabilities
            ...
            <input type="radio" name="i_485_general_eligibility_household_liabilities" value="a" <?php echo (showData('i_485_general_eligibility_household_liabilities') == 'a') ? 'checked' : '' ?>> $0&nbsp;<br>

            <input type="radio" name="i_485_general_eligibility_household_liabilities" value="b" <?php echo (showData('i_485_general_eligibility_household_liabilities') == 'b') ? 'checked' : '' ?>> $1-10,100 &nbsp; <br>

            <input type="radio" name="i_485_general_eligibility_household_liabilities" value="c" <?php echo (showData('i_485_general_eligibility_household_liabilities') == 'c') ? 'checked' : '' ?>> $10,101-57,700 &nbsp; <br>

            <input type="radio" name="i_485_general_eligibility_household_liabilities" value="d" <?php echo (showData('i_485_general_eligibility_household_liabilities') == 'd') ? 'checked' : '' ?>> $57,701-186,800 <br>

            <input type="radio" name="i_485_general_eligibility_household_liabilities" value="e" <?php echo (showData('i_485_general_eligibility_household_liabilities') == 'e') ? 'checked' : '' ?>> Over $186,800 <br>
        </div>
        <div class="control-label" style="margin: 20px;"><b>66. What is the highest degree or level of school you have
                completed? </b>&nbsp;<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="grades1_11" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'grades1_11') ? 'checked' : '' ?>> Grades 1 through 11 &nbsp;<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="grades11_nodiploma" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'grades11_nodiploma') ? 'checked' : '' ?>> 12th grade - no diploma&nbsp;<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="high_school_credential" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'high_school_credential') ? 'checked' : '' ?>> High school diploma, GED, or alternative credential&nbsp;<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="no_degree" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'no_degree') ? 'checked' : '' ?>> 1 or more years of college credit, no degree<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="associate_degree" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'associate_degree') ? 'checked' : '' ?>> Associate's degree<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="bachelor_degree" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'bachelor_degree') ? 'checked' : '' ?>> Bachelor's degree<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="master_degree" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'master_degree') ? 'checked' : '' ?>> Master's degree<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="professional_degree" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'professional_degree') ? 'checked' : '' ?>> Professional degree (JD, MD, DMD, etc.)<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="doctorate_degree" <?php echo (showData('i_485_general_eligibility_highest_degree') == 'doctorate_degree') ? 'checked' : '' ?>> Doctorate degree<br>
        </div>
        <div class="form-group">
            <div class="col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <table border="1" style="width: 100%;">
                    ...
                    <tbody>
                        <tr>
                            <td><input type="text" maxlength="33" style="width: 100%; margin: 0;" name="i_485_general_eligibility_benefit_receive[]" value="<?php echo showData('i_485_general_eligibility_benefit_receive', '0') ?>"></td>

                            <td><input type="date" style="width: 100%; margin: 0;" name="i_485_general_eligibility_benefit_start_date[]" value="<?php echo showData('i_485_general_eligibility_benefit_start_date', '0') ?>"></td>
                        ...
                        <tr>
                            <td><input type="text" maxlength="33" style="width: 100%; margin: 0;" name="i_485_general_eligibility_benefit_receive[]" value="<?php echo showData('i_485_general_eligibility_benefit_receive', '1') ?>"></td>

                            <td><input type="date" style="width: 100%; margin: 0;" name="i_485_general_eligibility_benefit_start_date[]" value="<?php echo showData('i_485_general_eligibility_benefit_start_date', '1') ?>"></td>
                        ...
                        <tr>
                            <td><input type="text" maxlength="33" style="width: 100%; margin: 0;" name="i_485_general_eligibility_benefit_receive[]" value="<?php echo showData('i_485_general_eligibility_benefit_receive', '2') ?>"></td>

                            <td><input type="date" style="width: 100%; margin: 0;" name="i_485_general_eligibility_benefit_start_date[]" value="<?php echo showData('i_485_general_eligibility_benefit_start_date', '2') ?>"></td>
                        ...
                        <tr>
                            <td><input type="text" maxlength="33" style="width: 100%; margin: 0;" name="i_485_general_eligibility_benefit_receive[]" value="<?php echo showData('i_485_general_eligibility_benefit_receive', '3') ?>"></td>
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 15 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <h4 class="bg-info"><i>Removal, Unlawful Presence, or Illegal Reentry After Previous Immigration Violations</i></h4>
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_485_interpreter_given_first_name" maxlength="39" value="<?php echo showData('i_485_interpreter_given_first_name') ?>" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_interpreter_address_street_number" maxlength="25" value="<?php echo showData('i_485_interpreter_address_street_number') ?>" />
                </div>
            </div>
            <div class="form-group">
                <div class="control-label col-md-6"><b>3.b. </b> &nbsp;
                    <input type="radio" name="i_485_interpreter_address_apt_ste_flr" value="apt" <?php echo (showData('i_485_interpreter_address_apt_ste_flr') === 'apt') ? 'checked' : ''; ?>>
                    Apt. &nbsp;
                    <input type="radio" name="i_485_interpreter_address_apt_ste_flr" value="ste" <?php echo (showData('i_485_interpreter_address_apt_ste_flr') === 'ste') ? 'checked' : ''; ?>>
                    Ste. &nbsp;
                    <input type="radio" name="i_485_interpreter_address_apt_ste_flr" value="flr" <?php echo (showData('i_485_interpreter_address_apt_ste_flr') === 'flr') ? 'checked' : ''; ?>>
                    Flr.:
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" class="form-control" name="i_485_interpreter_address_apt_ste_flr_value" maxlength="6" value="<?php echo showData('i_485_interpreter_address_apt_ste_flr_value') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.c. City or Town</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_interpreter_address_city_town" maxlength="20" value="<?php echo showData('i_485_interpreter_address_city_town') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.d. State</label>
                <div class="col-md-7">
                    <select class="form-control" name="i_485_interpreter_address_state">
                        <option style="" value=''>Select</option>
                        <?php
                        foreach ($allDataCountry as $record) {
                            if ($record->state_code == showData('i_485_interpreter_address_state')) $selected = "selected";
                            else $selected = "";
                            echo "<option value='$record->state_code' $selected>$record->state_code</option>";
                        }
                        ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_interpreter_address_zip_code" maxlength="5" value="<?php echo showData('i_485_interpreter_address_zip_code') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.f. Province</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_interpreter_address_province" maxlength="20" value="<?php echo showData('i_485_interpreter_address_province') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_interpreter_address_postal_code" maxlength="9" value="<?php echo showData('i_485_interpreter_address_postal_code') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">3.h. Country</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_485_interpreter_address_country" maxlength="39" value="<?php echo showData('i_485_interpreter_address_country') ?>" />
                </div>
            </div>
            <div class="bg-info">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_485_preparer_given_first_name" maxlength="39" value="<?php echo showData('i_485_preparer_given_first_name') ?>" />
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="control-label col-md-5">3.a. Street Number and Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_preparer_address_street_number" maxlength="25" value="<?php echo showData('i_485_preparer_address_street_number') ?>" />
                </div>
            </div>
            <div class="form-group">
                <div class="control-label col-md-6"><b>3.b. </b> &nbsp;
                    <input type="radio" name="i_485_preparer_address_apt_ste_flr" value="apt" <?php echo (showData('i_485_preparer_address_apt_ste_flr') === 'apt') ? 'checked' : ''; ?>>
                    Apt. &nbsp;
                    <input type="radio" name="i_485_preparer_address_apt_ste_flr" value="ste" <?php echo (showData('i_485_preparer_address_apt_ste_flr') === 'ste') ? 'checked' : ''; ?>>
                    Ste. &nbsp;
                    <input type="radio" name="i_485_preparer_address_apt_ste_flr" value="flr" <?php echo (showData('i_485_preparer_address_apt_ste_flr') === 'flr') ? 'checked' : ''; ?>>
                    Flr.:
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="i_485_preparer_address_apt_ste_flr_value" maxlength="6" value="<?php echo showData('i_485_preparer_address_apt_ste_flr_value') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.c. City or Town</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_preparer_address_city_town" maxlength="20" value="<?php echo showData('i_485_preparer_address_city_town') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.d. State</label>
                <div class="col-md-7">
                    <select class="form-control" name="i_485_preparer_address_state">
                        <option style="" value="">Select</option>
                        <?php
                        foreach ($allDataCountry as $record) {
                            if ($record->state_code == showData('i_485_preparer_address_state')) $selected = "selected";
                            else $selected = "";
                            echo "<option value='$record->state_code' $selected>$record->state_code</option>";
                        }
                        ?>
            ...
            <div class="form-group">
                <label class="control-label col-md-5">3.e. ZIP Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_preparer_address_zip_code" maxlength="5" value="<?php echo showData('i_485_preparer_address_zip_code') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.f. Province</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_preparer_address_province" maxlength="20" value="<?php echo showData('i_485_preparer_address_province') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_preparer_address_postal_code" maxlength="9" value="<?php echo showData('i_485_preparer_address_postal_code') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">3.h. Country</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="i_485_preparer_address_country" maxlength="39" value="<?php echo showData('i_485_preparer_address_country') ?>" />
                </div>
            </div>
            <div class="bg-info">
    ...
    <div class="row">
        ...
        <div class="col-md-6 ">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7 col-md-offset-5">
                    <input type="date" class="form-control" name="i_485_uscis_officer_sign_date" value="<?php echo showData('i_485_uscis_officer_sign_date') ?>" />
                </div>
            </div>
            <div class="form-group">
...
<fieldset class="setpage">
    <div class="page_number">
        <p style="text-align: right"><b>Page 20 of 20</b></p>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="bg-info">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-md-offset-4">
                    <div class="d-flexible">
                        <span style="left: calc(var(--scale-factor)*36.00px); top: calc(var(--scale-factor)*531.66px); font-size: calc(var(--scale-factor)*10.00px); font-family: serif; gap:1rem;" role="presentation" dir="ltr">►</span><b>A-</b>
