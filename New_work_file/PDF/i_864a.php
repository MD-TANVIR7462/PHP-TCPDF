...
class MyPDF extends TCPDF
{
    ...
    public function Footer()
    {
        ...
        // if ($this->page == 1){
        // $barcode_image = "images/i864a/I-864a-footer-pdf417-$this->page.png";
        // // )
...
$html = '<div><b>26.a. </b><input type="checkbox" name="part5_26a" value="Y" checked="' . $checked . '" /></div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('page5_p6_1b', 77, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 25, 115.5);
//..........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('page5_p6_2', 77, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 25, 137.5);
//...............
$pdf->SetFillColor(220, 220, 220);
$pdf->SetFont('times', '', 11); // set font
$pdf->setCellHeightRatio(1.1);
...
//.........
$pdf->SetFont('times', '', 10);
if (showData('i_864a_i_am_not_attorney_accredited_representative_status') == "Y") $checked = "checked";
else $checked = "";
...
//.........
$pdf->SetFont('times', '', 10);
if (showData('i_864a_i_am_an_attorney_accredited_representative_status') == "Y") $checked = "checked";
else $checked = "";
...
$pdf->SetFont('times', '', 10); // set font
if (showData('i_864a_extends_status') == "Y") $checked_extends = "checked";
else $checked_extends = "";
if (showData('i_864a_does_not_extends_status') == "Y") $checked_not_extends = "checked";
...
//page 3 end.............
    ...
    'preparer_contract_information':' " . showData('i_864a_the_preparer_named_in') . "',
...
//page 4 end.............
    'page5_p6_1b':' " . showData('i_864a_the_interpreter_name_in2') . "',
    'page5_p6_2':' " . showData('i_864a_the_preparer_named_in2') . "',
    ...
    'part7_interpreter_family_last_name':' " . showData('i_864a_interpreter_family_last_name') . "',
    'part7_interpreter_given_first_name':' " . showData('i_864a_interpreter_given_first_name') . "',
    'part7_interpreter_business_org_name':' " . showData('i_864a_interpreter_business_name') . "',
//page 5 end............
