...
if(showData('i_130_petition_filing_for')=="spouse") $checked_spouse = "checked"; else $checked_spouse = "";
if(showData('i_130_petition_filing_for')=="parent") $checked_parent = "checked"; else $checked_parent = "";
if(showData('i_130_petition_filing_for')=="brother") $checked_brother = "checked"; else $checked_brother = "";
if(showData('i_130_petition_filing_for')=="child") $checked_child = "checked"; else $checked_child = "";

$pdf->SetFont('times', '', 11);
$html = '<div><input type="checkbox" name="i_130_petition_filing_for" value="spouse" checked="'.$checked_spouse.'" /></div>';
$pdf->writeHTMLCell(90, 7, 17, 175, $html, 0, 1, false, false, 0, true);
$pdf->writeHTMLCell(20, 5, 18.5, 173.5, 'Spouse', 0, 1, false, false, 0, true);

$html = '<div><input type="checkbox" name="i_130_petition_filing_for" value="parent" checked="'.$checked_parent.'" /></div>';
$pdf->writeHTMLCell(90, 7, 35, 175, $html, 0, 1, false, false, 0, true);
$pdf->writeHTMLCell(20, 5, 36, 173.5, 'Parent', 0, 1, false, false, 0, true);

$html = '<div><input type="checkbox" name="i_130_petition_filing_for" value="brother" checked="'.$checked_brother.'" /></div>';
...
$html = '<div><input type="checkbox" name="i_130_petition_filing_for" value="child" checked="'.$checked_child.'" /></div>';
...
$pdf->SetFont('times', '', 11);
if(showData('i_130_petition_filing_for_child')=="Y") $checked_status = "checked"; else $checked_status = "";
...
$pdf->SetFont('times', '', 11);
if(showData('i_130_petition_filing_for_stepchild')=="Y") $checked_status = "checked"; else $checked_status = "";
...
$pdf->SetFont('times', '', 11);
if(showData('i_130_petition_filing_for_not_married_child')=="Y") $checked_status = "checked"; else $checked_status = "";
...
$pdf->SetFont('times', '', 11);
if(showData('i_130_petition_filing_for_adopted')=="Y") $checked_status = "checked"; else $checked_status = "";
...
if(showData('i_130_beneficiary_relation')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_130_beneficiary_relation')=="N") $checked_no = "checked"; else $checked_no = "";
...
if(showData('i_130_did_you_gain_status')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_130_did_you_gain_status')=="N") $checked_no = "checked"; else $checked_no = "";
...
$html= '<div><b>10.c. </b>&nbsp; &nbsp; 
<input type="checkbox" name="mailing_apt_ste_flr" value="Apt2" checked="'.$aptChecked.'" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="mailing_apt_ste_flr" value="Ste2" checked="'.$steChecked.'" />Ste.
<input type="checkbox" name="mailing_apt_ste_flr" value="Flr2" checked="'.$flrChecked.'" /> Flr.
</div>';
...
$html= '<div><b>12.b. </b>&nbsp; &nbsp;
<input type="checkbox" name="apt_ste_flr" value="Apt2" checked="'.$mailing_apt_p3_1.'" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="apt_ste_flr" value="Ste2" checked="'.$mailing_ste_p3_1.'" />Ste.
<input type="checkbox" name="apt_ste_flr" value="Flr2" checked="'.$mailing_flr_p3_1.'" /> Flr.
</div>';
...
$html= '<div><b>14.b. </b>&nbsp; &nbsp; 
<input type="checkbox" name="Apt3" value="Apt3" checked="'.$mailing_apt_p3_2.'" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="Ste3" value="Ste3" checked="'.$mailing_ste_p3_2.'" />Ste. 
<input type="checkbox" name="Flr3" value="Flr3" checked="'.$mailing_flr_p3_2.'" /> Flr.</div>';
...
if(showData('petitioner_marital_status')=='single') $checked_single='checked'; else $checked_single = '';
if(showData('petitioner_marital_status')=='married') $checked_married='checked'; else $checked_married = '';
if(showData('petitioner_marital_status')=='divorced') $checked_divorced='checked'; else $checked_divorced = '';
if(showData('petitioner_marital_status')=='widowed') $checked_widowed='checked'; else $checked_widowed = '';
if(showData('petitioner_marital_status')=='legally_separated') $checked_ls='checked'; else $checked_ls = '';
if(showData('petitioner_marital_status')=='marriage_annulled') $checked_ma='checked'; else $checked_ma = '';
...
$html= '<div>
<input type="checkbox" name="citizen" value="us" checked="'.$checked_birth.'" />Birth in the United States<br>
<input type="checkbox" name="citizen" value="lawful" checked="'.$checked_nature.'" />Naturalization<br>
<input type="checkbox" name="citizen" value="parents" checked="'.$checked_parent.'" />Parents<br>
</div>';
...
if(showData('petitioner_employer1_apt_ste_flr')=="apt") $apt_checked = "checked"; else $apt_checked = "";
if(showData('petitioner_employer1_apt_ste_flr')=="ste") $ste_checked = "checked"; else $ste_checked = "";
if(showData('petitioner_employer1_apt_ste_flr')=="flr") $flr_checked = "checked"; else $flr_checked = "";

$html= '<div><b>43.b. </b>&nbsp; &nbsp; 
<input type="checkbox" name="employer1_apt_ste_flr1" value="Apt" checked="'.$apt_checked.'" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="employer1_apt_ste_flr2" value="Ste" checked="'.$ste_checked.'" />Ste.
<input type="checkbox" name="employer1_apt_ste_flr3" value="Flr" checked="'.$flr_checked.'" /> Flr.
</div>';
...
if(showData('petitioner_employer2_apt_ste_flr')=="apt") $apt_checked = "checked"; else $apt_checked = "";
if(showData('petitioner_employer2_apt_ste_flr')=="ste") $ste_checked = "checked"; else $ste_checked = "";
if(showData('petitioner_employer2_apt_ste_flr')=="flr") $flr_checked = "checked"; else $flr_checked = "";

$html= '<div><b>47.b. </b>&nbsp; &nbsp; 
<input type="checkbox" name="employer2_apt_ste_flr1" value="Apt" checked="'.$apt_checked.'" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="employer2_apt_ste_flr2" value="Ste" checked="'.$ste_checked.'" />Ste.
<input type="checkbox" name="employer2_apt_ste_flr3" value="Flr" checked="'.$flr_checked.'" /> Flr.
</div>';
...
if(showData('biographic_info_ethnicity')=="hispanic") $checked_ethnicity = "checked"; else $checked_ethnicity = "";
if(showData('biographic_info_ethnicity')=="nothispanic") $checked_nothispanic = "checked"; else $checked_nothispanic = "";
...
if(showData('biographic_info_race_white')=="Y") $checked_white = "checked"; else $checked_white = "";
if(showData('biographic_info_race_asian')=="Y") $checked_asian = "checked"; else $checked_asian = "";
if(showData('biographic_info_race_black_african')=="Y") $checked_african = "checked"; else $checked_african = "";
if(showData('biographic_info_race_american_native')=="Y") $checked_american = "checked"; else $checked_american = "";
if(showData('biographic_info_race_native_islander')=="Y") $checked_islander = "checked"; else $checked_islander = "";

$html = '<div>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="checkbox" name="white" value="white" checked="'.$checked_white.'" /> White <br> &nbsp;&nbsp;&nbsp;
<input type="checkbox" name="asian" value="asian" checked="'.$checked_asian.'" /> Asian <br> &nbsp;&nbsp;&nbsp;
<input type="checkbox" name="black" value="black" checked="'.$checked_african.'" /> Black or African American <br> &nbsp;&nbsp;&nbsp;
<input type="checkbox" name="american" value="american" checked="'.$checked_american.'" />    American Indian or Alaska Native <br> &nbsp;&nbsp;&nbsp;
<input type="checkbox" name="native" value="native" checked="'.$checked_islander.'" /> Native Hawaiian or Other Pacific Islander <br>
</div>';
...
if(showData('biographic_info_eye_color')=="black") $checked_black = "checked"; else $checked_black = "";
if(showData('biographic_info_eye_color')=="blue") $checked_blue = "checked"; else $checked_blue = "";
if(showData('biographic_info_eye_color')=="brown") $checked_brown = "checked"; else $checked_brown = "";
if(showData('biographic_info_eye_color')=="gray") $checked_gray = "checked"; else $checked_gray = "";
if(showData('biographic_info_eye_color')=="green") $checked_green = "checked"; else $checked_green = "";
if(showData('biographic_info_eye_color')=="hazel") $checked_hazel = "checked"; else $checked_hazel = "";
if(showData('biographic_info_eye_color')=="maroon") $checked_maroon = "checked"; else $checked_maroon = "";
if(showData('biographic_info_eye_color')=="pink") $checked_pink = "checked"; else $checked_pink = "";
if(showData('biographic_info_eye_color')=="unknown") $checked_unknown = "checked"; else $checked_unknown = "";

$html = '<div>   
&nbsp; &nbsp;&nbsp;<input type="checkbox" name="black" value="black" checked="'.$checked_black.'" /> Black 
&nbsp;  &nbsp;  &nbsp;&nbsp;<input type="checkbox" name="blue" value="blue" checked="'.$checked_blue.'" /> Blue 
&nbsp; &nbsp; &nbsp;&nbsp;<input type="checkbox" name="brown" value="brown" checked="'.$checked_brown.'" /> Brown <br>
&nbsp; &nbsp; &nbsp; <input type="checkbox" name="gray " value="gray" checked="'.$checked_gray.'" />  Gray
&nbsp; &nbsp; &nbsp; &nbsp;<input type="checkbox" name="green " value="green" checked="'.$checked_green.'" /> Green 
&nbsp; &nbsp; <input type="checkbox" name="hazel " value="hazel" checked="'.$checked_hazel.'" /> Hazel <br>
&nbsp; &nbsp; &nbsp; <input type="checkbox" name="maroon" value="maroon" checked="'.$checked_maroon.'" /> Maroon 
&nbsp; &nbsp;<input type="checkbox" name="pink" value="pink" checked="'.$checked_pink.'" /> Pink 
&nbsp;  &nbsp;  &nbsp; <input type="checkbox" name="unknown" value="unknown" checked="'.$checked_unknown.'" /> Unknown/Other 
</div>';
...
if(showData('biographic_info_hair_color')=="bald") $checked_bald = "checked"; else $checked_bald = "";
if(showData('biographic_info_hair_color')=="black") $checked_black = "checked"; else $checked_black = "";
if(showData('biographic_info_hair_color')=="blond") $checked_blond = "checked"; else $checked_blond = "";
if(showData('biographic_info_hair_color')=="brown") $checked_brown = "checked"; else $checked_brown = "";
if(showData('biographic_info_hair_color')=="gray") $checked_gray = "checked"; else $checked_gray = "";
if(showData('biographic_info_hair_color')=="red") $checked_red = "checked"; else $checked_red = "";
if(showData('biographic_info_hair_color')=="sandy") $checked_sandy = "checked"; else $checked_sandy = "";
if(showData('biographic_info_hair_color')=="white") $checked_white = "checked"; else $checked_white = "";
if(showData('biographic_info_hair_color')=="unknown") $checked_unknown = "checked"; else $checked_unknown = "";

$html= '<div>   
&nbsp;<input type="checkbox" name="blad" value="blad" checked="'.$checked_bald.'" />Blad(No hair) 
&nbsp;&nbsp;<input type="checkbox" name="black" value="black" checked="'.$checked_black.'" /> Black
&nbsp; &nbsp; &nbsp;&nbsp;<input type="checkbox" name="blond" value="blond" checked="'.$checked_blond.'" /> Blond <br>
&nbsp; <input type="checkbox" name="brown" value="brown" checked="'.$checked_brown.'" /> brown 
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   &nbsp; <input type="checkbox" name="gray" value="gray" checked="'.$checked_gray.'" /> Gray 
&nbsp; &nbsp; &nbsp; &nbsp; <input type="checkbox" name="red" value="red" checked="'.$checked_red.'" /> Red <br>
&nbsp; <input type="checkbox" name="sandy" value=" sandy" checked="'.$checked_sandy.'" /> Sandy  
&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp; <input type="checkbox" name="white" value="white" checked="'.$checked_white.'" />  White
&nbsp; &nbsp; &nbsp; <input type="checkbox" name="unknown" value="unknown" checked="'.$checked_unknown.'" /> Unknown/Other 
</div>';
...
if(showData('beneficiary_petition_filed_status')=='yes') $checked_yes='checked'; else $checked_yes = '';
if(showData('beneficiary_petition_filed_status')=='no') $checked_no='checked'; else $checked_no = '';
if(showData('beneficiary_petition_filed_status')=='unknown') $checked_unknown='checked'; else $checked_unknown = '';
...
if(showData('information_about_you_home_apt_ste_flr_w1')=="apt") $apt_checked = "checked"; else $apt_checked = "";
if(showData('information_about_you_home_apt_ste_flr_w1')=="ste") $ste_checked = "checked"; else $ste_checked = "";
if(showData('information_about_you_home_apt_ste_flr_w1')=="flr") $flr_checked = "checked"; else $flr_checked = "";

$html= '<div><b>11.b.  </b>
<input type="checkbox" name="w1_apt1" value="apt1" checked="'.$apt_checked.'" /> Apt.   &nbsp;&nbsp;
<input type="checkbox" name="w1_ste1" value="ste1" checked="'.$ste_checked.'" /> Ste. &nbsp;&nbsp;
<input type="checkbox" name="w1_flr1" value="flr1" checked="'.$flr_checked.'" /> Flr.</div>';
...
if(showData('information_about_you_home_apt_ste_flr_w2')=="apt") $apt_checked = "checked"; else $apt_checked = "";
if(showData('information_about_you_home_apt_ste_flr_w2')=="ste") $ste_checked = "checked"; else $ste_checked = "";
if(showData('information_about_you_home_apt_ste_flr_w2')=="flr") $flr_checked = "checked"; else $flr_checked = "";

$html= '<div><b>12.b.  </b>
<input type="checkbox" name="w2_apt" value="apt" checked="'.$apt_checked.'" /> Apt.   &nbsp;&nbsp;
<input type="checkbox" name="w2_ste" value="ste" checked="'.$ste_checked.'" /> Ste. &nbsp;&nbsp;
<input type="checkbox" name="w2_flr" value="flr" checked="'.$flr_checked.'" /> Flr.
</div>';
...
if(showData('information_about_you_home_apt_ste_flr_w3')=="apt") $apt_checked = "checked"; else $apt_checked = "";
if(showData('information_about_you_home_apt_ste_flr_w3')=="ste") $ste_checked = "checked"; else $ste_checked = "";
if(showData('information_about_you_home_apt_ste_flr_w3')=="flr") $flr_checked = "checked"; else $flr_checked = "";

$html= '<div><b>13.b. </b>&nbsp; &nbsp; 
<input type="checkbox" name="w3_apt" value="Apt" checked="'.$apt_checked.'" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="w3_ste" value="Ste" checked="'.$ste_checked.'" />Ste. 
<input type="checkbox" name="w3_flr" value="Flr" checked="'.$flr_checked.'" /> Flr.</div>';
...
if(showData('other_information_about_you_marital_status')=='annulled') $annulled_check='checked'; else $annulled_check='';
...
if(showData('ever_in_united_states_status')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('ever_in_united_states_status')=="N") $checked_no = "checked"; else $checked_no = "";
...
$html= '<div><b>51.c.  </b>  <input type="checkbox" name="apt1" value="apt1" checked="'.$aptChecked.'" /> Apt.   &nbsp;&nbsp;
<input type="checkbox" name="ste1" value="ste1" checked="'.$steChecked.'" /> Ste. &nbsp;&nbsp;
<input type="checkbox" name="flr1" value="flr1" checked="'.$flrChecked.'" /> Flr.</div>';
...
if(showData('additional_info_immigration_proceedings_status')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('additional_info_immigration_proceedings_status')=="N") $checked_no = "checked"; else $checked_no = "";
...
if(showData('additional_info_immigration_removal_status')=="Y") $checked_removal = "checked"; else $checked_removal = "";
if(showData('additional_info_immigration_exclusion_status')=="Y") $checked_exclusion = "checked"; else $checked_exclusion = "";
if(showData('additional_info_immigration_rescission_status')=="Y") $checked_rescission = "checked"; else $checked_rescission = "";
if(showData('additional_info_immigration_other_status')=="Y") $checked_other = "checked"; else $checked_other = "";
...
if(showData('beneficiary_native_address_apt_ste_flr')=="apt") $apt_checked = "checked"; else $apt_checked = "";
if(showData('beneficiary_native_address_apt_ste_flr')=="ste") $ste_checked = "checked"; else $ste_checked = "";
if(showData('beneficiary_native_address_apt_ste_flr')=="flr") $flr_checked = "checked"; else $flr_checked = "";

$html= '<div><b>58.b.  </b>  
<input type="checkbox" name="beneficiary_apt" value="apt" checked="'.$apt_checked.'" /> Apt.   &nbsp;&nbsp;
<input type="checkbox" name="beneficiary_ste" value="ste" checked="'.$ste_checked.'" /> Ste. &nbsp;&nbsp;
<input type="checkbox" name="beneficiary_flr" value="flr" checked="'.$flr_checked.'" /> Flr.
</div>';
...
if(showData('beneficiary_lived_together_address_apt_ste_flr')=="apt") $apt_checked = "checked"; else $apt_checked = "";
if(showData('beneficiary_lived_together_address_apt_ste_flr')=="ste") $ste_checked = "checked"; else $ste_checked = "";
if(showData('beneficiary_lived_together_address_apt_ste_flr')=="flr") $flr_checked = "checked"; else $flr_checked = "";

$html= '<div><b>59.b.  </b>  
<input type="checkbox" name="lived_together_apt" value="apt1" checked="'.$apt_checked.'" /> Apt.   &nbsp;&nbsp;
<input type="checkbox" name="lived_together_ste" value="ste1" checked="'.$ste_checked.'" /> Ste. &nbsp;&nbsp;
<input type="checkbox" name="lived_together_flr" value="flr1" checked="'.$flr_checked.'" /> Flr.
</div>';
