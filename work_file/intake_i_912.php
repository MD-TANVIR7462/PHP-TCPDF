			...
			<div class="form-group">
				...
				<div class="col-md-10 col-md-offset-2">
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status" <?php echo (showData('other_information_about_you_marital_status')=='single')? 'checked':'' ?> value="single"> Single, Never Married
					</label>
					&nbsp;
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status" <?php echo (showData('other_information_about_you_marital_status')=='married')? 'checked':'' ?> value="married"> Married
					</label>
					&nbsp;
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status" <?php echo (showData('other_information_about_you_marital_status')=='divorced')? 'checked':'' ?> value="divorced"> Divorced
					</label>
					&nbsp;
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status" <?php echo (showData('other_information_about_you_marital_status')=='widowed')? 'checked':'' ?> value="widowed"> Widowed
					</label>
					&nbsp;
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status" <?php echo (showData('other_information_about_you_marital_status')=='separated')? 'checked':'' ?> value="separated"> Separated
					</label>
					&nbsp;
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status" <?php echo (showData('other_information_about_you_marital_status')=='marriage annulled')? 'checked':'' ?> value="marriage annulled"> Marriage Annulled
					</label>
					<div class="d-flexible">
						<label class="control-label">
							<input type="radio" name="other_information_about_you_marital_status" <?php echo (showData('other_information_about_you_marital_status')=='other')? 'checked':'' ?> value="other"> Other (Explain)
						</label>
						<div class="col-md-7">
							<input type="text" class="form-control" name="other_information_about_you_marital_explain" value="<?= showData('other_information_about_you_marital_explain')?>">
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		<div class="col-md-6">			
			...
			<div class="form-group">
				...
				<div class="col-md-12"> 
					<input type="text" class="form-control" name="requestors_daytime_tel"  maxlength="10"
						value="<?= showData('requestors_daytime_tel')?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-12">4. Requestor's Mobile Telephone Number (if any)</label>
				<div class="col-md-12">
					<input type="text" class="form-control" name="requestors_mobile" maxlength="10"
						value="<?= showData('requestors_mobile')?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-12">5. Requestor's Email Address (if any)</label>
				<div class="col-md-12">
					<input type="text" class="form-control" name="requestors_email" maxlength="39"
						value="<?= showData('requestors_email')?>">
				</div>
			</div>
		</div><!-- end of left side column -->
		<div class="col-md-6">			
			...
			<div class="form-group">
				...
				<div class="col-md-12">
					<div class="d-flexible">
						<input type="date" class="form-control" name="requestors_sign_date"
							value="<?= showData('requestors_sign_date')?>">
					</div>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<p>I am fluent in English and
				...
				and answer on the request, including the Applicant's Certification, and has verified the accuracy of every answer. </p>
			<div class="bg-info">
