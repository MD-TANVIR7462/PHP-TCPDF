...
$page_heading 	=   "Application for Replacement/Initial Nonimmigrant
...
<fieldset class="setpage">
    <div class="page_number">
        <b>
            <p style="text-align: right;">Page 1 of 5</p>
        </b>
    </div>
    <table style="border-collapse: collapse; ">
        ...
        <tbody>
            <tr>
                <td style="padding: 5px;"><?php echo createCheckbox("")?> Select this box if Form G-28 is attached to represent the applicant.</td>
                <td style="padding: 5px;"> <p>Attorney State License Number: </p><input type="text" class="form-control" id="" name="" value="<?php echo showData('')?>" maxlength=""></td>
            </tr>
        </tbody>
    </table>
    <div class="row  mt-3 ">
        <div class="col-md-6  ">
            ...
            <div class="bg-info">
                <h4><b>Your Full Legal Name</b></h4>
            </div>
