    ...
    <div class="row  mt-3 ">
        <div class="col-md-6  ">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="information_about_you_home_care_of_name" maxlength="" value="<?php echo showData('information_about_you_home_care_of_name')?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" type="text" class="form-control" name="information_about_you_home_apt_ste_flr_value" maxlength=""  value="<?php echo showData('information_about_you_home_apt_ste_flr_value')?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_home_zip_code" maxlength="" value="<?php echo showData('information_about_you_home_zip_code')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_home_postal_code" maxlength="" value="<?php echo showData('information_about_you_home_postal_code')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.h. Province</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_home_province" maxlength="" value="<?php echo showData('information_about_you_home_province')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">2.i. Country</label>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="information_about_you_home_country" maxlength="" value="<?php echo showData('information_about_you_home_country')?>">
                </div>
            </div>
        </div>
        <div class="col-md-6 mt-5">
            ...
            <div class="control-label" style="padding-left:18px;">
                ...
                <label class="control-label col-md-offset-2"> <input type="radio" name="" value="male"
                        <?php echo (showData('')=='male') ? 'checked' : '' ?>> Male &nbsp;</label>
                <label class="control-label"> <input type="radio" name="" value="female"
                        <?php echo (showData('')=='female') ? 'checked' : '' ?>> Female &nbsp;</label>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label col-md-12">1.a.
                    <?php echo createCheckbox("")?> I am a permanent resident or conditional resident of the United States, and I am applying for a reentry permit.
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">1.b.
                    <?php echo createCheckbox("")?> I now hold U.S. refugee or asylee status, and I am applying for a Refugee Travel Document.
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">1.c.
                    <?php echo createCheckbox("")?> I am a permanent resident as a direct result of refugee or asylee status, and I am applying for a Refugee Travel Document.
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">1.d.
                    <?php echo createCheckbox("")?> I am applying for an Advance Parole Document to allow me to return to the United States after temporary foreign travel.
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">1.e.
                    <?php echo createCheckbox("")?> I am outside the United States, and I am applying for an Advance Parole Document.
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">1.f.
                    <?php echo createCheckbox("")?> I am applying for an Advance Parole Document for a person who is outside the United States.
                </label>
            </div>
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="i_131_preparer_daytime_tel_1" maxlength="" value="<?php echo showData('i_131_preparer_daytime_tel_1')?>">
                    </div>
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="i_131_preparer_daytime_tel_2" maxlength="" value="<?php echo showData('i_131_preparer_daytime_tel_2')?>">
                    </div>
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="i_131_preparer_daytime_tel_3" maxlength="" value="<?php echo showData('i_131_preparer_daytime_tel_3')?>">
                    </div>
                </div>
                <div class="col-md-4 from-group">
                    <label>Extension</label>
                    <input type="text" class="form-control" name="" maxlength="" value="<?php echo showData('i_131_preparer_extension')?>">
                </div>
            </div>
            <div class="form-group">
              5. Preparer's E-mail Address (if any)
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_131_preparer_email" maxlength="25" value="<?php echo showData('i_131_preparer_email')?>">
                </div>
            </div>
            <p><b>Declaration</b></p>
            <p>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" disabled name="" maxlength="20" value="<?php echo showData('')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-6">1. Date of Intended Departure (mm/dd/yyyy)</label>
                <div class="col-md-6 ">
                    <div class="d-flexible">
                        ►<input type="date" class="form-control" maxlength="" name="i_131_preparer_sign_date" value="<?php echo showData('i_131_preparer_sign_date')?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
