        ...
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="information_about_proposed_travel_purpose_trip" maxlength="357" class="form-control" cols="30" rows="10"><?php echo showData('information_about_proposed_travel_purpose_trip')?></textarea>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="information_about_proposed_travel_country_list" maxlength="357" class="form-control" cols="30"
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
              5. Preparer's E-mail Address (if any)
                <div class="col-md-12">
                    <input type="text" class="form-control" name="i_131_preparer_email_address" maxlength="25" value="<?php echo showData('i_131_preparer_email_address')?>">
                </div>
            </div>
            <p><b>Declaration</b></p>
            <p>
