	...
	<fieldset class="setpage">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<div class="panel-group" id="accordionI94">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionI94" href="#collapseImmigration">Immigration History</a>
							</h4>
						</div>
						<!--<div class="bg-info">
							<h4><b>Immigration History</b></h4>
						</div>-->
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionI94" href="#collapseEntry" class="collapsed">Entry Information</a>
							</h4>
						</div>
						<!--<div class="bg-info">
							<h4><b>Entry Information</b></h4> 
						</div>-->
...
<div class="tab-pane" id="tabPersonal">
	<fieldset class="setpage">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<div class="panel-group joined" id="accordionPersonal">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPersonal" href="#collapseLegalFullName">Legal Full Name</a>
							</h4>
						</div>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPersonal" href="#collapseOtherName1" class="collapsed">Other Name 1</a>
							</h4>
						</div>
						<div id="collapseOtherName1" class="panel-collapse collapse" aria-expanded="false">
							<div class="panel-body">						
								<!--<div class="bg-info">
									<h4><b>Other Name 1</b></h4> 
								</div>-->
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPersonal" href="#collapseOtherName2" class="collapsed">Other Name 2</a>
							</h4>
						</div>
						<div id="collapseOtherName2" class="panel-collapse collapse" aria-expanded="false">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Other Name 2</b></h4> 
								</div>-->
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPersonal" href="#collapseOtherName3" class="collapsed">Other Name 3</a>
							</h4>
						</div>
						<div id="collapseOtherName3" class="panel-collapse collapse" aria-expanded="false">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Other Name 3</b></h4> 
								</div>-->
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPersonal" href="#collapseOtherInformation" class="collapsed">Other Information</a>
							</h4>
						</div>
						<div id="collapseOtherInformation" class="panel-collapse collapse" aria-expanded="false">
							<div class="panel-body">
								<!--<div class="bg-info">
								...
								<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" class="form-control"
													name="other_information_about_you_social_security_number" maxlength="9"
											...
											<div class="col-md-12">
												...
												<div class="form-check">
													<div class="col-md-4">
														<label class="control-label">
														<input type="radio" name="other_information_about_you_marital_status"
														value="other" <?php echo (showData('other_information_about_you_marital_status')=='other') ? 'checked':''?>> Other (Explain)</label>
													</div>
													<div class="col-md-8">
														<input type="text" class="form-control"
														name="other_information_about_you_marital_explain" maxlength="45"
														value="<?php echo showData('other_information_about_you_marital_explain')?>" />
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" class="form-control"
													name="other_information_about_you_total_married" maxlength="9"
													value="<?php echo showData('other_information_about_you_total_married')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-12">City or Town of Birth</label>
											<div class="col-md-12">
												<input type="text" class="form-control" name="other_information_about_you_city_of_birth"  maxlength="29"
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" class="form-control" name="other_information_about_you_country_of_birth"  maxlength="29" 
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" class="form-control" name="other_information_about_you_province_of_birth"  maxlength="29" 
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" class="form-control" name="other_information_about_you_country_of_citizen"  maxlength="29" 
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPersonal" href="#collapseContact" class="collapsed">Contact Information</a>
							</h4>
						</div>
						<div id="collapseContact" class="panel-collapse collapse" aria-expanded="false">
							<div class="panel-body">
								<!--<div class="bg-info">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" class="form-control"
											name="information_about_you_daytime_tel" maxlength="15"
											value="<?php echo showData('information_about_you_daytime_tel')?>" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" class="form-control"
											name="information_about_you_mobile" maxlength="15"
											value="<?php echo showData('information_about_you_mobile')?>" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="email" class="form-control"
											name="information_about_you_email" maxlength="36"
											value="<?php echo showData('information_about_you_email')?>" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPersonal" href="#collapsePassport" class="collapsed">Passport / Travel Information</a>
							</h4>
						</div>
						<div id="collapsePassport" class="panel-collapse collapse" aria-expanded="false">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Passport / Travel Information</b></h4> 
								</div>-->
								<h4><code><b>Note : </b> I-102, I-130, I-485, I-765, I-918 </code></h4>
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" class="form-control"
											name="other_information_about_you_passport_number" maxlength="36"
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" class="form-control"
											name="other_information_about_you_travel_document_number" maxlength="36"
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPersonal" href="#collapseBiographic" class="collapsed">Biographic Information</a>
							</h4>
						</div>
						<div id="collapseBiographic" class="panel-collapse collapse" aria-expanded="false">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Biographic Information</b></h4>
								</div>-->
...
<div class="tab-pane" id="tabAddress">
	<fieldset class="setpage">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<div class="panel-group joined" id="accordionAddress">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionAddress" href="#collapseUSMailingAddress">U.S Mailing Address</a>
							</h4>
						</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_us_mailing_care_of_name"  maxlength="29"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_us_mailing_street_number"  maxlength="29" 
												value="<?php echo showData('information_about_you_us_mailing_street_number')?>" />
											</div>
										</div>
										<div class="form-group">
											<div class="col-md-5">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_us_mailing_apt_ste_flr_value"  maxlength="6"
												value="<?php echo showData('information_about_you_us_mailing_apt_ste_flr_value')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">City or Town</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_us_mailing_city_town"  maxlength="29"
												value="<?php echo showData('information_about_you_us_mailing_city_town')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">State</label>
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_us_mailing_zip_code"  maxlength="5" 
												value="<?php echo showData('information_about_you_us_mailing_zip_code')?>" />
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_us_mailing_province"  maxlength="29"
												value="<?php echo showData('information_about_you_us_mailing_province')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Postal Code</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_us_mailing_postal_code"  maxlength="29" 
												value="<?php echo showData('information_about_you_us_mailing_postal_code')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Country</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_us_mailing_country"  maxlength="29" 
												value="<?php echo showData('information_about_you_us_mailing_country')?>" />
											</div>
										</div>
										<div class="form-group">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionAddress" href="#collapseSafeMailingAddress" class="collapsed">Alternate and/or Safe Mailing Address</a>
							</h4>
						</div>
						<div id="collapseSafeMailingAddress" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">In Care Of Name (if any)</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_mailing_care_of_name"  maxlength="29"
												value="<?php echo showData('information_about_you_mailing_care_of_name')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Street Number and Name</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_mailing_street_number"  maxlength="26" 
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												...
												value="<?php echo showData('information_about_you_mailing_apt_ste_flr_value')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">City or Town</label>
											<div class="col-md-7">
												...
												value="<?php echo showData('information_about_you_mailing_city_town')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">State</label>
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												...
												value="<?php echo showData('information_about_you_mailing_zip_code')?>" />
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Province</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_mailing_province"  maxlength="20"
												value="<?php echo showData('information_about_you_mailing_province')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Postal Code</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_mailing_postal_code"  maxlength="9" 
												value="<?php echo showData('information_about_you_mailing_postal_code')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Country</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_mailing_country"  maxlength="29" 
												value="<?php echo showData('information_about_you_mailing_country')?>" />
											</div>
										</div>
									</div>
								</div>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionAddress" href="#collapsePhysicalAddress1" class="collapsed">Physical Address 1</a>
							</h4>
						</div>
						<div id="collapsePhysicalAddress1" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">In Care Of Name (if any)</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_care_of_name"  maxlength="29"
												value="<?php echo showData('information_about_you_home_care_of_name')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Street Number and Name</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_street_number"  maxlength="26" 
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_apt_ste_flr_value"  maxlength="6"
										...
										<div class="form-group">
											<label class="control-label col-md-5">City or Town</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_city_town"  maxlength="29"
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Province</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_province"  maxlength="29"
										...
										<div class="form-group">
											<label class="control-label col-md-5">Country</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_country"  maxlength="29" 
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionAddress" href="#collapsePhysicalAddress2" class="collapsed">Physical Address 2</a>
							</h4>
						</div>
						<div id="collapsePhysicalAddress2" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Street Number and Name</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_street_number2"  maxlength="29" 
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_apt_ste_flr_value2"  maxlength="6"
										...
										<div class="form-group">
											<label class="control-label col-md-5">City or Town</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_city_town2"  maxlength="20"
												value="<?php echo showData('information_about_you_home_city_town2')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">State</label>
										...
										<div class="form-group">
											<label class="control-label col-md-5">ZIP Code</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_zip_code2"  maxlength="5" 
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Province</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_province2"  maxlength="20"
										...
										<div class="form-group">
											<label class="control-label col-md-5">Postal Code</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_postal_code2"  maxlength="9" 
										...
										<div class="form-group">
											<label class="control-label col-md-5">Country</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_home_country2"  maxlength="29" 
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionAddress" href="#collapseUSOutside" class="collapsed">Most Recent Address Outside Of the United States</a>
							</h4>
						</div>
						<div id="collapseUSOutside" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Street Number and Name</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_outside_us_street_number"  maxlength="29" 
										...
										<div class="form-group">
											<div class="col-md-5">
												<label class="control-label">
													<input type="radio" name="information_about_you_outside_us_apt_ste_flr" value="apt"
														<?php echo (showData('information_about_you_outside_us_apt_ste_flr') == 'apt') ? 'checked' : ''; ?>>
													Apt
												</label>
												&nbsp;
												<label class="control-label">
													<input type="radio" name="information_about_you_outside_us_apt_ste_flr" value="ste"
														<?php echo (showData('information_about_you_outside_us_apt_ste_flr') == 'ste') ? 'checked' : ''; ?>>
													Ste
												</label>
												 &nbsp;
												<label class="control-label">
													<input type="radio" name="information_about_you_outside_us_apt_ste_flr" value="flr"
														<?php echo (showData('information_about_you_outside_us_apt_ste_flr') == 'flr') ? 'checked' : ''; ?>>
													Flr
												</label>
											</div>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_outside_us_apt_ste_flr_value"  maxlength="6"
										...
										<div class="form-group">
											<label class="control-label col-md-5">City or Town</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_outside_us_city_town"  maxlength="29"
												value="<?php echo showData('information_about_you_outside_us_city_town')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">State</label>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Province</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_outside_us_province"  maxlength="29"
										...
										<div class="form-group">
											<label class="control-label col-md-5">Postal Code</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_outside_us_postal_code"  maxlength="9" 
										...
										<div class="form-group">
											<label class="control-label col-md-5">Country</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="information_about_you_outside_us_country"  maxlength="29" 
...
<div class="tab-pane" id="tabParents">
	<fieldset class="setpage">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<div class="panel-group joined" id="accordionParents">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionParents" href="#collapseParent1">Parent 1 (Father)</a>
							</h4>
						</div>
						<div id="collapseParent1" class="panel-collapse collapse in">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Parent 1</b></h4> 
								</div>-->
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												...
												value="<?php echo showData('parent1_info_date_of_birth')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Sex</label>
											<div class="col-md-7">
												<input type="radio" name="parent1_info_gender" value="male" 
												<?php echo (showData('parent1_info_gender')=='male') ? 'checked':''?>> Male &nbsp;

												<input type="radio" name="parent1_info_gender" value="female" 
												<?php echo (showData('parent1_info_gender')=='female') ? 'checked':''?>> Female &nbsp;
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">City or Town of Birth</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent1_info_city_of_birth"  maxlength="29" 
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent1_info_country_of_birth"  maxlength="29"
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" class="form-control" name="parent1_info_current_city_of_residence"  maxlength="29" 
												value="<?php echo showData('parent1_info_current_city_of_residence')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-12">Current Country of Residence (if living)</label>
											<div class="col-md-12">
												<input type="text" class="form-control" name="parent1_info_current_country_of_Residence"  maxlength="29"
												value="<?php echo showData('parent1_info_current_country_of_Residence')?>" />
											</div>
										</div>
									</div>
								</div>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionParents" href="#collapseParent2" class="collapsed">Parent 2 (Mother)</a>
							</h4>
						</div>
						<div id="collapseParent2" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Parent 2</b></h4> 
								</div>-->
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Family Name (Last Name)</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent2_info_family_last_name"  maxlength="29" 
										...
										<div class="form-group">
											<label class="control-label col-md-5">Given Name (First  Name)</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent2_info_given_first_name"  maxlength="29" 
										...
										<div class="form-group">
											<label class="control-label col-md-5">Middle Name</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent2_info_middle_name"  maxlength="29"
										...
										<div class="form-group">
											<label class="control-label col-md-5">Family Name (At Birth)</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent2_info_at_birth_family_last_name"  maxlength="29" 
												value="<?php echo showData('parent2_info_at_birth_family_last_name')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Given Name (At Birth)</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent2_info_at_birth_given_first_name"  maxlength="29"
												value="<?php echo showData('parent2_info_at_birth_given_first_name')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Middle Name (At Birth) </label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent2_info_at_birth_middle_name"  maxlength="29" 
												value="<?php echo showData('parent2_info_at_birth_middle_name')?>" />
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												...
												value="<?php echo showData('parent2_info_date_of_birth')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Sex</label>
											<div class="col-md-7">
												<input type="radio" name="parent2_info_gender" value="male" 
												<?php echo (showData('parent2_info_gender')=='male') ? 'checked':''?>> Male &nbsp;
												<input type="radio" name="parent2_info_gender" value="female" 
												<?php echo (showData('parent2_info_gender')=='female') ? 'checked':''?>> Female &nbsp;
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">City or Town of Birth</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent2_info_city_of_birth"  maxlength="29" 
												value="<?php echo showData('parent2_info_city_of_birth')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Country of Birth</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="parent2_info_country_of_birth"  maxlength="29"
										...
										<div class="form-group">
											<label class="control-label col-md-12">Current City or Town of Residence (if living)</label>
											<div class="col-md-12">
												<input type="text" class="form-control" name="parent2_info_current_city_of_residence"  maxlength="29" 
												value="<?php echo showData('parent2_info_current_city_of_residence')?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-12">Current Country of Residence (if living)</label>
											<div class="col-md-12">
												<input type="text" class="form-control" name="parent2_info_current_country_of_Residence"  maxlength="29"
												value="<?php echo showData('parent2_info_current_country_of_Residence')?>" />
											</div>
										</div>
									</div>
								</div>
...
<div class="tab-pane" id="tabSpouse">
	<fieldset class="setpage">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<div class="panel-group joined" id="accordionSpouseChildren">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseCurrentSpouse">Current Spouse</a>
							</h4>
						</div>
						<div id="collapseCurrentSpouse" class="panel-collapse collapse in">
							<div class="panel-body">							
								<!--<div class="bg-info">
									<h4><b>Current Spouse</b></h4> 
								</div>-->
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Family Name (Last Name)</label>
											<div class="col-md-7">
												<input type="text" maxlength="29" class="form-control" name="current_spouse_family_last_name" 
										...
										<div class="form-group">
											<label class="control-label col-md-5">Given Name (First Name)</label>
											<div class="col-md-7">
												<input type="text" maxlength="29" class="form-control" name="current_spouse_given_first_name" 
										...
										<div class="form-group">
											<label class="control-label col-md-5">Middle Name</label>
											<div class="col-md-7">
												<input type="text" maxlength="29" class="form-control" name="current_spouse_family_middle_name" 
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapsePriorSpouse1" class="collapsed">Prior Spouse 1</a>
							</h4>
						</div>
						<div id="collapsePriorSpouse1" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Prior Spouse 1</b></h4> 
								</div>-->
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapsePriorSpouse2" class="collapsed">Prior Spouse 2</a>
							</h4>
						</div>
						<div id="collapsePriorSpouse2" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Prior Spouse 2</b></h4> 
								</div>-->
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseSpouseChildren1" class="collapsed">Spouse or children 01</a>
							</h4>
						</div>
						<div id="collapseSpouseChildren1" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Spouse or children 01</b></h4> 
								</div>-->
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-7 ">
												<input type="date" class="form-control"
													name="spouse_children1_date_of_birth"
													value="<?php echo showData('spouse_children1_date_of_birth')?>">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children1_country_of_birth" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children1_relationship" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children1_current_location" maxlength="36"
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseSpouseChildren2" class="collapsed">Spouse or children 02</a>
							</h4>
						</div>
						<div id="collapseSpouseChildren2" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Spouse or children 02</b></h4> 
								</div>-->
								<h4><code><b>Note : </b>I-130, I-918, I-918A </code></h4>
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children2_country_of_birth" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children2_relationship" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children2_current_location" maxlength="36"
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseSpouseChildren3" class="collapsed">Spouse or children 03</a>
							</h4>
						</div>
						<div id="collapseSpouseChildren3" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Spouse or children 03</b></h4> 
								</div>-->
								<h4><code><b>Note : </b>I-130, I-918, I-918A </code></h4>
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children3_country_of_birth" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children3_relationship" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children3_current_location" maxlength="36"
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseSpouseChildren4" class="collapsed">Spouse or children 04</a>
							</h4>
						</div>
						<div id="collapseSpouseChildren4" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Spouse or children 04</b></h4> 
								</div>-->
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children4_country_of_birth" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children4_relationship" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children4_current_location" maxlength="36"
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseSpouseChildren5" class="collapsed">Spouse or children 05</a>
							</h4>
						</div>
						<div id="collapseSpouseChildren5" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Spouse or children 05</b></h4> 
								</div>-->
								<h4><code><b>Note : </b>I-130, I-918</code></h4>
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children5_country_of_birth" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children5_relationship" maxlength="36"
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control"
													name="spouse_children5_current_location" maxlength="36"
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseSpouseChildrenOther" class="collapsed">Spouse or children (Other)</a>
							</h4>
						</div>
						<div id="collapseSpouseChildrenOther" class="panel-collapse collapse">
							<div class="panel-body">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseChild1" class="collapsed">Child 1</a>
							</h4>
						</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-7">
												...
												value="<?php echo showData('child1_family_last_name')?>">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Given Name (First Name):</label>
											<div class="col-md-7"> 
												...
												value="<?php echo showData('child1_given_first_name')?>">
											</div>
										</div>       
										<div class="form-group">
											<label class="control-label col-md-5">Middle Name:</label>
											<div class="col-md-7">
												...
												value="<?php echo showData('child1_middle_name')?>">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">A-Number (if any):</label>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseChild2" class="collapsed">Child 2</a>
							</h4>
						</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Family Name (Last Name):</label>
											<div class="col-md-7">
												<input type="text" maxlength="29" class="form-control" name="child2_family_last_name" 
												value="<?php echo showData('child2_family_last_name')?>">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Given Name (First Name):</label>
											<div class="col-md-7"> 
												<input type="text" maxlength="29" class="form-control" name="child2_given_first_name" 
												value="<?php echo showData('child2_given_first_name')?>">
											</div>
										</div>       
										<div class="form-group">
											<label class="control-label col-md-5">Middle Name:</label>
											<div class="col-md-7">
												<input type="text" maxlength="29" class="form-control" name="child2_middle_name" 
												value="<?php echo showData('child2_middle_name')?>">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">A-Number (if any):</label>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionSpouseChildren" href="#collapseChild3" class="collapsed">Child 3</a>
							</h4>
						</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-5">Family Name (Last Name):</label>
											<div class="col-md-7">
												<input type="text" maxlength="29" class="form-control" name="child3_family_last_name" 
												value="<?php echo showData('child3_family_last_name')?>">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">Given Name (First Name):</label>
											<div class="col-md-7"> 
												<input type="text" maxlength="29" class="form-control" name="child3_given_first_name" 
												value="<?php echo showData('child3_given_first_name')?>">
											</div>
										</div>       
										<div class="form-group">
											<label class="control-label col-md-5">Middle Name:</label>
											<div class="col-md-7">
												<input type="text" maxlength="29" class="form-control" name="child3_middle_name" 
												value="<?php echo showData('child3_middle_name')?>">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-5">A-Number (if any):</label>
...
<div class="tab-pane" id="tabEmployment">
	<fieldset class="setpage">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<div class="panel-group joined" id="accordionEmployment">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionEmployment" href="#collapseEmployer1">Employer 1</a>
							</h4>
						</div>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionEmployment" href="#collapseEmployer2" class="collapsed">Employer 2</a>
							</h4>
						</div>
						<div id="collapseEmployer2" class="panel-collapse collapse">
							<div class="panel-body">
								<!--<div class="bg-info">
									<h4><b>Employer 2</b></h4> 
								</div>-->
								<h4><code><b>Note : </b> I-130A, I-192, I-485 </code></h4>
								<div class="row">
									<div class="col-md-6">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionEmployment" href="#accordionOutsideEmployment" class="collapsed">Provide your most recent employment outside of the United States</a>
							</h4>
						</div>
						<div id="accordionOutsideEmployment" class="panel-collapse collapse">
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<!--<div class="bg-info">
											<h4><b>Provide your most recent employment outside of the United States (if not already listed above).</b></h4> 
										</div>-->
...
<div class="tab-pane" id="tabPetitioner">
	<fieldset class="setpage">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<div class="panel-group joined" id="accordionPetitioner">
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapseFullname">Petitioner Full Name</a>
							</h4>
						</div>
						<div id="collapseFullname" class="panel-collapse collapse in">
							<div class="panel-body">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapseOthername">Other Name</a>
							</h4>
						</div>
						<div id="collapseOthername" class="panel-collapse collapse">
							<div class="panel-body">
								<h4><code><b>Note : </b> I-130 </code></h4>
								<div class="form-group">
									<label class="control-label col-md-5">Family Name(Last Name)</label>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapseOtherInfo">Other Information</a>
							</h4>
						</div>
						<div id="collapseOtherInfo" class="panel-collapse collapse">
							<div class="panel-body">
								<h4><code><b>Note : </b> I-130, I-290B </code></h4>
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<div class="d-flexible">
													<input type="text" class="form-control" name="petitioner_uscis_online_account_number"
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<div class="d-flexible">
													<input type="text" class="form-control" name="petitioner_social_security_number"
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapseMailingAddress">Mailing Address</a>
							</h4>
						</div>
						<div id="collapseMailingAddress" class="panel-collapse collapse">
							<div class="panel-body">
								<h4><code><b>Note : </b> I-130, I-290B </code></h4>
								<div class="row">
									<div class="col-md-6">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapseAddressHistory">Address History</a>
							</h4>
						</div>
						<div id="collapseAddressHistory" class="panel-collapse collapse">
							<div class="panel-body">
								<h4><code><b>Note : </b> I-130 </code></h4>
								<div class="row">
									<div class="col-md-6">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapseMaritalInfo">Marital Information</a>
							</h4>
						</div>
						<div id="collapseMaritalInfo" class="panel-collapse collapse">
							<div class="panel-body">
								<h4><code><b>Note : </b> I-130 </code></h4>
								<div class="row">
									<div class="col-md-6">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapseParentInfo">Parents Information</a>
							</h4>
						</div>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapseAdditionalInfo">Additional Information</a>
							</h4>
						</div>
						<div id="collapseAdditionalInfo" class="panel-collapse collapse">
							<div class="panel-body">
								<h4><code><b>Note : </b> I-130 </code></h4>
								<div class="row">
									<div class="col-md-6">
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapsEemployement">Employment History</a>
							</h4>
						</div>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordionPetitioner" href="#collapsPetitionContact">Contact Information</a>
							</h4>
						</div>
						<div id="collapsPetitionContact" class="panel-collapse collapse">
							<div class="panel-body">
								<h4><code><b>Note : </b> I-130, I-290B </code></h4>
								<div class="form-group">
...
<div class="tab-pane" id="tabAttorney">
	<fieldset class="setpage">
		<div class="panel panel-info">
			<div class="panel-heading">
				<div class="panel-title">Attorney Information</div>
			</div>
			<div class="panel-body">
