    ...
    <div class="row mt-5 gap-4">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <textarea class="form-control" cols="30" rows="10" maxlength="195" name="i_102_provide_explanation"><?php echo showData('i_102_p2_1f_provide_explanation')?></textarea>
                </div>
            </div>
            <div class="form-group">
    ...
    <div class="row mt-5 gap-4">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="email" class="form-control" name="i_102_interpreter_business_name" maxlength="34" value="<?php echo showData('i_102_interpreter_business_name')?>" />
                </div>
            </div>
            <div class="bg-info">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="email" class="form-control" maxlength="34 " name="i_102_preparer_business_name" value="<?php echo showData('i_102_preparer_business_name')?>">
                </div>
            </div>
            <div class="bg-info">
