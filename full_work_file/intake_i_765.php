	...
	<div class="form-group">
		<div class="col-md-5">
			<div class="d-flexible" style="margin-top:0">
				<?php echo createCheckbox("i_765_g28_checkbox")?>					
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"  maxlength="29" name="information_about_you_other_family_last_name2" value="<?php echo showData('information_about_you_other_family_last_name2')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">3.b. Given Name(First Name):</label>
				<div class="col-md-7">
					<input type="text" class="form-control"  maxlength="29" name="information_about_you_other_given_first_name2" value="<?php echo showData('information_about_you_other_given_first_name2')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">3.c. Middle Name:</label>
				<div class="col-md-7">
					<input type="text" class="form-control"  maxlength="29" name="information_about_you_other_middle_name2" value="<?php echo showData('information_about_you_other_middle_name2')?>" />
				</div>
			</div>
			<hr>
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"  maxlength="29" name="information_about_you_other_family_last_name3" value="<?php echo showData('information_about_you_other_family_last_name3')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">4.b. Given Name(First Name):</label>
				<div class="col-md-7">
					<input type="text" class="form-control"  maxlength="29" name="information_about_you_other_given_first_name3" value="<?php echo showData('information_about_you_other_given_first_name3')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">4.c. Middle Name:</label>
				<div class="col-md-7">
					<input type="text" class="form-control"  maxlength="29" name="information_about_you_other_middle_name3" value="<?php echo showData('information_about_you_other_middle_name3')?>" />
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" maxlength="27" class="form-control" name="information_about_you_us_mailing_street_number" value="<?php echo showData('information_about_you_us_mailing_street_number')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-6">5.c.  &nbsp; 
					...
					<input type="radio" name="information_about_you_us_mailing_apt_ste_flr" value="flr" <?php echo (showData('information_about_you_us_mailing_apt_ste_flr') == 'flr') ? 'checked' : ''; ?>> Flr.:</label>
				<div class="col-md-6">
					<input type="text" class="form-control" name="information_about_you_us_mailing_apt_ste_flr_value" value="<?php echo showData('information_about_you_us_mailing_apt_ste_flr_value')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">5.d. City or Town :</label>
				<div class="col-md-7">
					 <input type="text" class="form-control" maxlength="20" name="information_about_you_us_mailing_city_town" value="<?php echo showData('information_about_you_us_mailing_city_town')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" maxlength="5" class="form-control" name="information_about_you_us_mailing_zip_code" value="<?php echo showData('information_about_you_us_mailing_zip_code')?>" />
				</div>
			</div>
			 <div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="27" name="information_about_you_home_street_number" value="<?php echo showData('information_about_you_home_street_number')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-6">7.b.  &nbsp; 
					...
					<input type="radio" name="information_about_you_home_apt_ste_flr" value="flr" <?php echo (showData('information_about_you_home_apt_ste_flr') == 'flr') ? 'checked' : ''; ?>> Flr.:</label>
				<div class="col-md-6">
					<input type="text" class="form-control" name="information_about_you_home_apt_ste_flr_value" value="<?php echo showData('information_about_you_home_apt_ste_flr_value')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">7.c. City or Town :</label>
				<div class="col-md-7">
					 <input type="text" class="form-control" maxlength="20" name="information_about_you_home_city_town" value="<?php echo showData('information_about_you_home_city_town')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="5" name="information_about_you_home_zip_code" value="<?php echo showData('information_about_you_home_zip_code')?>" />
				</div>
			</div>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-md-offset-4">
					 <input type="text" class="form-control" name="other_information_about_you_social_security_number" value="<?php echo showData('other_information_about_you_social_security_number')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="29" name="parent1_info_family_last_name" value="<?php echo showData('parent1_info_family_last_name')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">16.b.Given Name (First Name):</label>
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="29" name="parent1_info_given_first_name" value="<?php echo showData('parent1_info_given_first_name')?>" />
				</div>
			</div>
			<div class="f-name">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="29" name="parent2_info_family_last_name" value="<?php echo showData('parent2_info_family_last_name')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">17.b. Given Name(First Name):</label>
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="29" name="parent2_info_given_first_name" value="<?php echo showData('parent2_info_given_first_name')?>" />
				</div>
			</div>
			<div class="bg-info">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="39" name="other_information_about_you_country_of_citizen2" value="<?php echo showData('other_information_about_you_country_of_citizen2')?>" />
				</div>
			</div>						
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" maxlength="39" class="form-control" name="other_information_about_you_city_of_birth" value="<?php echo showData('other_information_about_you_city_of_birth')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">19.b.  State/Province of Birth:</label>
				<div class="col-md-7">
					<input type="text" maxlength="20" class="form-control" name="other_information_about_you_province_of_birth" value="<?php echo showData('other_information_about_you_province_of_birth')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-5">
					<input type="text" maxlength="11" class="form-control" name="i_94_imgt_arrival_record_number" value="<?php echo showData('i_94_imgt_arrival_record_number')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-5">
					<input type="text" maxlength="39" class="form-control" name="i_94_imgt_country_issuance_passport" value="<?php echo showData('i_94_imgt_country_issuance_passport')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-5">
					<input type="text" maxlength="39" class="form-control" name="i_94_imgt_city_town" value="<?php echo showData('i_94_imgt_city_town')?>" />
				</div>
			</div>
			<div class="form-group">
