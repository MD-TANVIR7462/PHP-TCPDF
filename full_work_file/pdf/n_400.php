...
var fields = {
	...
	'other_explain':' ',
	'legal_last_name':' " . showData('') . "',
	'legal_first_name':' " . showData('') . "',
	'legal_middle_name':' " . showData('') . "',
	'other_name_last_name1':' " . showData('') . "',
	'other_name_first_name1':' " . showData('') . "',
	'other_name_middle_name1':' " . showData('') . "',
	'other_name_last_name2':' " . showData('') . "',
	'other_name_first_name2':' " . showData('') . "',
	'other_name_middle_name2':' " . showData('') . "',
//page 1 end.....
