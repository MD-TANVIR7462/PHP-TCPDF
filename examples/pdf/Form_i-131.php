...
$pdf->TextField('attorney_state_licence', 35, 7,array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),165, 80);
//.............
...
$pdf->writeHTMLCell(90, 7, 13, 136, $html, 0, 1, false, false, 'R', true);
//..........
...
$pdf->writeHTMLCell(80, 7, 120, 54, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(45, 7, 158, 53, "", 1, 1, false, true, 'L', true);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part3_daytime_phone', 45, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 157, 102);
...
$pdf->SetFont('times', '', 10);
$html ='<div><b>4.c. </b>  Been granted refugee or asylee <br>  &nbsp; &nbsp; &nbsp;
status in any other country?</div>';
...
$pdf->writeHTMLCell(190, 7, 13, 210, $html, 1, 1, true, true, 'L', true);

//........
$pdf->SetFont('times', '', 10);
$html ='<b>1. </b>';
$pdf->writeHTMLCell(70, 7, 12, 220, $html, 0, 1, false, true, 'L', true);
$html ='<div>I am requesting an Employment 
Authorization Document (EAD) 
upon approval of my new Operation 
Allies Welcome (OAW) period of 
parole.</div>';
$pdf->writeHTMLCell(55, 10, 18, 220, $html, 0, 1, false, true, 'L', true);

$pdf->SetFont('times', '', 12);
$html ='<div><input type="checkbox" name="part8_1" value="Y" checked=" "/>  Yes  <input type="checkbox" name="part8_1" value="N" checked=" "/> No </div>';
$pdf->writeHTMLCell(40, 7, 75, 222, $html, 0, 1, false, true, 'J', true);
