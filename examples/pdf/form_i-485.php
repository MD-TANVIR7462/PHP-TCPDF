...
$html ='<div><b>6.    </b> Sex   <input type="checkbox" name="gender" value="M"  checked="" />  Male  &nbsp;  <input type="checkbox" name="gender" value="F"  checked=""/>  Female</div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_online_account_number', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 87);
...
//...........
$pdf->SetFont('times', '', 10); // set font
$html= '<div><b>12.c. </b>&nbsp; &nbsp; <input type="checkbox" name="Apt" value="Apt" checked="" />Apt. &nbsp;&nbsp;<input type="checkbox" name="Ste" value="Ste" checked="" />Ste. <input type="checkbox" name="Flr" value="Flr" checked="" /> Flr.</div>';
...
$html ='<div><input type="checkbox" name="part1_14" value="Y" checked=" " />  Yes   &nbsp; <input type="checkbox" name="part1_14" value="N" checked=" " /> No</div>';
...
$html ='<div><input type="checkbox" name="part1_16" value="Y" checked=" " />  Yes   &nbsp; <input type="checkbox" name="part1_16" value="N" checked=" " /> No</div>';
...
$html ='<div><input type="checkbox" name="part1_17" value="Y" checked=" " />  Yes   &nbsp; <input type="checkbox" name="part1_17" value="N" checked=" " /> No</div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_pasport_number', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 129);
//.......
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_travel_number', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 141);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_pasport_expire_date', 43, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 160, 154);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_country_issue_pasport', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 166);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_nonimmigrant_number', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 179);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_city_town', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 197);
//........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_date_last_arrive', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 173, 212);
...
$pdf->SetFont('times', '', 10);
$html ='<div><b>25.a.</b> <input type="checkbox" name="inspected" value="Y" checked=" " /></div>';
...
$pdf->writeHTMLCell(77, 7, 26, 49, '', 1, 1, false, true, 'J', true);

//.........

$pdf->SetFont('times', '', 10);
$html ='<div><b>25.b.</b> <input type="checkbox" name="came_into" value="Y" checked=" " /></div>';
...
$pdf->writeHTMLCell(77, 7, 26, 66, '', 1, 1, false, true, 'J', true);
//........

$pdf->SetFont('times', '', 10);
$html ='<div><b>25.c.</b> <input type="checkbox" name="inspect2" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 10);
$html ='<div><b>25.d.</b> <input type="checkbox" name="other" value="Y" checked=" " />   other :</div>';
$pdf->writeHTMLCell(90, 7, 12, 83, $html, 0, 1, false, true, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_other', 78, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 25, 88);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_arival_record_number', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 108);
//............
$pdf->StartTransform();
$pdf->SetFillColor(0,0,0);
$pdf->Rotate(-30);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_pasport_expire_date_authorized', 43, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 60, 121);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_status_on_form_I94', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 137);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('recent_immigration_status_on_current_immigration', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 154);
...
$html ='<div><b>  <input type="checkbox" name="relative_spouse1" value="Y" checked=" " /></div>';
...
//............
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse2" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse3" value="Y" checked=" " /></div>';
...
//............ 
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse4" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse5" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse6" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse7" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse8" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse9" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse10" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse11" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse12" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse13" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse14" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse15" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse16" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse17" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse18" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse19" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse20" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse21" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse22" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse23" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse24" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse25" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse26" value="Y" checked=" " /></div>';
...
$pdf->SetFont('times', '', 11);
$html ='<div><b>  <input type="checkbox" name="relative_spouse27" value="Y" checked=" " /></div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_you_receipt_number_underliying', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 41);
//.........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_you_priority_date', 34, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 169, 54);
...
$pdf->SetFont('times', '', 10); // set font
$html= '<div><b>9.b. </b>&nbsp; &nbsp; <input type="checkbox" name="Apt0" value="Apt0" checked="" />Apt. &nbsp;&nbsp;<input type="checkbox" name="Ste0" value="Ste0" checked="" />Ste. <input type="checkbox" name="Flr0" value="Flr0" checked="" /> Flr.</div>';
...
$pdf->SetFont('times', '', 10); // set font
$html= '<div><b>12.b. </b>&nbsp; &nbsp; <input type="checkbox" name="Apt4" value="Apt4" checked="" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="Ste4" value="Ste4" checked=" " />Ste. 
<input type="checkbox" name="Flr4" value="Flr4" checked=" " /> Flr.</div>';
...
$pdf->SetFont('times', '', 11);
$html= '<div><b>4. </b> Sex   &nbsp; &nbsp; <input type="checkbox" name="G" value="y" checked=" " />Male  &nbsp; &nbsp;
...
$pdf->SetFont('times', '', 11);
$html= '<div><b>12. </b> Sex   &nbsp; &nbsp; <input type="checkbox" name="g" value="y" checked=" " />Male  &nbsp; &nbsp;
<input type="checkbox" name="g" value="n" checked=" " /> Female</div>';
...
<input type="checkbox" name="annuled" value="annulled" checked=" " /> Mariage Annulled <br>
<input type="checkbox" name="separeted" value="separeted" checked=" " /> Legally Separeted 
...
$html= '<div><input type="checkbox" name="part8_63_1" value="$0-27,000" checked=" " />   $0-27,000<br>
<input type="checkbox" name="part8_63_2" value="$27,001-52,000" checked=" " />  $27,001-52,000<br>
<input type="checkbox" name="part8_63_3" value="$52,001-85,000" checked=" " />  $52,001-85,000<br>
<input type="checkbox" name="part8_63_4" value="$85,001-141,000" checked=" " />  $85,001-141,000<br>
<input type="checkbox" name="part8_63_4" value="Over $141,000" checked=" " />  Over $141,000
...
$html= '<div><input type="checkbox" name="part8_64_1" value="$0-18,400" checked=" " />   $0-18,400<br>
<input type="checkbox" name="part8_64_2" value="$18.401-136,000" checked=" " />  $18.401-136,000<br>
<input type="checkbox" name="part8_64_3" value="$136,001-321,400" checked=" " />  $136,001-321,400<br>
<input type="checkbox" name="part8_64_4" value="$321.401-707,100" checked=" " />  $321.401-707,100<br>
<input type="checkbox" name="part8_64_4" value="Over $707,100" checked=" " />  Over $707,100
</div>';
...
$html= '<div><input type="checkbox" name="part8_65_1" value="$0" checked=" " />  $0</div>';
$pdf->writeHTMLCell(85, 7, 20,  32, $html, 0, 0, false, true, 'L', false);

$html= '<div><input type="checkbox" name="part8_65_2" value="$1-10,100" checked=" " />  $1-10,100</div>';
$pdf->writeHTMLCell(85, 7, 35,  32, $html, 0, 0, false, true, 'L', false);

$html= '<div><input type="checkbox" name="part8_65_3" value="$10,101-57,700" checked=" " />  $10,101-57,700</div>';
$pdf->writeHTMLCell(85, 7, 60,  32, $html, 0, 0, false, true, 'L', false);

$html= '<div><input type="checkbox" name="part8_65_4" value="$57,701-186,800" checked=" " />  $57,701-186,800</div>';
$pdf->writeHTMLCell(85, 7, 95,  32, $html, 0, 0, false, true, 'L', false);

$html= '<div><input type="checkbox" name="part8_65_5" value="Over $186,800" checked=" " />  Over $186,800</div>';
...
//..first row 
$html= '<div><input type="checkbox" name="part8_66_1" value=" Grades 1" checked=" " />  Grades 1 through 11</div>';
$pdf->writeHTMLCell(85, 7, 20,  47, $html, 0, 0, false, true, 'L', false);

$html= '<div><input type="checkbox" name="part8_66_2" value="12th grade - no diploma" checked=" " />  12th grade - no diploma</div>';
$pdf->writeHTMLCell(85, 7, 55,  47, $html, 0, 0, false, true, 'L', false);

$html= '<div><input type="checkbox" name="part8_66_3" value="GED" checked=" " />  High school diploma, GED, or alternative credential</div>';
$pdf->writeHTMLCell(85, 7, 95,  47, $html, 0, 0, false, true, 'L', false);

//..Second row 
$html= '<div><input type="checkbox" name="part8_66_4" value="1 more" checked=" " />  1 or more years of college credit, no degree</div>';
$pdf->writeHTMLCell(85, 7, 20,  53, $html, 0, 0, false, true, 'L', false);

$html= '<div><input type="checkbox" name="part8_66_5" value="Associate degree" checked=" " />  Associate\'s degree</div>';
$pdf->writeHTMLCell(85, 7, 95,  53, $html, 0, 0, false, true, 'L', false);

$html= '<div><input type="checkbox" name="part8_66_6" value="Bachelor" checked=" " />  Bachelor\'s degree</div>';
$pdf->writeHTMLCell(85, 7, 130,  53, $html, 0, 0, false, true, 'L', false);
//third row 

$html= '<div><input type="checkbox" name="part8_66_7" value="Master" checked=" " />  Master\'s degree</div>';
...
$html= '<div><input type="checkbox" name="part8_66_9" value="Doctorate degree" checked=" " /> Doctorate degree</div>';
...
$html= '<div> <input type="checkbox" name="part8_68a" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_68a" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_68b" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_68b" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_69b" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_69b" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_72" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_72" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_73" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_73" value="N" checked=" " />  No </div>';
$pdf->writeHTMLCell(85, 7, 80, 140, $html, 0, 0, false, true, 'J', false);
...
$html= '<div> <input type="checkbox" name="part8_78a" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_78a" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_78b" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_78b" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_80" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_80" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_81" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_81" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_82" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_82" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_83" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_83" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_84" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_84" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_85" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_85" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_85b" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_85b" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_85c" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_85c" value="N" checked=" " />  No </div>';
...
$html= '<div> <input type="checkbox" name="part8_86a" value="Y" checked=" " />  Yes   <input type="checkbox" name="part8_86a" value="N" checked=" " />  No </div>';
...
var fields = {
    ...
    'info_about_you_us_social_security_card':' ',
    ...
    'aditional_info_address_date_to':' Present',
