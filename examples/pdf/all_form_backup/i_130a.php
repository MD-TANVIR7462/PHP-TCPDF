...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('address1_name', 59.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),44, 198);
...
$html= '<div><b>4.b. </b>&nbsp; 
<input type="checkbox" name="address1_apt_ste_flr1" value="Apt" checked="'.$apt_checked.'" />Apt. 
<input type="checkbox" name="address1_apt_ste_flr2" value="Ste" checked="'.$ste_checked.'" />Ste.
<input type="checkbox" name="address1_apt_ste_flr3" value="Flr" checked="'.$flr_checked.'" /> Flr.
</div>';

$pdf->writeHTMLCell(50, 0, 13, 206.5, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10.5); // set font
$pdf->TextField('address1_apt_ste_flr_value', 41, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),62.5, 206.5);
...
$pdf->SetFont('times', '', 10.5); // set font
if($outside_of_ny_apt_ste_flr=="Apt") $apt_checked = "checked"; else $apt_checked = "";
if($outside_of_ny_apt_ste_flr=="Ste") $ste_checked = "checked"; else $ste_checked = "";
if($outside_of_ny_apt_ste_flr=="Flr") $flr_checked = "checked"; else $flr_checked = "";
$html= '<div><b>6.b. </b>&nbsp; &nbsp; 
<input type="checkbox" name="outside_of_ny_apt_ste_flr1" value="Apt" checked="'.$apt_checked.'" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="outside_of_ny_apt_ste_flr2" value="Ste" checked="'.$ste_checked.'" />Ste.
<input type="checkbox" name="outside_of_ny_apt_ste_flr3" value="Flr" checked="'.$flr_checked.'" /> Flr.
</div>';
...
var fields = {
	...
	'address1_name':' $street_address',
	'address1_apt_ste_flr_value':' $address1_apt_ste_flr_value',
	'address1_city_or_town':' $city',
	'address1_state':'$state',
	'address1_zip_code':' $zip',
	'address1_province':' $province',
	'address1_postal_code':' $postal_code',
	'address1_country_name':' $country_name',
	'address1_date_from':' ',
	'address1_date_to':' ',
	'address2_name':' ',
	...
	'outside_date_from':' ',
	'outside_date_to':' ',
	'parent1_maiden_name':' $father_maiden_name',
	'parent1_first_name':' $father_first_name',
	'parent1_middle_name':' $father_middle_name',
	'parent1_date_of_birth':' $father_date_of_birth',
	'parent1_city_town_village_of_birth':' $father_birth_location',
    'parent1_country_of_birth':' $father_country_of_birth',
	'parent1_city_town_village_of_residence':' $father_city_town_village_of_residence',
	'parent1_country_of_residence':' $father_country_of_residence',
	'parent2_family_last_name':' ',
	'parent2_last_name':' $mother_last_name',
	'parent2_middle_name':' $mother_middle_name',
	'parent2_date_of_birth':' $mother_date_of_birth',
	'parent2_city_town_village_of_birth':' $mother_birth_location',
	'parent2_country_of_birth':' $mother_country_of_birth',
	'parent2_city_town_village_of_residence':' $mother_city_town_village_of_residence',
	'parent2_country_of_residence':' $mother_country_of_residence',
	'employer1_name':' $employer1_name',
	'employer1_address':' $employer1_address',
	'employer1_apt_ste_flr':'$employer1_apt_ste_flr',
	'employer1_city_or_town':' $employer1_city_or_town',
	'employer1_apt_ste_flr_value':' $employer1_apt_ste_flr_value',
	'employer1_state':' $employer1_state',
	'employer1_zip_code':' $employer1_zip_code',
	'employer1_province':' $employer1_province',
	'employer1_postal_code':' $employer1_postal_code',
	'employer1_country':' $employer1_country',
	'employer1_occupation':' $employer1_occupation',
	'employer1_date_from':' $employer1_date_from',
	'employer1_date_to':' $employer1_date_to',
	'employer2_name':' $employer2_name',
	'employer2_address':' $employer2_address',
	'employer2_city_or_town':' $employer2_city_or_town',
	'employer2_apt_ste_flr_value':' $employer2_apt_ste_flr_value',
	'employer2_state':' $employer2_state',
	'employer2_zip_code':' $employer2_zip_code',
	'employer2_province':' $employer2_province',
	'employer2_postal_code':' $employer2_postal_code',
	'employer2_country':' $employer2_country',
	'employer2_occupation':' $employer2_occupation',
	'employer2_date_from':' $employer2_date_from',
	'employer2_date_to':' $employer2_date_to',
	'outside_of_ny_company_name':' $outside_of_ny_company_name',
	'outside_of_ny_address':' $outside_of_ny_address',
	'outside_of_ny_city_or_town':' $outside_of_ny_city_or_town',
	'outside_of_ny_apt_ste_flr_value':' $outside_of_ny_apt_ste_flr_value',
	'outside_of_ny_state':' $outside_of_ny_state',
	'outside_of_ny_zip_code':' $outside_of_ny_zip_code',
	'outside_of_ny_province':' $outside_of_ny_province',
	'outside_of_ny_postal_code':' $outside_of_ny_postal_code',
	'outside_of_ny_country':' $outside_of_ny_country',
	'outside_of_ny_occupation':' $outside_of_ny_occupation',
	'outside_of_ny_date_from':' $outside_of_ny_date_from',
	'outside_of_ny_date_to':' $outside_of_ny_date_to',
