...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part-2_info_about_you_align_reg', 48, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 31, 238.5);

$pdf->SetFont('times', '', 10); // set font
$html = '<b>4. </b> USCIS Online Account Number (if any)';
$pdf->writeHTMLCell(80, 7, 96, 233, $html, 0, 0, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part-2_info_about_you_uscis_online_acc_num', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 107, 238.5);
//.................
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part-2_info_about_you_date_of_birth', 48, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 19, 252.5);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part-2_info_about_you_us_social_secur_num', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 90, 252.5);
$pdf->StartTransform();
$pdf->SetFillColor(0,0,0);
$pdf->Rotate(90);
$pdf->SetFont('zapfdingbats', 'B', 10);
...
if(showData('other_information_about_you_marital_status')=='single')   $single_check='checked'; else $single_check='';
if(showData('other_information_about_you_marital_status')=='divorced') $divorce_check='checked'; else $divorce_check='';
if(showData('other_information_about_you_marital_status')=='married')  $married_check='checked'; else $married_check='';
if(showData('other_information_about_you_marital_status')=='widowed') $widowed_check='checked'; else $widowed_check='';
if(showData('other_information_about_you_marital_status')=='annulled') $marriage_annulled_check='checked'; else $marriage_annulled_check='';
if(showData('other_information_about_you_marital_status')=='separated') $separated_check='checked'; else $separated_check='';
if(showData('other_information_about_you_marital_status')=='other') $other_check='checked'; else $other_check='';
...
$pdf->TextField( 'part2-7', 100, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 50, 37);
...
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField( 'part3_applications_or_petitions_requesting_fee_waiver_family_memb_full_name1', 32, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18, 82 );
$pdf->TextField( 'part3_applications_or_petitions_requesting_fee_waiver_family_memb_full_name2', 32, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18, 89 );
$pdf->TextField( 'part3_applications_or_petitions_requesting_fee_waiver_family_memb_full_name3', 32, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18, 96 );
// $pdf->writeHTMLCell(  5, 6, 51, 78.4, $html, "", 0, false, false, 'C', true );//A-
...
//................
$pdf->SetFont( 'courier', 'B', 10 );
// $pdf->TextField( 'part3_fullname1', 32, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18.2, 82.5 );

//................

$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_a_num1', 49.8, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 56.5, 76 );
//................

$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_a_num2', 49.8, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 56.5, 82.5 );
//................

$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_a_num3', 49.8, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 56.5, 89.2 );
//................

$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_a_num4', 49.8, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 56.5, 96.2 );
//................
$pdf->SetFont( 'courier', 'B', 10 );
...
//................
$pdf->SetFont( 'courier', 'B', 10 );
// $pdf->TextField( 'part3_input_date_of_birth1', 30, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 106.2, 82.5 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth1', 30, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 106.2, 76 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth2', 30, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 106.2, 82.5 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth3', 30, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 106.2, 89.2 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth4', 30, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 106.2, 96.2 );
//................
$pdf->SetFont( 'courier', 'B', 10 );
...
$pdf->SetFont( 'courier', 'B', 10 );
$html = "<div>Self</div>";
$pdf->writeHTMLCell(   34.5, 6.5, 136.2, 76, $html, "", 0, false, false, 'C', true );

//................
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_relate1', 34.5, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 136.2, 82.5 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_relate2', 34.5, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 136.2, 89.2 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_relate3', 34.5, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 136.2, 96.2 );
//................
$pdf->SetFont( 'courier', 'B', 10 );
...
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed1', 31.7, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(),171.1, 76 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed2', 31.7, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(),171.1, 82.5 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed3', 31.7, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(),171.1, 89.2 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed4', 31.7, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(),171.1, 96.2 );
//................
$pdf->SetFont( 'courier', 'B', 10 );
...
//................
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField( 'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_total_num', 31.7, 6.6, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(),171.1,  103.1 );
...
//................
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField( 'part4_1_means_test_benefits_full_name1', 37, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18.2, 167.9 );
$pdf->TextField( 'part4_1_means_test_benefits_full_name2', 37, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18.2, 175.5 );
$pdf->TextField( 'part4_1_means_test_benefits_full_name3', 37, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18.2, 183 );
$pdf->TextField( 'part4_1_means_test_benefits_full_name4', 37, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18.2, 190.6 );
//................
$pdf->TextField( 'part4_1_means_test_benefits_relate1', 23.5, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 55.3, 167.9 );
$pdf->TextField( 'part4_1_means_test_benefits_relate2', 23.5, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 55.3, 175.5 );
$pdf->TextField( 'part4_1_means_test_benefits_relate3', 23.5, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 55.3, 183 );
$pdf->TextField( 'part4_1_means_test_benefits_relate4', 23.5, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 55.3, 190.6 );
//................
$pdf->TextField( 'part_4_1_means_test_benefits_agency_award1', 39.8, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 79, 167.9 );
$pdf->TextField( 'part_4_1_means_test_benefits_agency_award2', 39.8, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 79, 175.5 );
$pdf->TextField( 'part_4_1_means_test_benefits_agency_award3', 39.8, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 79, 183 );
$pdf->TextField( 'part_4_1_means_test_benefits_agency_award4', 39.8, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 79, 190.6 );
//................
$pdf->TextField( 'part_4_1_means_test_benefits_type_of_benefit1', 27, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 119.1, 167.9 );
$pdf->TextField( 'part_4_1_means_test_benefits_type_of_benefit2', 27, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 119.1, 175.5 );
$pdf->TextField( 'part_4_1_means_test_benefits_type_of_benefit3', 27, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 119.1, 183 );
$pdf->TextField( 'part_4_1_means_test_benefits_type_of_benefit4', 27, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 119.1, 190.6 );
//................
$pdf->TextField( 'part_4_1_means_test_benefits_date_benefit_award1', 25, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 146.1, 167.9 );
$pdf->TextField( 'part_4_1_means_test_benefits_date_benefit_award2', 25, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 146.1, 175.5 );
$pdf->TextField( 'part_4_1_means_test_benefits_date_benefit_award3', 25, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 146.1, 183 );
$pdf->TextField( 'part_4_1_means_test_benefits_date_benefit_award4', 25, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 146.1, 190.6 );
//................
$pdf->TextField( 'part_4_1_means_test_benefits_date_benefit_expire1', 31.8, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 171.1, 167.9 );
$pdf->TextField( 'part_4_1_means_test_benefits_date_benefit_expire2', 31.8, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 171.1, 175.5 );
$pdf->TextField( 'part_4_1_means_test_benefits_date_benefit_expire3', 31.8, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 171.1, 183 );
$pdf->TextField( 'part_4_1_means_test_benefits_date_benefit_expire4', 31.8, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 171.1, 190.6 );
...
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField( 'part5_1_chkbox_other', 70, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 132.8, 240 );
...
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField( 'part5_annual_household_income_chkbox_expl', 50, 6, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 150.4 , 250.5 );
...
// $pdf->TextField('part7-1-checkBox-B', 100, 6.3, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 48, 145.4);
$pdf->setFont('courier', 'B', 10); 
...
$pdf->SetFillColor(220,220,220);
// $pdf->writeHTMLCell(70, 7, 20, 55.3, "", 1, 0, false, true, 'L', true);
// $pdf->writeHTMLCell(56, 7, 97, 55.3, "", 1, 0, false, true, 'L', true);
// $pdf->writeHTMLCell(48, 7, 155.5, 55.3, "", 1, 0, false, true, 'L', true);
$pdf->TextField('additional_information_part_11_family_name_last_name', 70, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 55.3);
$pdf->TextField('additional_information_part_11_family_name_first_name', 56, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 97, 55.3);
$pdf->TextField('additional_information_part_11_family_name_middle_name', 48, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 155.5, 55.3);
//...........
...
// $pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField('additional_information_part_11_2_i_912_a_numb', 50, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 60, 64);
...
// $pdf->MultiCell(90, 40, 25, 85, $html, 0, 0, false, 'L');
// $pdf->writeHTMLCell(90, 40, 25, 85, $html, 0, 0, false, 'L');
...
/* $html = <<<EOD
<textarea cols="42" rows="6" name="i_912_additional_info_6d" multiline="true">
...
'part2-1_middle_name':' ".showData('information_about_you_requestor_middle_name')."  ',
'part2-1_first_name':' ".showData('information_about_you_requestor_given_first_name')." ',
'part2-1_last_name':' ".showData('information_about_you_family_requestor_last_name')." ',
'part2-2_middle_name':' ".showData('information_about_you_requestor_other_middle_name')."',
'part2-2_first_name':' ".showData('information_about_you_requestor_other_given_first_name')." ',
'part2-2_last_name':' ".showData('information_about_you_requestor_other_family_last_name')." ',
'part2-2_middle_name2':' ',
'part2-2_first_name2':' ',
'part2-2_last_name2':' ',
'part2-3':' ".showData('other_information_about_you_alien_registration_number')." ',
'part2-4':' ".showData('other_information_about_you_uscis_online_account_number')." ',
'part2-5':' ".showData('other_information_about_you_date_of_birth')." ',
'part2-6':' ".showData('other_information_about_you_social_security_number')." ',
'part2-7':' ".showData('info_about_you_requestor_other_expl')." ',
'part-2_info_about_you_align_reg':' ".showData('other_information_about_you_requestor_other_alien_registration_number')."',
'part-2_info_about_you_uscis_online_acc_num':' ".showData('other_information_about_you_requestor_other_uscis_online_account_number')."',
'part-2_info_about_you_date_of_birth':' ".showData('other_information_about_you_requestor_other_date_of_birth')."',
'part-2_info_about_you_us_social_secur_num':' ".showData('other_information_about_you_requestor_other_social_security_num')."',
'part-1_3':' ',
//*page 1 complete..........
...
'part3_applications_or_petitions_requesting_fee_waiver_family_memb_full_name1':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_full_name','0')."',
'part3_applications_or_petitions_requesting_fee_waiver_family_memb_full_name2':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_full_name','1')."',
'part3_applications_or_petitions_requesting_fee_waiver_family_memb_full_name3':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_full_name','2')."',

'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_a_num1':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_a_num','0')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_a_num2':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_a_num','1')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_a_num3':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_a_num','2')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_a_num4':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_a_num','3')."',

'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth1':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth','0')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth2':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth','1')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth3':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth','2')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth4':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_date_of_birth','3')."',
...
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed1':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed','0')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed2':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed','1')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed3':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed','2')."',
'part_3_applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed4':'".showData('applications_or_petitions_requesting_fee_waiver_family_memb_form_being_filed','3')."',
...
'part3_fullname2':'',
'part3_fullname3':'',
'part3_input_a_number1':'',
'part3_input_a_number2':'',
'part3_input_a_number3':'',
'part3_input_a_number4':'',
'part3_input_date_of_birth1':'',
'part3_input_date_of_birth2':'',
'part3_input_date_of_birth3':'',
'part3_input_date_of_birth4':'',
'part3_input_relation_2':'',
'part3_input_relation_3':'',
'part3_input_relation_4':'',
'part3_input-15':'',
'part3_input-16':'',
'part3_input-17':'',
'part3_input-18':'',
...
'part5_input-11':'',
'part5_input-12':'',
'part5_1_chkbox_other':'".showData('income_federal_povert_guide_other_expl')."',
...
'part5_annual_household_income_chkbox_expl':' ".showData('annual_household_income_chkbox_expl')."',
'part5-7-1':' ',
'part5-7-2':' ',
'part5-7-3':' ',
'part5-7-4':' ',
...
//*part 9.................
'part9_2_provide':' ".showData('interpreters_contact_information_interpreter_for')."',
'part9_5_state':' ',
'part9_Interpreter_contact_Email':' ".showData('interpreters_email_addr')."',
'part9_Interpreter_contact_mobile_telephone':' ".showData('interpreters_mobile_tel_num')."',
'part9_Interpreter_contact_daytime_telephone':' ".showData('interpreters_daytime_tel_num')."',
'part9_Interpreter_mailing_address_country':' ".showData('interpreter_mailing_country')."',
'part9_Interpreter_mailing_address_postal_code':' ".showData('interpreter_mailing_postal_code')."',
'part9_Interpreter_mailing_address_provience':' ".showData('interpreter_mailing_province')."',
'part9_5_state':' ".showData('')."',
'part9_Interpreter_mailing_address_zipcode1':' ".showData('interpreter_mailing_zip_code')."',
'part9_Interpreter_mailing_address_city_town':' ".showData('interpreter_mailing_city_or_town')."',
'part9_Interpreter_number':' ',
'part9_Interpreter_mailing_address_street_name_number':' ".showData('interpreter_mailing_street_num')."',
'part9_Interpreter_organiz_name':' ".showData('interpreters_business_and_organization_name')."',
'part9_Interpreter_first_name':' ".showData('interpreters_first_name')."',
'part9_Interpreter_last_name':' ".showData('interpreters_last_name')."',
'part9_9_signature':' ".showData('Interpreters_contact_information_interpreter_date_of_sign')."',
'part9_Interpreter_certification_input':' ".showData('interpreters_certification_lang')."',
'flr9':' ',
'ste9':' ',
'apt9':' ',
...
//*part 10..............
'part10_2_provide':' ".showData('interpreters_contact_info_date_of_sign')."',
'part10_5_state':' ',
'part10_Preparer_contact_Email':' ".showData('preparers_contact_info_email_addr')."',
'part10_Preparer_contact_mobile_telephone':' ".showData('preparers_contact_info_mobile_tel_num')."',
'part10_Preparer_contact_daytime_telephone':' ".showData('preparers_contact_info_daytime')."',
'part10_Preparer_mailing_address_country':' ".showData('contact_info_preparers_mailing_addr_country')."',
'part10_Preparer_mailing_address_postal_code':' ".showData('contact_info_preparers_mailing_addr_postal_code')."',
'part10_Preparer_mailing_address_provience':' ".showData('contact_info_preparers_mailing_addr_province')."',
'part10_5_state':' ',
'part10_Preparer_mailing_address_zipcode1':' ".showData('contact_info_preparers_mailing_addr_zip_code')."',
'part10_Preparer_mailing_address_city_town':' ".showData('contact_info_preparers_mailing_addr_city_or_town')."',
'part10_Preparer_number':' ',
'part10_Preparer_mailing_address_street_name_number':' ".showData('contact_info_preparers_mailing_addr_street_num')."',
'part10_Preparer_organiz_name':' ".showData('contact_info_preparers_business_and_organization_name')."',
'part10_Preparer_first_name':' ".showData('contact_info_preparers_first_name')."',
'part10_Preparer_last_name':' ".showData('contact_info_preparers_last_name')."',
'part10_9_signature':' ',
...
'part10_9A':' ',
'part10_9B':' ',
'part_10_preparer_date_of_signature':' ".showData('preparers_date_of_sign')."',
//*aditional information...................
'additional_information_part_11_family_name_last_name':' ".showData('additional_information_i_912_last_name')."',
'additional_information_part_11_family_name_first_name':' ".showData('additional_information_i_912_first_name')."',
'additional_information_part_11_family_name_middle_name':' ".showData('additional_information_i_912_middle_name')."',
'additional_information_part_11_2_i_912_a_numb':' ".showData('additional_information_i_912_a_numb')."',
...
'additional_information_5d':' ".showData('additional_information_i_192_third_comment')."',
'additional_information_5c':' ".showData('additional_information_i_912_third_item_numb')."',
'additional_information_5b':' ".showData('additional_information_i_912_third_part_numb')."',
'additional_information_5a':' ".showData('additional_information_i_912_third_page_numb')."',
'additional_information_4d':' ".showData('additional_information_i_912_second_comment')."',
'additional_information_4a':' ".showData('additional_information_i_912_second_page_numb')."',
'additional_information_4b':' ".showData('additional_information_i_912_second_part_numb')."',
'additional_information_4c':' ".showData('additional_information_i_912_second_item_numb')."',
'additional_information_6b':' ".showData('additional_information_i_192_fourth_part_numb')."',
'additional_information_3c':' ".showData('additional_information_i_912_first_item_numb')."',
'additional_information_3d':' ".showData('additional_information_i_912_first_comment')."',
'additional_information_3b':' ".showData('additional_information_i_912_first_part_numb')."',
'additional_information_3a':' ".showData('additional_information_i_912_first_page_numb')."',
