...
if(showData('part_2_q7_immigration_proceding')=="N") $checked_no = "checked"; else $checked_no = "";
...
$pdf->writeHTMLCell(91, 7, 13, 18, $html, 1, 1, true, 'L' );
//........
$pdf->setCellHeightRatio( 1.2 );
$pdf->setFont('Times', '', 10);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_last_name', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 63);
//........
$pdf->setFont('Times', '', 10);
$html = '<div><b>1.b. </b> &nbsp; Given Name<br> &nbsp; &nbsp; &nbsp; &nbsp; (First Name)</div>';
$pdf->writeHTMLCell( 35, 7, 12, 71, $html, 0, 1, false, 'L' );
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_first_name', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 72);
//.......
$pdf->setFont('Times', '', 10);
$html = '<div><b>1.c. </b> &nbsp; Middle Name</div>';
$pdf->writeHTMLCell( 35, 7, 12, 81, $html, 0, 1, false, 'L' );
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_middle_name', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 81);
//.......

$pdf->setFont('Times', '', 10);
$html = '<div><b>2. </b> &nbsp;&nbsp;&nbsp; A-Number (if any) &nbsp;&nbsp;&nbsp;&nbsp; <b>A-</b></div>';
$pdf->writeHTMLCell(49, 7, 12, 91, $html, 0, 1, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_a_number', 46, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 58, 91);

$pdf->Image('images/right_angle.jpg', 50, 92.6, 3.2, 3.2, 'JPG', '', '', true, 150, '', false, false, 0, false, false, false);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField( 'i_918_additional_info_3a_page_no', 18.5, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 21, 104);
//.....
$pdf->setFont('Times', '', 10);
$html = '<div><b>3.b. </b>&nbsp;Part Number </div>';
$pdf->writeHTMLCell(30, 7, 43, 98, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField( 'i_918_additional_info_3b_part_no', 18, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 54, 104);
//......
$pdf->setFont('Times', '', 10);
$html = '<div><b>3.c. </b>&nbsp;Item Number </div>';
$pdf->writeHTMLCell( 30, 7, 75, 98, $html, 0, 0, false, 'L' );
$pdf->setFont('courier', 'B', 10);
$pdf->TextField( 'i_918_additional_info_3c_item_no', 20, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 84, 104);
//............
$pdf->setFont('Times', '', 10);
$html = '<div><b>3.d. </b> </div>';
$pdf->writeHTMLCell(10, 7, 12, 112, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_3d', 83.5, 64, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>0, 'borderStyle'=>'solid'), array('v' => showData('i_918_additional_info_3d')), 21, 113);
...
$pdf->writeHTMLCell(32, 7, 12, 179, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_4a_page_no', 18.5, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 21, 184.5);
//.....
$pdf->setFont('Times', '', 10);
$html = '<div><b>4.b. </b>&nbsp;Part Number </div>';
$pdf->writeHTMLCell(32, 7, 43, 179, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_4b_part_no', 18, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 54, 184.5);
//......
$pdf->setFont('Times', '', 10);
$html = '<div><b>4.c. </b>&nbsp;&nbsp;Item Number </div>';
$pdf->writeHTMLCell(32, 7, 75, 179, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_4c_item_no', 20, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 84, 184.5);
//.........
$pdf->setFont('Times', '', 10);
$html = '<div><b>4.d. </b></div>';
$pdf->writeHTMLCell(10, 7, 12, 192, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_4d', 83.5, 64, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>0, 'borderStyle'=>'solid'), array('v' => showData('i_918_additional_info_4d')), 21, 193);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_5a_page_no', 20, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 120.4, 23 );
//.....
$pdf->setFont('Times', '', 10);
$html = '<div><b>5.b. </b>&nbsp;Part Number </div>';
$pdf->writeHTMLCell( 30, 7, 145, 17, $html, 0, 0, false, 'L' );
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_5b_part_no', 18, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 153, 23 );
//......
$pdf->setFont('Times', '', 10);
$html = '<div><b>5.c. </b>&nbsp;Item Number </div>';
$pdf->writeHTMLCell( 30, 7, 175, 17, $html, 0, 0, false, 'L' );
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_5c_item_no', 19.5, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 184, 23 );
//.........
$pdf->setFont('Times', '', 10);
...
$pdf->TextField('i_918_additional_info_5d', 83, 65, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_918_additional_info_5d')), 120.5, 31.5);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField( 'i_918_additional_info_6a_page_no', 20, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 120.4, 104);
//.....
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField( 'i_918_additional_info_6b_part_no', 18, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 153, 104);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_6c_item_no', 19.5, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 184, 104);
//.........
...
$pdf->TextField('i_918_additional_info_6d', 83, 62.5,array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_918_additional_info_6d')), 120.5, 113);
...
$pdf->writeHTMLCell(30, 7, 111.3, 178, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_7a_page_no', 20, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 120.4, 183.5);
//.....

$pdf->setFont('Times', '', 10);
$html = '<div><b>7.b. </b>&nbsp;Part Number</div>';
$pdf->writeHTMLCell(30, 7, 144, 178, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_918_additional_info_7b_part_no', 18, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 153, 183.5);
...
$pdf->setFont('courier', 'B', 10 );
$pdf->TextField('i_918_additional_info_7c_item_no', 19.5, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 184, 183.5);
//.........
...
$pdf->TextField('i_918_additional_info_7d', 83, 62, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_918_additional_info_7d')), 120.5, 192);
...
'part1_4a_Care_Of_Name':' ".showData('information_about_you_safe_mailing_care_of_name')." ',
'part1_4b_street_number': ' ".showData('information_about_you_safe_mailing_street_number')." ',
'part1_4c_apt_ste' :' ".showData('information_about_you_safe_mailing_number')." ',
'part1_4d_city_town':' ".showData('information_about_you_safe_mailing_city_town')." ',
'part1_4e_state': ' ".showData('information_about_you_safe_mailing_state')." ',
'part1_4f_zip_code':' ".showData('information_about_you_safe_mailing_zip_code')." ',
'part1_4g_province':' ".showData('information_about_you_safe_mailing_province')." ',
'part1_4h_Postal_Code':' ".showData('information_about_you_safe_mailing_postal_code')." ',
'part1_4i_Country':' ".showData('information_about_you_safe_mailing_country')." ',
...
'part1_13_Arrival_Departure':' ".showData('other_information_about_you_arival_record_number')." ',
...
'part1_16_Country_of_Issuance':' ".showData('other_information_about_you_country_issuance_passport')." ',
'part1_17_Date_of_Issuance':' ".showData('other_information_about_you_date_issuance_passport')." ',
'part1_18_Expiration_Date':' ".showData('other_information_about_you_expiry_date_issuance_passport')." ',
'part1_19b_state':' ".showData('other_information_about_you_last_entry_state')." ',
'part1_19a_city_or_town':' ".showData('other_information_about_you_last_entry_city_town')." ',
...
'part4_2_date_of_birth':' ".showData('current_spouse_birth_date')." ',
...
'part4_7_date_of_birth':' ".showData('information_about_spouse_children_2_date_of_birth')." ',
...
'part4_12_date_of_birth':' ".showData('information_about_spouse_children_3_date_of_birth')." ',
...
'part4_17_date_of_birth':' ".showData('information_about_spouse_children_4_date_of_birth')." ',
...
'part4_22_date_of_birth':' ".showData('information_about_spouse_children_5_date_of_birth')." ',
'part4_23_Country_of_Birth':' ".showData('information_about_spouse_children_5_country_of_birth')." ',
