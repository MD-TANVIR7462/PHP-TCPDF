...
class MyPDF extends TCPDF {
    ...
    public function Header() {
        ...
        if ( $this->page > 1 ) {
            ...
            //* set filling color
            $this->MultiCell( 0, 0, '', 'T', 1, 'C', 1, '', 6.8, false, 'T', 'C' );
            ...
            $this->SetFillColor( 255, 255, 255 );
            //* set filling color
            $this->MultiCell( 191, 0, '', 'T', 1, 'C', 1, 12.8, 8.7, false, 'T', 'C' );
        }
    }
...
if(showData('i_912_part_1_basis_for_your_request_1')=="Y") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_1_basis_for_your_request_2')=="Y") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_1_basis_for_your_request_3')=="Y") $checked_data = "checked"; else $checked_data = "";
...
if(showData('i_912_info_about_you_requestor_marital_status')=='single')   $single_check='checked'; else $single_check='';
if(showData('i_912_info_about_you_requestor_marital_status')=='married')  $married_check='checked'; else $married_check='';
if(showData('i_912_info_about_you_requestor_marital_status')=='divorced') $divorce_check='checked'; else $divorce_check='';
if(showData('i_912_info_about_you_requestor_marital_status')=='widowed') $widowed_check='checked'; else $widowed_check='';
if(showData('i_912_info_about_you_requestor_marital_status')=='annulled') $marriage_annulled_check='checked'; else $marriage_annulled_check='';
if(showData('i_912_info_about_you_requestor_marital_status')=='separated') $separated_check='checked'; else $separated_check='';
if(showData('i_912_info_about_you_requestor_marital_status')=='other') $other_check='checked'; else $other_check='';
...
$pdf->TextField( 'part2-7', 137, 7, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 50, 44);
...
if(showData('i_912_part_5_income_guidence_emplyment_status_employed')=="Y") $checked_employed = "checked"; else $checked_employed = "";
if(showData('i_912_part_5_income_guidence_emplyment_status_unemployed')=="Y") $checked_unemployed = "checked"; else $checked_unemployed = "";
if(showData('i_912_part_5_income_guidence_emplyment_status_retired')=="Y") $checked_retired = "checked"; else $checked_retired = "";
if(showData('i_912_part_5_income_guidence_emplyment_status_others')=="Y") $checked_others = "checked"; else $checked_others = "";
...
if(showData('i_912_part_5_income_continued_2')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_2')=="N") $checked_no = "checked"; else $checked_no = "";
...
if(showData('i_912_part_5_income_continued_information_about_your_spouse_3')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_information_about_your_spouse_3')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-3" value="Y" checked="'.$checked_yes.'" />Yes
   
   &nbsp;   &nbsp;   <input type="checkbox" name="part5-3" value="N" checked="'.$checked_no.'" />No ';
...
if(showData('i_912_part_5_income_continued_infomration_about_your_spouse_3a')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_infomration_about_your_spouse_3a')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-3A" value="Y" checked="'.$checked_yes.'" />Yes
   
   &nbsp;   &nbsp;   <input type="checkbox"      name="part5-3A" value="N" checked="'.$checked_no.'" />No ';
...
if(showData('i_912_part_5_income_continued_infomration_about_your_spouse_4')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_infomration_about_your_spouse_4')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-4" value="Y" checked="'.$checked_yes.'" />Yes
   
   &nbsp;   &nbsp;   <input type="checkbox"      name="part5-4" value="N" checked="'.$checked_no.'" />No ';
...
$pdf->TextField( 'part5_input_table_cell_4_full_name1', 37, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18,131.5 );
$pdf->TextField( 'part5_input_table_cell_4_full_name2', 37, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18,139 );
$pdf->TextField( 'part5_input_table_cell_4_full_name3', 37, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18,146 );
$pdf->TextField( 'part5_input_table_cell_4_full_name4', 37, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18,153.7 );

$pdf->TextField( 'part5_input_table_cell_4_your_household_size_date_of_birth1', 23.6, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 55,131.5 );
$pdf->TextField( 'part5_input_table_cell_4_your_household_size_date_of_birth2', 23.6, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 55,139 );
$pdf->TextField( 'part5_input_table_cell_4_your_household_size_date_of_birth3', 23.6, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 55,146 );
$pdf->TextField( 'part5_input_table_cell_4_your_household_size_date_of_birth4', 23.6, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 55,153.7 );

$pdf->TextField( 'part5_input_table_cell_4_your_household_relate1', 25.3, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 79.3,139 );
$pdf->TextField( 'part5_input_table_cell_4_your_household_relate2', 25.3, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 79.3,146 );
$pdf->TextField( 'part5_input_table_cell_4_your_household_relate3', 25.3, 7.4, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 79.3,153.7 );

$pdf->writeHTMLCell( "1", "44.1", 54, 117, '',  "R",  0, false, true, 'L', true );/// vertical line
...
$pdf->TextField( 'part5_input_table_cell_4_your_household_total_size', 41.6, 6, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 163, 161.4 );

$html = "<div><b>Full
Name</div>";
$pdf->writeHTMLCell(  10, 4, 29, 118.4, $html, "", 0, false, false, 'C', true );
$html = "<div><b>Date of Birth</div>";
$pdf->writeHTMLCell(  17, 4, 58.5, 118.4, $html, "", 0, false, false, 'C', true );
$html = "<div><b>Relationship to You</div>";
$pdf->writeHTMLCell(  26, 4, 79, 118.4, $html, "", 0, false, false, 'C', true );
$html = "<div><b>Married</div>";
$pdf->writeHTMLCell(  17, 4, 111, 121, $html, "", 0, false, false, 'C', true );
...
if(showData('i_912_part_5_income_continued_household_size_married_1')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_married_1')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-M1" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part5-M1" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 104, 132.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_married_2')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_married_2')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-M2" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox"      name="part5-M2" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 104, 139.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_married_3')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_married_3')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-M3" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part5-M3" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 104, 146.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_married_4')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_married_4')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-M4" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part5-M4" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 104, 154.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_full_time_1')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_full_time_1')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-S1" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part5-S1" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 133, 132.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_full_time_2')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_full_time_2')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-S2" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part5-S2" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 133, 139.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_full_time_3')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_full_time_3')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-S3" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part5-S3" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 133, 146.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_full_time_4')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_full_time_4')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-S4" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part5-S4" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 133, 154.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_counted_1')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_counted_1')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-isAnyIncome_1" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox"      name="part5-isAnyIncome_1" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 4, 168, 132.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_counted_2')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_counted_2')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-isAnyIncome_2" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox"      name="part5-isAnyIncome_2" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 6, 168, 139.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_counted_3')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_counted_3')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-isAnyIncome_3" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox"      name="part5-isAnyIncome_3" value="N" checked="'.$checked_no.'" />No ';
$pdf->writeHTMLCell(30, 6, 168, 146.5, $html, 0, 1, false, true, 'J'); 

//...........

$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_5_income_continued_household_size_counted_4')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_household_size_counted_4')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part5-isAnyIncome_4" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox"      name="part5-isAnyIncome_4" value="N" checked="'.$checked_no.'" />No ';
...
$pdf->writeHTMLCell(160, 4, 12, 128, $html, 0, 1, false, 'L');
...
if(showData('i_912_information_about_biography_info_eye_color')=="Parental") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-1" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_information_about_biography_info_eye_color')=="Spousal") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-2" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_information_about_biography_info_eye_color')=="Child") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-3" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_information_about_biography_info_eye_color')=="Educational Stipends") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-4" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_information_about_biography_info_eye_color')=="Royalties") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-5" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_information_about_biography_info_eye_color')=="Pensions") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-6" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_information_about_biography_info_eye_color')=="Unemployment") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-7" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_information_about_biography_info_eye_color')=="Social Security") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-8" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_information_about_biography_info_eye_color')=="Veteran") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-9" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_information_about_biography_info_eye_color')=="Financial Support") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-10" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_information_about_biography_info_eye_color')=="Other") $checked_data = "checked"; else $checked_data = "";
$html ='<input type="checkbox" name="part5-7-11" value="Y" checked="'.$checked_data.'" /><br>';
...
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField( 'i_912_annual_household_income_chkbox_expl', 50, 6, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 150.4 , 250.5 ); */
...
if(showData('i_912_part_5_income_continued_federal_poverty_9')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_5_income_continued_federal_poverty_9')=="N") $checked_no = "checked"; else $checked_no = "";
...
$pdf->setFont('courier', 'B', 10);
$part6_textarea = showData('financial_hardship_incur_expenses');
$html = <<<EOD
...
//................
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField( 'part6_1_input_2_table_cell_type_asset1', 44, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18, 216.5 );
$pdf->TextField( 'part6_1_input_2_table_cell_type_asset2', 44, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18, 223 );
$pdf->TextField( 'part6_1_input_2_table_cell_type_asset3', 44, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 18, 229.5 );
$pdf->TextField( 'part6_1_input_2_table_cell_value_us1', 46, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 62, 216.5 );
$pdf->TextField( 'part6_1_input_2_table_cell_value_us2', 46, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 62, 223 );
$pdf->TextField( 'part6_1_input_2_table_cell_value_us3', 46, 6.5, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 62, 229.5 );
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_6_financial_hardship_3')=="Rent") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_6_financial_hardship_3')=="Food") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_6_financial_hardship_3')=="Utilities") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_6_financial_hardship_3')=="Child Care") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_6_financial_hardship_3')=="Insurance") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_part_6_financial_hardship_3')=="Loans") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_part_6_financial_hardship_3')=="Car Payment") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_part_6_financial_hardship_3')=="Commuting Costs") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_part_6_financial_hardship_3')=="Medical Expenses") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_part_6_financial_hardship_3')=="School Expenses") $checked_data = "checked"; else $checked_data = "";
...
$pdf->SetFont( 'times', '', 9.7 );
if(showData('i_912_part_6_financial_hardship_3')=="Other") $checked_data = "checked"; else $checked_data = "";
...
$pdf->setFont('Times', '', 10); 
if(showData('i_912_part_7_financial_hardship_1a')=="Y") $checked_data = "checked"; else $checked_data = "";
...
if(showData('i_912_part_7_financial_hardship_1b')=="Y") $checked_data = "checked"; else $checked_data = "";
$html= '<div><b>B.  </b>  <input type="checkbox" name="part7-1-checkBox-B" value="Y" checked="'.$checked_data.'" />   The interpreter named in <b>Part 9</b>. read to me every question and instruction on this request and my answer to every<br> &nbsp; &nbsp; &nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;question, in </div>';
...
$pdf->setFont('courier', 'B', 10); 
$pdf->TextField( 'part7_1_ckbox_b', 100, 6.3, array( 'strokeColor' => array( 64, 64, 64 ), 'lineWidth'=>1, 'borderStyle'=>'solid' ), array(), 48, 145.4 );
...
if(showData('i_912_part_7_financial_hardship_2')=="Y") $checked_data = "checked"; else $checked_data = "";
$html= '<div><input type="checkbox" name="part7-2-checkBox" value="Y" checked="'.$checked_data.'" />&nbsp;  At my request, the preparer named in <b>Part 10.</b>, <br>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; prepared this request for me based only upon information I provided or authorized.</div>';
$pdf->writeHTMLCell(190, 7, 17, 162,  $html, 0, 1, false, 'L');
$pdf->setFont('courier', 'B', 10); 
$pdf->TextField('part7_1_ckbox', 100, 6.3, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 91, 161);
...
$pdf->setFont('courier', 'B', 10); 
$pdf->TextField('part_7-3_requestor_contact_daytime_telephone', 85, 7,array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 18, 188);
...
$pdf->setFont('courier', 'B', 10); 
$pdf->TextField('part_7-4_requestor_contact_mobile_telephone', 84, 7,array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 118, 188);
...
$pdf->setFont('courier', 'B', 10); 
$pdf->TextField('part_7-5_requestor_contact_email_address', 85, 7,array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 18, 202);
...
$pdf->SetFont( 'times', '', 10 );
if(showData('i_912_part_8_family_member_statement_1a')=="Y") $checked_data = "checked"; else $checked_data = "";
$html= '<div><b>   &nbsp;  &nbsp;  A.     </b>     <input type="checkbox" name="part8-1-checkBox-A" value="Y" checked="'.$checked_data.'" /></div>';
...
if(showData('i_912_part_8_family_member_statement_1b')=="Y") $checked_data = "checked"; else $checked_data = "";
$html= '<div><b>B.  </b>  <input type="checkbox" name="part8-1-checkBox-B" value="Y" checked="'.$checked_data.'" />   The interpreter named in <b>Part 9</b>. read to me every question and instruction on this request and my answer to every<br> &nbsp; &nbsp; &nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;question, in </div>';
$pdf->TextField('part8_1_b_input', 103, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 47, 74.9);
...
if(showData('i_912_part_8_family_member_statement_1b')=="Y") $checked_data = "checked"; else $checked_data = "";
$html= '<div>
<input type="checkbox" name="part8-2-checkBox" value="Y" checked="'.$checked_data.'" />&nbsp; 
...
$pdf->TextField('part8_2_authorized_input', 103, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 94, 96);
...
if(showData('i_912_part_9_interpreter_contact_information_signature_1')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_9_interpreter_contact_information_signature_1')=="N") $checked_no = "checked"; else $checked_no = "";
$pdf->setFont('Times', '', 10);
$html= "<div><b>1.      </b>    Did any person filing this request use an interpreter?</div>";
$pdf->writeHTMLCell(100, 7, 12, 26, $html, 0, 1, false, 'L');
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part9-1" value="Y" checked="'.$checked_yes.'" />Yes, (complete this section)
&nbsp;   &nbsp;   <input type="checkbox" name="part9-1" value="N" checked="'.$checked_no.'" />No (skip to <b>Part 10</b>.) ';
...
if(showData('i_912_part_9_interpreter_contact_information_signature_2')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_9_interpreter_contact_information_signature_2')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part9-2" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part9-2" value="N" checked="'.$checked_no.'" />No ';
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_note_for_family_member', 103, 6.3, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 100, 55);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_family_last_name', 90, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 19, 79);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_family_given_first_name', 90, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 113.8, 79);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_business_name', 90, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 19, 92);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_mailing_address_street_number', 130, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 116);

if(showData('i_912_interpreter_mailing_address_apt_ste_flr')=="apt") $checked_apt = "checked"; else $checked_apt = "";
if(showData('i_912_interpreter_mailing_address_apt_ste_flr')=="ste") $checked_ste = "checked"; else $checked_ste = "";
if(showData('i_912_interpreter_mailing_address_apt_ste_flr')=="flr") $checked_flr = "checked"; else $checked_flr = "";
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_765_interpreter_mailing_address_apt_ste_flr_value',17.7, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),187, 116);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_mailing_address_city_town', 130, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 130);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_mailing_address_zip_code', 25, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 180, 130);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_mailing_address_province', 50, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 143);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_mailing_address_postal_code', 52, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 75, 143);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_mailing_address_country', 71, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 133, 143);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_daytime_tel', 85, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 18, 167.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_mobile', 85, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 118, 167.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_email', 85, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 18, 180.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_certification_language_skill', 100, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 50.6,203.3);
$pdf->setFont('Times', '', 10);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_interpreter_sign_date', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 239.5);
...
if(showData('i_912_part_10_contact_info_declaration_requestor_1')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_10_contact_info_declaration_requestor_1')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part10 -1" value="Y" checked="'.$checked_yes.'" />Yes, (complete this section)
&nbsp;   &nbsp;   <input type="checkbox" name="part10_1" value="N" checked="'.$checked_no.'" />No, skip';
...
if(showData('i_912_part_10_contact_info_declaration_requestor_2')=="Y") $checked_yes = "checked"; else $checked_yes = "";
if(showData('i_912_part_10_contact_info_declaration_requestor_2')=="N") $checked_no = "checked"; else $checked_no = "";
$html ='&nbsp;  &nbsp;    <input type="checkbox" name="part10 -2" value="Y" checked="'.$checked_yes.'" />Yes
&nbsp;   &nbsp;   <input type="checkbox" name="part10_2" value="N" checked="'.$checked_no.'" />No ';
...
$pdf->writeHTMLCell(95, 7, 12, 73, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_family_last_name', 90, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 19, 79);
...
$pdf->writeHTMLCell(95, 7, 114, 73, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_family_given_first_name', 90, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 113.8, 79);
...
$pdf->writeHTMLCell(95, 7, 12, 86, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_business_name', 90, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 19, 92);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_mailing_address_street_number', 130, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 116);

if(showData('i_912_preparer_mailing_address_apt_ste_flr')=="apt") $checked_apt = "checked"; else $checked_apt = "";
if(showData('i_912_preparer_mailing_address_apt_ste_flr')=="ste") $checked_ste = "checked"; else $checked_ste = "";
if(showData('i_912_preparer_mailing_address_apt_ste_flr')=="flr") $checked_flr = "checked"; else $checked_flr = "";
...
$pdf->writeHTMLCell(20, 7, 175, 116, $html, 0, 1, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_mailing_address_apt_ste_flr_value',17.7, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),187, 116);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_mailing_address_city_town', 130, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 130);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_mailing_address_zip_code', 25, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 180, 130);
...
$pdf->writeHTMLCell(80, 7, 20, 137, $html, 0, 1, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_mailing_address_province', 50, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 143);
...
$pdf->writeHTMLCell(70, 7, 74, 137, $html, 0, 1, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_mailing_address_postal_code', 52, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 75, 143);
...
$pdf->writeHTMLCell(80, 7, 133, 137, $html, 0, 1, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_mailing_address_country', 71, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 133, 143);
...
$pdf->writeHTMLCell(80, 7, 12, 161.5, $html, 0, 1, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_daytime_tel', 85, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 18, 167.5);
...
$pdf->writeHTMLCell(80, 7, 112, 161.5, $html, 0, 1, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_mobile', 85, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 118, 167.5);
...
$pdf->writeHTMLCell(80, 7, 12, 175, $html, 0, 1, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_email', 85, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 18, 180.5);
...
if(showData('i_912_part_10_prepare_statment_9a')=="Y") $checked_data = "checked"; else $checked_data = "";
if(showData('i_912_preparer_statement_7b_extend')=="Y") $checkbox_extend_status = "checked"; else $checkbox_extend_status = "";
if(showData('i_912_preparer_statement_7b_not_extend')=="Y") $checkbox_not_extend_status = "checked"; else $checkbox_not_extend_status = "";
$pdf->setFont('Times', '', 10);// set font
$html= '<div><b>9.    &nbsp;   A.     </b>     <input type="checkbox" name="part10_9A" value="Y" checked="'.$checked_data.'" /></div>';
...
if(showData('i_912_preparer_statement_7b_extend')=="Y") $checked_data = "checked"; else $checked_data = "";

$pdf->setFont('Times', '', 10);// set font
if(showData('i_912_part_10_prepare_statment_9b')=="Y") $checked_data = "checked"; else $checked_data = "";
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_preparer_sign_date', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 76);
...
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->writeHTMLCell(70, 7, 12, 46, $html, 0, 0, false, true, 'L', true);
$html = 'Given Name (First Name)';
...
$pdf->TextField('i_912_additional_info_last_name', 70, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 55.3);
$pdf->TextField('i_912_additional_info_first_name', 56, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 97, 55.3);
$pdf->TextField('i_912_additional_info_middle_name', 48, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 155.5, 55.3);
...
$pdf->SetFont( 'courier', 'B', 10 );
$pdf->TextField('i_912_additional_info_a_number', 50, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 60, 64);

$pdf->Image('images/right_angle.jpg', 50, 65.3, 3.3, 3.3);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_3a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 26, 77);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_3b_part_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 55, 77);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_3c_item_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 87, 77);
...
$pdf->TextField('i_912_additional_info_3d', 178, 27, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v'=>showData('i_912_additional_info_3d')), 25, 85);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_4a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 26, 117);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_4b_part_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 55, 117);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_4c_item_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 87, 117);
...
$pdf->TextField('i_912_additional_info_4d', 178, 27, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v'=>showData('i_912_additional_info_4d')), 26, 126);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_5a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 26, 157);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_5b_part_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 55, 157);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_5c_item_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 87, 157);
...
$pdf->TextField('i_912_additional_info_5d', 178, 27, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v'=>showData('i_912_additional_info_5d')), 25, 165);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_6a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 26, 197);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_6b_part_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 55, 197);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_6c_item_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 87, 197);
...
$pdf->TextField('i_912_additional_info_6d', 178, 27,array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_912_additional_info_6d')), 26, 207);
...
'part2-7':' ".showData('info_about_you_requestor_other_expl')." ',
...
'part_7-3_requestor_contact_daytime_telephone':' ".showData('requestors_daytime_telephone_num')."',
'part_7-4_requestor_contact_mobile_telephone':' ".showData('requestors_daytime_mobile_tel_num')."',
'part_7-5_requestor_contact_email_address':' ".showData('requestors_daytime_email_addr')."',

'part7_6_signature':' ".showData('requestors_statement_date_of_sign')."',
...
'i_912_additional_info_3a_page_no':' ".showData('i_912_additional_info_3a_page_no')."',
'i_912_additional_info_3b_part_no':' ".showData('i_912_additional_info_3b_part_no')."',
'i_912_additional_info_3c_item_no':' ".showData('i_912_additional_info_3c_item_no')."',
'i_912_additional_info_4a_page_no':' ".showData('i_912_additional_info_4a_page_no')."',
'i_912_additional_info_4b_part_no':' ".showData('i_912_additional_info_4b_part_no')."',
'i_912_additional_info_4c_item_no':' ".showData('i_912_additional_info_4c_item_no')."',
'i_912_additional_info_5a_page_no':' ".showData('i_912_additional_info_5a_page_no')."',
'i_912_additional_info_5b_part_no':' ".showData('i_912_additional_info_5b_part_no')."',
'i_912_additional_info_5c_item_no':' ".showData('i_912_additional_info_5c_item_no')."',
'i_912_additional_info_6a_page_no':' ".showData('i_912_additional_info_6a_page_no')."',
'i_912_additional_info_6b_part_no':' ".showData('i_912_additional_info_6b_part_no')."',
'i_912_additional_info_6c_item_no':' ".showData('i_912_additional_info_6c_item_no')."',
