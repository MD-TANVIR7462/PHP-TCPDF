...
<form method="post" action="https://lms.siscotech.com/views/work_file/pdf/fetch.php" enctype="multipart/form-data" target="_blank">
	<label for="name">name:</label> <input type="text" name="firstname" value="" size="20" maxlength="30" /><br />
