	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="information_about_you_address_street_number" maxlength="29"
						value="<?= showData('information_about_you_address_street_number') ?>">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="information_about_you_safe_mailing_apt_ste_flr_value" maxlength="6"
						value="<?= showData('information_about_you_safe_mailing_apt_ste_flr_value')?>">
				</div>
			</div>
			<div class="form-group">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-8">
					<input type="radio" name="travel_info_about_you_inadmissible_status" value="yes" <?php echo (showData('travel_info_about_you_inadmissible_status') == 'yes') ? 'checked' : ''; ?>> Yes &nbsp;
					
					<input type="radio" name="travel_info_about_you_inadmissible_status" value="no" <?php echo (showData('travel_info_about_you_inadmissible_status') == 'no') ? 'checked' : ''; ?>> No
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-8">
					<input type="radio" name="travel_info_about_you_previous_application_status" value="yes" <?php echo (showData('travel_info_about_you_previous_application_status') == 'yes') ? 'checked' : '';?>> Yes &nbsp;
					<input type="radio" name="travel_info_about_you_previous_application_status" value="no" <?php echo (showData('travel_info_about_you_previous_application_status') == 'no') ? 'checked' : '';?>> No
				</div>
			</div>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-8">
					<input type="radio" name="immigration_criminal_info_about_you_six_month_more_status" value="yes" <?php echo (showData('immigration_criminal_info_about_you_six_month_more_status') == 'yes') ? 'checked' : '';?>> Yes &nbsp;
					<input type="radio" name="immigration_criminal_info_about_you_six_month_more_status" value="no" <?php echo (showData('immigration_criminal_info_about_you_six_month_more_status') == 'no') ? 'checked' : '';?>> No
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-8">
					<input type="radio" name="immigration_criminal_info_about_you_filed_behalf_status" value="yes" <?php echo (showData('immigration_criminal_info_about_you_filed_behalf_status') == 'yes') ? 'checked' : '';?>> Yes &nbsp;
					<input type="radio" name="immigration_criminal_info_about_you_filed_behalf_status" value="no" <?php echo (showData('immigration_criminal_info_about_you_filed_behalf_status') == 'no') ? 'checked' : '';?>> No
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-8">
					<input type="radio" name="info_about_you_revoke_terminate_status" value="yes" <?php echo (showData('info_about_you_revoke_terminate_status') == 'yes') ? 'checked' : '';?>> Yes &nbsp;
					<input type="radio" name="info_about_you_revoke_terminate_status" value="no" <?php echo (showData('info_about_you_revoke_terminate_status') == 'no') ? 'checked' : '';?>> No
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-8">
					<input type="radio" name="info_about_you_breaking_violating_status" value="yes" <?php echo (showData('info_about_you_breaking_violating_status') == 'yes') ? 'checked' : '';?>> Yes &nbsp;
					<input type="radio" name="info_about_you_breaking_violating_status" value="no" <?php echo (showData('info_about_you_breaking_violating_status') == 'no') ? 'checked' : '';?>> No
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-12">
					<input type="radio" name="information_about_biography_info_ethnicity"
						value="hispanic" <?php echo (showData('information_about_biography_info_ethnicity') == 'hispanic') ? 'checked' : '';?>> Hispanic or Latino &nbsp;
				</div>
				<div class="col-md-12">
					<input type="radio" name="information_about_biography_info_ethnicity"
						value="nothispanic" <?php echo (showData('information_about_biography_info_ethnicity') == 'nothispanic') ? 'checked' : '';?>> Not Hispanic or Latino
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-12">2. Race (Select <b>all applicable</b> boxes)</label>
				<div class="col-md-12">
					<input type="hidden" name="information_about_biography_american" id="information_about_biography_american"
					 value="<?php echo (showData('information_about_biography_american') == 'Y') ? 'Y' : 'N'; ?>" />

					<input type="checkbox" onChange="checkboxValue(this,'information_about_biography_american')" 
					<?php echo (showData('information_about_biography_american') == 'Y') ? 'checked' : ''; ?>> American Indian or Alaska Native &nbsp;
				</div>

				<div class="col-md-12">
					<input type="hidden" name="information_about_biography_asian" id="information_about_biography_asian"
					 value="<?php echo (showData('information_about_biography_asian') == 'Y') ? 'Y' : 'N'; ?>" />

					<input type="checkbox" onChange="checkboxValue(this,'information_about_biography_asian')" 
					<?php echo (showData('information_about_biography_asian') == 'Y') ? 'checked' : ''; ?>> Asian &nbsp;
				</div>
				
				<div class="col-md-12">
					<input type="hidden" name="information_about_biography_african" id="information_about_biography_african"
					 value="<?php echo (showData('information_about_biography_african') == 'Y') ? 'Y' : 'N'; ?>" />

					<input type="checkbox" onChange="checkboxValue(this,'information_about_biography_african')" 
					<?php echo (showData('information_about_biography_african') == 'Y') ? 'checked' : ''; ?>> Black or African American &nbsp;
				</div>				
				<div class="col-md-12">
					<input type="hidden" name="information_about_biography_hawaiian" id="information_about_biography_hawaiian"
					 value="<?php echo (showData('information_about_biography_hawaiian') == 'Y') ? 'Y' : 'N'; ?>" />

					<input type="checkbox" onChange="checkboxValue(this,'information_about_biography_hawaiian')" 
					<?php echo (showData('information_about_biography_hawaiian') == 'Y') ? 'checked' : ''; ?>> Native Hawaiian or Other Pacific Islander &nbsp;
				</div>
				<div class="col-md-12">
					<input type="hidden" name="information_about_biography_white" id="information_about_biography_white"
					 value="<?php echo (showData('information_about_biography_white') == 'Y') ? 'Y' : 'N'; ?>" />

					<input type="checkbox" onChange="checkboxValue(this,'information_about_biography_white')" 
					<?php echo (showData('information_about_biography_white') == 'Y') ? 'checked' : ''; ?>> White
				</div>
			</div>
			<div class="form-group">
				<h5 class="control-label col-md-4">3. Height </h5>
				<div class="col-md-4">
					<div class="d-flexible">
						<span>Feet</span>
						<select name="information_about_biography_info_height_feet" 
							class="form-control">
							<option value='' style="display:none;">Feet</option>
							<?php if(showData('information_about_biography_info_height_feet')!=''){
									echo"<option value='".showData('information_about_biography_info_height_feet')."' selected>".showData('information_about_biography_info_height_feet')."</option>";
							}?>
				...
				<div class="col-md-4">
					<div class="d-flexible">
						...
						<select name="information_about_biography_info_height_inches" 
							class="form-control">
							<option value="" style="display:none;">Inch</option>
							<?php if(showData('information_about_biography_info_height_inches')!=''){
									echo"<option value='".showData('information_about_biography_info_height_inches')."' selected>".showData('information_about_biography_info_height_inches')."</option>";
							}?>
			...
			<div class="form-group">
				<h5 class="control-label col-md-4">4. Weight</h5>
				<div class="col-md-8">
					<div class="d-flexible">
						<span>Pounds</span>
						<input type="text" class="form-control"
							name="information_about_biography_info_weight_pounds1" 
							value="<?= showData('information_about_biography_info_weight_pounds1')?>" maxlength="1">

						<input type="text" class="form-control"
							name="information_about_biography_info_weight_pounds2" 
							value="<?= showData('information_about_biography_info_weight_pounds2')?>" maxlength="1">

						<input type="text" class="form-control"
							name="information_about_biography_info_weight_pounds3" 
							value="<?= showData('information_about_biography_info_weight_pounds3')?>" maxlength="1">
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="black" 
						<?php echo (showData('information_about_biography_info_eye_color') == 'black') ? 'checked' : ''; ?>>
						<p>Black</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="blue"
						<?php echo (showData('information_about_biography_info_eye_color') == 'blue') ? 'checked' : ''; ?>>
						<p>Blue</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="brown"
						<?php echo (showData('information_about_biography_info_eye_color') == 'brown') ? 'checked' : ''; ?>>
						<p>Brown</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="gray"
						<?php echo (showData('information_about_biography_info_eye_color') == 'gray') ? 'checked' : ''; ?>>
						<p>Gray</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="green"
						<?php echo (showData('information_about_biography_info_eye_color') == 'green') ? 'checked' : ''; ?>>
						<p>Green</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="hazel"
						<?php echo (showData('information_about_biography_info_eye_color') == 'hazel') ? 'checked' : ''; ?>>
						<p>Hazel</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="maroon"
						<?php echo (showData('information_about_biography_info_eye_color') == 'maroon') ? 'checked' : ''; ?>>
						<p>Maroon</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="pink"
						<?php echo (showData('information_about_biography_info_eye_color') == 'pink') ? 'checked' : ''; ?>>
						<p>Pink</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_eye_color" value="other"
						<?php echo (showData('information_about_biography_info_eye_color') == 'other') ? 'checked' : ''; ?>>
						<p>Unknown/Other</p>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="bald"
						<?php echo (showData('information_about_biography_info_hair_color') == 'bald') ? 'checked' : ''; ?>>
						<p>Bald (No hair)</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="black"
						<?php echo (showData('information_about_biography_info_hair_color') == 'black') ? 'checked' : ''; ?>>
						<p>Black</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="blond"
						<?php echo (showData('information_about_biography_info_hair_color') == 'blond') ? 'checked' : ''; ?>>
						<p>Blond</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="brown"
						<?php echo (showData('information_about_biography_info_hair_color') == 'brown') ? 'checked' : ''; ?>>
						<p>Brown</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="gray"
						<?php echo (showData('information_about_biography_info_hair_color') == 'gray') ? 'checked' : ''; ?>>
						<p>Gray</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="red"
						<?php echo (showData('information_about_biography_info_hair_color') == 'red') ? 'checked' : ''; ?>>
						<p>Red</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="sandy"
						<?php echo (showData('information_about_biography_info_hair_color') == 'sandy') ? 'checked' : ''; ?>>
						<p>Sandy</p>
					</div>
				</div>
				<div class="col-md-3">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="white"
						<?php echo (showData('information_about_biography_info_hair_color') == 'white') ? 'checked' : ''; ?>>
						<p>White</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="d-flexible">
						<input type="radio" name="information_about_biography_info_hair_color" value="other"
						<?php echo (showData('information_about_biography_info_hair_color') == 'other') ? 'checked' : ''; ?>>
						<p>Unknown/Other</p>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-5">
					<input type="text" class="form-control" name="mother_city_of_birth" maxlength="20"
						value="<?php echo showData('mother_city_of_birth')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-5">
					<input type="text" class="form-control" name="father_city_town_of_birth" maxlength="20"
						value="<?php echo showData('father_city_town_of_birth')?>" />
				</div>
			</div>
			<div class="form-group">
...
<fieldset class="setpage">
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="d-flexible">
				<b>1.a.</b><input type="checkbox" onChange="checkboxValue(this,'I_can_read_and_understand_status')"  <?php echo (showData('I_can_read_and_understand_status') == 'Y') ? 'checked' : ''; ?>>

				<input type="hidden" name="I_can_read_and_understand_status" id="I_can_read_and_understand_status" value="<?php echo (showData('I_can_read_and_understand_status') == 'Y') ? 'Y' : 'N'; ?>" />
			...
			<div class="d-flexible">
				<b>1.b.</b><input type="checkbox" onChange="checkboxValue(this,'The_interpreter_named_in_status')"  <?php echo (showData('The_interpreter_named_in_status') == 'Y') ? 'checked' : ''; ?>>

				<input type="hidden" name="The_interpreter_named_in_status" id="The_interpreter_named_in_status" value="<?php echo (showData('The_interpreter_named_in_status') == 'Y') ? 'Y' : 'N'; ?>" />
			...
			<input type="text" class="form-control" name="i_192_part5_1b_applicant_answer_question" 
			value="<?= showData('i_192_part5_1b_applicant_answer_question')?>">

			<p>a language in which I am fluent, and I understood
				everything.</p>
			<div class="d-flexible">
				<b>2.</b><input type="checkbox" onChange="checkboxValue(this,'language_in_which_fluent_status')"  <?php echo (showData('language_in_which_fluent_status') == 'Y') ? 'checked' : ''; ?>>

				<input type="hidden" name="language_in_which_fluent_status" id="language_in_which_fluent_status" value="<?php echo (showData('language_in_which_fluent_status') == 'Y') ? 'Y' : 'N'; ?>" />

				<p>At my request, the preparer named in <b>Part 7.</b></p>
			</div>
			<input type="text" class="form-control" name="i_192_part5_2_applicant_answer_question" 
			value="<?= showData('i_192_part5_2_applicant_answer_question')?>">
...
<fieldset class="setpage">
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="d-flexible">
				<b>7.a.</b>
				<input type="hidden" name="i_192_7a_attorney_status" id="i_192_7a_attorney_status" 
				value="<?php echo (showData('i_192_7a_attorney_status') == 'Y') ? 'Y' : 'N'; ?>" />

				<input type="checkbox" onChange="checkboxValue(this,'i_192_7a_attorney_status')"  
				<?php echo (showData('i_192_7a_attorney_status') == 'Y') ? 'checked' : ''; ?>>
			...
			<div class="d-flexible">
				<b>7.b.</b>
				<input type="hidden" name="i_192_7b_attorney_status" id="i_192_7b_attorney_status" 
				value="<?php echo (showData('i_192_7b_attorney_status') == 'Y') ? 'Y' : 'N'; ?>"/>

				<input type="checkbox" onChange="checkboxValue(this,'i_192_7b_attorney_status')"  
				<?php echo (showData('i_192_7b_attorney_status') == 'Y') ? 'checked' : ''; ?>>

				<p>I am an attorney or accredited representative and my
					representation of the applicant in this case &nbsp;
					<input type="hidden" name="i_192_7b_extend_status" id="i_192_7b_extend_status" 
					value="<?php echo (showData('i_192_7b_extend_status') == 'Y') ? 'Y' : 'N'; ?>"/>

					<input type="checkbox" onChange="checkboxValue(this,'i_192_7b_extend_status')"  
					<?php echo (showData('i_192_7b_extend_status') == 'Y') ? 'checked' : ''; ?>> 
					&nbsp; extends  &nbsp;
					<input type="hidden" name="i_192_7b_doesnt_extend_status" id="i_192_7b_doesnt_extend_status" 
					value="<?php echo (showData('i_192_7b_doesnt_extend_status') == 'Y') ? 'Y' : 'N'; ?>"/>

					<input type="checkbox" onChange="checkboxValue(this,'i_192_7b_doesnt_extend_status')"  
					<?php echo (showData('i_192_7b_doesnt_extend_status') == 'Y') ? 'checked' : ''; ?>>  
		...
		<div class="col-md-6"></div><!-- right side column end -->
	</div>
