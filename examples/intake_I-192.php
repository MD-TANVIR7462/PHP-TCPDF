                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 " style='margin-left:10px; margin-top:0px;'>
                                <label class="control-label">
                                    <input type="radio" name="#" value="pending" checked=""> Pending
                                </label>
                                &nbsp;
                                <label class="control-label">
            ...
            <fieldset>
                <div class="row mt-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="control-label col-md-12 mb-5"><b>11. Marital Status </b> &nbsp;
                ...
                <!-- <div class="col-md-6 ">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-5">11.e. City or Town </label>
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="information_about_you_safe_mailing_city_town"
                                value="<?= showData('information_about_you_safe_mailing_city_town')?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-5">11.h. Province </label>
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="information_about_you_safe_mailing_province"
                                value="<?= showData('information_about_you_safe_mailing_province')?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-12">11.j. Country </label>
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="information_about_you_safe_mailing_country"
                                value="<?= showData('information_about_you_safe_mailing_country')?>">
                        </div>
                    </div>
                </div> -->
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="information_about_your_mother_family_last_name"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="information_about_your_mother_given_first_name"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-md-offset-5">
                        <input type="date" class="form-control" name="information_about_your_mother_date_of_birth"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-md-offset-5">
                        <input type="date" class="form-control" name="information_about_your_mother_country_of_birth"
            ...
            <div class="col-md-5 col-md-offset-1">
                ...
                <div class="form-group">
                    <label class="control-label col-md-12">15. Current Country of Residence (if living)
                        :</label>
                    <div class="col-md-7 col-md-offset-5">
                        <input type="text" class="form-control" name="information_about_your_mother_country_residence"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="information_about_your_father_family_last_name"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="information_about_your_father_given_first_name"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-md-offset-5">
                        <input type="date" class="form-control" name="information_about_your_father_date_of_birth"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-md-offset-5">
                        <input type="date" class="form-control" name="information_about_your_father_country_of_birth"
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-md-offset-4">
                        <div class="d-flexible">
                            <span
                                style="left: calc(var(--scale-factor)*36.00px); top: calc(var(--scale-factor)*531.66px); font-size: calc(var(--scale-factor)*10.00px); font-family: serif; gap:1rem;"
                                role="presentation" dir="ltr">►</span><b>A-</b><input type="text" class="form-control"
                ...
                <div class="form-group">
                    <label class="control-label col-md-12">27. Current Spouse's Date of Birth
                        (mm/dd/yyyy):</label>
                    <div class="col-md-7 col-md-offset-5">
                        <input type="date" class="form-control" name="information_about_spouse_children_date_of_birth"
