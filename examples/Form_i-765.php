...
class MyPDF extends TCPDF {
    ...
    public function Footer() {
		...
		$this->MultiCell(50, 6, 'Form I-765    Edition   10/31/22', 0, 'L', 0, 0, 13.5, 268, true);
...
$pdf->MultiCell(40, 5, "OMB No. 1615-0040\nExpires 10/31/2025", 0, 'C', 0, 1, 169, 15.5, true);
...
$html = '<span style="letter-spacing:3.3mm">'.showData('alien_registration_number').'</span>';
...
$html ='<div><input type="checkbox" name="agree" value="1" checked=" " /></div>';
...
// $pdf->TextField('attorney_uscis_online_number', 60, 7,array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),140.5, 97);
...
$html ='&nbsp;<input type="text" class="heighttext" name="attorney_uscis_online_account_number" value="'.showData('attorney_uscis_online_account_number').'" size="14" style="letter-spacing:2.8mm; width: 200px" maxlength="12" />';

// $html ='<textarea cols="14" rows="2" maxlength="12" name="attorney_uscis_online_account_number" style="letter-spacing:9px">'.showData('attorney_uscis_online_account_number').'</textarea>';
...
$pdf->SetDrawColor(100,0,0); // set color for cell border
...
$pdf->writeHTMLCell(90, 7, 26, 130.5, $html, 0, 1, false, true, 'L', true);
...
$pdf->writeHTMLCell(40, 7, 19, 136.2, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('times', '', 10);
$html = '<div>Replacement of lost, stolen, or damaged employment authorization document, or correction
 of my employment authorization document <b>NOT DUE</b> to U.S. Citizenship and Immigration Services (USCIS) error.</div>';
$pdf->writeHTMLCell(80, 7, 26, 137, $html, 0, 1, false, true, 'L', true);

$html = '<div><b>NOTE:</b> Replacement (correction) of an employment authorization document due to USCIS error does not require a new Form I-765 and filing fee. Refer to <b>Replacement for Card Error</b> in the <b>What is the Filing Fee</b> section of the Form I-765 Instructions for further details .</div>';
$pdf->writeHTMLCell(80, 7, 26, 159.5, $html, 0, 1, false, true, 'L', true);

//.......

$pdf->SetFont('times', '', 10);
$html ='<div><b>1.c. </b>';
$pdf->writeHTMLCell(10, 7, 12, 187, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('times', '', 15);
...
$pdf->writeHTMLCell(40, 7, 19, 186.2, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(80, 7, 26, 187, $html, 0, 1, false, true, 'L', true);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_other_family_last_name_2a', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 143);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_other_given_first_name_2b', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 152);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_other_middle_name_2c', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 161);
...
$pdf->TextField('information_about_you_other_family_last_name_3a', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 172);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_other_given_first_name_3b', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 181);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_other_middle_name_3c', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 190);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_other_family_last_name_4a', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 202);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_other_given_first_name_4b', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 211);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_other_middle_name_4c', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 142, 220);
...
if(showData('information_about_you_safe_mailing_apt_ste_flr')=="apt") $apt_checked = "checked"; else $apt_checked = "";
if(showData('information_about_you_safe_mailing_apt_ste_flr')=="ste") $ste_checked = "checked"; else $ste_checked = "";
if(showData('information_about_you_safe_mailing_apt_ste_flr')=="flr") $flr_checked = "checked"; else $flr_checked = "";
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_us_mail_apt_ste_flr', 40, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),63, 59);
...
if(showData('is_your_current_mailing_same_as_physical')=="yes") $current_mail_checked_yes = "checked"; else $current_mail_checked_yes = "";
if(showData('is_your_current_mailing_same_as_physical')=="no") $current_mail_checked_no = "checked"; else $current_mail_checked_no = "";
...
//...........
$pdf->SetFont('times', '', 10); // set font
$html= '<div><b>7.b. </b>&nbsp; &nbsp; <input type="checkbox" name="Apt" value="Apt" checked="" />Apt. &nbsp;&nbsp;<input type="checkbox" name="Ste" value="Ste" checked="" />Ste. <input type="checkbox" name="Flr" value="Flr" checked="" /> Flr.</div>';
...
$pdf->writeHTMLCell(25, 0, 29.5, 151, $html, '', 0, 0, true, 'L');
...
$pdf->writeHTMLCell(90, 5, 12, 221, $html, 0, 1, false, false, 'J', true);
...
Number 13.b.</b></div>';
$pdf->writeHTMLCell(80, 6, 20, 236, $html, 0, 1, false, false, 'J', true);
...
$pdf->writeHTMLCell(90, 5, 170, 45, $html, 0, 1, false, true, 'J', true);
...
Number 15.<b/></div>';
$pdf->writeHTMLCell(82, 5, 120, 50, $html, 0, 1, false, true, 'J', true);
//............
$pdf->SetFont('times', '', 10);
$html ='<div><b>15. </b></div>';
...
$pdf->writeHTMLCell(90, 5, 175, 85, $html, 0, 1, false, true, 'J', true);
...
$pdf->writeHTMLCell(80, 5, 120, 90, $html, 0, 1, false, true, 'J', true);

//..........

$pdf->SetFont('times', '', 10);
$html ='<div><b>Father\'s Name</b><br>Provide your father\'s birth name.</div>';
$pdf->writeHTMLCell(90, 5, 112, 105, $html, 0, 1, false, false, 'J', true);

$pdf->SetFont('times', '', 10);
$html ='<div><b>16.a.  </b>  Family Name <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  (Last Name) </div>';
$pdf->writeHTMLCell(35, 5, 112, 114, $html, 0, 1, false, false, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('about_you_father_lastname', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 116);
//............

$pdf->SetFont('times', '', 10);
$html ='<div><b>16.b.  </b>  Given Name <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; (First Name) </div>';
$pdf->writeHTMLCell(35, 5, 112, 123, $html, 0, 1, false, false, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('about_you_father_firstname', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 125);

//........

$pdf->SetFont('times', '', 10);
$html ='<div><b>Mother\'s Name</b><br>Provide your mother\'s birth name.</div>';
$pdf->writeHTMLCell(90, 5, 112, 134, $html, 0, 1, false, false, 'J', true);

//.......

$pdf->SetFont('times', '', 10);
$html ='<div><b>17.a.  </b>  Family Name <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  (Last Name) </div>';
$pdf->writeHTMLCell(35, 5, 112, 144, $html, 0, 1, false, false, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('about_you_mother_lastname', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 146);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('about_you_mother_firstname', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 155);
//.......
$pdf->SetFillColor(220,220,220);
$pdf->SetFont('times', 'I', 12);
$html ='<div><b>Your Country or Countries of Citizenship or
Nationality</b></div>';
$pdf->writeHTMLCell(90, 5, 113, 167, $html, 0, 1, true, false, 'L', true);
...
$pdf->writeHTMLCell(90, 5, 113, 180, $html, 0, 1, false, true, 'L', true);
//..........

$pdf->SetFont('times', '', 10);
$html ='<div><b>18.a.  </b>Country</div>';
$pdf->writeHTMLCell(35, 5, 112, 197, $html, 0, 1, false, false, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('country1', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 122, 202);
//.......
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('country2', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 122, 218);
...
$pdf->SetFont('times', '', 12);
$html ='<div><b>Part 2. Information About You</b> (continued)</div>';
$pdf->writeHTMLCell(90, 3.5, 13, 17, $html, 1, 1, true, false, 'L', true);
//......

$pdf->SetFont('times', 'I', 12);
$html ='<div><b>Place of Birth</b></div>';
$pdf->writeHTMLCell(90, 5, 13, 25, $html, 0, 1, true, false, 'J', true);
//..........
$pdf->SetFont('times', '', 10);
...
category (c)(8) in <b>Item Number 27.</b>, have you <b>EVER</b>
been arrested for and/or convicted of any crime?</div>';
$pdf->writeHTMLCell(83, 5, 120, 136, $html, 0, 1, false, true, 'J', true);
//........
$html ='<div><input type="checkbox" name="crimeed" value="y" checked=" "/>Yes &nbsp;<input type="checkbox" name="crimeed" value="n" checked=" " />No </div>';
$pdf->writeHTMLCell(90, 7, 175, 150, $html, 0, 1, false, true, 'J', true);

//..............

$html = '<div><b>NOTE:</b> If you answered "Yes" to <b>Item Number 30.</b>,
refer to <b>Special Filing Instructions for Those With 
Pending Asylum Applications (c)(8)</b> in the <b>Required 
Documentation</b> section of the Form I-765 Instructions 
for information about providing court dispositions.</div>';
$pdf->writeHTMLCell(83, 5, 120, 156, $html, 0, 1, false, true, 'J', true);

//........

$pdf->SetFont('times', '', 10);
$html ='<div><b>31.a. </b></div>';
$pdf->writeHTMLCell(20, 5, 112, 177, $html, 0, 1, false, true, 'J', true);
...
$pdf->writeHTMLCell(83, 5, 120, 177, $html, 0, 1, false, true, 'J', true);
...
$pdf->writeHTMLCell(20, 5, 112, 215, $html, 0, 1, false, true, 'J', true);
...
$pdf->writeHTMLCell(83, 5, 120, 215, $html, 0, 1, false, true, 'J', true);
$html ='<div><input type="checkbox" name="dhs" value="y" checked=" " />Yes &nbsp;<input type="checkbox" name="dhs" value="n" checked=" " /> No</div>';
$pdf->writeHTMLCell(90, 7, 175, 224, $html, 0, 1, false, true, 'J', true);

//..............

$html ='<div><b>NOTE:</b> If you answered “Yes” to <b>Item Number 31.b.</b>, 
refer to <b>Employment-Based Nonimmigrant Categories, 
Items 8. - 9.</b>, in the <b>Who May File Form I-765</b> section 
of the Form I-765 Instructions for information about 
providing court dispositions.</div>';
$pdf->writeHTMLCell(83, 5, 120, 230, $html, 0, 1, false, true, 'J', true);
...
$pdf->writeHTMLCell(90, 5, 12, 34, $html, 0, 1, false, true, 'J', true);
//.........
$pdf->SetFont('times', 'I', 12);
...
$pdf->writeHTMLCell(90, 5, 12, 56, $html, 0, 1, false, true, 'L', true);
//.........
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(80, 7, 23, 65, $html, 0, 1, false, true, 'L', true);
...
$pdf->writeHTMLCell(91, 6, 13, 130, $html, 0, 1, true, false, 'J', true);
//.........
...
$pdf->writeHTMLCell(79, 7, 20, 136, $html, 0, 0, false, true, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_daytime_tel', 83, 7,array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),  20, 141);

//....

$pdf->SetFont('times', '', 10);
$html= '<div><b>4.<b/></div>';
$pdf->writeHTMLCell(90, 7, 12, 149, $html, 0, 0, false, true, 'J', true);
$html= '<div>Applicant\'s Mobile Telephone Number (if any)</div>';
$pdf->writeHTMLCell(79, 7, 20, 149, $html, 0, 0, false, true, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_mobile', 83, 7,array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),  20, 155);
//........
...
$pdf->writeHTMLCell(79, 7, 20, 162, $html, 0, 0, false, true, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_email', 83, 7,array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 168);
//.........

$pdf->SetFont('times', '', 10);
$html ='<div><b>6. </b><input type="checkbox" name="part3_6" value="Y" checked=" " /></div>';
$pdf->writeHTMLCell(50, 7, 12, 176, $html, 0, 1, false, true, 'J', true);
...
$pdf->writeHTMLCell(79, 7, 23, 176, $html, 0, 1, false, true, 'J', true);
...
$pdf->writeHTMLCell(92, 7, 112, 24, $html, 0, 1, false, true, 'L', true);
...
$pdf->writeHTMLCell(90, 7, 112, 70, $html, 0, 1, false, true, 'L', true);
...
$pdf->writeHTMLCell(80, 7, 122, 87, $html, 0, 1, false, true, 'L', true);
//......
...
$pdf->writeHTMLCell(90, 7, 112, 108, $html, 0, 1, false, true, 'L', true);
//.........
$pdf->SetFont('times', 'I', 12);
$html ='<div><b>Applicant\'s Signature</b></div>';
$pdf->writeHTMLCell(91, 6, 113, 135, $html, 0, 1, true, false, 'L', true);

//.......
$pdf->setFont('Times', '', 10);
$html= '<div><b>7.a. </b> Applicant\'s Signature </div>';
$pdf->writeHTMLCell(92, 7, 112, 142, $html, 0, 1, false, 'L');
$pdf->writeHTMLCell(81, 7, 122, 148, '', 1, 0, false, 'L');
$pdf->setFont('Times', '', 10);
$html= '<div><b>7.b. </b>&nbsp;  Date of Signature (mm/dd/yyyy)</div>';
$pdf->writeHTMLCell(92, 7, 112, 156, $html, 0, 1, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('applicant_sign_date', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 173, 156);
//.........
$pdf->SetFont('zapfdingbats', '', 22);  // symbol font
$pdf->writeHTMLCell(82, 7, 112, 147, TCPDF_FONTS::unichr(225), 0, 0, false, 'L');
//........
$pdf->setFont('Times', '', 10);
...
$pdf->writeHTMLCell(92, 7, 113, 163, $html, 0, 1, false, 'L');
...
$pdf->writeHTMLCell(91, 7, 113, 178, $html, 1, 0, true, true, 'L', true);
//......
$pdf->setFont('Times', '', 10);
$html= '<div>Provide the following information about the interpreter.</div>';
$pdf->writeHTMLCell(91, 7, 112, 190, $html, 0, 1, false, 'L');
//.......
$pdf->setFillColor(220, 220, 220); 
$pdf->setFont('Times', '', 12);
$pdf->setCellHeightRatio(1.2);
...
$pdf->writeHTMLCell(90, 7, 113, 197,  $html,  0, 1, true, 'L');
//..........
$pdf->setFont('Times', '', 10);
$html = '<div><b>1.a.</b>&nbsp;&nbsp; Interpreter\'s Family Name (Last Name)</div>';
$pdf->writeHTMLCell(95, 7, 112, 205, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_765_interpreter_family_last_name', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 211);
//.........
$pdf->setFont('Times', '', 10);
$html = '<div><b>1.b.</b>&nbsp;&nbsp; Interpreter\'s Given Name (First Name)</div>';
$pdf->writeHTMLCell(95, 7, 112, 220, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_765_interpreter_family_given_first_name', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 226);
//......
$pdf->setFont('Times', '', 10);
$html = '<div><b>2. </b> &nbsp; &nbsp;Interpreter\'s Business or Organization Name (if any)</div>';
$pdf->writeHTMLCell(90, 7, 112, 234, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_765_interpreter_business_name', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 240);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_765_preparer_mobile', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 196);
...
$pdf->writeHTMLCell(95, 7, 112, 205, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_765_preparer_email', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 211);
...
$pdf->SetFont('times', '', 10);
$html= '<div><b>7.b.   <b/><input type="checkbox" name="part12_7b" value="Y" checked=" " /></div>';
...
$pdf->writeHTMLCell(90, 7, 13, 170,  $html,  0, 1, true, 'L');


//.......
$pdf->setFont('Times', '', 10);
$html= '<div><b>8.a. </b> &nbsp; Preparer\'s Signature </div>';
$pdf->writeHTMLCell(92, 7, 12, 178, $html, 0, 1, false, 'L');
$pdf->writeHTMLCell(81, 7, 22, 185, '', 1, 0, false, 'L');
$pdf->setFont('Times', '', 10);
$html= '<div><b>8.b. </b>&nbsp;  Date of Signature (mm/dd/yyyy)</div>';
$pdf->writeHTMLCell(92, 7, 12, 193, $html, 0, 1, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_preparer_sign_date', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 73, 193);
...
$pdf->writeHTMLCell(94, 25, 12, 26, $html, 0, 1, 0, true, 'L', false, false);
//...........
$pdf->setFont('Times', '', 10);
$html= '<div><b>1.a. </b> &nbsp; Family Name<br> &nbsp; &nbsp; &nbsp; &nbsp; (Last Name)</div>';
$pdf->writeHTMLCell(35, 7, 12, 61, $html, 0, 1, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_last_name', 62, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 63);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_first_name', 62, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 72);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_middle_name', 62, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 81);
// $pdf->writeHTMLCell(60, 7, 45, 82, '', 1, 0, false, 'L');
//.......

$pdf->setFont('Times', '', 10);
$html= '<div><b>2. </b> &nbsp;&nbsp; A-Number (if any) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>A-</b></div>';
$pdf->writeHTMLCell(49, 7, 12, 90, $html, 0, 1, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_a_number', 47, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 58, 90);
// $pdf->writeHTMLCell(45, 7, 60, 91, '', 1, 0, false, 'L');

$pdf->Image('images/right_angle.jpg', 48.5, 91.5, 3.5, 3.5, 'JPG', '', '', true, 150, '', false, false, 0, false, false, false);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_3a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 21, 104);
//.....
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_3b_part_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 52, 104);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_3c_item_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 85, 104);
//............
$pdf->setFont('Times', '', 10);
$html= '<div><b>3.d. </b></div>';
$pdf->writeHTMLCell(10, 7, 12, 112, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_3d', 83.5, 64, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 21, 113);


/* $lineStyle = array('width' => 0.5, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(213, 213, 213));
$pdf->Line(20, 10, 200, 100, $lineStyle); */
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_4a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 21, 186);
//.....
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_4b_part_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 50, 186);
...
$pdf->TextField('i_765_additional_info_4d', 83.5, 62, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 21, 195);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_5a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120.4, 23);
//.....
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_5b_part_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 152, 23);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_5c_item_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 182, 23);
//.........
...
/* $html = <<<EOD
<textarea rows="11" name="additional_information_5d">

</textarea>
EOD;
$pdf->writeHTMLCell(120, 62, 120, 31, $html, 0, 0, false, 'L'); */



// $pdf->setCellPaddings(0, 2, 0, 0); // set cell padding

// $pdf->writeHTMLCell(82, 59, 121, 32, '', 1, 0, false, 'L'); // Textarea border

// $pdf->setCellPaddings(1, 1, 1, 1); // set cell padding
//.....

$pdf->TextField('i_765_additional_info_5d', 83, 45,array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120.5, 31.5);

$pdf->setFont('Times', '', 10);
$html= '<div><b>6.a. </b>&nbsp;&nbsp;Page Number</div>';
$pdf->writeHTMLCell(30, 7, 111.3, 82, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_6a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120.4, 88);
//.....


$pdf->setFont('Times', '', 10);
$html= '<div><b>6.b. </b>&nbsp;Part Number </div>';
$pdf->writeHTMLCell(30, 7, 145, 82, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_6b_part_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 152, 88);

//......

$pdf->setFont('Times', '', 10);
$html= '<div><b>6.c. </b>&nbsp;Item Number </div>';
$pdf->writeHTMLCell(30, 7, 175, 82, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_6c_item_no', 22, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 182, 88);
//.........

$pdf->setFont('Times', '', 10);
$html= '<div><b>6.d. </b> </div>';
$pdf->writeHTMLCell(10, 7, 111.3, 98, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);

$pdf->TextField('i_765_additional_info_6d', 83, 55,array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120.5, 98);
...
$pdf->writeHTMLCell(30, 7, 111.3, 158, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_7a_page_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120.4, 163);
//.....


$pdf->setFont('Times', '', 10);
$html= '<div><b>7.b. </b>&nbsp;Part Number </div>';
$pdf->writeHTMLCell(30, 7, 145, 158, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_7b_part_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 152, 163);

//......

$pdf->setFont('Times', '', 10);
$html= '<div><b>7.c. </b>&nbsp;Item Number </div>';
$pdf->writeHTMLCell(30, 7, 175, 158, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_765_additional_info_7c_item_no', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 183, 163);
//.........

$pdf->setFont('Times', '', 10);
$html= '<div><b>7.d. </b> </div>';
$pdf->writeHTMLCell(10, 7, 111.3, 171, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);

$pdf->TextField('i_765_additional_info_7d', 83, 62,array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120.5, 172);
...
var fields = {
    ...
    'information_about_you_other_family_last_name_2a':' ".showData('information_about_you_other_family_last_name_2a')."',
    'information_about_you_other_given_first_name_2b':' ".showData('information_about_you_other_given_first_name_2b')."',
    'information_about_you_other_middle_name_2c':' ".showData('information_about_you_other_middle_name_2c')."',

    'information_about_you_other_family_last_name_3a':' ".showData('information_about_you_other_family_last_name_3a')."',
    'information_about_you_other_given_first_name_3b':' ".showData('information_about_you_other_given_first_name_3b')."',
    'information_about_you_other_middle_name_3c':' ".showData('information_about_you_other_middle_name_3c')."',

    'information_about_you_other_family_last_name_4a':' ".showData('information_about_you_other_family_last_name_4a')."',
    'information_about_you_other_given_first_name_4b':' ".showData('information_about_you_other_given_first_name_4b')."',
    'information_about_you_other_middle_name_4c':' ".showData('information_about_you_other_middle_name_4c')."',
	
	// Page 2
    'information_about_you_us_mail_in_care_name':' ".showData('information_about_you_safe_mailing_care_of_name')."',
    'information_about_you_us_mail_street':' ".showData('information_about_you_safe_mailing_street_number')."',
    'information_about_you_us_mail_apt_ste_flr':' ".showData('information_about_you_safe_mailing_number')."',
    'information_about_you_us_mail_city_town':' ".showData('information_about_you_safe_mailing_city_town')."',
    'information_about_you_us_mail_state':' ".showData('information_about_you_safe_mailing_state')."',
    'information_about_you_us_mail_zipcode':' ".showData('information_about_you_safe_mailing_zip_code')."',

    'about_you_us_physical_street':' ".showData('information_about_you_safe_us_physical_street_number')."',
    'about_you_us_physical_apt_ste_flr':' ".showData('information_about_you_safe_us_physical_number')."',
    'about_you_us_physical_city_town':' ".showData('information_about_you_safe_us_physical_city_town')."',
    'about_you_us_physical_state':' ".showData('information_about_you_safe_us_physical_state')."',
    'about_you_us_physical_zipcode':' ".showData('information_about_you_safe_us_physical_zip_code')."',
    ...
    'about_you_ssn_number':' ".showData('other_information_social_security_number_ssn')."',

    'about_you_father_lastname':' ".showData('information_about_your_father_family_last_name')."',
    'about_you_father_firstname':' ".showData('information_about_your_father_given_first_name')."',
    'about_you_mother_lastname':' ".showData('information_about_your_mother_family_last_name')."',
    'about_you_mother_firstname':' ".showData('information_about_your_mother_given_first_name')."',
    'country1':' ".showData('other_information_about_you_country_of_citizen')."',
    'country2':' ".showData('other_information_about_you_country_of_citizen_2')."',
	
	// Page 3
    'about_you_village_of_birth':' ".showData('information_about_you_city_town_village')."',
    'about_you_province_of_birth':' ".showData('information_about_you_state_province')."',
    ...
    'about_you_dept_record_number':' ".showData('other_information_about_you_arival_record_number')."',
    ...
    'about_you_country_issued_passport':' ".showData('other_information_about_you_country_issuance_passport')."',
    'about_you_passport_expire_date':' ".showData('other_information_about_you_expiry_date_issuance_passport')."',
    'about_you_us_last_arrival_date':' ".showData('information_about_you_last_arrivat_us')."',
    'about_you_last_arrival_place':' ".showData('information_about_you_place_your_last_arrival_us')."',
    ...
    'i_765_additional_info_3d':' ".showData('i_765_additional_info_3d')."',
    ...
    'i_765_additional_info_4d':' ".showData('i_765_additional_info_4d')."',
    ...
    'i_765_additional_info_5d':' ".showData('i_765_additional_info_5d')."',
    ...
    'i_765_additional_info_6d':' ".showData('i_765_additional_info_6d')."',
