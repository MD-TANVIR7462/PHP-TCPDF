	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-12">
					<label><input type="radio" name="notice_apperance_as_attorney_or_accredited_reprentative_check" value="applicant" <?php echo (showData('notice_apperance_as_attorney_or_accredited_reprentative_check') == 'applicant') ? 'checked' : ''; ?>> Applicant </label>&nbsp;
					<label><input type="radio" name="notice_apperance_as_attorney_or_accredited_reprentative_check" value="petitioner" <?php echo (showData('notice_apperance_as_attorney_or_accredited_reprentative_check') == 'petitioner') ? 'checked' : ''; ?>> Petitioner </label>&nbsp; 
					<label><input type="radio" name="notice_apperance_as_attorney_or_accredited_reprentative_check" value="requester" <?php echo (showData('notice_apperance_as_attorney_or_accredited_reprentative_check') == 'requester') ? 'checked' : ''; ?>> Requestor </label>&nbsp; &nbsp;<br>
					<label><input type="radio" name="notice_apperance_as_attorney_or_accredited_reprentative_check" value="benificiary" <?php echo (showData('notice_apperance_as_attorney_or_accredited_reprentative_check') == 'benificiary') ? 'checked' : ''; ?>> Beneficiary/Derivative  </label>&nbsp; 
					<label><input type="radio" name="notice_apperance_as_attorney_or_accredited_reprentative_check" value="respondent" <?php echo (showData('notice_apperance_as_attorney_or_accredited_reprentative_check') == 'respondent') ? 'checked' : ''; ?>> Respondent (ICE, CBP)</label>
				</div>
			</div>
		...
		<div class="bg-info">
			...
			<div class="form-group">
				<label class="control-label col-md-6">13.b.  &nbsp; 
					<input type="radio" name="g28_mailing_address_client_flr" value="apt" <?php echo (showData('g28_mailing_address_client_flr') == 'apt') ? 'checked' : ''; ?>> Apt. &nbsp;

					<input type="radio" name="g28_mailing_address_client_flr" value="ste" <?php echo (showData('g28_mailing_address_client_flr') == 'ste') ? 'checked' : ''; ?>> Ste. &nbsp; 

					<input type="radio" name="g28_mailing_address_client_flr" value="flr" <?php echo (showData('g28_mailing_address_client_flr') == 'flr') ? 'checked' : ''; ?>> Flr.:</label>
				<div class="col-md-6">
					<input type="text" class="form-control" name="interpreter_contact_information_mailing_address_number" value="<?php echo showData('interpreter_contact_information_mailing_address_number')?>" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-7">
					<select class="form-control" name="information_mailing_address_client_state">
						...
						foreach ($allDataCountry as $record) {
							if($record->state_code==showData('information_mailing_address_client_state')) $selected = "selected"; else $selected = "";
