...
class MyPDF extends TCPDF {
    ...
    public function Footer() {
		...
		// if ($this->page == 1){
			$barcode_image = "images/n-400-footer-pdf417-$this->page.png";
		// )
...
$pdf->SetFillColor(255,255,255);
//$a_number = "666";
$html ='<input type="text" name="a_number" value="'.$a_number.'" size="10" style="width:100px;height:100px;padding:50px;letter-spacing:9px;border:5px solid #00000" maxlength="9" placeholder="123-45-678" />';
...
$pdf->MultiCell(10, 10, "t", '', 'C', 0, 1, 124.5, 55.4, false); // angle
$pdf->Rotate(-240);
$pdf->MultiCell(10, 10, "t", '', 'L', 0, 1, 13.5, 31.5, false); // angle
$pdf->StopTransform();
...
$pdf->SetDrawColor(0,0,0); // set color for cell border
$pdf->SetFillColor(255,255,255);
$html ='<input type="text" name="us_social_security_number" value="'.$social_security_number.'" size="10" style="width:100px;height:100px;padding:50px;letter-spacing:9px;border:5px solid #00000" maxlength="9" />';
$pdf->writeHTMLCell(42.5, 3, 25, 100.2, $html, 1, 1, false, true, 'J', 0);
	

$html ='<input type="text" name="uscis_social_security_number" value="'.$uscis_online_account_number.'" size="14" style="width:100px;height:100px;padding:50px;letter-spacing:10px;border:5px solid #00000" maxlength="13" />';
$pdf->writeHTMLCell(59, 3, 97, 100.2, $html, 1, 1, false, true, 'J', 0);


$pdf->SetFont('times', '', 10.5);
$pdf->setCellHeightRatio(1.2);
if($gender=="Female") $gender_M_checked = "checked"; else $gender_F_checked = "checked";

$html ='<b>7.  </b>   Gender  <br>
   &nbsp;  &nbsp;    <input type="checkbox" name="gender" value="male" checked="'.$gender_M_checked .'" /> Male
   
   &nbsp;   &nbsp;   <input type="checkbox" name="gender" value="female" checked="'.$gender_F_checked.'" /> Female
   ';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('date_of_birth', 48, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 60, 117);
...
$html ='<b>12.    </b>     Do you have a physical or developmental disability or mental impairment that prevents you from <br>
 ...
 &nbsp;  &nbsp;  &nbsp; If you answered "Yes," submit a completed Form N-648, Medical Certification for Disability Exceptions, when you file your <br>
 
 &nbsp;  &nbsp; &nbsp; Form N-400.';
$pdf->writeHTMLCell(200, 7, 12, 138, $html, 0, 1, false, true, 'J', 0);
...
if($address1_apt_ste_flr=="Apt") $apt_checked = "checked"; else $apt_checked = "";
if($address1_apt_ste_flr=="Ste") $ste_checked = "checked"; else $ste_checked = "";
if($address1_apt_ste_flr=="Flr") $flr_checked = "checked"; else $flr_checked = "";
$html= '<div>  <input type="checkbox" name="apt" value="apt5_1a" checked="'.$apt_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 155, 132, $html, 0, 1, false, 'L');

$html= '<div>  <input type="checkbox" name="ste" value="ste5_1a" checked="'.$ste_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 165, 132, $html, 0, 1, false, 'L');

$html= '<div>  <input type="checkbox" name="flr" value="flr5_1a" checked="'.$flr_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 175, 132, $html, 0, 1, false, 'L');
$pdf->writeHTMLCell(15, 7, 188, 132, $address1_apt_ste_flr_value, 1, 1, false, 'L');
//.................
...
$pdf->writeHTMLCell(80, 7, 85, 140, $html, 0, 1, false, 'L');


$html= '<div>State</div>';
$pdf->writeHTMLCell(60, 7, 140, 140, $html, 0, 1, false, 'L');
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_information_to_contact_you_city_town', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 23, 145);
...
$pdf->writeHTMLCell(25, 0, 140, 145, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_information_to_contact_you_zipcode', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 167, 145);

$pdf->TextField('part5_information_to_contact_you_zipcode1', 10, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 193, 145);
$pdf->setFont('Times', 'I', 8);
$html= '<div><a href="https://tools.usps.com/go/ZipLookupAction_input"><i>(USPS ZIP Code Lookup)</i></a></div>';
$pdf->writeHTMLCell(80, 7, 165, 152, $html, 0, 1, false, 'L');
//......................
$pdf->setFont('Times', '', 10.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_information_to_contact_you_date_to', 35, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 85, 176);
...
$pdf->setFont('Times', '', 10.5);
$html= '<div>  <input type="checkbox" name="apt1" value="apt" checked="'.$apt_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 155, 211, $html, 0, 1, false, 'L');

$html= '<div>  <input type="checkbox" name="ste1" value="ste" checked="'.$ste_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 165, 211, $html, 0, 1, false, 'L');


$html= '<div>  <input type="checkbox" name="flr1" value="flr" checked="'.$flr_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 175, 211, $html, 0, 1, false, 'L');
$pdf->writeHTMLCell(15, 7, 188, 210, $address1_apt_ste_flr_value, 1, 1, false, 'L');
//.................
...
$html= '<div>Country</div>';
$pdf->writeHTMLCell(80, 7, 85, 217, $html, 0, 1, false, 'L');


$html= '<div>State</div>';
$pdf->writeHTMLCell(60, 7, 140, 217, $html, 0, 1, false, 'L');
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_b_information_to_contact_you_city_town', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 23, 222);
...
$pdf->writeHTMLCell(25, 0, 140, 222, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_b_information_to_contact_you_zipcode', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 167, 222);

$pdf->TextField('part5_b_information_to_contact_you_zipcode1', 10, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 193, 222);
$pdf->setFont('Times', '', 9);
...
$html= '<div>Country</div>';
$pdf->writeHTMLCell(80, 7, 85, 44, $html, 0, 1, false, 'L');


$html= '<div>State</div>';
$pdf->writeHTMLCell(60, 7, 140, 44, $html, 0, 1, false, 'L');
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_c_information_to_contact_you_city_town', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 23, 49);
...
$pdf->writeHTMLCell(25, 0, 140, 49, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_c_information_to_contact_you_zipcode', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 167, 49);

$pdf->TextField('part5_c_information_to_contact_you_zipcode1', 10, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 193, 49);
...
$html= '<div>Country</div>';
$pdf->writeHTMLCell(80, 7, 85, 109, $html, 0, 1, false, 'L');


$html= '<div>State</div>';
$pdf->writeHTMLCell(60, 7, 140, 109, $html, 0, 1, false, 'L');
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_d_information_to_contact_you_city_town', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 23, 114);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_d_information_to_contact_you_country', 50, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 85, 114);
...
$pdf->writeHTMLCell(25, 0, 140, 114, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_d_information_to_contact_you_zipcode', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 167, 114);

$pdf->TextField('part5_d_information_to_contact_you_zipcode1', 10, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 193, 114);
...
$html= '<div>Country</div>';
$pdf->writeHTMLCell(80, 7, 85, 173, $html, 0, 1, false, 'L');


$html= '<div>State</div>';
$pdf->writeHTMLCell(60, 7, 140, 173, $html, 0, 1, false, 'L');
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_e_information_to_contact_you_city_town', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 23, 178);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_e_information_to_contact_you_country', 50, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 85, 178);
...
$pdf->writeHTMLCell(25, 0, 140, 178, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_e_information_to_contact_you_zipcode', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 167, 178);

$pdf->TextField('part5_e_information_to_contact_you_zipcode1', 10, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 193, 178);
...
$pdf->writeHTMLCell(190, 7, 13, 218, $html, 1, 1, true, 'L');
...
$pdf->writeHTMLCell(100, 7, 12, 230, $html, 0, 1, false, 'L');
...
$pdf->writeHTMLCell(50, 7, 170, 232, $html, 0, 1, false, true, 'J', 0);


$pdf->setFont('Times', 'BI', 12);
$html= '<div>Information About Your Mother</div>';
$pdf->writeHTMLCell(190, 7, 12, 237, $html, 0, 1, true, 'L');


$pdf->setFont('Times', '', 10.5);
$pdf->setCellHeightRatio(1.3);
$html= '<div><b>2.    </b>  Is your mother a U.S. citizen? <br>

    &nbsp;    &nbsp;   If you answered " Yes," complete the following information. If you answered "No," go to <b>Item Number 3</b>.</div>';
$pdf->writeHTMLCell(190, 7, 12, 244, $html, 0, 1, false, 'L');
...
$pdf->writeHTMLCell(60, 7, 25, 36.5, $mother_last_name, 1, 1, false, 'L');
...
$pdf->writeHTMLCell(60, 7, 87, 36.5, $mother_first_name, 1, 1, false, 'L');
...
$pdf->writeHTMLCell(54, 7, 150, 36.5, $mother_middle_name, 1, 1, false, 'L');
...
$pdf->writeHTMLCell(78, 7, 25, 49.5, $mother_country_of_birth, 1, 1, false, 'L');
...
$pdf->writeHTMLCell(60, 7, 25, 108, $father_last_name, 1, 1, false, 'L');
...
$pdf->writeHTMLCell(60, 7, 87, 108, $father_first_name, 1, 1, false, 'L');
...
$pdf->writeHTMLCell(54, 7, 150, 108, $father_middle_name, 1, 1, false, 'L');
...
$pdf->writeHTMLCell(78, 7, 25, 121.5, $father_country_of_birth, 1, 1, false, 'L');
...
$pdf->writeHTMLCell(60, 7, 117, 121.5, $father_date_of_birth, 1, 1, false, 'L');
...
if($employer1_apt_ste_flr=="Apt") $apt_checked = "checked"; else $apt_checked = "";
if($employer1_apt_ste_flr=="Ste") $ste_checked = "checked"; else $ste_checked = "";
if($employer1_apt_ste_flr=="Flr") $flr_checked = "checked"; else $flr_checked = "";
$html= '<div>  <input type="checkbox" name="apt4" value="apt" checked="'.$apt_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 155, 68, $html, 0, 1, false, 'L');

$html= '<div>  <input type="checkbox" name="ste4" value="ste" checked="'.$ste_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 165, 68, $html, 0, 1, false, 'L');


$html= '<div>  <input type="checkbox" name="flr4" value="flr" checked="'.$flr_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 175, 68, $html, 0, 1, false, 'L');
$pdf->writeHTMLCell(15, 7, 188, 68,  $employer1_apt_ste_flr_value, 1, 1, false, 'L');
//.................
...
$pdf->setFont('Times', '', 10.5);
if($employer2_apt_ste_flr=="Apt") $apt_checked = "checked"; else $apt_checked = "";
if($employer2_apt_ste_flr=="Ste") $ste_checked = "checked"; else $ste_checked = "";
if($employer2_apt_ste_flr=="Flr") $flr_checked = "checked"; else $flr_checked = "";
$html= '<div>  <input type="checkbox" name="apt8" value="apt" checked="'.$apt_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 155, 140, $html, 0, 1, false, 'L');

$pdf->setFont('Times', '', 10.5);
$html= '<div>  <input type="checkbox" name="ste8" value="ste" checked="'.$ste_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 165, 140, $html, 0, 1, false, 'L');

$pdf->setFont('Times', '', 10.5);
$html= '<div>  <input type="checkbox" name="flr8" value="flr" checked="'.$flr_checked.'" />  </div>';
$pdf->writeHTMLCell(20, 7, 175, 140, $html, 0, 1, false, 'L');
$pdf->writeHTMLCell(15, 7, 188, 140, $employer2_apt_ste_flr_value, 1, 1, false, 'L');
...
if($crime_convicted=="Yes") $crime_yes_checked = "checked"; else $crime_yes_checked = "";
if($crime_convicted=="No") $crime_no_checked = "checked"; else $crime_no_checked = "";

$html ='
&nbsp;  &nbsp;    <input type="checkbox" name="convicted_of_a_crime" value="Yes" checked="'.$crime_yes_checked.'" /> Yes

&nbsp;   &nbsp;   <input type="checkbox" name="convicted_of_a_crime" value="No" checked="'.$crime_no_checked.'" /> No
 ';
...
var fields = {
	...
	'since_birth_last_name1':' ".showData('last_name')."',
	'since_birth_first_name1':' ".showData('first_name')."',
	'since_birth_middle_name1':' ',
	'since_birth_last_name2':' ".showData('last_name')."',
	'since_birth_first_name2':' ".showData('first_name')."',
	'since_birth_middle_name2':' ',
	'testname':' ',

	'date_of_birth':' $date_of_birth',
	'date_law_full_resident':' ',
	'information_about_you_country_of_birth':' $country_of_birth',
	'information_about_you_cityzenship':' $nationality',
	'part3_accomodation_1a':' ',
	'part3_accomodation_1b':' ',
	'part3_accomodation_1c':' ',
	'part4_information_to_contact_you_daytime_telephone':' ',
	'part4_information_to_contact_you_work_telephone':' $work_or_business_phone',
	...
	'part5_information_to_contact_you_street_number':' $street_address',
	'state':' ',
	'part5_information_to_contact_you_city_town':' $city',
	'current_physical_address_state':' $state',
	'part5_information_to_contact_you_country':' $country_name',
	'part5_information_to_contact_you_zipcode':' $zip',
	...
	'part5_b_information_to_contact_you_street_number':' $street_address',
	'part5_b_information_to_contact_you_city_town':' $city',
	'part5_b_information_to_contact_you_country':' $country_name',
	'part5_b_information_to_contact_you_zipcode':' $zip',
	...
	'pound2':' ',
	'pound3':' ',
	'part8_information_employeer_school':'  $employer1_name',
	'part8_information_employeer_street_number':' $employer1_address',
	'part8_information_employment_city_town':' $employer1_city_or_town',
	'part8_information_employment_zipcode1':' $employer1_zip_code',
	'part8_information_employment_zipcode2':' ',
	'part8_information_employment_state':' $employer1_state',
	'part8_information_employment_foreign_region':' $employer1_province',
	'part8_information_employment_foreign_postalcode':' $employer1_postal_code',
	'part8_information_employment_foreign_country':' $employer1_country',
	'part8_information_employment_date_from':' $employer1_date_from',
	'part8_information_employment_date_to':' $employer1_date_to',
	'part8_information_employment_occupation':' $employer1_occupation',

	'part8_information_employeer_school2':' $employer2_name',
	'part8_information_employment_city_town2':' $employer2_city_or_town',
	'part8_2_information_employment_zipcode1':' $employer2_zip_code',
	'part8_2_information_employment_zipcode2':' ',
	'part8_2_information_employment_state':' $employer2_state',

	'part8_information_employment_foreign_region2':' $employer2_province',
	'part8_information_employment_foreign_postalcode2':' $employer2_postal_code',
	'part8_information_employment_foreign_country2':' $employer2_country',
	'part8_information_employment_date_from2':' $employer2_date_from',
	'part8_information_employment_date_to2':' $employer2_date_to',
	'part8_information_employment_occupation2':' $employer2_occupation',
	'part8_information_employeer_street_number2':' $employer2_address',
	...
	'part10_times_married':' $marital_times',
	'part10_4_a_last_name':' $spouse_last_name',
	'part10_4_a_first_name':' $spouse_first_name',
	'part10_4_a_middle_name':' $spouse_middle_name',
	...
	'part10_4_d_spouse_date_of_birth':' $spouse_birth_date',
	'part10_4_e_spouse_date_entred':' $current_marriage_date',
	'part10_f_current_spouse_street_number':' ',
	'part10_f_information_spouse_city_town':' $city_of_marriage',
	'part10_f_information_spouse_country':' $country_of_marriage',
	...
	'part10_7a_current_spouse_citizen':' $spouse_nationality',
	'current_spouse_state':' $state_of_marriage ',

	'part10_7b_current_spouse_a_number':' ',
	'part10_7c_explain':' ',
	'part10_8a_last_name':' ',
	'part10_8a_first_name':' $spouse_prior_spouse',
	'part10_8a_middle_name':' ',
	'part10_8b_explain':' ',
	'part10_8c_spouse_date_of_birth':' ',
	'part10_8d_spouse_prior_spouse':' ',
	'part10_8e_spouse_prior_spouse_country':' ',
	'part10_8_d_current_spouse_prior_date_marriage':' $spouse_prior_marriage_date ',
	'part10_8_e_current_spouse_ended':' $spouse_prior_spouse_marriage_end_date',
	'part10_8_h_explain':' ',
	'part10_9a_last_name':' ',
	...
	'part11_2a_last_name':' $frst_child_name',
	'part11_2a_first_name':' ',
	'part11_2a_middle_name':' ',
	'part11_2a_a_number':' $first_child_a_number',
	'part11_2a_date_of_birth':' $first_child_dob',
	'part11_2a_country_of_birth':' ',
	'part11_2a_child_street_number':' $first_child_adress',
	...
	'part11_2b_last_name':' $second_child_name',
	'part11_2b_first_name':' ',
	'part11_2b_middle_name':' ',
	'part11_2b_a_number':' $secon_child_a_number',
	'part11_2b_date_of_birth':'  $second_child_dob',
	'part11_2b_country_of_birth':' ',
	'part11_2b_child_street_number':'  $second_child_address',
	...
	'part11_2c_last_name':' $third_child_name',
	'part11_2c_first_name':' ',
	'part11_2c_middle_name':' ',
	'part11_2c_a_number':' $third_child_a_number',
	'part11_2c_date_of_birth':' $third_child_dob',
	'part11_2c_country_of_birth':' ',
	'part11_2c_child_street_number':' $third_child_address ',
	...
	'part11_2d_last_name':' $fourth_child_name',
	'part11_2d_first_name':' ',
	'part11_2d_middle_name':' ',
	'part11_2d_a_number':' $fourth_child_a_number',
	'part11_2d_date_of_birth':' $fourth_child_dob',
	'part11_2d_country_of_birth':' ',
	'part11_2d_child_street_number':' $fourth_child_address',
