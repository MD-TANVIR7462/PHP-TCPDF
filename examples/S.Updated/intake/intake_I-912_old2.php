		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-12">
					<br>
					<div class="">
						<input type="radio" name="information_about_biography_info_eye_color" /> Other (Explain)
					</div>
					<textarea name="financial_hardship_chkbox_other" cols="75" rows="8" class="form-control" ><?= showData('financial_hardship_chkbox_other')?></textarea>
				</div>
			</div>
			<div class="bg-info">
