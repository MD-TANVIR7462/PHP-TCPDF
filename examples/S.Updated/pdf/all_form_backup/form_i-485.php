...
$html ='<div><b>6.    </b>       Gender     <input type="checkbox" name="gender" value="M"  checked="'.$gender_M_checked .'" />  Male  &nbsp;  <input type="checkbox" name="gender" value="F"  checked="'.$gender_F_checked .'"/>  Female</div>';
...
$pdf->SetFont('times', '', 10); // set font
$html= '<div><b>12.b. </b>&nbsp; &nbsp; <input type="checkbox" name="Apt2" value="Apt2" checked="'.$apt_checked.'" />Apt. &nbsp;&nbsp;
<input type="checkbox" name="Ste2" value="Ste2" checked="'.$ste_checked.'" />Ste. 
<input type="checkbox" name="Flr2" value="Flr2" checked="'.$flr_checked.'" /> Flr.</div>';
...
if($employer2_apt_ste_flr=="Apt") $apt2_checked = "checked"; else $apt2_checked = "";
if($employer2_apt_ste_flr=="Ste") $ste2_checked = "checked"; else $ste2_checked = "";
if($employer2_apt_ste_flr=="Flr") $flr2_checked = "checked"; else $flr2_checked = "";
$pdf->SetFont('times', '', 10); // set font
$html= '<div><b>16.b. </b>&nbsp; &nbsp; <input type="checkbox" name="Apte" value="Apt" checked="'.$apt2_checked.'" />Apt. &nbsp;&nbsp;<input type="checkbox" name="Ste3" value="Ste3" checked="'.$ste2_checked.'" />Ste. <input type="checkbox" name="Flre" value="Flr" checked="'.$flr2_checked.'" /> Flr.</div>';
$pdf->writeHTMLCell(60, 0, 112, 156, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10); // set font
...
<input type="checkbox" name="mariage" value="married" checked="'.$married_checked.'" />Married  &nbsp;&nbsp;  
<input type="checkbox" name="divorce" value="divorce" checked="'.$divorced_checked.'" /> Divorcee  <br>
<input type="checkbox" name="widow" value="widowed" checked="'.$widowed_checked.'" /> Widowed  &nbsp;&nbsp;
<input type="checkbox" name="separeted" value="separeted" checked="'.$separeted_checked .'" /> Legally Separeted <br>
<input type="checkbox" name="annuled" value="annulled" checked="'.$annulled_checked.'" /> Mariage Annulled 
</div>';
...
$js = "
var fields = {
    'volga_number':' $volag_number',
    'attorney_statebar_number':' $attorney_state_bar_number',
    'attorney_uscis_online_number':' $uscis_online_account_number',
    'a_number':' $a_number',

    'your_current_legal_lastname':' $last_name',
    'your_current_legal_firstname':' $first_name',
    'your_current_legal_middlename':' $middle_name',
    ...
    'other_information_you_date_of_birth':' $date_of_birth',
    'other_information_city_town_of_birth':' $city_town_village_of_birth',
    'information_about_you_country_birth':' $country_of_birth',
    'information_about_you_citizen_nationality':' $nationality',
    'information_about_you_alien_number':' $a_number',
    'information_about_you_online_account_number':' $uscis_online_account_number',
    'information_about_you_us_social_number':' $social_security_number',
    'information_about_you_us_mail_in_care_name':' ',
    'information_about_you_us_mail_street':' $street_address',
    'information_about_you_us_mail_apt_ste_flr':' $address1_apt_ste_flr_value',
    'information_about_you_us_mail_city_town':' $city',
    'information_about_you_us_mail_state':' $state',
    'information_about_you_us_mail_zipcode':' $zip',
    ...
    'recent_immigration_pasport_number':' $passport_number',
    'recent_immigration_travel_number':' ',
    'recent_immigration_pasport_expire_date':' $passport_expire_date',
    'recent_immigration_country_issue_pasport':' $country_issued_pasport',
    'recent_immigration_nonimmigrant_number':' ',
    'recent_immigration_city_town':' $last_arival_place_us',
    'recent_immigration_state':' ',
    'recent_immigration_date_last_arrive':' $last_arival_date_us',
    ...
    'aditional_info_address_street':' $address1_street_number',
    'aditional_info_address_apt_ste_flr':' ',
    'aditional_info_address_city_or_town':' $address1_city',
    'aditional_info_address_state':' $address1_state',
    'aditional_info_address_zip_code':' $address1_zip',
    'aditional_info_address_province':' ',
    'aditional_info_address_postal_code':' ',
    'aditional_info_address_country':' ',
    'aditional_info_address_date_from':' $address1_date',
    'aditional_info_address_date_to':' ',

    'aditional_info_address2_street':' $address2_street_number ',
    'aditional_info_address2_apt_ste_flr':' ',
    'aditional_info_address2_city_or_town':' $address2_city',
    'aditional_info_address2_state':' $address2_state',
    'aditional_info_address2_zip_code':' $address2_zip',
    'aditional_info_address2_province':' ',
    'aditional_info_address2_postal_code':' ',
    'aditional_info_address2_country':' ',
    'aditional_info_address2_date_from':' $address2_date',
    ...
    'aditional_info_employement_company':' $employer1_name',
    'aditional_info_employer_street':' $employer1_address',
    'aditional_info_employer_apt_ste_flr':' $employer1_apt_ste_flr_value',
    'aditional_info_employer_city_or_town':' $employer1_city_or_town',
    'aditional_info_employer_state':' $employer1_state',
    'aditional_info_employer_zip_code':' $employer1_zip_code',
    'aditional_info_employer_province':' $employer1_province',
    'aditional_info_employer_postal_code':' $employer1_postal_code',
    'aditional_info_employer_country':' $employer1_country',
    'aditional_info_employer_date_from':' $employer1_date_from',
    'aditional_info_employer_date_to':' $employer1_date_to',
    'aditional_info_employer_occupation':' $employer1_occupation',

    'aditional_info_employer2_company':' $employer2_name ',
    'aditional_info_employer2_street':' $employer2_address',
    'aditional_info_employer2_apt_ste_flr':' $employer2_apt_ste_flr_value',
    'aditional_info_employer2_city_or_town':' $employer2_city_or_town',
    'aditional_info_employer2_state':' $employer2_state',
    'aditional_info_employer2_zip_code':' $employer2_zip_code',
    'aditional_info_employer2_province':' $employer2_province',
    'aditional_info_employer2_postal_code':' $employer2_postal_code',
    'aditional_info_employer2_country':' $employer2_country',
    'aditional_info_employer2_date_from':' $employer2_date_from',
    'aditional_info_employer2_date_to':' $employer2_date_to',
    'aditional_info_employer2_occupation':' $employer2_occupation',
    ...
    'information_parent1_lastname':' $father_last_name',
    'information_parent1_firstname':' $father_first_name',
    'information_parent1_middlename':' $father_middle_name',
    'information_parent1_lastname_at_birth':' ',
    'information_parent1_firstname_at_birth':' ',
    'information_parent1_middlename_at_birth':' ',
    'information_parent1_date_of_birth':' $father_date_of_birth ',
    'information_parent1_city_of_birth':' $father_birth_location',
    'information_parent1_country_of_birth':' $father_country_of_birth',
    'information_parent1_current_city_of_resident':' $father_city_town_village_of_residence',
    'information_parent1_current_country_of_resident':' $father_country_of_residence',

    'information_parent2_lastname':' $mother_last_name',
    'information_parent2_firstname':' $mother_first_name',
    'information_parent2_middlename':' $mother_middle_name ',
    'information_parent2_lastname_at_birth':' ',
    'information_parent2_firstname_at_birth':' ',
    'information_parent2_middlename_at_birth':' ',
    'information_parent2_date_of_birth':' $mother_date_of_birth',
    'information_parent2_city_of_birth':' $mother_birth_location ',
    'information_parent2_country_of_birth':' $mother_country_of_birth',
    'information_parent2_current_city_of_resident':' $mother_city_town_village_of_residence',
    'information_parent2_current_country_of_resident':' $mother_country_of_residence',

    'how_many_times_married':' $marital_times',
    'current_mariage_spouse_lastname':' $spouse_last_name',
    'current_mariage_spouse_firstname':' $spouse_first_name',
    'current_mariage_spouse_middlename':' $spouse_middle_name',
    'current_mariage_spouse_a_number':' $spouse_social_security_number',
    'current_mariage_spouse_date_of_birth':' $spouse_birth_date',
    'current_mariage_spouse_date_of_marriage':' $current_marriage_date',
    'current_mariage_spouse_birth_city_town':' $city_of_marriage',
    'current_mariage_spouse_birth_state':' $province_of_marriage',
    'current_mariage_spouse_birth_country':' $country_of_marriage',
    'place_of_mariage_current_spouse_city_or_town':' $spouse_city_town_birth',
    'place_of_mariage_current_spouse_province':' $spouse_city_town_birth',
    'place_of_mariage_current_spouse_country':' $spouse_nationality',


    'information_prior_marriage_lastname':' $spouse_prior_spouse',
    'information_prior_marriage_firstname':' ',
    'information_prior_marriage_middlename':' ',
    'prior_spouse_date_of_marriage':' $spouse_prior_marriage_date',
    'prior_spouse_date_of_birth':' ',
    'place_of_mariage_prior_spouse_city_town':' $spouse_prior_place_mariage',
    'place_of_mariage_prior_spouse_state_province':' ',
    'place_of_mariage_prior_spouse_country':' ',
    'legally_ended_date_of_prior_spouse_marriage':' $spouse_prior_spouse_marriage_end_date',
    'place_of_spouse_prior_marriage_ended_city_town':' $spouse_prior_place_divorce',
    'place_of_spouse_prior_marriage_ended_state_province':' ',
    'place_of_spouse_prior_marriage_ended_country':' ',

    'total_number_of_children':' ',
    'information_children1_lastname':' $frst_child_name',
    'information_children1_firstname':' ',
    'information_children1_middlename':' ',
    'information_children1_a_number':' $first_child_a_number',
    'information_children1_date_of_birth':' $first_child_dob',
    'information_children1_country_of_birth':' ',

    'information_children2_lastname':' $second_child_name ',
    'information_children2_firstname':' ',
    'information_children2_middlename':' ',
    'information_children2_a_number':' $secon_child_a_number',
    'information_children2_date_of_birth':' $second_child_dob',
    'information_children2_country_of_birth':' ',

    'information_children3_lastname':' $third_child_name',
    'information_children3_firstname':' ',
    'information_children3_middlename':' ',
    'information_children3_a_number':' $third_child_a_number',
    'information_children3_date_of_birth':' $third_child_dob',
