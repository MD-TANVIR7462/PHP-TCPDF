...
if(isset($_GET['clientId'])){
	...
	$singleData = $objQuery->indexByQuerySingleData("
...
$pdf->writeHTMLCell(91, 6, 13, 112, $html, '', 0, 0, true, 'L'); 
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('spouse_beneficiary_date_to_2', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),74, 31);
//.....

$pdf->setFont('times', '', 10);
$html = '<div><b>9.b. &nbsp; &nbsp;</b> Date from (mm/dd/yyyy)</div>';
$pdf->setFont('times', '', 10);	
$pdf->writeHtmlCell(91, 12, 13, 40, $html, 0, 0, false, 'J', true);	
$pdf->TextField('spouse_beneficiary_date_to_2', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),74, 40);
...
$pdf->TextField('parent_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),48, 62);
//........
$pdf->setFont('times','', 10);
$html= '<div><b>10.b. &nbsp; &nbsp;</b>Given  Name <br>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; (First Name)</div>';
$pdf->writeHTMLCell(60, 12, 13, 70, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),48, 71);
//..........

$pdf->setFont('times','', 10);
$html= '<div><b>10.c. &nbsp; &nbsp;</b>Middle Name</div>';
$pdf->writeHTMLCell(60, 12, 13, 81, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),48, 80);
...
$pdf->TextField('parent_info', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),73, 89);
//.......

$pdf->setFont('times','', 10);
$html= '<div><b>12. </b> &nbsp;  Sex &nbsp; &nbsp; <input type="checkbox" name="gender" value="Male" checked="" />Male &nbsp;&nbsp; <input type="checkbox" name="gender" value="Female" checked="" /> Female</div>';
...
$pdf->TextField('parent_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),21, 108);
//.....

$pdf->setFont('times', '', 10);
$html= '<div><b>14.</b> &nbsp; Country of Birth</div>';
$pdf->writeHTMLCell(60, 12, 13, 115.5, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),21, 122);
//.....

$pdf->setFont('times', '', 10);
$html= '<div><b>15.</b> &nbsp; City / Town/ Village of Residence</div>';
$pdf->writeHTMLCell(60, 12, 13, 130, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),21, 137);
//.......

$pdf->setFont('times', '', 11);
$html= '<div><b>16.</b> &nbsp; Country Of Residence</div>';
$pdf->writeHTMLCell(60, 12, 13, 145, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),21, 151);
...
$pdf->TextField('parent_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),48, 174);
//...........

$pdf->setFont('times','', 10);
$html= '<div><b>17.b. &nbsp; &nbsp;</b>Given Name <br>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; (Last Name)</div>';
$pdf->writeHTMLCell(90, 12, 13, 182, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),48, 184);
//......

$pdf->setFont('times','', 10);
$html= '<div><b>17.c. &nbsp; &nbsp;</b>Middle Name </div>';
$pdf->writeHTMLCell(90, 12, 13, 193.5, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),48, 193.5);
...
$pdf->TextField('parent_info', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),73, 202);
//.......

$pdf->setFont('times','', 10);
$html= '<div><b>19. </b>  &nbsp;  Sex &nbsp; &nbsp; <input type="checkbox" name="sex" value="Male" checked="" />Male &nbsp;&nbsp; <input type="checkbox" name="sex" value="Female" checked="" /> Female</div>';
...
$pdf->TextField('parent_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),21, 221);
//.....

$pdf->setFont('times', '', 10);
$html= '<div><b>21.</b> &nbsp; Country of Birth</div>';
$pdf->writeHTMLCell(60, 12, 13, 228, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),21, 234);
//.....

$pdf->setFont('times', '', 10);
$html= '<div><b>22.</b> &nbsp; City / Town/ Village of Residence</div>';
$pdf->writeHTMLCell(60, 12, 13, 241, $html,0, 0, false, 'L', true);
$pdf->TextField('parent_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),21, 246);
// //.......
...
$pdf->TextField('parent_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),21, 259);
...
$pdf->TextField('Employee_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),122, 71);
//............
$pdf->setFont('times', '', 11);
$html= '<div><b>2.a. &nbsp;</b>Street Number <br>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; and Name </div>';
$pdf->writeHTMLCell(60, 12, 112, 78, $html,0, 0, false, 'L', true);
$pdf->TextField('Employee_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),149, 79.5);
...
$pdf->TextField('Employee_info', 40, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),164, 88);
...
$pdf->TextField('Employee_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),149, 96.5);
//............
...
$pdf->TextField('Employee_info', 33, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),171, 105);
//..........


$pdf->SetFont('times', '', 10.5); // set font
$html= '<div><b>2.f.</b> &nbsp; Provience </div>';
$pdf->writeHTMLCell(30, 0, 112, 114.5, $html, '', 0, 0, true, 'L');
$pdf->TextField('Employee_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),149, 114.5);
//...............

$pdf->SetFont('times', '', 10.5); // set font
$html= '<div><b>2.g.</b> &nbsp; Postal Code </div>';
$pdf->writeHTMLCell(40, 0, 112, 124, $html, '', 0, 0, true, 'L');
$pdf->TextField('Employee_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),149, 124);
//........
...
$pdf->TextField('Employee_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),122, 138);
//.....

$pdf->SetFont('times', '', 10.5); // set font
$html= '<div><b>3.</b> &nbsp; Your Occupation </div>';
$pdf->writeHTMLCell(60, 0, 112, 145, $html, '', 0, 0, true, 'L');
$pdf->TextField('Employee_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),122, 151);
//......

$pdf->SetFont('times', '', 10.5);
$html= '<div><b>4.a.</b> &nbsp; Date From (dd/mm/yyyy) </div>';
$pdf->writeHTMLCell(60, 0, 112, 160, $html, '', 0, 0, true, 'L');
$pdf->TextField('Employee_info', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),174, 160);
//...........
$pdf->SetFont('times', '', 10.5);
$html= '<div><b>4.b.</b> &nbsp; Date To (dd/mm/yyyy) </div>';
$pdf->writeHTMLCell(60, 0, 112, 169, $html, '', 0, 0, true, 'L');
$pdf->TextField('Employee_info', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),174, 169);
//....
...
$pdf->TextField('Employee_info', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),121, 190);
//............
$pdf->setFont('times', '', 11);
$html= '<div><b>6.a. &nbsp;</b>Street Number <br>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; and Name </div>';
$pdf->writeHTMLCell(60, 12, 112, 197, $html,0, 0, false, 'L', true);
$pdf->TextField('Employee_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),149, 199);
...
$pdf->TextField('Employee_info', 40, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),164, 208);
...
$pdf->TextField('Employee_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),149, 217);
//............
$pdf->SetFont('times', '', 10.5); // set font
...
$pdf->TextField('Employee_info', 33, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),171, 226);
//..........


$pdf->SetFont('times', '', 10.5); // set font
$html= '<div><b>6.f.</b> &nbsp; Provience </div>';
$pdf->writeHTMLCell(30, 0, 112, 235, $html, '', 0, 0, true, 'L');
$pdf->TextField('Employee_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),149, 235);
//...............

$pdf->SetFont('times', '', 10.5); // set font
$html= '<div><b>6.g.</b> &nbsp; Postal Code </div>';
$pdf->writeHTMLCell(40, 0, 112, 243, $html, '', 0, 0, true, 'L');
$pdf->TextField('Employee_info', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),149, 244);
...
$pdf->TextField('Employee_info', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 122, 258);

//........ end page two ..............end right side.................

//  $pdf->AddPage('P', 'LETTER'); // page number 3.................................. page 3 start 


//.........continue spouse benifishioary............
...
// $pdf->setCellPaddings(1, 0.5, 1, 0.5); // set cell padding
// $pdf->SetFontSize(11.6); // set font
// $html ='<div><b>Part 2. Information About Your Employment </b> </br>(Continued)</div>';
// $pdf->writeHTMLCell(91, 7, 13, 15, $html, 1, 1, true, false, 'J', true);
...
var fields = {
	...
	'street_number_and_name_by_physical_address_outside':'$address',
	'street_number_and_name_by_physical_address_1':'$address',
	'street_number_and_name_by_physical_address_2':'$address',
	'city_or_town':'$city',
	'state':'$state',
	'zip_code':'$zip',
	'province':' ',
