	...
	<div class="row">
		...
		<div class="col-md-5">
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-md-offset-4">
					 <input type="text" class="form-control" maxlength="13" name="notice_apperance_as_attorney_or_accredited_reprentative_receipt_number" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_receipt_number')?>" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"  maxlength="29" name="notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_last_name" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_last_name')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">6.b. Given Name(First Name):</label>
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="29" name="notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_first_name" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_first_name')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">6.c. Middle Name:</label>
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="29" name="notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_middle_name" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_middle_name')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-12">7.a. Name of Entity (if applicable) </label>
				<div class="col-md-12" >
					<input type="text" class="form-control"  maxlength="39" name="notice_apperance_as_attorney_or_accredited_reprentative_immegration_name_of_entity_1" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_immegration_name_of_entity_1')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-12">7.b. Title of Authorized Signatory for Entity (if applicable) </label>
				<div class="col-md-12" >
					<input type="text" class="form-control" maxlength="39" name="notice_apperance_as_attorney_or_accredited_reprentative_title_of_authorized_signatory" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_title_of_authorized_signatory')?>" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-md-offset-4">
					 <input type="text" class="form-control" maxlength="12" name="notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_uscis_account_number" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_uscis_account_number')?>" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-md-offset-4">
					 <input type="text" class="form-control" maxlength="9" name="notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_alien_reg_no" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_information_about_client_alien_reg_no')?>" />
				</div>
			</div>
		...
		<div class="bg-info">
			...
			<div class="form-group">
				...
				<div class="col-md-12 ">
					<input type="text" class="form-control" maxlength="10" name="notice_apperance_as_attorney_or_accredited_reprentative_client_contact_information_day_time_telephone_number" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_client_contact_information_day_time_telephone_number')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-12">11. Mobile Telephone Number (if any): </label>
				<div class="col-md-12 ">
					<input type="text" class="form-control" maxlength="10" name="notice_apperance_as_attorney_or_accredited_reprentative_client_contact_information_day_time_mobile_number" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_client_contact_information_day_time_mobile_number')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-12">12. Email Address (if any): </label>
				<div class="col-md-12 ">
					<input type="email" class="form-control" maxlength="38" name="notice_apperance_as_attorney_or_accredited_reprentative_client_contact_information_day_time_eamil_address" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_client_contact_information_day_time_eamil_address')?>" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="29" name="notice_apperance_as_attorney_or_accredited_reprentative_client_contact_information_mailing_address_client_street_number" value="<?php echo showData('notice_apperance_as_attorney_or_accredited_reprentative_client_contact_information_mailing_address_client_street_number')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					 <input type="text" class="form-control" maxlength="20" name="interpreter_contact_information_mailing_address_city_or_town" value="<?php echo showData('interpreter_contact_information_mailing_address_city_or_town')?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="5" name="interpreter_contact_information_mailing_address_zip" value="<?php echo showData('interpreter_contact_information_mailing_address_zip')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">13.f. Province :</label>
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="20" name="interpreter_contact_information_mailing_address_province" value="<?php echo showData('interpreter_contact_information_mailing_address_province')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">13.g. Postel Code :</label>
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="9" name="interpreter_contact_information_mailing_address_postel_code" value="<?php echo showData('interpreter_contact_information_mailing_address_postel_code')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">13.h. Country :</label>
				<div class="col-md-7">
					<input type="text" class="form-control" maxlength="39" name="interpreter_contact_information_mailing_address_country" value="<?php echo showData('interpreter_contact_information_mailing_address_country')?>" />
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-md-5">
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>2.d.</b></span>
					<textarea class="form-control" id="g_28_additional_info_2d" maxlength="321" name="g_28_additional_info_2d" rows="8" cols="50"><?php echo showData('g_28_additional_info_2d')?></textarea>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>3.d.</b></span>
					<textarea class="form-control" maxlength="357" id="g_28_additional_info_3d" name="g_28_additional_info_3d" rows="8" cols="50"><?php echo showData('g_28_additional_info_3d')?></textarea>
				</div>
			</div>
		</div><!--end column-->
		...
		<div class="col-md-5 col-md-offset-1">
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>4.d.</b></span>
					<textarea class="form-control"  maxlength="321" id="g_28_additional_info_4d" name="g_28_additional_info_4d" rows="8" cols="50"><?php echo showData('g_28_additional_info_4d')?></textarea>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>5.d.</b></span>
					<textarea class="form-control" id="g_28_additional_info_5d" maxlength="321" name="g_28_additional_info_5d" rows="8" cols="50"><?php echo showData('g_28_additional_info_5d')?></textarea>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>6.d.</b></span>
					<textarea class="form-control" id="g_28_additional_info_6d" maxlength="357" name="g_28_additional_info_6d" rows="8" cols="50"><?php echo showData('g_28_additional_info_6d')?></textarea>
				</div>
			</div>
		</div><!--end column-->
	</div>
