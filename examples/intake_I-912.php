...
$page_heading 	= "Intake Form I-912, Application for Employment Authorization";
	...
	<div class="row">
		<div class="col-md-12">
				...
				<div class="col-md-10 col-md-offset-2">
					...
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status"
							value="single"> Single, Never Married
					</label>
					&nbsp;
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status"
					...
					<label class="control-label">
						<input type="radio" name="other_information_about_you_marital_status"
							value="marriage annulled"> Marriage Annulled
					</label>
					<div class="d-flexible">
						<label class="control-label">
							<input type="radio" name="other_information_about_you_marital_status"
								value="other"> Other (Explain)
						</label>
						<div>
							<input type="text" class="form-control"
			...
			<table>
				...
				<tr>
					<td><input type="text" class="form-control" name="means_test_benefits_full_name[]" maxlength="19"
							value="<?= showData('means_test_benefits_full_name','0')?>"></td>
					<td><input type="text" class="form-control" name="means_test_benefits_relate[]" maxlength="11"
							value="<?= showData('means_test_benefits_relate','0')?>"></td>
					<td><input type="text" class="form-control" name="means_test_benefits_agency_award[]" maxlength="18"
							value="<?= showData('means_test_benefits_agency_award','0')?>"></td>
					<td><input type="text" class="form-control" name="means_test_benefits_type_of_benefit[]" maxlength="12"
							value="<?= showData('means_test_benefits_type_of_benefit','0')?>"></td>
					<td><input type="text" class="form-control"
							name="means_test_benefits_date_benefit_award[]" maxlength="11"
							value="<?= showData('means_test_benefits_date_benefit_award','0')?>"></td>
					<td><input type="text" class="form-control"
							name="means_test_benefits_date_benefit_expire[]" maxlength="16"
			...
			<div class="d-flexible">
				...
				<p>Other (Explain)</p>
				<div>
					<input type="text" class="form-control" name="income_federal_poverty_guide_other_exp"
						value="<?= showData('income_federal_poverty_guide_other_exp')?>">
				</div>
			</div>
		</div><!-- end of left side column -->
	</div>
		...
		<div class="col-md-5">
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					...
					<textarea name="financial_hardship_chkbox_other" cols="30" rows="10" class="form-control" ><?= showData('financial_hardship_chkbox_other')?></textarea>
				</div>
			</div>
			<div class="bg-info">
	...
	<div class="row">
		<div class="col-md-5">
			...
			<div class="form-group">
				...
				<div class="col-md-7 col-md-offset-5">
					<input type="radio" name="" value="yes"> Yes, (complete this section) &nbsp;
		...
		<div class="col-md-6 col-md-offset-1">
			...
			<div class="d-flexible">
				<b>B.</b> <input type="checkbox" name="" >
				<p>I am an attorney or accredited representative and my representation of the requestor in this case
					<input type="checkbox" name="" > extends <input type="checkbox" name="" > does not extend beyond the preparation of this request.
				</p>
			</div>
	...
	<div class="row">
		<div class="col-md-5">
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>D.</b></span>
					<textarea name="i_912_additional_info_3d" class="form-control" cols="30" maxlength="316"
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>D.</b></span>
					<textarea name="i_912_additional_info_4d" class="form-control" cols="30" maxlength="316"
		...
		<div class="col-md-6 col-md-offset-1">
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>D.</b></span>
					<textarea name="i_912_additional_info_5d" class="form-control" cols="30" maxlength="316"
			...
			<div class="form-group">
				<div class="col-md-12">
					<span><b>D.</b></span>
					<textarea name="i_912_additional_info_6d" class="form-control" cols="30" maxlength="316"
