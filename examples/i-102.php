...
class MyPDF extends TCPDF {
    ...
    public function Footer() {
		...
		$this->Cell(40, 6, "Form I-102 Edition 12/02/21", 0, 0, 'L');
		
		
		// if ($this->page == 1){
			$barcode_image = "images/I-102-footer-pdf417-$this->page.png";
		// )
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('your_legal_name_middle_name19c', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 44, 237);
...
$pdf->SetFont('courier', 'B', 10);
$html = <<<EOD
<textarea cols="19" rows="11" name="procesing_information_2b">
...
$pdf->writeHTMLCell(90, 7, 14, 101, $html, 1, 1, true, false, 'L', true);
//.........

$pdf->SetFont('times', '', 10); 
$html= '<div><b>NOTE:</b> Read the Penalties section of the Form 1-102
Instructions before completing this section.</b></div>';
$pdf->writeHTMLCell(90, 4, 13, 113, $html, '', 0, 0, true, 'L');


$pdf->SetFont('times', '', 10); 
$html= '<div>You must file Form 1-102 while in the United States.
</div>';
$pdf->writeHTMLCell(90, 4, 13, 123, $html, '', 0, 0, true, 'L');
//..........
$pdf->SetFillColor(220,220,220);
$pdf->SetFont('times', '', 11); // set font
$pdf->setCellHeightRatio(1.1);
...
$pdf->writeHTMLCell(91.5, 7, 13, 130, $html, 0, 1, true, false, 'L', true);
//.........

$pdf->SetFont('times', '', 10); 
$html= '<div><b>Note</b>:Select the box for either <b>Item Number 1.a.</b> or 1.b. If
applicable, select the box for <b>Item Number 2.</b>
</div>';
$pdf->writeHTMLCell(90, 4, 13, 137, $html, '', 0, 0, true, 'L');
//...........
$pdf->SetFont('times', '', 10);
$html ='<div><b>1.a.   </b>    <input type="checkbox" name="applicantonea" value="Y" checked=" " /></div>';
$pdf->writeHTMLCell(90, 7, 12, 147, $html, 0, 1, false, true, 'J', true);
$html ='<div>I can read and understand English, and I have read <br>and understand every question and instruction ,<br>on this
application and my answer to every question. </div>';
$pdf->writeHTMLCell(90, 7, 26, 147, $html, 0, 1, false, true, 'J', true);
//.........

$pdf->SetFont('times', '', 10);
$html ='<div><b>1.b.   </b>    <input type="checkbox" name="applicantoneb" value="Y" checked=" " /></div>';
$pdf->writeHTMLCell(90, 7, 12, 160, $html, 0, 1, false, true, 'J', true);
$html ='<div>The interpreter named in Part 5. read to me every <br>question and instruction on this
application and my <br>answer to every question, in</div>';
$pdf->writeHTMLCell(90, 7, 26, 160, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_statement_1b', 74, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 27, 169);

$pdf->SetFont('times', '', 10);
$html ='<div>a language in which I am fluent, and I understood
<br>everything.</div>';
$pdf->writeHTMLCell(90, 7, 26, 176, $html, 0, 1, false, true, 'J', true);


//.........

$pdf->SetFont('times', '', 10);
$html ='<div><b>2.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="applicantoneb" value="Y" checked=" " /></div>';
$pdf->writeHTMLCell(90, 7, 12, 185, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('times', '', 10);
$html ='<div>At my request, the preparer named in Part 6.,</div>';
$pdf->writeHTMLCell(90, 7, 26, 185, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_statement_2', 74, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 27, 190);

$pdf->SetFont('times', '', 10);
$html ='<div>prepared this application for me based only upon
<br>information provided or authorized.</div>';
$pdf->writeHTMLCell(90, 7, 26, 197, $html, 0, 1, false, true, 'J', true);
//...........
$pdf->SetFillColor(220,220,220);
$pdf->SetFont('times', '', 11); // set font
$pdf->setCellHeightRatio(1.1);
...
$pdf->writeHTMLCell(91.5, 7, 14, 210, $html, 0, 1, true, false, 'L', true);
//.........
$pdf->SetFont('times', '', 10);
$html ='<div><b>3.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Applicant\'s Daytime Telephone Number</div>';
$pdf->writeHTMLCell(90, 7, 12, 219, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_contact_info_daytime', 85.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 224);
//...............
$pdf->SetFont('times', '', 10);
$html ='<div><b>4.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Applicant\'s Mobile Telephone Number (if any)</div>';
$pdf->writeHTMLCell(90, 7, 12, 232, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_contact_info_mobile', 85.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 237);
//...............

$pdf->SetFont('times', '', 10);
$html ='<div><b>5.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Applicant\'s Mobile Telephone Number (if any)</div>';
$pdf->writeHTMLCell(90, 7, 12, 245, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_contact_info_telephone', 85.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 250);
//...............
$pdf->SetFillColor(220,220,220);
$pdf->SetFont('times', '', 11); // set font
$pdf->setCellHeightRatio(1.1);
$pdf->setCellPaddings(1, 0.5, 1, 0.5); // set cell padding
$pdf->SetFontSize(11.6); // set font
$html ='<div><b><i>Applicant\'s Certification</i></b></div>';
$pdf->writeHTMLCell(90, 7, 113, 18, $html, 0, 1, true, false, 'L', true);
//...........
...
benefit that I seek.</div>';
$pdf->writeHTMLCell(93, 7, 112, 26, $html, 0, 1, false, true, 'J', true);
...
and that all of this information is complete, true, and correct.</div>';
...
$pdf->writeHTMLCell(90, 7, 113, 94, $html, 0, 1, true, false, 'L', true);
//.............

$pdf->SetFont('times', '', 10);
$html ='<div><b>6.a.</b> &nbsp;&nbsp;Applicant\'s Signature</div>';
$pdf->writeHTMLCell(92, 7, 112, 103, $html, 0, 1, false, true, 'J', true);
//...........

$pdf->SetFont('zapfdingbats', '', 22);  // symbol font
$pdf->writeHTMLCell(82, 7, 112, 106, TCPDF_FONTS::unichr(225), 0, 0, false, 'L');

$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(83, 7, 120, 108, "", 1, 1, false, true, 'C', true);
//.............

$pdf->SetFont('times', '', 10);
$html ='<div><b>6.b.</b> &nbsp;&nbsp;Date of Signature (mm/dd/yyyy)</div>';
$pdf->writeHTMLCell(92, 7, 112, 117, $html, 0, 1, false, true, 'J', true);
//...........

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('applicant_signature_date', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 173, 117);
//...............
...
$pdf->writeHTMLCell(92, 7, 112, 125, $html, 0, 1, false, true, 'J', true);
//...........
...
$pdf->writeHTMLCell(90, 7, 113, 144, $html, 1, 1, true, false, 'L', true);
//.........

$pdf->SetFont('times', '', 10);
$html ='<div>Provide the following information about the interpreter.</div>';
$pdf->writeHTMLCell(92, 7, 112, 156, $html, 0, 1, false, true, 'J', true);
//...........
...
$pdf->writeHTMLCell(90, 7, 113, 165, $html, 0, 1, true, false, 'L', true);
//.............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_full_famiy_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 178);
//...............

$pdf->SetFont('times', '', 10);
$html ='<div><b>1.b.</b>&nbsp;&nbsp;&nbsp; Interpreter\'s Given Name (First Name)</div>';
$pdf->writeHTMLCell(90, 7, 112, 186, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_full_given_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 191);
//...............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_full_business_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 205);
//...............
...
$pdf->SetFont('times', '', 10);
$html = '<b>3.a.</b> &nbsp;&nbsp;Street Number and Name';
$pdf->writeHTMLCell(90, 7, 13, 42, $html, '', 0, 0, true, 'L'); 

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_mailing_address_street_name', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),  22, 47);
...
$pdf->TextField('interpreter_mailing_address__apt_ste_flr', 42, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 61.1, 56);
//.........

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.c.</b> &nbsp;&nbsp;City or Town';
$pdf->writeHTMLCell(90, 7, 13, 66, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('interpreter_mailing_address_city_or_town', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),  45.1, 65);
//..........

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.d.</b> &nbsp;&nbsp;State&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>3.e.</b>&nbsp;&nbsp;ZIP Code';
$pdf->writeHTMLCell(60, 0, 13, 74, $html, '', 0, 0, true, 'L');
...
$html .= '</select>';
$pdf->writeHTMLCell(25, 0, 30, 74, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('interpreter_mailing_address_zip_code', 33, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 70, 74);
//...........
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('interpreter_mailing_address_province', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43,83 );
//.............

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.g.</b> &nbsp;&nbsp;Postal Code';
$pdf->writeHTMLCell(90, 7, 13, 93, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('interpreter_mailing_address_postal_code', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 42.9, 92);
//.............

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.h.</b> &nbsp;&nbsp;Country';
$pdf->writeHTMLCell(90, 7, 13, 100, $html, '', 0, 0, true, 'L');

$pdf->SetFont('times', 'B', 11);
$pdf->ComboBox('interpreter_mailing_address_country', 81, 7, array(
'Afghanistan',
'Albania',
'Algeria',
'American Samoa',
...
$pdf->writeHTMLCell(90, 7, 13, 116, $html, 0, 1, true, false, 'L', true);
//.............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_contact_info_daytime', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 130);
//...............
$pdf->SetFont('times', '', 10);
$html ='<div><b>5.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Interpreter\'s Mobile Telephone Number (if any)</div>';
$pdf->writeHTMLCell(90, 7, 12, 138, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_contact_info_mobile', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 143);
//...............

$pdf->SetFont('times', '', 10);
$html ='<div><b>6.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Interpreter\'s E-mail Address (if any)</div>';
$pdf->writeHTMLCell(90, 7, 12, 151, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_contact_info_email', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 156);
//...............
...
$pdf->writeHTMLCell(90, 7, 13, 167, $html, 0, 1, true, false, 'L', true);
//.............

$pdf->SetFont('times', '', 10);
$html ='<div><b>I certify under penalty of perjury, that:</b></div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_certification_perjury', 50, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 51, 179);

$pdf->SetFont('times', '', 10);
$html ='<div>,</div>';
$pdf->writeHTMLCell(90, 7, 101, 180, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('times', '', 10);
$html ='<div>which is the same language specified in <b>Part 4., Item Number
...
verified the accuracy of every answer.</div>';
$pdf->writeHTMLCell(93, 7, 12, 185, $html, 0, 1, false, true, 'J', true);
...
$pdf->writeHTMLCell(90, 7, 13, 217, $html, 0, 1, true, false, 'L', true);
//.............

$pdf->SetFont('times', '', 10);
$html ='<div><b>7.a.</b> &nbsp;&nbsp;Interpreter\'s Signature</div>';
$pdf->writeHTMLCell(92, 7, 12, 226, $html, 0, 1, false, true, 'J', true);
//...........

$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(83, 7, 20, 231, "", 1, 1, false, true, 'C', true);
//.............

$pdf->SetFont('times', '', 10);
$html ='<div><b>7.b.</b> &nbsp;&nbsp;Date of Signature (mm/dd/yyyy)</div>';
$pdf->writeHTMLCell(92, 7, 12, 241, $html, 0, 1, false, true, 'J', true);
//............

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('interpreter_date_of_signature', 34, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 69, 240);
//.........
...
$pdf->writeHTMLCell(92, 7, 112, 35, $html, 0, 1, false, true, 'J', true);
//............
...
$pdf->writeHTMLCell(90, 7, 113, 44, $html, 0, 1, true, false, 'L', true);
//.............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('preparer_full_famiy_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 57);
//...............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('preparer_full_given_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 70);
//...............

$pdf->SetFont('times', '', 10);
$html ='<div><b>2.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Preparer\'s Business or Organization Name (if any)
</div>';
$pdf->writeHTMLCell(90, 7, 112, 78, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('preparer_full_business_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 83);
//...............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('preparer_mailing_address_street_name', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),  122, 107);
//........

$pdf->SetFont('times', '', 10); // set font
$html= '<div><b>3.b. </b>&nbsp; &nbsp; <input type="checkbox" name="Apt1" value="Apt2" checked="" />Apt. &nbsp;&nbsp;<input type="checkbox" name="Ste1" value="Ste2" checked="" />Ste. <input type="checkbox" name="Flr1" value="Flr2" checked="" /> Flr.</div>';
$pdf->writeHTMLCell(90, 7, 113, 117, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('preparer_mailing_address__apt_ste_flr', 40, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 163, 116);
//.........

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.c.</b> &nbsp;&nbsp;City or Town';
$pdf->writeHTMLCell(90, 7, 113, 126, $html, '', 0, 0, true, 'L');
//.......
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('preparer_mailing_address_city_or_town', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),  145, 126);

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.d.</b> &nbsp; &nbsp;State&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>3.e.</b>&nbsp;&nbsp;ZIP Code';
$pdf->writeHTMLCell(60, 0, 113, 135, $html, '', 0, 0, true, 'L');
...
$html .= '</select>';
$pdf->writeHTMLCell(25, 0, 130, 135, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('preparer_mailing_address_zip_code', 33, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 170, 135);
//.........

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.f.</b> &nbsp;&nbsp;Province';
$pdf->writeHTMLCell(90, 7, 113, 144, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('preparer_mailing_address_province', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 143, 144);
//.............
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('preparer_mailing_address_postal_code', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 143, 153);
//.............

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.h.</b> &nbsp;&nbsp;Country';
$pdf->writeHTMLCell(90, 7, 113, 161, $html, '', 0, 0, true, 'L');

$pdf->SetFont('times', 'B', 11);
$pdf->ComboBox('preparer_mailing_address_country', 81, 7, array(
'Afghanistan',
'Albania',
'Algeria',
'American Samoa',
...
$pdf->writeHTMLCell(90, 7, 113, 177, $html, 0, 1, true, false, 'L', true);
//...........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('preparer_contact_info_daytime', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 191);
//...............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('preparer_contact_info_mobile', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 205);
//...............

$pdf->SetFont('times', '', 10);
$html ='<div><b>6.</b>&nbsp;&nbsp;&nbsp;&nbsp; Preparer\'s Email Address (if any)
</div>';
$pdf->writeHTMLCell(90, 7, 112, 213, $html, 0, 1, false, true, 'J', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('preparer_contact_info_email', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 218);
//...............
...
var fields = {
    ...
    'additional_inf0_7d':' ',
    'your_legal_name_middle_name19c':' ',
