...
class MyPDF extends TCPDF {
    ...
    public function Footer() {
        ...
        $this->SetFont('times', '', 10); // Set font
...
$pdf->MultiCell(110, 15, "Petition for Alien Relative", 0, 'C', 0, 1, 50, 8, true);
...
$pdf->MultiCell(78, 5, "Department of Homeland Security", 0, 'C', 0, 1, 67, 12, true);
...
$pdf->writeHTMLCell(50, 5, 60, 58.5, $html, 0, 1, false, true, 'L',true);
//..........
...
$pdf->writeHTMLCell(40, 6, 135, 95, '', 'B', 1, false, true, 'L',true);
//.......
...
$pdf->writeHTMLCell(90, 7, 14, 175, $html, 0, 1, false, false, 0, true);
$pdf->writeHTMLCell(20, 5, 18.5, 173.5, 'Spouse', 0, 1, false, false, 0, true);

$html ='<div>
<input type="checkbox" name="Parent" value="Parent" style="margin-right:3px;  " /></div>';
$pdf->writeHTMLCell(90, 7, 31, 175, $html, 0, 1, false, false, 0, true);
...
$pdf->writeHTMLCell(90, 7, 80, 175, $html, 0, 1, false, false, 0, true);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part2_14b_apt_ste_flr', 40, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 162.5, 152);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_27_country_birth', 84, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 21);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_28_city_town', 84, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 35);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_29_residence', 84, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 120, 48);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_30a_lastname', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 70);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_30b_firstname', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 79);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_30c_middle', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 88);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_31_date_birth', 35, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 169, 97);
...
$pdf->SetFont('times', '', 10);
$html ='<div><b>17.  </b>  How many times have you been married?</div>';
$pdf->writeHTMLCell(80, 7, 12, 64, $html, 0, 1, false, false, 'J', true);

$pdf->StartTransform();
$pdf->SetFillColor(0,0,0);
$pdf->Rotate(-30);
$pdf->SetFont('zapfdingbats', 'B', 10);
$pdf->MultiCell(10, 10, "t", '', 'L', 0, 1, 68, 29, false); // angle
$pdf->StopTransform();
$pdf->TextField('part4_17_married', 18, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(),85, 64);
...
$pdf->writeHTMLCell(70, 10, 12, 256, $html, 0, 1, false, false, 'J', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_24_date_ended', 30, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 73, 255.5);
...
$pdf->SetFont('times', '', 10.5);
$html= '<div><b>45.   </b> Have you <b>EVER</b> previously filed a petition for this <br>&nbsp; &nbsp; &nbsp; &nbsp; beneficiary or any other alien? 
...
$pdf->SetFont('times', '', 10.5);
$html ='<div><b>35. </b>  Date Filed (mm/dd/yyyy)</div>';
...
$pdf->writeHTMLCell(50, 7, 12, 86, $html, '', 0, 0, true, 'L'); 
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_3a_street', 55, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 48, 88);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_3b_ste_flr', 35, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 68, 97);
//.......... 

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.c.</b> &nbsp;&nbsp;City or Town';
$pdf->writeHTMLCell(50, 0, 12, 105.5, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part7_3c_city_or_town', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 46, 105.5);

$pdf->SetFont('times', '', 10); // set font
$html = '<b>3.d.</b> &nbsp;&nbsp;State&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp; <b>3.e.</b>  &nbsp; ZIP Code'; 
$pdf->writeHTMLCell(65, 0, 12, 114, $html, '', 0, 0, true, 'L');
...
$html .= '</select>';
$pdf->writeHTMLCell(25, 0, 29.5, 114, $html, '', 0, 0, true, 'L');

$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part7_3_zip_code', 33, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 70, 114);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part7_3f_province', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 46, 122.5);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part7_3g_postal_code', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 46, 131);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part7_3h_country', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 22, 144);
...
$pdf->setFont('Times', 'BI', 12);
$html= '<div>Petitioner\'s Contact Information</div>';
$pdf->writeHTMLCell(91, 7, 13, 154,  $html,  0, 1, true, 'L');
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_4_daytime_telephone', 84, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 168);
//.........
$pdf->setFont('Times', '', 10);
$html = '<div><b>5.</b>&nbsp; &nbsp; &nbsp;  Interpreter\'s Mobile Telephone Number (if any) </div>';
$pdf->writeHTMLCell(95, 7, 12, 175.5, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_5_telephone', 84, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 181);
//......
$pdf->setFont('Times', '', 10);
$html = '<div><b>6. </b> &nbsp; &nbsp;  Interpreter\'s Email Address (if any) </div>';
$pdf->writeHTMLCell(95, 7, 12, 188.5, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_6_email', 84, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 20, 194);
...
$pdf->writeHTMLCell(30, 7, 75, 182,"", "T", 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
...
$pdf->writeHTMLCell(30, 7, 175, 180, 'jdhflkgsdjhf', 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
