    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_other_family_last_name3" maxlength="29"
                        value="<?php echo showData('information_about_you_other_family_last_name3')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">4.b. Given Name(First Name)</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_other_given_first_name3" maxlength="29"
                        value="<?php echo showData('information_about_you_other_given_first_name3')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">4.c. Middle Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_you_other_middle_name3" maxlength="29"
                        value="<?php echo showData('information_about_you_other_middle_name3')?>" />
                </div>
            </div>
            <div class="bg-info">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" name="other_information_about_you_city_of_birth" maxlength="60"
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text"  maxlength="12" class="form-control" name="other_information_about_you_uscis_online_account_number" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text"  maxlength="29" class="form-control" name="information_about_you_mailing_street_number" 
                    value="<?php echo showData('information_about_you_mailing_street_number')?>" />
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-md-offset-4">
                    <input type="text"  maxlength="29" class="form-control" name="i_94_imgt_arrival_record_number" 
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control"
                        name="i_485_principal_applicant_family_last_name" maxlength="29"
                        value="<?php echo showData('i_485_principal_applicant_family_last_name')?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control"
                        name="i_485_principal_applicant_given_first_name" maxlength="29"
                        value="<?php echo showData('i_485_principal_applicant_given_first_name')?>" />
                </div>
            </div>
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"
						name="information_about_you_home_street_number" maxlength="28"
			...
			<div class="form-group">
				<div class="control-label col-md-6"><b>5.b. </b> &nbsp;
					<input type="radio"
						name="information_about_you_home_apt_ste_flr" value="apt"
						<?php echo (showData('information_about_you_home_apt_ste_flr') === 'apt') ? 'checked' : ''; ?>>
					Apt. &nbsp;
					<input type="radio"
						name="information_about_you_home_apt_ste_flr" value="ste"
						<?php echo (showData('information_about_you_home_apt_ste_flr') === 'ste') ? 'checked' : ''; ?>>
					Ste. &nbsp;
					<input type="radio"
						name="information_about_you_home_apt_ste_flr" value="flr"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"
						name="information_about_you_home_city_town" maxlength="20"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"
						name="information_about_you_home_zip_code" maxlength="5"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" maxlength="29" class="form-control"
						name="information_about_you_home_province"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" maxlength="29" class="form-control" name="information_about_you_home_postal_code"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" maxlength="29" class="form-control" name="information_about_you_home_country"
			...
			<div class="form-group">
				...
				<div class="col-md-7 ">
					<input type="date" class="form-control" name="information_about_you_home_residence_from_date"
						value="<?= showData('information_about_you_home_residence_from_date')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">6.b. To (mm/dd/yyyy)</label>
				<div class="col-md-7 ">
					<input type="date" class="form-control" name="information_about_you_home_residence_to_date"
						value="<?= showData('information_about_you_home_residence_to_date')?>" />
				</div>
			</div>
			<hr>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control"
                        name="information_about_you_home_street_number2" maxlength="28"
                        value="<?php echo showData('information_about_you_home_street_number2')?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control"
                        ...
                        value="<?php echo showData('information_about_you_home_zip_code2')?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">7.f. Province</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_home_province2"
                        value="<?php echo showData('information_about_you_home_province2')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">7.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_home_postal_code2"
                        value="<?php echo showData('information_about_you_home_postal_code2')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">7.h. Country</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_home_country2"
                        value="<?php echo showData('information_about_you_home_country2')?>" />
                </div>
            </div>
            <p>Dates of Residence</p>
            <div class="form-group">
                ...
                <div class="col-md-7 ">
                    <input type="date" class="form-control" name="information_about_you_home_residence_from_date2"
                        value="<?= showData('information_about_you_home_residence_from_date2')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">8.b. To (mm/dd/yyyy)</label>
                <div class="col-md-7 ">
                    <input type="date" class="form-control" name="information_about_you_home_residence_to_date2"
                        value="<?= showData('information_about_you_home_residence_to_date2')?>" />
                </div>
            </div>
        </div>
        <div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"
						name="information_about_you_outside_us_street_number" maxlength="28"
						value="<?php echo showData('information_about_you_outside_us_street_number')?>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-6">
					<input type="text" class="form-control"
						name="information_about_you_outside_us_apt_ste_flr_value" maxlength="6"
						value="<?php echo showData('information_about_you_outside_us_apt_ste_flr_value')?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">9.c. City or Town</label>
				<div class="col-md-7">
					<input type="text" class="form-control" name="information_about_you_outside_us_city_town" maxlength="20"
						value="<?= showData('information_about_you_outside_us_city_town')?>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-7">
					<select class="form-control" name="information_about_you_outside_us_state">
						...
						<?php
						foreach ($allDataCountry as $record) {
							if($record->state_code==showData('information_about_you_outside_us_state')) $selected = "selected"; else $selected = "";
							echo "<option value='$record->state_code' $selected>$record->state_code</option>";
						}
						?>
					</select>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="information_about_you_outside_us_zip_code" maxlength="5"
						value="<?php echo showData('information_about_you_outside_us_zip_code')?>">
				</div>
			</div>
            <div class="form-group">
                <label class="control-label col-md-5">9.f. Province</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_outside_us_province"
                        value="<?php echo showData('information_about_you_outside_us_province')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">9.g. Postal Code</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_outside_us_postal_code"
                        value="<?php echo showData('information_about_you_outside_us_postal_code')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">9.h. Country</label>
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="information_about_you_outside_us_country"
                        value="<?php echo showData('information_about_you_outside_us_country')?>" />
                </div>
            </div>
            <p>Dates of Residence</p>
            <div class="form-group">
                ...
                <div class="col-md-7 ">
                    <input type="date" class="form-control" name="information_about_you_outside_us_residence_from_date"
                        value="<?= showData('information_about_you_outside_us_residence_from_date')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">10.b. To (mm/dd/yyyy)</label>
                <div class="col-md-7 ">
                    <input type="date" class="form-control" name="information_about_you_outside_us_residence_to_date"
                        value="<?= showData('information_about_you_outside_us_residence_to_date')?>" />
                </div>
            </div>
            <div class="bg-info">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="employer1_address" maxlength="28"
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="employer1_apt_ste_flr_value" maxlength="6"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"
						name="employer1_city_town" maxlength="20"
						value="<?= showData('employer1_city_town')?>">
				</div>
			</div>
			<div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" maxlength="29" class="form-control" name="employer_outside_us_postal_code"
            ...
            <div class="form-group">
                <label class="control-label col-md-5">1.a. Family Name(Last Name)</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="parent1_info_family_last_name" maxlength="29"
            ...
            <div class="form-group">
                <label class="control-label col-md-5">1.b. Given Name(First Name)</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="parent1_info_given_first_name" maxlength="29"
            ...
            <div class="form-group">
                <label class="control-label col-md-5">1.c. Middle Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="parent1_info_middle_name" maxlength="29"
            ...
            <div class="form-group">
                <label class="control-label col-md-5">2.a. Family Name(Last Name)</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="parent1_info_at_birth_family_last_name" maxlength="29"
                        value="<?php echo showData('parent1_info_at_birth_family_last_name')?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.b. Given Name(First Name)</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="parent1_info_at_birth_given_first_name" maxlength="29"
                        value="<?php echo showData('parent1_info_at_birth_given_first_name')?>"/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.c. Middle Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="parent1_info_at_birth_middle_name" maxlength="29"
                        value="<?php echo showData('parent1_info_at_birth_middle_name')?>" />
                </div>
            </div>
            <div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="parent1_info_city_of_birth" maxlength="28"
						value="<?php echo showData('parent1_info_city_of_birth')?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">6. Country of Birth</label>
				<div class="col-md-7">
					<input type="text" class="form-control" name="parent1_info_country_of_birth" maxlength="28"
        ...
        <div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="form-check">
					<input class="form-check-input" type="radio" name="other_information_about_you_marital_status"
						value="single" <?php echo (showData('other_information_about_you_marital_status')=='single') ? 'checked':''?>>
					<label class="form-check-label" for="marital-single">Single, Never Married</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="other_information_about_you_marital_status"
						value="married" <?php echo (showData('other_information_about_you_marital_status')=='married') ? 'checked':''?>>
					<label class="form-check-label" for="marital-married">Married</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="other_information_about_you_marital_status"
						value="divorced" <?php echo (showData('other_information_about_you_marital_status')=='divorced') ? 'checked':''?>>
					<label class="form-check-label" for="marital-divorced">Divorced</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="other_information_about_you_marital_status" 
						value="widowed" <?php echo (showData('other_information_about_you_marital_status')=='widowed') ? 'checked':''?>>
					<label class="form-check-label" for="marital-widowed">Widowed</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="other_information_about_you_marital_status"
						value="annulled" <?php echo (showData('other_information_about_you_marital_status')=='annulled') ? 'checked':''?>>
					<label class="form-check-label" for="marital-annulled">Marriage Annulled</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="other_information_about_you_marital_status"
						value="separated" <?php echo (showData('other_information_about_you_marital_status')=='separated') ? 'checked':''?>>
			...
			<div class="form-group">
				<label>2. If you are married, is your spouse a current member of the U.S. armed forces or U.S. Coast
					Guard?</label>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="current_spouse_us_armed_force"
						value="na" <?php echo (showData('current_spouse_us_armed_force')=='NA') ? 'checked':''?>>
					<label class="form-check-label" for="spouse-military-na">N/A</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="current_spouse_us_armed_force" 
						value="yes" <?php echo (showData('current_spouse_us_armed_force')=='Y') ? 'checked':''?>>
					<label class="form-check-label" for="spouse-military-yes">Yes</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="current_spouse_us_armed_force" 
						value="no" <?php echo (showData('current_spouse_us_armed_force')=='N') ? 'checked':''?>>
        ...
        <div class="col-md-6">
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="text" maxlength="29" class="form-control" name="child1_family_last_name" 
                    value="<?php echo showData('child1_family_last_name')?>"><br>

                    <label>2.b. Given Name (First Name):</label><br>
                    <input type="text" maxlength="29" class="form-control" name="child1_given_first_name" 
                    value="<?php echo showData('child1_given_first_name')?>"><br>

                    <label>2.c. Middle Name:</label><br>
                    <input type="text" maxlength="29" class="form-control" name="child1_middle_name" 
                    value="<?php echo showData('child1_middle_name')?>"><br>
...
<fieldset class="setpage">
    ...
    <div class="row">
        ...
        <div class="control-label" style="margin: 20px;"><b>66. What is the highest degree or level of school you have
            ...
            <?php echo (showData('i_485_general_eligibility_highest_degree')=='high_school_credential') ? 'checked':''?>> High school diploma, GED, or alternative credential&nbsp;<br>
            <input type="radio" name="i_485_general_eligibility_highest_degree" value="no_degree" 
            <?php echo (showData('i_485_general_eligibility_highest_degree')=='no_degree') ? 'checked':''?>> 1 or more years of college credit, no degree<br>
            ...
            <?php echo (showData('i_485_general_eligibility_highest_degree')=='professional_degree') ? 'checked':''?>> Professional degree (JD, MD, DMD, etc.)<br>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <select class="form-control" name="i_485_interpreter_address_state">
                        ...
                        <?php
                        foreach ($allDataCountry as $record) {
							if($record->state_code==showData('i_485_interpreter_address_state')) $selected = "selected"; else $selected = "";
							echo "<option value='$record->state_code' $selected>$record->state_code</option>";
						}
                        ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <select class="form-control" name="i_485_preparer_address_state">
                        ...
                        <?php
                        foreach($allDataCountry as $record) {
							if($record->state_code==showData('i_485_preparer_address_state')) $selected = "selected"; else $selected = "";
							echo "<option value='$record->state_code' $selected>$record->state_code</option>";
						}
                        ?>
                    </select>
