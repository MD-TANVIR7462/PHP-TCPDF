...
<fieldset class="setpage">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" maxlength="12" class="form-control" name="" value="<?php echo showData('i_290b_appeal_or_motion_nonimmigrant_or_immigrant') ?>" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Male</label>
                    <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Female</label>
                    <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Another Gender Identity</label>
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 ">
                <input type="text" class="form-control" name="i_290b_additional_info_7a_page_no" maxlength="9" value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
...
<fieldset class="setpage">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6 ">
            <div class="form-group">
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Hispanic or Latino</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Not Hispanic or Latino</label>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-12 ">
            <div class="form-group">
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>American Indian or Alaska Native</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Asian</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Black or African American</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Native Hawaiian or Other Pacific Islander</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>White</label>
            </div>
        </div>
    </div>
    ...
    <div style="padding-left: 1.5%;">
        <div>
            ...
            <select id="feet" name="biographic_info_height_feet" style="padding: 8px; margin-right: 10px; border: 1px solid #ccc; border-radius: 5px;">
                <?php echo "<option value=" . showData('') . " selected>" . showData('') . "</option>"; ?>
            ...
            <select id="inches" name="biographic_info_height_inches" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px;">
                <?php echo "<option value=" . showData('biographic_info_height_inches') . " selected>" . showData('') . "</option>"; ?>
...
<fieldset class="setpage">
    ...
    <div class="form-group">
        ...
        <div class="col-md-12 ">
            <div class="form-group">
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Single, Never Married</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Married</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Divorced</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Widowed</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Separated</label>
                <label class="control-label" style="margin-left: 30px;"><?php echo createCheckbox("") ?>Marriage Annulled</label>
            </div>
        </div>
    ...
    <div class="form-group" style="padding-left:1.5%; ">
        <h5><b>4.a. Your Current Legal Name (do not provide a nickname)</b> </h5>
    </div>
    <div class="row form-group" style="margin-bottom:20px ;">
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 15px;">Family Name (Last Name)</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7a_page_no" maxlength="33" value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
            </div>
        </div>
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 15px;">Given Name (First Name)</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7b_part_no" maxlength="29" value="<?php echo showData('i_290b_additional_info_7b_part_no') ?>">
            </div>
        </div>
        <div class=" col-md-4">
            <label class="control-label " style="margin-left: 15px;">Middle Name (if applicable)
            ...
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7c_item_no" maxlength="21" value="<?php echo showData('i_290b_additional_info_7c_item_no') ?>">
            </div>
        </div>
    </div>
    <div class="row form-group" style="margin-bottom: 20px;">
        <div class=" col-md-6">
            ...
            <div class="col-md-12">
                <input type="date" class="form-control" name="i_290b_additional_info_7a_page_no" value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
            </div>
        </div>
        <div class=" col-md-6">
            <label class="control-label " style="margin-left: 15px;">4.c. Date You Entered into Marriage with Current Spouse (mm/dd/yyyy)</label>
            <div class="col-md-12">
                <input type="date" class="form-control" name="i_290b_additional_info_7b_part_no" value="<?php echo showData('i_290b_additional_info_7b_part_no') ?>">
            </div>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="date" class="form-control" name="i_290b_additional_info_4b_part_no" value="<?php echo showData('i_290b_additional_info_4b_part_no') ?>">
            </div>
        </div>
    </div>
...
<fieldset class="setpage">
    ...
    <div class="form-group">
        ...
        <div class="col-md-3 ">
            <input type="text" class="form-control" maxlength="7" name="postal_code" value="<?php echo showData('') ?>" style="width: 100%; padding: 5px; margin-bottom: 5px;" />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-3 ">
            <input type="text" class="form-control" maxlength="35" name="postal_code" value="<?php echo showData('') ?>" style="width: 100%; padding: 5px; margin-bottom: 5px;" />
        </div>
    </div>
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        ...
        <div class=" col-md-6">
            ...
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7b_part_no" maxlength="10" value="<?php echo showData('i_290b_additional_info_7b_part_no') ?>">
            </div>
        </div>
        <div class=" col-md-6">
            <label class="control-label ">3. Applicant's Email Address (if any)</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7a_page_no" maxlength="38" value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
            </div>
        </div>
    </div>
    <div class="bg-info">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        <div class=" col-md-9">
            ...
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7a_page_no" maxlength="" disabled value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
            </div>
        </div>
        <div class=" col-md-3">
            <label class="control-label " style="margin-left: 15px;">Date of Signature (mm/dd/yyyy)</label>
            <div class="col-md-12">
                <input type="date" class="form-control" name="i_290b_additional_info_7b_part_no" maxlength="" value="<?php echo showData('i_290b_additional_info_7b_part_no') ?>">
            </div>
        </div>
    </div>
    <input type="button" name="previous" class="previous btn btn-default" value="Previous" />
...
<fieldset class="setpage">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        <div class=" col-md-6">
            ...
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7a_page_no" maxlength="43" value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
            </div>
        </div>
        <div class=" col-md-6">
            <label class="control-label " style="margin-left: 15px;">Interpreter's Given Name (First Name)</label>
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7b_part_no" maxlength="42" value="<?php echo showData('i_290b_additional_info_7b_part_no') ?>">
            </div>
        </div>
        <div class=" col-md-6">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" name="i_290b_additional_info_7a_page_no" maxlength="18" value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
        </div>
...
<fieldset class="setpage">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        ...
        <div class=" col-md-4">
            ...
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7a_page_no" maxlength="22" value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <textarea name="i_864_additional_info_5d" class="form-control" maxlength="255" cols="30" rows="10"><?php echo showData('i_864_additional_info_5d') ?></textarea>
            </div>
        </div>
        <div class="d-flexible">
            <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <textarea name="i_864_additional_info_6d" class="form-control" maxlength="256" cols="30" rows="10"><?php echo showData('i_864_additional_info_6d') ?></textarea>
            </div>
        </div>
        <div class="d-flexible">
            <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <textarea class="form-control" name="i_864_additional_info_7d" maxlength="341" class="form-control" cols="30" rows="10"><?php echo showData('i_864_additional_info_7d') ?></textarea>
            </div>
        </div>
        <div class="d-flexible">
            <div class="form-group">
...
<fieldset class="setpage">
    ...
    <div class="row form-group" style="margin-bottom: 20px;">
        <div class=" col-md-8">
            ...
            <div class="col-md-12">
                <input type="text" class="form-control" name="i_290b_additional_info_7a_page_no" maxlength="83" value="<?php echo showData('i_290b_additional_info_7a_page_no') ?>">
            </div>
    ...
    <div class="row" style="margin-bottom: 20px">
        ...
        <div class=" col-md-4">
            <div class="col-md-12">
                ...
                <input type="date" class="form-control" name="" maxlength="6" value="<?php echo showData('') ?>">
            </div>
        </div>
    </div>
