        ...
        <tbody>
            <tr>
                ...
                <td style="padding: 5px">
                    <p>Attorney State Bar Number (if applicable)</p><input type="text" class="form-control" maxlength="22" style="margin-top:30px" value="">
                </td>
                <td style="padding: 5px">
                    <p>Attorney or Accredited Representative USCIS Online Account Number (if any)</p><input maxlength="12" type="text" class="form-control" value="">
                </td>
            </tr>
            <!-- <tr>
                <td style="padding: 5px"><label class="control-label"><?php echo createCheckbox("i_290b_g_28_box") ?> Fill in box if G-28 is attached to represent the applicant.</label></td>
...
<fieldset class="setpage">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="text" maxlength="39" class="form-control" name=" " value="<?php echo showData('i_290b_appeal_or_motion_uscis_form_no') ?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-12">3. Receipt Number for the Application or Petition</label>
            <div class="col-md-12">
                <input type="text" maxlength="34" class="form-control" name="" value="<?php echo showData('i_290b_appeal_or_motion_receipt_number') ?>" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-12">
                <input type="text" maxlength="39" class="form-control" name="" value="<?php echo showData('i_290b_appeal_or_motion_nonimmigrant_or_immigrant') ?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-12">5. Date of the Adverse Decision (mm/dd/yyyy)</label>
            <div class="col-md-6 col-md-offset-6">
                <input type="date" class="form-control" name="" maxlength="38" value="<?php echo showData('i_290b_appeal_or_motion_adverse_decision_date') ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-12">
                <select class="form-control" name="i_290b_appeal_or_motion_adverse_decision">
                    ...
                    <!----------------------------------------------------------NOTE : The varial will be placed here-------------------------------------->
                    <?php
                    foreach ($demoData as $record) {
                        if ($record->state_code == showData('i_290b_appeal_or_motion_adverse_decision')) $selected = "selected";
                        else $selected = "";
                        echo "<option value='$record->state_code' $selected>$record->state_code</option>";
                    }
                    ?>
