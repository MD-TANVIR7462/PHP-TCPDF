...
<fieldset class="setpage">
    ...
    <table style="border-collapse: collapse">
        ...
        <tbody>
            <tr>
                <td style="padding: 5px"><?php echo createCheckbox("i_102_g28_checkbox")?> Fill in box if G-28 is attached to represent the applicant.</td>
                <td style="padding: 5px"><p>Attorney State Bar Number (if applicable)</p><input type="text" class="form-control" style="margin-top:30px" value="" ></td>
                <td style="padding: 5px"><p>Attorney or Accredited Representative USCIS Online Account Number (if any)</p><input type="text" class="form-control" value="" ></td>
                <!-- <td style="padding: 5px"><p>Attorney State Bar Number (if applicable)</p><input type="text" class="form-control" value="<?php echo $attorneyData->bar_number?>" ></td>
                <td style="padding: 5px"><p>Attorney or Accredited Representative USCIS Online Account Number (if any)</p><input type="text" class="form-control" value="<?php echo $attorneyData->bar_number?>" ></td> -->
            </tr>
        </tbody>
    </table>
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="col-md-12 ">
                    ...
                    I,<input type="text" class="form-control" maxlength="9" name="other_information_about_you_alien_registration_number" value="<?php echo showData('other_information_about_you_alien_registration_number')?>"><span style="font-size:20px; ">,</span>
                    </div>
                </div>
                <h5 style="padding-left:30px">am the sponsor submitting this affidavit of support because (Select only one box):</h5>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-11"><input type="text" class="form-control" maxlength="9" name="other_information_about_you_alien_registration_number" value="<?php echo showData('other_information_about_you_alien_registration_number')?>"></div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">1.c. <?php echo createCheckbox("i_102_p2_1b_form_i_95_status")?> 
                I have an ownership interest of at least 5 percent in</label>
                <div class="col-md-11"><input type="text" class="form-control" maxlength="9" name="other_information_about_you_alien_registration_number" value="<?php echo showData('other_information_about_you_alien_registration_number')?>"></div>
                <h5 class="col-md-12" >am the sponsor submitting this affidavit of support because (Select only one box):</h5>
                <div class="col-md-11"><input type="text" class="form-control" maxlength="9" name="other_information_about_you_alien_registration_number" value="<?php echo showData('other_information_about_you_alien_registration_number')?>"></div>
            </div>
            <div class="form-group">
                <label class="control-label ">1.d. <?php echo createCheckbox("i_102_p2_1b_form_i_95_status")?>I am the only joint sponsor.</label>
            </div>
            <div class="form-group">
                <label class="control-label ">1.d. <?php echo createCheckbox("i_102_p2_1b_form_i_95_status")?>I am the</label>
                <label class="control-label " style="margin-left:10px"><?php echo createCheckbox("i_102_p2_1b_form_i_95_status")?>first</label>
                <label class="control-label " style="margin-left:10px"><?php echo createCheckbox("i_102_p2_1b_form_i_95_status")?>second of two joint sponsors.</label>    
            </div>
