...
if(showData('marital_status')=="Single") $single_checked = "checked"; else $single_checked = "";
if(showData('marital_status')=="Married") $married_checked = "checked"; else $married_checked = "";
if(showData('marital_status')=="Divorced") $divorced_checked = "checked"; else $divorced_checked = "";
if(showData('marital_status')=="Widowed") $widowed_checked = "checked"; else $widowed_checked = "";
if(showData('marital_status')=="Separeted") $separeted_checked = "checked"; else $separeted_checked = "";
if(showData('marital_status')=="Annulled") $annulled_checked = "checked"; else $annulled_checked = "";
$html ='
...
var fields = {
	...
	'date_of_birth':' ".showData('dob')."',
	'date_law_full_resident':' ".showData('residence_date')."',
	...
	'part5_information_to_contact_you_date_from':' ".showData('address_dates')[0]."',
	...
	'part5_c_information_to_contact_you_date_from':' ".showData('address_dates')[1]."',
