...
$html ='<input type="checkbox"  name="g28box" value="1" checked=" " />';
...
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Apt1" value="Apt1" checked="" />';
...
//
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Ste1" value="Ste1" checked="" />';
...
//
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Flr1" value="Flr1" checked="" />';
...
// //
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="gender" value="male" checked=" " />';
...
// //
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="gender" value="female" checked=" " />';
...
//...............image .............
$pdf->Image('images/right_angle.jpg', 66.5, 136, 4, 4, 'JPG', '', '', true, 150, '', false, false, 0, false, false, false);
$pdf->Image('images/right_angle.jpg', 66.5, 161, 4, 4, 'JPG', '', '', true, 150, '', false, false, 0, false, false, false);
$pdf->Image('images/right_angle.jpg', 165, 178, 4, 4, 'JPG', '', '', true, 150, '', false, false, 0, false, false, false);
//.....
...
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Apt2" value="Apt2" checked="" />';
...
//
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Ste2" value="Ste2" checked="" />';
...
//
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Flr2" value="Flr2" checked="" />';
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part_3_processing_info_4c', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 47);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part_3_processing_info_4c', 71, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 33, 56);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part_3_processing_info_4c', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 43, 71);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part_3_processing_info_4c', 71, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 33, 80);
...
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Apt3" value="Apt3" checked="" />';
...
//
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Ste3" value="Ste3" checked="" />';
...
//
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Flr3" value="Flr3" checked="" />';
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part3_daytime_phone', 12, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 158.2, 102.5);
$pdf->TextField('part3_daytime_phone', 12, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 173.5, 102.5);
$pdf->TextField('part3_daytime_phone', 14, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 189, 102.5);
...
$pdf->TextField('part_4_1a', 82.7, 27, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('part_4_1a')),21, 138);
$pdf->setCellHeightRatio( 1.1 );
...
$pdf->setFont('courier', 'B', 10);
$pdf->setCellHeightRatio( 1.8 );
$pdf->TextField('part_4_1b', 81.7, 27, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('part_4_1b')),121, 138);
$pdf->setCellHeightRatio( 1.1 );
...
$pdf->SetFont('times', '', 10);
$html ='<input type="checkbox" name="part5_1c" value="1" checked=" " />';
...
$pdf->SetFont('times', '', 10);
$html ='<input type="checkbox" name="part5_1e" value="1" checked=" " />';
...
$pdf->SetFont('times', '', 10);
$html ='<input type="checkbox" name="part5_1f" value="1" checked=" " />';
...
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Apt4" value="Apt4" checked="" />';
...
//
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Ste4" value="Ste4" checked="" />';
...
//
$pdf->SetFont('times', '', 14); 
$html= '<input type="checkbox" name="Flr4" value="Flr4" checked="" />';
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part3_daytime_phone', 12, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 158.2, 179.7);
$pdf->TextField('part3_daytime_phone', 12, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 173.5, 179.7);
$pdf->TextField('part3_daytime_phone', 14, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 189, 179.7);

// $pdf->SetFont('courier', 'B', 10); // set font
// $pdf->TextField('part7_4j_daytime_phone', 45, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 157, 180);
...
$pdf->SetFont('times', '', 10);
$html ='<div><input type="checkbox" name="part8_1" value="Y" checked=" "/>  Yes  <input type="checkbox" name="part8_1" value="N" checked=" "/> No </div>';
...
that U.S. Citizenship and Immigration Services needs<br>
to determine eligibility for the benefit I am seeking.</div>';
$pdf->writeHTMLCell(85, 7, 18, 33, $html, 0, 1, false, true, 'L', true);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part9_2_daytime_phone', 47, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 157, 42);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part10_daytime_phone_code', 50, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 118, 95);

$pdf->TextField('part10_daytime_phone_extension', 15, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 180, 95);
//............
$pdf->setFont('Times', '', 10);
...
//page 2 part 2....
    'part_2_application_2a':' ',
    'part_2_application_2b':' ',
    'part_2_application_2c':' ',
    'part_2_application_2d':' ',
    'part_2_application_2e':' ',
    'part_2_application_2f':' ',
    'part_2_application_2g1':' ',
    'part_2_application_2g2':' ',
    'part_2_application_2g3':' ',
//page 2 part 3.....
    'part_3_processing_info_3b':' ',
    'part_3_processing_info_4b':' ',
    'part_3_processing_info_4c':' ',
