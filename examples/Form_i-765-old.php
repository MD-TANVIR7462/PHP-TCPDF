...
// $pdf->writeHTMLCell(58, 6, 139, 97.5, $html, 0, 1, false, true, 'J', 0);
...
//...........
$pdf->SetFont('times', '', 11); // set font
$html= '<div><b>7.b. </b>&nbsp;<input type="checkbox" name="Apt2" value="Apt" checked="" /> Apt. &nbsp;&nbsp;<input type="checkbox" name="Ste2" value="Ste" checked="" /> Ste. <input type="checkbox" name="Flr2" value="Flr" checked="" /> Flr.</div>';
...
$pdf->writeHTMLCell(90, 5, 13, 26, $html, 0, 1, true, false, 'J', true);
//..........
$pdf->SetFont('times', '', 10);
