...
$pdf->SetFont('courier', '', 10); // set font
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_city_town_birth', 83.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 19.5, 55);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('information_about_you_country_birth',  83.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 19.5, 68);
//...........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('mother_name_first_name', 63, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 40, 87);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('father_name_first_name', 63, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 40, 104);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('date_of_admission', 38, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 65, 131);
//............
...
$pdf->writeHTMLCell(90, 7, 20, 155, $html, 0, 1, false, true, 'J', true);
//............

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('process_info_city_town', 85.3, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 160);
//............
...
//...........
$pdf->writeHTMLCell(90, 7, 146, 78, "<div>Feet</div>", 0, 0, false, true, 'J', true);
$html = '<div>
...
$pdf->SetFont('courier', 'B', 10);
$pdf->writeHTMLCell(90, 7, 154, 78, $html, 0, 0, false, true, 'J', true);
//..........
$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(90, 7, 174, 78, "<div>Inches</div>", 0, 0, false, true, 'J', true);
$html1 = '<div>
...
$pdf->writeHTMLCell(90, 7, 185, 78, $html1, 0, 0, false, true, 'J', true);
//..........
$pdf->SetFont('times', '', 10);

$html = '<div><b>9.</b>&nbsp;&nbsp;&nbsp;&nbsp;Weight</div>';
$pdf->writeHTMLCell(90, 7, 113, 85, $html, 0, 0, false, true, 'J', true);
$pdf->writeHTMLCell(90, 7, 170, 86, "Pounds", 0, 0, false, true, 'J', true);
//...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('processing_info_pound1', 5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 184, 86);
$pdf->TextField('processing_info_pound2', 5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 191, 86);
$pdf->TextField('processing_info_pound3', 5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 198, 86);
...
$html = '<div><input type="checkbox" name="blue" value="blue" checked="' . $bio_eye_blue . '"/> Blue<br><br><input type="checkbox" name="green " value="green" checked="' . $bio_eye_green . '"/> Green<br><br><input type="checkbox" name="pink" value="pink" checked="' . $bio_eye_pink . '"/> Pink </div>';
$pdf->writeHTMLCell(90, 7, 145, 99, $html, 0, 0, false, true, 'J', true);
$html = '<div><input type="checkbox" name="brown" value="brown" checked="' . $bio_eye_brown . '"/> Brown <br><br><input type="checkbox" name="hazel " value="hazel" checked="' . $bio_eye_hazel . '"/> Hazel <br><br><input type="checkbox" name="unknown" value="unknown" checked="' . $bio_eye_unk . '" /> Unknown/Other </div>';
$pdf->writeHTMLCell(90, 7, 171, 99, $html, 0, 0, false, true, 'J', true);

//......
$pdf->SetFont('times', '', 10);
$html = '<div><b>11.    </b>  Hair Color (Select <b>only one</b> box )  </div>';
$pdf->writeHTMLCell(90, 7, 113, 120, $html, 0, 0, false, true, 'J', true);
...
//......
$html = '<div><input type="checkbox" name="blad" value="blad" checked="' . $bio_hair_bald . '"/> Blad(No hair) <br><br><input type="checkbox" name="Brown1 " value="Brown" checked="' . $bio_hair_brown . '"/> Brown <br><br><input type="checkbox" name=" sandy" value=" sandy" checked="' . $bio_hair_sandy . '"/> Sandy<br></div>';
$pdf->writeHTMLCell(90, 7, 119, 126, $html, 0, 0, false, true, 'J', true);
$html = '<div><input type="checkbox" name="black1" value="black" checked="' . $bio_hair_black . '"/> Black<br><br><input type="checkbox" name="gray1 " value="gray" checked="' . $bio_hair_gray . '"/> Gray<br><br><input type="checkbox" name="white" value="white" checked="' . $bio_hair_white . '"/>  White</div>';
$pdf->writeHTMLCell(90, 7, 145, 126, $html, 0, 0, false, true, 'J', true);
$html = '<div><input type="checkbox" name="blond" value="blond" checked="' . $bio_hair_blond . '"/> Blond <br><br><input type="checkbox" name="red " value="red" checked="' . $bio_hair_red . '"/> Red <br><br><input type="checkbox" name="unknown1" value="unknown" checked="' . $bio_hair_unk . '"/> Unknown/Other </div>';
$pdf->writeHTMLCell(90, 7, 171, 126, $html, 0, 0, false, true, 'J', true);
//............
...
$pdf->writeHTMLCell(90, 6, 114, 149, $html, 1, 1, true, false, 'L', true);
// //...........
...
$pdf->writeHTMLCell(85, 7, 113, 170, $html, 0, 1, false, true, 'J', true);
// //............
...
$pdf->writeHTMLCell(85, 7, 113, 180, $html, 0, 1, false, true, 'J', true);
// //............
...
$pdf->writeHTMLCell(90, 7, 178, 186, $html, 0, 1, false, true, 'J', true);
// //..........
...
$pdf->writeHTMLCell(80, 7, 114, 192, $html, 0, 1, false, true, 'J', true);
//............
...
$pdf->writeHTMLCell(90, 7, 113, 200, $html, 0, 1, false, true, 'J', true);
//............
...
$pdf->writeHTMLCell(80, 7, 126, 200, $html, 0, 1, false, true, 'J', true);
// //............

$pdf->SetFont('courier', 'B', 10);
$pdf->setCellHeightRatio(1.8);
$pdf->TextField('accommodations_for_individuals_1a', 77, 25, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 0, 'borderStyle' => 'solid'), array('v' => showData('i_90_accomodation_1a_deaf_hard_text_value')), 126, 218);
...
sheet of paper. Include your name and A -Number (if any) at<br>
the top of each sheet; indicate the <b>Page Number, Part</b><br>
<b>Number,</b>and <b>Item Number</b> to which your answer refers; and<br>
sign and date each sheet.</div>';
$pdf->writeHTMLCell(110, 7, 12, 23, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('times', 'B', 10.5);
$html = '<div><i><b>Your Full Name</b></i></div>';
$pdf->writeHTMLCell(91, 6, 13, 58, $html, "", '', true, false, 'L', true);
$pdf->setCellHeightRatio(1.1);
$pdf->SetFont('times', '', 10);
$html = '<div><b>1.a.</b>&nbsp;&nbsp;&nbsp;&nbsp;Family Name <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Last Name) </div>';
$pdf->writeHTMLCell(90, 7, 12, 64, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_info_family_last_name', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 43, 66);
//.......
$pdf->SetFont('times', '', 10);
$html = '<div><b>1.b.&nbsp;&nbsp;&nbsp;&nbsp;</b>Given Name <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(First Name) </div>';
$pdf->writeHTMLCell(90, 7, 12, 73, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_info_given_first_name', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 43, 74.5);
//.........
$pdf->SetFont('times', '', 10);
$html = '<div><b>1.c.&nbsp;&nbsp;&nbsp;&nbsp;</b>Middle Name  </div>';
$pdf->writeHTMLCell(90, 7, 12, 83, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_info_middle_name', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 43, 83);
//..........
$pdf->SetFont('times', '', 10);
$html = '<div><b>2.  </b>  &nbsp;&nbsp;&nbsp;&nbsp;A-Number  (if any)  </div>';
$pdf->writeHTMLCell(90, 7, 12, 90, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('times', '', 11);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_info_a_number', 46, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 57.9, 94);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_info_page_number', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22, 107);
//.............
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.b.</b> &nbsp;&nbsp;Part Number</div>';
$pdf->writeHTMLCell(90, 7, 45, 102, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_info_part_number', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 54, 107);
//............
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.c.</b> &nbsp;&nbsp;Item Number</div>';
$pdf->writeHTMLCell(90, 7, 75, 102, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_info_item_number', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 84, 107);
...
$pdf->TextField('i_90_additional_info_3d', 82.5, 64, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_90_additional_info_3d')), 21.5, 116);
$pdf->setCellHeightRatio(1.2);
...
$pdf->TextField('i_90_additional_info_4d', 82.5, 64, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_90_additional_info_4d')), 21.5, 194);
$pdf->setCellHeightRatio(1.2);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_90_additional_info_5d', 82, 64, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_90_additional_info_5d')), 122.5, 31);
$pdf->setCellHeightRatio(1.2);
//...........
...
$pdf->TextField('i_90_additional_info_6d', 82.5, 64, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_90_additional_info_6d')), 121.5, 116);
$pdf->setCellHeightRatio(1.2);
//............
$pdf->SetFont('times', '', 10);
...
$pdf->TextField('i_90_additional_info_7d', 82.5, 58, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_90_additional_info_7d')), 121.5, 194);
...
var fields = {
    ...
    'additional_info_a_number':' " . showData('i_90_additional_info_a_number') . "',
