...
//..........
if (showData('information_about_you_eligibility_provision_status') == "Y") $checked_a = "checked";
else $checked_a = "";
if (showData('information_about_you_eligibility_us_citizen_status') == "Y") $checked_b = "checked";
else $checked_b = "";
if (showData('information_about_you_eligibility_vawa_women_act_status') == "Y") $checked_c = "checked";
else $checked_c = "";
if (showData('information_about_you_eligibility_qualified_employment_status') == "Y") $checked_d = "checked";
else $checked_d = "";
if (showData('information_about_you_eligibility_period_of_hostilities_status') == "Y") $checked_e = "checked";
else $checked_e = "";
if (showData('information_about_you_eligibility_member_us_armed_force_status') == "Y") $checked_f = "checked";
else $checked_f = "";
if (showData('information_about_you_eligibility_reason_not_listed_status') == "Y") $checked_g = "checked";
else $checked_g = "";
//.............
$pdf->SetFont('times', '', 14); // set font
$pdf->writeHTMLCell(6, 6, 28, 115.6, '<input type="checkbox" name="a_lawful_permanent_resident_a" value="Y" checked="' . $checked_a . '"  />', 0, 1, false, false, 'L', true);
$pdf->writeHTMLCell(6, 6, 28, 122.6, '<input type="checkbox" name="a_lawful_permanent_resident_b" value="Y" checked="' . $checked_b . '" />', 0, 1, false, false, 'L', true);
$pdf->writeHTMLCell(6, 6, 28, 129.6, '<input type="checkbox" name="a_lawful_permanent_resident_c" value="Y" checked="' . $checked_c . '" />', 0, 1, false, false, 'L', true);
$pdf->writeHTMLCell(6, 6, 28, 140,   '<input type="checkbox" name="a_lawful_permanent_resident_d" value="Y" checked="' . $checked_d . '" />', 0, 1, false, false, 'L', true);
$pdf->writeHTMLCell(6, 6, 28, 174.6, '<input type="checkbox" name="a_lawful_permanent_resident_e" value="Y" checked="' . $checked_e . '" />', 0, 1, false, false, 'L', true);
$pdf->writeHTMLCell(6, 6, 28, 184.6, '<input type="checkbox" name="a_lawful_permanent_resident_f" value="Y" checked="' . $checked_f . '" />', 0, 1, false, false, 'L', true);
$pdf->writeHTMLCell(6, 6, 28, 195.6, '<input type="checkbox" name="a_lawful_permanent_resident_g" value="Y" checked="' . $checked_g . '" />', 0, 1, false, false, 'L', true);
//..........
$pdf->SetFillColor(220, 220, 220);
...
$pdf->writeHTMLCell(43, 0, 161, 19.5, showData('n_400_a_number'), 1, 1, false, false, 'L', true);
//...............
$pdf->SetFont('times', '', 10);
...
if (showData('information_about_you_legally_change_name_status') == "Y") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="legally_change_your_name" value="Y" checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 0, 138, 39, $html, 0, 1, false, false, 'L', false);
if (showData('information_about_you_legally_change_name_status') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="legally_change_your_name" value="N" checked="' . $checked . '" />';
...
//.............
$pdf->SetFont('times', '', 14);
if (showData('other_information_about_you_gender') == "male") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 0, 98, 70, '<input type="checkbox" name="Male" value="male" checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
if (showData('other_information_about_you_gender') == "female") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 0, 115, 70, '<input type="checkbox" name="Female" value="female" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('other_information_about_you_gender') == "another_gender") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 0, 135, 70, '<input type="checkbox" name="Another" value="Another" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('information_about_you_civics_for_naturalization_status') == "Y") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="requirements_for_naturalizaion" value="Y" checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 1, 172, 158, $html, 0, 1, false, false, 'L', false);
if (showData('information_about_you_civics_for_naturalization_status') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="requirements_for_naturalizaion" value="N" checked="' . $checked . '" />';
...
$pdf->SetFont('times', '', 14);
if (showData('information_about_you_ssa_naturalizd_status') == "Y") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="immigration_status_SSA" value="Y" checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 1, 19.3, 208.5, $html, 0, 1, false, false, 'L', false);
if (showData('information_about_you_ssa_naturalizd_status') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="immigration_status_SSA" value="N" checked="' . $checked . '" />';
...
$pdf->SetFont('times', '', 14);
if (showData('information_about_you_consent_for_disclosure_status') == "Y") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="consent_for_disclosure" value="Y" checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 1, 172, 233, $html, 0, 1, false, false, 'L', false);
if (showData('information_about_you_consent_for_disclosure_status') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="consent_for_disclosure" value="N" checked="' . $checked . '" />';
...
$pdf->writeHTMLCell(5, 1, 21, 54, '<input type="checkbox" name="p3_race1" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_race_asian') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 58, 54, '<input type="checkbox" name="p3_race2" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_race_black_african') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 78, 54, '<input type="checkbox" name="p3_race3" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_race_native_islander') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 115, 54, '<input type="checkbox" name="p3_race4" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_race_white') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 158, 54, '<input type="checkbox" name="p3_race5" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//.........
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(5, 1, 21, 80, '<input type="checkbox" name="p3_eye_color_status1" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_eye_color') == "blue") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 42, 80, '<input type="checkbox" name="p3_eye_color_status2" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_eye_color') == "brown") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 60, 80, '<input type="checkbox" name="p3_eye_color_status3" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_eye_color') == "gray") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 80, 80, '<input type="checkbox" name="p3_eye_color_status4" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_eye_color') == "green") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 100, 80, '<input type="checkbox" name="p3_eye_color_status5" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_eye_color') == "hazel") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 120, 80, '<input type="checkbox" name="p3_eye_color_status6" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_eye_color') == "marron") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 140, 80, '<input type="checkbox" name="p3_eye_color_status7" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_eye_color') == "pink") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 160, 80, '<input type="checkbox" name="p3_eye_color_status8" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_eye_color') == "unknown") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 176, 80, '<input type="checkbox" name="p3_eye_color_status9" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..................
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(5, 1, 21, 93, '<input type="checkbox" name="p3_hair_color_status1" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_hair_color') == "black") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 42, 93, '<input type="checkbox" name="p3_hair_color_status2" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_hair_color') == "blond") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 60, 93, '<input type="checkbox" name="p3_hair_color_status3" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_hair_color') == "brown") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 80, 93, '<input type="checkbox" name="p3_hair_color_status4" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_hair_color') == "gray") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 100, 93, '<input type="checkbox" name="p3_hair_color_status5" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_hair_color') == "red") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 120, 93, '<input type="checkbox" name="p3_hair_color_status6" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_hair_color') == "sandy") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 140, 93, '<input type="checkbox" name="p3_hair_color_status7" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_hair_color') == "white") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 160, 93, '<input type="checkbox" name="p3_hair_color_status8" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('biographic_info_hair_color') == "unknown") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 176, 93, '<input type="checkbox" name="p3_hair_color_status9" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//.................
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(5, 1, 158, 162.3, '<input type="checkbox" name="p4_apt" value="apt"   checked="' . $checked_apt . '" />', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 166, 162.3, '<input type="checkbox" name="p4_ste" value="ste"   checked="' . $checked_ste . '"/>', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 174, 162.3, '<input type="checkbox" name="p4_flr" value="flr"   checked="' . $checked_flr . '"/>', 0, 1, false, false, 'L', false);
//...............
$pdf->SetFont('times', '', 10);
...
//.............
$pdf->SetFont('times', '', 14);
if (showData('information_about_you_residence_curren_mailing_status') == "Y") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p4_2_physical_address_status" value="Y" checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 1, 20, 258, $html, 0, 1, false, false, 'L', false);
if (showData('information_about_you_residence_curren_mailing_status') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p4_2_physical_address_status" value="N"  checked="' . $checked . '" />';
...
//...............
$pdf->SetFont('times', 'B', 14);
if (showData('information_about_you_residence_mailing_apt_ste_flr') == "apt") $checked_apt = "checked";
else $checked_apt = "";
if (showData('information_about_you_residence_mailing_apt_ste_flr') == "ste") $checked_ste = "checked";
else $checked_ste = "";
if (showData('information_about_you_residence_mailing_apt_ste_flr') == "flr") $checked_flr = "checked";
else $checked_flr = "";
$pdf->writeHTMLCell(5, 1, 158, 51.5, '<input type="checkbox" name="p4_apt2" value="apt"  checked="' . $checked_apt . '"  />', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 166, 51.5, '<input type="checkbox" name="p4_ste2" value="ste"  checked="' . $checked_ste . '" />', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 174, 51.5, '<input type="checkbox" name="p4_flr2" value="flr"  checked="' . $checked_flr . '" />', 0, 1, false, false, 'L', false);
//...............
$pdf->SetFontSize(11.6);
...
if (showData('other_information_about_you_marital_status') == "divorced") $checked_divorced = "checked";
...
if (showData('other_information_about_you_marital_status') == "separated") $checked_separated = "checked";
else $checked_separated = "";
if (showData('other_information_about_you_marital_status') == "annulled") $checked_annulled = "checked";
else $checked_annulled = "";

$pdf->writeHTMLCell(5, 1, 20, 104, '<input type="checkbox" name="p5_maritial_status_1" value="Y"  checked="' . $checked_single . '" />', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 62, 104, '<input type="checkbox" name="p5_maritial_status_2" value="Y"  checked="' . $checked_married . '"/>', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 83, 104, '<input type="checkbox" name="p5_maritial_status_3" value="Y"  checked="' . $checked_divorced . '"/>', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 105, 104, '<input type="checkbox" name="p5_maritial_status_4" value="Y" checked="' . $checked_widowed . '" />', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 127, 104, '<input type="checkbox" name="p5_maritial_status_5" value="Y" checked="' . $checked_separated . '" />', 0, 1, false, false, 'L', false);
$pdf->writeHTMLCell(5, 1, 150, 104, '<input type="checkbox" name="p5_maritial_status_6" value="Y" checked="' . $checked_annulled . '" />', 0, 1, false, false, 'L', false);
//.................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
$html = '<input type="checkbox" name="p5_2_status" value="Y"  checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 1, 172, 117, $html, 0, 1, false, false, 'L', false);
if (showData('other_information_about_you_marital_spouse_armed_force_status') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p5_2_status" value="N"  checked="' . $checked . '" />';
...
$pdf->SetFont('times', '', 14);
if (showData('current_spouse_physical_address_status') == "Y") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p5_4d_status" value="Y"  checked="' . $checked . '"/>';
$pdf->writeHTMLCell(5, 1, 18.2, 225, $html, 0, 1, false, false, 'L', false);
if (showData('current_spouse_physical_address_status') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p5_4d_status" value="N"  checked="' . $checked . '"/>';
...
$html = '<input type="checkbox" name="p5_5a_status" value="Y" checked="' . $checked . '" />';
...
//.............
$pdf->SetFont('times', '', 14);
if (showData('child_support_status') == "Y") $checked = "checked";
else $checked = "";

$html = '<input type="checkbox" name="p6_suppor_1" value="Y" checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 0, 176, 143.3, $html, 0, 1, false, false, 'L', false);
if (showData('child_support_status') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p6_suppor_1" value="N" checked="' . $checked . '" />';
...
if (showData('child_support_status2') == "Y") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p6_suppor_2" value="Y" checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 0, 176, 153.3, $html, 0, 1, false, false, 'L', false);
if (showData('child_support_status2') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p6_suppor_2" value="N" checked="' . $checked . '" />';
...
//.............
$pdf->SetFont('times', '', 14);
if (showData('child_support_status3') == "Y") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p6_suppor_3" value="Y" checked="' . $checked . '" />';
$pdf->writeHTMLCell(5, 0, 176, 163.3, $html, 0, 1, false, false, 'L', false);
if (showData('child_support_status3') == "N") $checked = "checked";
else $checked = "";
$html = '<input type="checkbox" name="p6_suppor_3" value="N" checked="' . $checked . '" />';
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_us_citizen_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 141.5, '<input type="checkbox" name="p9_1_status" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_us_citizen_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 141.5, '<input type="checkbox" name="p9_1_status" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_vote_federal_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 149, '<input type="checkbox" name="p9_2_status" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_vote_federal_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 149, '<input type="checkbox" name="p9_2_status" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//...................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_local_taxes_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 161.5, '<input type="checkbox" name="p9_3_status" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_local_taxes_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 161.5, '<input type="checkbox" name="p9_3_status" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_permanent_resident_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 169, '<input type="checkbox" name="p9_4_status" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_permanent_resident_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 169, '<input type="checkbox" name="p9_4_status" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//...........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_communist_or_totalitarain_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 188, '<input type="checkbox" name="p9_5a_status" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_communist_or_totalitarain_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 188, '<input type="checkbox" name="p9_5a_status" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_advocated_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 198, '<input type="checkbox" name="p9_5b_status" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_advocated_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 198, '<input type="checkbox" name="p9_5b_status" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//...........
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(5, 1, 175.5, 36, '<input type="checkbox" name="p9_6a_staus" value="Y"    checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
if (showData('additional_info_damage_property_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 36, '<input type="checkbox" name="p9_6a_staus" value="N"    checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(5, 1, 175.5, 52.6, '<input type="checkbox" name="p9_6c_staus" value="Y"    checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
if (showData('additional_info_attempted_planned_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 52.6, '<input type="checkbox" name="p9_6c_staus" value="N"    checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
//...........
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(5, 1, 175.5, 70.6, '<input type="checkbox" name="p9_7a_staus" value="Y"    checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
if (showData('additional_info_torture_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 70.6, '<input type="checkbox" name="p9_7a_staus" value="N"    checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(5, 1, 175.5, 77.6, '<input type="checkbox" name="p9_7b_staus" value="Y"    checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
if (showData('additional_info_genocide_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 77.6, '<input type="checkbox" name="p9_7b_staus" value="N"    checked="' . $checked . '"  />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_commit_a_crime_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 114, '<input type="checkbox" name="p9_15a_staus" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_commit_a_crime_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 114, '<input type="checkbox" name="p9_15a_staus" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_arrested_offense_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 123, '<input type="checkbox" name="p9_15b_staus" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_arrested_offense_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 123, '<input type="checkbox" name="p9_15b_staus" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_probation_or_parole_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 224, '<input type="checkbox" name="p9_16_staus" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_probation_or_parole_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 224, '<input type="checkbox" name="p9_16_staus" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..............
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_engaged_in_prostitution_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 33, '<input type="checkbox" name="p9_17a" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_engaged_in_prostitution_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 33, '<input type="checkbox" name="p9_17a" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_manufactured_foreign_country_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 44, '<input type="checkbox" name="p9_17b" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_manufactured_foreign_country_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 44, '<input type="checkbox" name="p9_17b" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_married_more_than_one_person_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 58, '<input type="checkbox" name="p9_17c" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_married_more_than_one_person_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 58, '<input type="checkbox" name="p9_17c" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_immiagration_benefit_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 65, '<input type="checkbox" name="p9_17d" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_immiagration_benefit_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 65, '<input type="checkbox" name="p9_17d" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_us_illegally_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 72, '<input type="checkbox" name="p9_17e" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_us_illegally_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 72, '<input type="checkbox" name="p9_17e" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_gambled_illegal_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 79.6, '<input type="checkbox" name="p9_17f" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_gambled_illegal_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 79.6, '<input type="checkbox" name="p9_17f" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_pay_alimony_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 86.5, '<input type="checkbox" name="p9_17g" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_pay_alimony_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 86.5, '<input type="checkbox" name="p9_17g" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_public_benefit_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 95.6, '<input type="checkbox" name="p9_17h" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_public_benefit_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 95.6, '<input type="checkbox" name="p9_17h" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_fraudulent_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 103, '<input type="checkbox" name="p9_18" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_fraudulent_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 103, '<input type="checkbox" name="p9_18" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_government_official_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 113, '<input type="checkbox" name="p9_19" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_government_official_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 113, '<input type="checkbox" name="p9_19" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_removal_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 138, '<input type="checkbox" name="p9_20" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_removal_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 138, '<input type="checkbox" name="p9_20" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_deported_us_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 145, '<input type="checkbox" name="p9_21" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_deported_us_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 145, '<input type="checkbox" name="p9_21" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_born_as_male_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 162, '<input type="checkbox" name="p9_22a" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_born_as_male_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 162, '<input type="checkbox" name="p9_22a" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_selective_service_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 171.5, '<input type="checkbox" name="p9_22b" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_selective_service_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 171.5, '<input type="checkbox" name="p9_22b" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_avoid_armed_force_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 212.5, '<input type="checkbox" name="p9_23" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_avoid_armed_force_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 212.5, '<input type="checkbox" name="p9_23" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//.........................
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_applied_exemption_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 220.5, '<input type="checkbox" name="p9_24" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_applied_exemption_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 220.5, '<input type="checkbox" name="p9_24" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//.........................
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_served_us_armed_force_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 227.5, '<input type="checkbox" name="p9_25" value="Y"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_served_us_armed_force_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 227.5, '<input type="checkbox" name="p9_25" value="N"   checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//.........................
/******************************
 ******** End Page No 9 *******
 ******************************/
...
$pdf->writeHTMLCell(140, 1, 182, 33.4, $html, 0, 0, false, true, 'L', true);
$pdf->SetFont('times', '', 14);
if (showData('additional_info_currently_member_us_armed_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 33, '<input type="checkbox" name="p9_26a" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_currently_member_us_armed_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 33, '<input type="checkbox" name="p9_26a" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_outside_us_vessel_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 40, '<input type="checkbox" name="p9_26b" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_outside_us_vessel_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 40, '<input type="checkbox" name="p9_26b" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
...
$pdf->writeHTMLCell(140, 1, 182, 58, $html, 0, 0, false, true, 'L', true);
$pdf->SetFont('times', '', 14);
if (showData('additional_info_currently_stationed_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 58, '<input type="checkbox" name="p9_26c" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_currently_stationed_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 58, '<input type="checkbox" name="p9_26c" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_former_us_military_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 64.6, '<input type="checkbox" name="p9_26d" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_former_us_military_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 64.6, '<input type="checkbox" name="p9_26d" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_court_martialed_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 82.6, '<input type="checkbox" name="p9_27" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_court_martialed_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 82.6, '<input type="checkbox" name="p9_27" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_discharged_training_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 92.6, '<input type="checkbox" name="p9_28" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_discharged_training_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 92.6, '<input type="checkbox" name="p9_28" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_deserted_us_armed_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 101.6, '<input type="checkbox" name="p9_29" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_deserted_us_armed_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 101.6, '<input type="checkbox" name="p9_29" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_hereditary_title_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 135.5, 120.6, '<input type="checkbox" name="p9_30a" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_hereditary_title_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 150, 120.6, '<input type="checkbox" name="p9_30a" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//............................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('p9_30b_input_value', 88, 6.7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 38.8, 136);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_inherited_title_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 130.6, '<input type="checkbox" name="p9_30b" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_inherited_title_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 130.6, '<input type="checkbox" name="p9_30b" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//......................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_constitution_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 160.6, '<input type="checkbox" name="p9_31" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_constitution_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 160.6, '<input type="checkbox" name="p9_31" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_allegiance_to_us_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 167.6, '<input type="checkbox" name="p9_32" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_allegiance_to_us_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 167.6, '<input type="checkbox" name="p9_32" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_physical_or_developmental_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 176, '<input type="checkbox" name="p9_33" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_physical_or_developmental_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 176, '<input type="checkbox" name="p9_33" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//..........................
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_willing_allegiance_to_us_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 189, '<input type="checkbox" name="p9_34" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_willing_allegiance_to_us_status') == "N ") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 189, '<input type="checkbox" name="p9_34" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_willing_bear_arms_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 195, '<input type="checkbox" name="p9_35" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_willing_bear_arms_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 195, '<input type="checkbox" name="p9_35" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_noncombatant_service_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 202, '<input type="checkbox" name="p9_36" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_noncombatant_service_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 202, '<input type="checkbox" name="p9_36" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
...
$pdf->SetFont('times', '', 14);
if (showData('additional_info_importance_under_civilian_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 213, '<input type="checkbox" name="p9_37" value="Y" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('additional_info_importance_under_civilian_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 213, '<input type="checkbox" name="p9_37" value="N" checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
...
$pdf->SetFont('times', '', 14);
if (showData('fee_reduction_household_income_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 19, 55, '<input type="checkbox" name="p10_1" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('fee_reduction_household_income_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 19, 62, '<input type="checkbox" name="p10_1" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//............
$pdf->setFont('Times', '', 10);
...
$pdf->SetFont('times', '', 14);
if (showData('fee_reduction_household_head_status') == "Y") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 175.5, 93, '<input type="checkbox" name="p10_5a" value="Y"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
if (showData('fee_reduction_household_head_status') == "N") $checked = "checked";
else $checked = "";
$pdf->writeHTMLCell(5, 1, 189, 93, '<input type="checkbox" name="p10_5a" value="N"  checked="' . $checked . '" />', 0, 1, false, false, 'L', false);
//.......................
$pdf->SetFont('courier', 'B', 10); // set font
...
$pdf->TextField('p14_additional_info_3d', 183, 27, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('n_400_additional_info_2d')), 21, 74);
$pdf->setCellHeightRatio(1.2);
...
$pdf->setCellHeightRatio(1.8);
$pdf->TextField('p14_additional_info_4d', 183, 27, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('n_400_additional_info_3d')), 21, 117.4);
$pdf->setCellHeightRatio(1.2);
...
$pdf->setCellHeightRatio(1.8);
$pdf->TextField('p14_additional_info_5d', 183, 32, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('n_400_additional_info_4d')), 21, 160.4);
$pdf->setCellHeightRatio(1.2);
...
$pdf->setCellHeightRatio(1.8);
$pdf->TextField('p14_additional_info_6d', 183, 32, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('n_400_additional_info_5d')), 21, 207.44);
$pdf->setCellHeightRatio(1.2);
//.................
...
$js = "
var fields = {
	'9_digit_a_number':' " . showData('n_400_a_number') . "',
...
//page 1 end.....
	'legally_change_name_last_name':' " . showData('information_about_you_legally_change_family_last_name') . "',
	'legally_change_name_first_name':' " . showData('information_about_you_legally_change_given_first_name') . "',
	'legally_change_name_middle_name':' " . showData('information_about_you_legally_change_middle_name') . "',
	'p2_4_uscis_online_acount_number':' " . showData('other_information_about_you_uscis_online_account_number') . "',
	'p2_date_of_birth':' " . showData('other_information_about_you_date_of_birth') . "',
	'p2_permanent_resident_date_of_birth':' " . showData('information_about_you_lawful_permanent_resident_date') . "',
	'p2_country_of_birth':' " . showData('other_information_about_you_country_of_birth') . "',
	'p2_country_of_nationality':' " . showData('other_information_about_you_country_of_citizen') . "',
	'p2_Social_Security_number':' " . showData('other_information_about_you_social_security_number') . "',
//page 2 end.....
	'p3_height_feet':' " . showData('biographic_info_height_feet') . "',
	'p3_height_inch':' " . showData('biographic_info_height_inches') . "',
	'p3_Pounds1':' " . showData('biographic_info_weight_in_pound1') . "',
	'p3_Pounds2':' " . showData('biographic_info_weight_in_pound2') . "',
	'p3_Pounds3':' " . showData('biographic_info_weight_in_pound3') . "',
	'p4_1_incare_name':' " . showData('information_about_you_residence_care_of_name') . "',
	'p4_1_street_name':' " . showData('information_about_you_residence_street_number_and_name') . "',
	'p4_1_state_number':' " . showData('information_about_you_residence_apt_ste_flr_value') . "',
	'p4_1_city_town':' " . showData('information_about_you_residence_city_or_town') . "',
    'p4_1_state1':' " . showData('information_about_you_residence_state') . "',
	'p4_1_zip_code':' " . showData('information_about_you_residence_zip') . "',
	'p4_1_province':' " . showData('information_about_you_residence_province') . "',
	'p4_1_postal_code':' " . showData('information_about_you_residence_postal_code') . "',
	'p4_1_country':' " . showData('information_about_you_residence_current_country') . "',
	'p4_date_of_residence_from_date':' " . showData('information_about_you_date_of_residence_from_date') . "',
	'p4_date_of_residence_to_date':' " . showData('information_about_you_date_of_residence_to_date') . "',
	'p4_1_physical_adress_1':' " . showData('information_about_you_residence_street_number', '0') . "',
	'p4_1_physical_adress_2':' " . showData('information_about_you_residence_street_number', '1') . "',
	'p4_1_physical_adress_3':' " . showData('information_about_you_residence_street_number', '2') . "',
	'p4_1_city_town_1':' " . showData('information_about_you_residence_city_town', '0') . "',
	'p4_1_city_town_2':' " . showData('information_about_you_residence_city_town', '1') . "',
	'p4_1_city_town_3':' " . showData('information_about_you_residence_city_town', '2') . "',
	'p4_1_state_province_1':' " . showData('information_about_you_residence_state_province', '0') . "',
	'p4_1_state_province_2':' " . showData('information_about_you_residence_state_province', '1') . "',
	'p4_1_state_province_3':' " . showData('information_about_you_residence_state_province', '2') . "',
	'p4_1_zip_code_1':' " . showData('information_about_you_residence_zip_code', '0') . "',
	'p4_1_zip_code_2':' " . showData('information_about_you_residence_zip_code', '1') . "',
	'p4_1_zip_code_3':' " . showData('information_about_you_residence_zip_code', '2') . "',
	'p4_1_country_1':' " . showData('information_about_you_residence_country', '0') . "',
	'p4_1_country_2':' " . showData('information_about_you_residence_country', '1') . "',
	'p4_1_country_3':' " . showData('information_about_you_residence_country', '2') . "',
	'p4_1_from_date_1':' " . showData('information_about_you_residence_from_date', '0') . "',
	'p4_1_from_date_2':' " . showData('information_about_you_residence_from_date', '1') . "',
	'p4_1_from_date_3':' " . showData('information_about_you_residence_from_date', '2') . "',
	'p4_1_to_date_1':' " . showData('information_about_you_residence_to_date', '0') . "',
	'p4_1_to_date_2':' " . showData('information_about_you_residence_to_date', '1') . "',
	'p4_1_to_date_3':' " . showData('information_about_you_residence_to_date', '2') . "',

//page 3 end..............
	'p4_1_incare_name2':' " . showData('information_about_you_residence_mailing_care_of_name') . "',
	'p4_1_street_name2':' " . showData('information_about_you_residence_mailing_street_number') . "',
	'p4_1_state_number2':' " . showData('information_about_you_residence_mailing_apt_ste_flr_value') . "',
	'p4_1_city_town2':' " . showData('information_about_you_residence_mailing_city_town') . "',
    'p4_1_state2':' " . showData('information_about_you_residence_mailing_state') . "',
	'p4_1_zip_code2':' " . showData('information_about_you_residence_mailing_zip_code') . "',
	'p4_1_province2':' " . showData('information_about_you_residence_mailing_province') . "',
	'p4_1_postal_code2':' " . showData('information_about_you_residence_mailing_postal_code') . "',
	'p4_1_country2':' " . showData('information_about_you_residence_mailing_country') . "',
	'p5_3_how_many_times_married':' " . showData('other_information_about_you_marital_married_number') . "',
	'p5_4a_legal_last_name':' " . showData('current_spouse_family_last_name') . "',
	'p5_4a_legal_first_name':' " . showData('current_spouse_given_first_name') . "',
	'p5_4a_legal_middle_name':' " . showData('current_spouse_family_middle_name') . "',
	'p5_4b_date_of_birth':' " . showData('current_spouse_date_of_birth') . "',
	'p5_4c_current_spouse_date':' " . showData('current_spouse_date_of_marriage') . "',
	'p5_5b_us_citizen_date':' " . showData('current_spouse_us_armed_force') . "',

//page 4 end.......
	'p5_6_a_number':' " . showData('current_spouse_a_number') . "',
	'p5_7_item_number':' " . showData('current_spouse_married') . "',
	'p5_8_current_employer':' " . showData('current_spouse_employer_or_company') . "',
	'p6_1_under_18':' " . showData('total_number_of_all_children') . "',
	'p6_2_childs_name1':' " . showData('child_first_falmily_name', '0') . "',
	'p6_2_childs_name2':' " . showData('child_first_falmily_name', '1') . "',
	'p6_2_childs_name3':' " . showData('child_first_falmily_name', '2') . "',
	'p6_2_date_of_birth1':' " . showData('child_date_of_birth', '0') . "',
	'p6_2_date_of_birth2':' " . showData('child_date_of_birth', '1') . "',
	'p6_2_date_of_birth3':' " . showData('child_date_of_birth', '2') . "',
	'p6_2_residence1':' " . showData('child_residence', '0') . "',
	'p6_2_residence2':' " . showData('child_residence', '1') . "',
	'p6_2_residence3':' " . showData('child_residence', '2') . "',
	'p6_2_relationship1':' " . showData('child_relationship', '0') . "',
	'p6_2_relationship2':' " . showData('child_relationship', '1') . "',
	'p6_2_relationship3':' " . showData('child_relationship', '2') . "',
	'p7_1_name1':' " . showData('n_400_information_employment_and_school_name', '0') . "',
	'p7_1_name2':' " . showData('n_400_information_employment_and_school_name', '1') . "',
	'p7_1_name3':' " . showData('n_400_information_employment_and_school_name', '2') . "',
	'p7_1_city_town1':' " . showData('n_400_information_employment_and_school_city_town', '0') . "',
	'p7_1_city_town2':' " . showData('n_400_information_employment_and_school_city_town', '1') . "',
	'p7_1_city_town3':' " . showData('n_400_information_employment_and_school_city_town', '2') . "',
	'p7_1_state1':' " . showData('n_400_information_employment_and_school_state_province', '0') . "',
	'p7_1_state2':' " . showData('n_400_information_employment_and_school_state_province', '1') . "',
	'p7_1_state3':' " . showData('n_400_information_employment_and_school_state_province', '2') . "',
	'p7_1_zip_code1':' " . showData('n_400_information_employment_and_school_zip_code', '0') . "',
	'p7_1_zip_code2':' " . showData('n_400_information_employment_and_school_zip_code', '1') . "',
	'p7_1_zip_code3':' " . showData('n_400_information_employment_and_school_zip_code', '2') . "',
	'p7_1_country1':' " . showData('n_400_information_employment_and_school_country', '0') . "', 
	'p7_1_country2':' " . showData('n_400_information_employment_and_school_country', '1') . "', 
	'p7_1_country3':' " . showData('n_400_information_employment_and_school_country', '2') . "', 
	'p7_1_from_date_1':' " . showData('n_400_information_employment_and_school_from_date', '0') . "', 
	'p7_1_from_date_2':' " . showData('n_400_information_employment_and_school_from_date', '1') . "', 
	'p7_1_from_date_3':' " . showData('n_400_information_employment_and_school_from_date', '2') . "', 
	'p7_1_to_date_1':' PRESENT', 
	'p7_1_to_date_2':' " . showData('n_400_information_employment_and_school_to_date', '0') . "', 
	'p7_1_to_date_3':' " . showData('n_400_information_employment_and_school_to_date', '1') . "', 
	'p7_1_occupation1':' " . showData('n_400_information_employment_and_school_occupation', '0') . "', 
	'p7_1_occupation2':' " . showData('n_400_information_employment_and_school_occupation', '1') . "', 
	'p7_1_occupation3':' " . showData('n_400_information_employment_and_school_occupation', '2') . "', 

//page 5 end.......
	'p8_1_left_us_date_1':' " . showData('n_400_outside_the_us_left_date', '0') . "', 
	'p8_1_left_us_date_2':' " . showData('n_400_outside_the_us_left_date', '1') . "', 
	'p8_1_left_us_date_3':' " . showData('n_400_outside_the_us_left_date', '2') . "', 
	'p8_1_left_us_date_4':' " . showData('n_400_outside_the_us_left_date', '3') . "', 
	'p8_1_left_us_date_5':' " . showData('n_400_outside_the_us_left_date', '4') . "', 
	'p8_1_left_us_date_6':' " . showData('n_400_outside_the_us_left_date', '5') . "', 
	'p8_1_return_us_date_1':' " . showData('n_400_outside_the_us_return_date', '0') . "', 
	'p8_1_return_us_date_2':' " . showData('n_400_outside_the_us_return_date', '1') . "', 
	'p8_1_return_us_date_3':' " . showData('n_400_outside_the_us_return_date', '2') . "', 
	'p8_1_return_us_date_4':' " . showData('n_400_outside_the_us_return_date', '3') . "', 
	'p8_1_return_us_date_5':' " . showData('n_400_outside_the_us_return_date', '4') . "', 
	'p8_1_return_us_date_6':' " . showData('n_400_outside_the_us_return_date', '5') . "', 
	'p8_1_traveled_country1':' " . showData('n_400_outside_the_us_country_traveled', '0') . "', 
	'p8_1_traveled_country2':' " . showData('n_400_outside_the_us_country_traveled', '1') . "', 
	'p8_1_traveled_country3':' " . showData('n_400_outside_the_us_country_traveled', '2') . "', 
	'p8_1_traveled_country4':' " . showData('n_400_outside_the_us_country_traveled', '3') . "', 
	'p8_1_traveled_country5':' " . showData('n_400_outside_the_us_country_traveled', '4') . "', 
	'p8_1_traveled_country6':' " . showData('n_400_outside_the_us_country_traveled', '5') . "', 

//page 6 end.......
	'p9_15b_crime_1':' " . showData('n_400_additional_information_crime_or_offense', '0') . "', 
	'p9_15b_crime_2':' " . showData('n_400_additional_information_crime_or_offense', '1') . "', 
	'p9_15b_crime_3':' " . showData('n_400_additional_information_crime_or_offense', '2') . "', 
	'p9_15b_crime_4':' " . showData('n_400_additional_information_crime_or_offense', '3') . "', 
	'p9_15b_crime_5':' " . showData('n_400_additional_information_crime_or_offense', '4') . "', 
	'p9_15b_date_of_crime_1':' " . showData('n_400_additional_information_date_of_crime_or_offense', '0') . "', 
	'p9_15b_date_of_crime_2':' " . showData('n_400_additional_information_date_of_crime_or_offense', '1') . "', 
	'p9_15b_date_of_crime_3':' " . showData('n_400_additional_information_date_of_crime_or_offense', '2') . "', 
	'p9_15b_date_of_crime_4':' " . showData('n_400_additional_information_date_of_crime_or_offense', '3') . "', 
	'p9_15b_date_of_crime_5':' " . showData('n_400_additional_information_date_of_crime_or_offense', '4') . "', 
	'p9_15b_conviction_date_1':' " . showData('n_400_additional_information_date_of_conviction', '0') . "', 
	'p9_15b_conviction_date_2':' " . showData('n_400_additional_information_date_of_conviction', '1') . "', 
	'p9_15b_conviction_date_3':' " . showData('n_400_additional_information_date_of_conviction', '2') . "', 
	'p9_15b_conviction_date_4':' " . showData('n_400_additional_information_date_of_conviction', '3') . "', 
	'p9_15b_conviction_date_5':' " . showData('n_400_additional_information_date_of_conviction', '4') . "', 
	'p9_15b_place_of_crime_1':' " . showData('n_400_additional_information_place_of_crime_or_offense', '0') . "', 
	'p9_15b_place_of_crime_2':' " . showData('n_400_additional_information_place_of_crime_or_offense', '1') . "', 
	'p9_15b_place_of_crime_3':' " . showData('n_400_additional_information_place_of_crime_or_offense', '2') . "', 
	'p9_15b_place_of_crime_4':' " . showData('n_400_additional_information_place_of_crime_or_offense', '3') . "', 
	'p9_15b_place_of_crime_5':' " . showData('n_400_additional_information_place_of_crime_or_offense', '4') . "', 
	'p9_15b_arrest_result_1':' " . showData('n_400_additional_information_result_of_disposition', '0') . "', 
	'p9_15b_arrest_result_2':' " . showData('n_400_additional_information_result_of_disposition', '1') . "', 
	'p9_15b_arrest_result_3':' " . showData('n_400_additional_information_result_of_disposition', '2') . "', 
	'p9_15b_arrest_result_4':' " . showData('n_400_additional_information_result_of_disposition', '3') . "', 
	'p9_15b_arrest_result_5':' " . showData('n_400_additional_information_result_of_disposition', '4') . "', 
	'p9_15b_your_sentence_1':' " . showData('n_400_additional_information_sentence', '0') . "', 
	'p9_15b_your_sentence_2':' " . showData('n_400_additional_information_sentence', '1') . "', 
	'p9_15b_your_sentence_3':' " . showData('n_400_additional_information_sentence', '2') . "', 
	'p9_15b_your_sentence_4':' " . showData('n_400_additional_information_sentence', '3') . "', 
	'p9_15b_your_sentence_5':' " . showData('n_400_additional_information_sentence', '4') . "', 

//page 8 end.......

	'p9_22c_register_date':' " . showData('additional_info_ragistration_date') . "', 
	'p9_22c_service_number':' " . showData('additional_info_ragistration_service_number') . "', 

//page 9 end.......

	'p9_30b_input_value':' " . showData('additional_info_inherited_title') . "',

//page 10 end.......
	'p10_2_household_income':' " . showData('fee_reduction_household_income') . "', 
	'p10_3_household_size':' " . showData('fee_reduction_household_size') . "', 
	'p10_4_household_member':' " . showData('fee_reduction_household_members_income') . "', 
	'p10_4_household_head':' " . showData('fee_reduction_household_head_name') . "',
	'p11_1_applicant_daytime':' " . showData('n_400_applicant_daytime_tel') . "', 
	'p11_1_applicant_mobile':' " . showData('n_400_applicant_mobile') . "', 
	'p11_1_applicant_email':' " . showData('n_400_applicant_email') . "', 
	'p11_1_applicant_signature_date':' " . showData('n_400_applicant_sign_date') . "', 
//page 11 end.......
...
//page 14.......
	...
	'p15_name_or_stamp':' " . showData('signature_at_interview_subscribed_affirmed') . "', 
	'p15_date_of_signature':' " . showData('signature_at_interview_sign_date') . "', 
	'p16_date_signature':' " . showData('allegiance_sign_date') . "', 
