...
Number</b>, <b>and Item Number</b> to which your answer refers; and<br>
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_family_last_name', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 61);
//.......
$pdf->SetFont('times', '', 10);
$html = '<div><b>1.b.  </b>  Given Name <br> &nbsp; &nbsp; &nbsp; &nbsp; (First Name) </div>';
$pdf->writeHTMLCell(90, 7, 12, 68, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_given_first_name', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 70);
//.........
$pdf->SetFont('times', '', 10);
$html = '<div><b>1.c.  </b>  Middle Name  </div>';
$pdf->writeHTMLCell(90, 7, 12, 78, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_middle_name', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 79);
//..........
$pdf->SetFont('times', '', 10);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_a_number', 46, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 57.9, 88);
//............
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.a.  </b> &nbsp;Page Number</div>';
$pdf->writeHTMLCell(90, 7, 12, 98, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_page_number', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22, 103);
//.............
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.b.</b> &nbsp;&nbsp;Part Number</div>';
$pdf->writeHTMLCell(90, 7, 45, 98, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_part_number', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 54, 103);
//............
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.c.</b> &nbsp;&nbsp;Item Number</div>';
$pdf->writeHTMLCell(90, 7, 75, 98, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_item_number', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 84, 103);
//............
$pdf->SetFont('times', '', 10);
...
$pdf->TextField('aditional_info_name_3d', 82.5, 66, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('601a_additional_info_3d')), 21.5, 112);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_page_number1', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22, 185);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_part_number1', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 54, 185);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_item_number1', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 84, 185);
...
$pdf->TextField('aditional_info_name_4d', 82.5, 63.4, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('601a_additional_info_4d')), 21.5, 194);
$pdf->setCellHeightRatio(1.2);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_page_number2', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122, 22);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_part_number2', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 154, 22);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_item_number2', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 184, 22);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_name_5d', 82, 65, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('601a_additional_info_5d')), 122.5, 30.5);
$pdf->setCellHeightRatio(1.2);
//...........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_page_number3', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122, 100.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_part_number3', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(),  154, 100.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_item_number3', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 184, 100.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_name_6d', 82, 66, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('601a_additional_info_6d')), 122.5, 109.5);
$pdf->setCellHeightRatio(1.2);
//...........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_page_number4', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122, 181.2);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_part_number4', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(),  154, 181.2);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_item_number4', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 184, 181.2);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('601a_additional_info_name_7d', 82, 65, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('601a_additional_info_7d')), 122.5, 191);
...
//page 4 end......
    '601a_additional_info_family_last_name':' " . showData('601a_additional_info_last_name') . "',
    '601a_additional_info_given_first_name':' " . showData('601a_additional_info_first_name') . "',
    '601a_additional_info_middle_name':' " . showData('601a_additional_info_middle_name') . "',
    '601a_additional_info_a_number':' " . showData('601a_additional_info_a_number') . "',
    '601a_additional_info_page_number':' " . showData('601a_additional_info_3a_page_no') . "',
    '601a_additional_info_part_number':' " . showData('601a_additional_info_3b_part_no') . "',
    '601a_additional_info_item_number':' " . showData('601a_additional_info_3c_item_no') . "',
    '601a_additional_info_page_number1':' " . showData('601a_additional_info_4a_page_no') . "',
    '601a_additional_info_part_number1':' " . showData('601a_additional_info_4b_part_no') . "',
    '601a_additional_info_item_number1':' " . showData('601a_additional_info_4c_item_no') . "',
    '601a_additional_info_page_number2':' " . showData('601a_additional_info_5a_page_no') . "',
    '601a_additional_info_part_number2':' " . showData('601a_additional_info_5b_part_no') . "',
    '601a_additional_info_item_number2':' " . showData('601a_additional_info_5c_item_no') . "',
    '601a_additional_info_page_number3':' " . showData('601a_additional_info_6a_page_no') . "',
    '601a_additional_info_part_number3':' " . showData('601a_additional_info_6b_part_no') . "',
    '601a_additional_info_item_number3':' " . showData('601a_additional_info_6c_item_no') . "',
    '601a_additional_info_page_number4':' " . showData('601a_additional_info_7a_page_no') . "',
    '601a_additional_info_part_number4':' " . showData('601a_additional_info_7b_part_no') . "',
    '601a_additional_info_item_number4':' " . showData('601a_additional_info_7c_item_no') . "', 
