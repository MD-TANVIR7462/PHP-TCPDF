<?php
$meta_title     =   "INTAKE FORM I-864a";
$page_heading   =   "INTAKE FORM I-864a, Contract Between Sponsor and Household Member";
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">
                    <div class="d-flexible">
                        <b>1.a. </b> <?php echo createCheckbox("i_864w_i_have_earned_status") ?> I am the intending immigrant and also the sponsor's spouse.
                    </div>
                </label>
            </div>
            <div class="form-group">
                ...
                <label class="control-label col-md-12">
                    <div class="d-flexible">
                        <b>1.b. </b> <?php echo createCheckbox("i_864w_i_am_under_18_year_status") ?> I am the intending immigrant and also a member of the sponsor's household.
                    </div>
                </label>
            </div>
            <div class="form-group">
                ...
                <label class="control-label col-md-12">
                    <div class="d-flexible">
                        <b>1.c. </b> <?php echo createCheckbox("i_864w_i_am_filing_an_immigrant_visa_status") ?> I am not the intending immigrant. I am the sponsor's household member. I am related to the sponsor as his/her:
                    </div>
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-10 col-md-offset-2">
                    <div class="d-flexible"> <?php echo createCheckbox("i_864w_i_am_filing_an_immigrant_visa_adjustment_status") ?> Spouse</div>
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-10 col-md-offset-2">
                    <div class="d-flexible"> <?php echo createCheckbox("i_864w_i_am_filing_an_immigrant_visa_adjustment_status") ?> Son or Daughter (at least 18 years of age)</div>
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-10 col-md-offset-2">
                    <div class="d-flexible"> <?php echo createCheckbox("i_864w_i_am_filing_an_immigrant_visa_adjustment_status") ?> Parent</div>
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-10 col-md-offset-2">
                    <div class="d-flexible"> <?php echo createCheckbox("i_864w_i_am_filing_an_immigrant_visa_adjustment_status") ?> Brother or Sister</div>
                </label>
            </div>
            <div class="form-group">
                <label class="control-label col-md-10 col-md-offset-2">
                    <div class="d-flexible"> <?php echo createCheckbox("i_864w_i_am_filing_an_immigrant_visa_adjustment_status") ?> Other Dependent (Specify)</div>
                </label>
                <div class="col-md-10 col-md-offset-2">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">
                    <div class="d-flexible">
                        <b>1. </b> <?php echo createCheckbox("i_864w_i_can_read_understand_english_status") ?> Employed as a/an
                    </div>
                </label>
            ...
            <div class="form-group">
                <label class="control-label col-md-12">
                    <div class="d-flexible">
                        <b>4. </b> <?php echo createCheckbox("i_864w_i_can_read_understand_english_status") ?> Self employed as a/an
                    </div>
                </label>
                <div class="col-md-11 col-md-offset-1">
                    <input type="text" class="form-control" name="i_864w_the_interpreter_named_in" maxlength="34" value="<?php echo showData('i_864w_the_interpreter_named_in') ?>">
            ...
            <div class="form-group">
                <label class="control-label col-md-12">
                    <div class="d-flexible">
                        <b>5. </b> <?php echo createCheckbox("i_864w_i_can_read_understand_english_status") ?> Retired from (Company Name)
                    </div>
                </label>
                <div class="col-md-11 col-md-offset-1">
                    <input type="text" class="form-control" name="i_864w_the_interpreter_named_in" maxlength="34" value="<?php echo showData('i_864w_the_interpreter_named_in') ?>">
            ...
            <div class="form-group row">
                <div class="col-md-offset-2">
                    ...
                    <div class="col-md-6">
                        <input type="date" class="form-control" name="i_864w_the_interpreter_named_in" maxlength="34" value="<?php echo showData('i_864w_the_interpreter_named_in') ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-12">
                    <div class="d-flexible">
                        6.  <?php echo createCheckbox("i_864w_i_can_read_understand_english_status") ?> Unemployed since (mm/dd/yyyy)
                    </div>
                </label>
            ...
            <div class="form-group">
                ...
                <b>$</b> <input type="text" class="form-control" name="i_864w_the_interpreter_named_in" maxlength="34" value="<?php echo showData('i_864w_the_interpreter_named_in') ?>">
                </div>
            </div>
            <div class="bg-info">
