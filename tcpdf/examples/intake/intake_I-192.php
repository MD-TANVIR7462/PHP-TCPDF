	...
	<div class="row">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control"
						name="information_about_you_other_family_last_name_2" maxlength="29"
						value="<?php echo showData('information_about_you_other_family_last_name_2')?>" />
					<input type="text" class="form-control"
						name="information_about_you_other_family_last_name_3" maxlength="29"
						value="<?php echo showData('information_about_you_other_family_last_name_3')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">Given Name (First Name)</label>
				<div class="col-md-7">
					<input type="text" class="form-control"
						name="information_about_you_other_given_first_name_2" maxlength="29"
						value="<?php echo showData('information_about_you_other_given_first_name_2')?>" />
					<input type="text" class="form-control"
						name="information_about_you_other_given_first_name_3" maxlength="29"
						value="<?php echo showData('information_about_you_other_given_first_name_3')?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-5">Middle Name (if applicable)</label>
				<div class="col-md-7">
					<input type="text" class="form-control" name="information_about_you_other_middle_name_2" maxlength="29"
						value="<?php echo showData('information_about_you_other_middle_name_2')?>" />
					<input type="text" class="form-control" name="information_about_you_other_middle_name_3" maxlength="29"
						value="<?php echo showData('information_about_you_other_middle_name_3')?>" />
				</div>
			</div>
			<br>
			<div class="bg-info">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-md-12">
					<input type="text" class="form-control" name="information_about_you_city_town" maxlength="20"
