...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('US_Mailing__Incare', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 121, 110);
//.......
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_4d', 83, 105, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('')), 122, 31);
$pdf->setCellHeightRatio(1.2);
//.........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_5d', 83, 91, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_130_additional_info_3d')), 122, 155);
$pdf->setCellHeightRatio(1.2);
