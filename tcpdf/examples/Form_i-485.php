...
class MyPDF extends TCPDF {
    ...
    public function Footer() {
		...
		// if ($this->page == 1){
			...
			// $barcode_image = "images/I-485-footer-pdf417-$this->page.png";?new comment(Tanvir)


		// )


        // $this->Image($barcode_image, 65, 265, 95, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false); ;?new comment(Tanvir)
