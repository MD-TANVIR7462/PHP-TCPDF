...
class MyPDF extends TCPDF {
    ...
    public function Footer() {
     ...
     /*  if($this->page > 1){
         ...
         $this->Cell(38, 6, "Form I-589 Edition 03/01/23 ", 0, 0, 'R');	
         $this->MultiCell(59, 5.8, 'Page '.$this->getAliasNumPage(), 0, 'R', 0, 1, 151.4, 264.5, true);
      } */
        // Set font
...
$pdf->TextField('a_i_alien_registration_number', 68, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_interpreter_family_last_name')), 14, 59);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_us_social_security_number', 52, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 84, 59);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_uscis_online_account_number', 65, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 137, 59);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_complete_lastname', 75, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 14, 69);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_first_name', 52, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 90, 69);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_middle_name', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 142, 69);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_what_other_name_used', 188, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 14, 79);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_residence_street_number_name', 130, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 94);
//..........
$pdf->SetFont('times', '', 8.7);
$html ='<div> Apt. Number </div>';
$pdf->writeHTMLCell(100, 1, 143, 90, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_residence_apt_number', 59, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 143, 94);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_residence_city', 54, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 103);
//..........
$pdf->SetFont('times', '', 8.7);
$html ='<div> State </div>';
$pdf->writeHTMLCell(100, 1, 67, 99, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_residence_state', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 68, 103);
//............
$pdf->SetFont('times', '', 8.7);
$html ='<div> Zip Code </div>';
$pdf->writeHTMLCell(100, 1, 117, 99, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_residence_zipcode', 30, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 119, 103);
//.............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_residence_telephone_code', 10, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 152, 103);
$pdf->TextField('a_i_residence_telephone_number', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 165, 103);
// ............
// 
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_mailing_in_care_of', 130, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 122);
// //.............
$pdf->SetFont('times', '', 9);
$html ='<div> Telephone Number <br> (  &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp;  )</div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_mailing_telephone_code', 10, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 146, 122);
$pdf->TextField('a_i_mailing_telephone_number', 44, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 158, 122);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_mailing_street_number_name', 129, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 131);
// //..........
$pdf->SetFont('times', '', 9);
$html ='<div> Apt. Number </div>';
$pdf->writeHTMLCell(100, 4, 143, 127, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_mailing_apt_number', 58, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 144, 131);
...
$pdf->SetFont('times', '', 9);
$html ='<div> City </div>';
$pdf->writeHTMLCell(100, 4, 13, 136, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_mailing_city', 67, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 140);
// //..........
$pdf->SetFont('times', '', 9);
$html ='<div> State </div>';
$pdf->writeHTMLCell(100, 4, 80, 136, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_mailing_state', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 82, 140);
// //............
$pdf->SetFont('times', '', 9);
$html ='<div> Zip Code </div>';
$pdf->writeHTMLCell(100, 4, 143, 136, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_mailing_zipcode', 58, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 144, 140);
// //.............
$pdf->writeHTMLCell (1, 9, 142, 137, "", "R", 1, false,true,'C', true);  //verticale line | .
$pdf->writeHTMLCell (1, 9, 80, 137, "", "R", 1, false,true,'C', true);  //verticale line | .
$pdf->writeHTMLCell (189.6, 1, 13, 140, "", "B", 1, false, true,'C', true);  // 9 horizontal line .end
...
$pdf->writeHTMLCell(100, 4, 13, 145, $html, 0, 1, false, true, 'L', true);
...
$pdf->writeHTMLCell (1, 5, 70, 146, "", "R", 1, false,true,'C', false);  //verticale line | .
$pdf->writeHTMLCell (189.6, 1, 13, 145, "", "B", 1, false, true,'C', true);  // 10 horizontal line .end
...
$pdf->writeHTMLCell(100, 4, 13, 149.6, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_date_of_birth', 57, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 154.5);
// //...........
$pdf->SetFont('times', '', 9);
$html ='<div><b>13.  </b>  City and Country of Birth</div>';
$pdf->writeHTMLCell(120, 4, 71, 149.6, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_country_of_birth', 130, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 72, 154.5);

$pdf->writeHTMLCell (1, 9, 70, 151, "", "R", 1, false,true,'C', false);  //verticale line | .
...
$pdf->writeHTMLCell(100, 4, 13, 158.5, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_present_nationality', 57, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 163);
// //........
$pdf->SetFont('times', '', 9);
$html ='<div><b>15.  </b> Nationality at Birth</div>';
$pdf->writeHTMLCell(120, 4, 71, 158.5, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_nationality_at_birth', 47, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 72, 163);
// //.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>16.  </b>  Race, Ethnic, or Tribal Group</div>';
$pdf->writeHTMLCell(120, 4, 120, 158.5, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_race_ethnic_tribal', 48, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 121, 163);
// //..........
$pdf->SetFont('times', '', 9);
$html ='<div><b>17.  </b> Religion </div>';
$pdf->writeHTMLCell(100, 4, 170, 158.5, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_religion', 31, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 171, 163);

$pdf->writeHTMLCell (1, 7.8, 70, 160, "", "R", 1, false,true,'C', false);  //verticale line | .
$pdf->writeHTMLCell (1, 7.8, 119, 160, "", "R", 1, false,true,'C', false);  //verticale line | .
$pdf->writeHTMLCell (1, 7.8, 169, 160, "", "R", 1, false,true,'C', false);  //verticale line | .
$pdf->writeHTMLCell (189.6, 1, 13, 161.9, "", "B", 1, false, true,'C', true);  // 17 horizontal line .end
// //..........

$pdf->SetFont('times', '', 9);
$html ='<div><b>18. </b><i> Check the box, a through c, that applies:</i></div>';
$pdf->writeHTMLCell(100, 4, 13, 166.5, $html, 0, 1, false, true, 'L', true);
// //........
$pdf->SetFont('times', '', 9.5);
$html ='<div><b>a. </b> <input type="checkbox" name="never_been" value="a"/> I have never been in Immigration Court proceedings.</div>';
$pdf->writeHTMLCell(100, 4, 73.5, 166.8, $html, 0, 1, false, true, 'L', true);
// //.........

$pdf->SetFont('times', '', 9.5);
$html ='<div><b>b. </b> <input type="checkbox" name="iam_now" value="a"/> I am now in Immigration Court proceedings. </div>';
$pdf->writeHTMLCell(100, 4, 17, 170.3, $html, 0, 1, false, true, 'L', true);
// //............
$pdf->SetFont('times', '', 9.5);
$html ='<div><b>c. </b> <input type="checkbox" name="iam_not_now" value="a"/> I am <b>not</b> now in Immigration Court proceedings, but I have been in the past.</div>';
$pdf->writeHTMLCell(120, 4, 90, 170.3, $html, 0, 1, false, true, 'L', true);
...
$pdf->writeHTMLCell(100, 4, 13, 174.5, $html, 0, 1, false, true, 'L', true);
// //........
...
// //............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_last_leave_country', 20, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 90, 177);
...
// //............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_current_i-94_number', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 175, 177);
...
$pdf->writeHTMLCell(170, 4, 16, 182, $html, 0, 1, false, true, 'L', true);
...
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_date1', 25, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 26, 192);
...
// //............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_date2', 25, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 26, 198);
$pdf->writeHTMLCell (25, 1, 26, 197, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end
// //...........

$pdf->SetFont('times', '', 9);
$html ='<div>Date</div>';
$pdf->writeHTMLCell(100, 4, 18, 204, $html, 0, 1, false, true, 'L', true);
// //............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_date3', 25, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 26, 205);
$pdf->writeHTMLCell (25, 1, 26, 204, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end
// //..............................

$pdf->SetFont('times', '', 9);
$html ='<div>Place</div>';
$pdf->writeHTMLCell(100, 4, 53, 190, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_place1', 40, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 62, 191);
$pdf->writeHTMLCell (40, 1, 62, 190, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end

// //.....................

$pdf->SetFont('times', '', 9);
$html ='<div>Place</div>';
$pdf->writeHTMLCell(100, 4, 53, 197, $html, 0, 1, false, true, 'L', true);
// //............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_place2', 40, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 62, 198);
$pdf->writeHTMLCell (40, 1, 62, 197, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end
//..............

$pdf->SetFont('times', '', 9);
$html ='<div>Place</div>';
$pdf->writeHTMLCell(100, 4, 53, 204, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_place3', 40, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 62, 205);
$pdf->writeHTMLCell (40, 1, 62, 204, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end
...
$pdf->SetFont('times', '', 9);
$html ='<div>Status</div>';
$pdf->writeHTMLCell(100, 4, 105, 189, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_status1', 25, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 115, 191);
$pdf->writeHTMLCell (25, 1, 115, 190, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end

//.........
$pdf->SetFont('times', '', 9);
$html ='<div>Status</div>';
$pdf->writeHTMLCell(100, 4, 105, 197, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_status2', 25, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 115, 198);
$pdf->writeHTMLCell (25, 1, 115, 197, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end
// //...........

$pdf->SetFont('times', '', 9);
$html ='<div>Status</div>';
$pdf->writeHTMLCell(100, 4, 105, 204, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_status3', 25, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 115, 205);
$pdf->writeHTMLCell (25, 1, 115, 204, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end

//...........................
$pdf->SetFont('times', '', 9);
$html ='<div>Date Status Expired</div>';
$pdf->writeHTMLCell(100, 4, 142, 190, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_date_status_expired', 30, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 170, 191);
$pdf->writeHTMLCell (30, 1, 170, 190, "", "B", 1, false, true,'C', true);  // 19 horizontal line .end
//........
$pdf->writeHTMLCell (189.6, 1, 13, 205, "", "B", 1, false,true,'C', true);
// //.........
...
document?</div>';
$pdf->writeHTMLCell(80, 4, 13, 210, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_what_country_issued', 70, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 218);
//........

$pdf->SetFont('times', '', 9);
$html ='<div><b>21. </b> Passport Number</div>';
$pdf->writeHTMLCell(80, 4, 85, 210, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_passport_number', 53, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 115, 211.5);
// //........


$pdf->SetFont('times', '', 9);
$html ='<div>Travel Document Number</div>';
$pdf->writeHTMLCell(80, 4, 85, 217, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_travel_document_number', 46, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 122, 218);
//........
$pdf->SetFont('times', '', 9);
$html ='<div><b>22. </b> Expiration Date <br>  &nbsp; &nbsp; &nbsp;
(mm/dd/yyyy)</div>';
$pdf->writeHTMLCell(80, 4, 170, 210, $html, 0, 1, false, true, 'L', true);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_expiration_date', 32, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 170, 218);
//........
...
$pdf->writeHTMLCell (85, 1, 84, 211.6, "", "B", 1, false,true,'C', true); // horizontal line 2
...
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_what_is_your_native_language', 85, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 227);
//........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_i_what_other_language_speak_fluently', 62, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 140, 227);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_alien_registration_number', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 14, 37);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_passport_idcard_number', 37, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 37);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_date_of_birth', 40, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 37);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>4.</b> U.S. Social Security Number<br> &nbsp; &nbsp; <i>(if any)</i></div>';
$pdf->writeHTMLCell(100, 4, 150, 29, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_social_security_number', 52, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 150, 37);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_complete_last_name', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 49);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>6.</b> First Name</div>';
$pdf->writeHTMLCell(100, 4, 70, 41, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_firstname', 37, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 49);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>7.</b> Middle Name </div>';
$pdf->writeHTMLCell(100, 4, 108, 41, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_middlename', 40, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 49);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_other_name_used_include_maiden', 52, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 150, 49);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_date_of_marriage', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 58);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>10.</b> Place of Marriage</div>';
$pdf->writeHTMLCell(100, 4, 70, 53, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_place_of_mariage', 50, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 58);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>11.</b> City and Country of Birth </div>';
$pdf->writeHTMLCell(100, 4, 120, 53, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_city_country_birth', 82, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 121, 58);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_nationality_citizenship', 65, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 67);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_race_ethnic_tribal_group', 65, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 78, 67);
//............
...
//.............
$pdf->SetFont('times', '', 9);
$html ='<div><b>15.</b>  Is this person in the U.S.?  <br>  &nbsp;  &nbsp;  &nbsp;  &nbsp; <input type="checkbox" name="person_us" value="y"/>  Yes <i>(Complete Blocks 16 to 24.) </i>  &nbsp; &nbsp; <input type="checkbox"
 name="person_us" value="n"/>   No <i>(Specify location)</i> :</div>';
$pdf->writeHTMLCell(100, 4, 13, 72, $html, 0, 1, false, true, 'L', true);
//................
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_15_in_us', 98, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 105, 74.8);

$pdf->writeHTMLCell(98, 1, 105, 75, "", "B", 1, false, true, 'L', true);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_place_of_last_entry_us', 45, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 89);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_date_last_entry_us', 48, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 60, 89);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_I94number_ifany', 41, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 109, 89);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_status_when_last_admited', 52, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 89);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_what_is_your_spouse_current_status', 40, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 101);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_authorization_expiration_date', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 53, 101);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_date_of_priviews_arrival', 52, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 101);
//............
...
$pdf->SetFont('times', '', 10);
$html ='<div> <input type="checkbox" name="include" value="y"/>  Yes';
$pdf->writeHTMLCell(190, 5, 15, 110, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('times', '', 10);
$html ='<div> <input type="checkbox" name="include" value="n"/> No  </div>';
$pdf->writeHTMLCell(190, 5, 15, 115, $html, 0, 1, false, true, 'L', true);
//............
...
$pdf->SetFont('times', '', 9.7);
$html ='<div><input type="checkbox" name="children" value="y"/> I do not have any children.  <i>(Skip to Part A.III., Information about your background.)</i>
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_alien_registration_number', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 14, 152);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_passport_idcard_number', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 152);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_marital_status', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 152);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>4.</b> U.S. Social Security Number<br> &nbsp; &nbsp; <i>(if any)</i></div>';
$pdf->writeHTMLCell(100, 4, 155, 144, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_social_security_number', 48, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 155, 152);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_complete_last_name', 57, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 162);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>6.</b> First Name</div>';
$pdf->writeHTMLCell(100, 4, 70, 157, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_firstname', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 162);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>7.</b> Middle Name </div>';
$pdf->writeHTMLCell(100, 4, 108, 157, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_middlename', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 162);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>8.</b> Date of Birth <i>(mm/dd/yyyy)</i></div>';
$pdf->writeHTMLCell(100, 4, 155, 157, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_date_of_birth', 47, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 155, 162);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_city_country_birth', 56, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 172);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>10.</b> Nationality <i>(Citizenship)</i></div>';
$pdf->writeHTMLCell(100, 4, 70, 167, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('p_a_ii_10_nationality_citizenship', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 172);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>11.</b> Race, Ethnic, or Tribal Group</div>';
$pdf->writeHTMLCell(100, 4, 108, 167, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_race_ethnic_tribal_group', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 172);
//............
$pdf->SetFont('times', '', 9.7);
...
$pdf->SetFont('times', '', 9.7);
$html ='<div><b>13.</b> Is this child in the U.S. ?  &nbsp; &nbsp; <input type="checkbox" name="child_us3" value="y"/>  Yes <i>(Complete Blocks 14 to 21.)</i>  &nbsp;  &nbsp;  <input type="checkbox" name="child_us3" value="n"/> No <i>(Specify location):</i> </div>';
$pdf->writeHTMLCell(180, 4, 13, 179, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_is_this_us', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 143, 179);
//............
$pdf->writeHTMLCell(60, 1, 143, 179, "", "B", 1, false, true, 'L', true);// horizontal line -----
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_place_of_last_entry_us', 45, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 193);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_date_last_entry_us', 48, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 60, 193);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_I94number_ifany', 41, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 109, 193);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_status_when_last_admited', 52, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 193);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_current_status', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 205);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child_what_is_expiration_date', 58, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 205);
//............

$pdf->SetFont('times', '', 9.7);
$html ='<div><b>20. </b> Is your child in Immigration Court proceedings? <br> <br> &nbsp; &nbsp; &nbsp; <input type="checkbox" name="proceding_page2" value="y"/>  Yes  &nbsp;  &nbsp;  <input type="checkbox" name="proceding_page2" value="n"/> No</div>';
$pdf->writeHTMLCell(180, 4, 129, 197, $html, 0, 1, false, true, 'L', true);
//............
...
$html ='<div><b>21. </b> If in the U.S., is this child to be included in this application? <i>(Check the appropriate box.)</i>
 <br><br> &nbsp; &nbsp; &nbsp;<input type="checkbox" name="inc_application" value="y"/>   Yes    <br><br> &nbsp; &nbsp; &nbsp;<input type="checkbox" name="inc_application" value="n"/>   No </div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_alien_registration_number', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 14, 29);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_passport_idcard_number', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 29);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_marital_status', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 29);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>4.</b> U.S. Social Security Number<br> &nbsp; &nbsp; <i>(if any)</i></div>';
$pdf->writeHTMLCell(100, 4, 155, 21, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_social_security_number', 48, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 155, 29);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_complete_last_name', 57, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 39);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>6.</b> First Name</div>';
$pdf->writeHTMLCell(100, 4, 70, 34, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_firstname', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 39);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>7.</b> Middle Name </div>';
$pdf->writeHTMLCell(100, 4, 108, 34, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_middlename', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 39);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>8.</b> Date of Birth <i>(mm/dd/yyyy)</i></div>';
$pdf->writeHTMLCell(100, 4, 155, 34, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_date_of_birth', 47, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 155, 39);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_city_country_birth', 56, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 49);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>10.</b> Nationality <i>(Citizenship)</i></div>';
$pdf->writeHTMLCell(100, 4, 70, 44, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_nationality_citizenship', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 49);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>11.</b> Race, Ethnic, or Tribal Group</div>';
$pdf->writeHTMLCell(100, 4, 108, 44, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_race_ethnic_tribal_group', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 49);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_is_this_us', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 143, 56);
//............
...
$pdf->writeHTMLCell(100, 4, 13, 62, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_place_of_last_entry_us', 45, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 70);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_date_last_entry_us', 48, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 60, 70);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_I94number_ifany', 41, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 109, 70);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>17.</b> Status when last admitted 
<br> &nbsp; &nbsp; <i>(Visa type, if any)</i></div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_status_when_last_admited', 52, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 70);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_current_status', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 82);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child2_what_is_expiration_date', 58, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 82);
//............

$pdf->SetFont('times', '', 9.7);
$html ='<div><b>20. </b> Is your child in Immigration Court proceedings? <br> <br> &nbsp; &nbsp; &nbsp; <input type="checkbox" name="proceding_page3_section1" value="y"/>  Yes  &nbsp;  &nbsp;  <input type="checkbox" name="proceding_page3_section1" value="n"/> No</div>';
...
$pdf->SetFont('times', '', 9);
$html ='<div><b>21. </b> If in the U.S., is this child to be included in this application? <i>(Check the appropriate box.)</i>
 <br>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="incl_application" value="y"/>   Yes   <br>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="incl_application" value="n"/>   No </div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_alien_registration_number', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 14, 107);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_passport_idcard_number', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 107);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_marital_status', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 107);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>4.</b> U.S. Social Security Number<br> &nbsp; &nbsp; <i>(if any)</i></div>';
$pdf->writeHTMLCell(100, 4, 155, 99, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_social_security_number', 48, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 155, 107);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_complete_last_name', 57, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 117);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>6.</b> First Name</div>';
$pdf->writeHTMLCell(100, 4, 70, 112, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_firstname', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 117);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>7.</b> Middle Name </div>';
$pdf->writeHTMLCell(100, 4, 108, 112, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_middlename', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 117);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>8.</b> Date of Birth <i>(mm/dd/yyyy)</i></div>';
$pdf->writeHTMLCell(100, 4, 155, 112, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_date_of_birth', 47, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 155, 117);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_city_country_birth', 56, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 127);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>10.</b> Nationality <i>(Citizenship)</i></div>';
$pdf->writeHTMLCell(100, 4, 70, 122, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_nationality_citizenship', 37, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 127);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>11.</b> Race, Ethnic, or Tribal Group</div>';
$pdf->writeHTMLCell(100, 4, 108, 122, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_race_ethnic_tribal_group', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 127);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>12.</b> Gender   <br> &nbsp; &nbsp; <input type="checkbox" name="child2_gender_section2" value="m"/>  Male  &nbsp;  <input type="checkbox" name="child2_gender_section2" value="f"/>  Female </div>';
...
$pdf->SetFont('times', '', 9.7);
$html ='<div><b>13.</b> Is this child in the U.S. ?  &nbsp; &nbsp; <input type="checkbox" name="child_us2" value="y"/>  Yes <i>(Complete Blocks 14 to 21.)</i>  &nbsp;  &nbsp;  <input type="checkbox" name="child_us2" value="n"/> No <i>(Specify location):</i> </div>';
$pdf->writeHTMLCell(180, 4, 13, 134, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_is_this_us', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 143, 134);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_place_of_last_entry_us', 45, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 148);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_date_last_entry_us', 48, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 60, 148);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_I94number_ifany', 41, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 109, 148);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>17.</b> Status when last admitted 
<br> &nbsp; &nbsp; <i>(Visa type, if any)</i></div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_status_when_last_admited', 52, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 148);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_current_status', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 160);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_section2_child2_what_is_expiration_date', 58, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 160);
//............

$pdf->SetFont('times', '', 9.7);
$html ='<div><b>20. </b> Is your child in Immigration Court proceedings? <br> <br> &nbsp; &nbsp; &nbsp; <input type="checkbox" name="proceding_page3_section2" value="y"/>  Yes  &nbsp;  &nbsp;  <input type="checkbox" name="proceding_page3_section2" value="n"/> No</div>';
...
$pdf->SetFont('times', '', 9);
$html ='<div><b>21. </b> If in the U.S., is this child to be included in this application? <i>(Check the appropriate box.)</i>
 <br>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="incl_application_section2" value="y"/>   Yes    
 <br>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="incl_application_section2" value="n"/>   No </div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_alien_registration_number', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 14, 185);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_passport_idcard_number', 37, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 185);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_marital_status', 45, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 185);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_social_security_number', 48, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 155, 185);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_complete_last_name', 57, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 194);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>6.</b> First Name</div>';
$pdf->writeHTMLCell(100, 4, 70, 189, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_firstname', 37, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 194);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>7.</b> Middle Name </div>';
$pdf->writeHTMLCell(100, 4, 108, 189, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_middlename', 45, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 194);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>8.</b> Date of Birth <i>(mm/dd/yyyy)</i></div>';
$pdf->writeHTMLCell(100, 4, 155, 189, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_date_of_birth', 47, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 155, 194);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_city_country_birth', 56, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 203);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>10.</b> Nationality <i>(Citizenship)</i></div>';
$pdf->writeHTMLCell(100, 4, 70, 198, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_nationality_citizenship', 37, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 203);
//.........
$pdf->SetFont('times', '', 9);
$html ='<div><b>11.</b> Race, Ethnic, or Tribal Group</div>';
$pdf->writeHTMLCell(100, 4, 108, 198, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_race_ethnic_tribal_group', 45, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 108, 203);
//............
$pdf->SetFont('times', '', 9.7);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_is_this_us', 60, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 143, 209);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_place_of_last_entry_us', 45, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 221);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_date_last_entry_us', 48, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 60, 221);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_I94number_ifany', 41, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 109, 221);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>17.</b> Status when last admitted 
<br> &nbsp; &nbsp; <i>(Visa type, if any)</i></div>';
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_status_when_last_admited', 52, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 221);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_current_status', 55, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 233);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_ii_child3_what_is_expiration_date', 58, 5, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 233);
//............

$pdf->SetFont('times', '', 9.7);
$html ='<div><b>20. </b> Is your child in Immigration Court proceedings? <br> <br>&nbsp; &nbsp; &nbsp; <input type="checkbox" name="proceding3" value="y"/>  Yes  &nbsp;  &nbsp;  <input type="checkbox" name="proceding3" value="n"/> No</div>';
...
$pdf->SetFont('times', '', 9.7);
$html ='<div><b>21. </b> If in the U.S., is this child to be included in this application? <i>(Check the appropriate box.)</i>
 <br>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="incl3_application" value="y"/>   Yes    </div>';
$pdf->writeHTMLCell(190, 7, 13, 239, $html, 0, 1, false, true, 'L', true);
$html ='<div><input type="checkbox" name="incl3_application" value="n"/>&nbsp;  No </div>';
...
//..........
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_live_address_number_and_street1', 38, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 44);
$pdf->TextField('a_iii_live_address_number_and_street2', 38, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 52);
//.........
$pdf->TextField('a_iii_live_address_city_town1', 29, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 51, 44);
$pdf->TextField('a_iii_live_address_city_town2', 29, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 51, 52);
//.........
$pdf->TextField('a_iii_live_address_dept_province_state1', 51, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 80, 44);
$pdf->TextField('a_iii_live_address_dept_province_state2', 51, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 80, 52);
//.........
$pdf->TextField('a_iii_live_address_country1', 25, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 131, 44);
$pdf->TextField('a_iii_live_address_country2', 25, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 131, 52);
//.........

$pdf->TextField('a_iii_live_address_date_from1', 23, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 156, 44);
$pdf->TextField('a_iii_live_address_date_from2', 23, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 156, 52);
//.........
$pdf->TextField('a_iii_live_address_date_to1', 24, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 179, 44);
$pdf->TextField('a_iii_live_address_date_to2', 24, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 179, 52);
//.........page 4 table 1 end -----------------------------------------------------------
...
//..........
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_residence_address_number_and_street1', 38, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 77);
$pdf->TextField('a_iii_residence_address_number_and_street2', 38, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 84);
$pdf->TextField('a_iii_residence_address_number_and_street3', 38, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 91);
$pdf->TextField('a_iii_residence_address_number_and_street4', 38, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 98);
$pdf->TextField('a_iii_residence_address_number_and_street5', 38, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 105);

//.........
$pdf->TextField('a_iii_residence_address_city_town1', 29, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 51, 77);
$pdf->TextField('a_iii_residence_address_city_town2', 29, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 51, 84);
$pdf->TextField('a_iii_residence_address_city_town3', 29, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 51, 91);
$pdf->TextField('a_iii_residence_address_city_town4', 29, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 51, 98);
$pdf->TextField('a_iii_residence_address_city_town5', 29, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 51, 105);
//.........
$pdf->TextField('a_iii_residence_address_dept_province_state1', 51, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 80, 77);
$pdf->TextField('a_iii_residence_address_dept_province_state2', 51, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 80, 84);
$pdf->TextField('a_iii_residence_address_dept_province_state3', 51, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 80, 91);
$pdf->TextField('a_iii_residence_address_dept_province_state4', 51, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 80, 98);
$pdf->TextField('a_iii_residence_address_dept_province_state5', 51, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 80, 105);
//.........
$pdf->TextField('a_iii_residence_address_country1', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 131, 77);
$pdf->TextField('a_iii_residence_address_country2', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 131, 84);
$pdf->TextField('a_iii_residence_address_country3', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 131, 91);
$pdf->TextField('a_iii_residence_address_country4', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 131, 98);
$pdf->TextField('a_iii_residence_address_country5', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 131, 105);
//.........

$pdf->TextField('a_iii_residence_address_date_from1', 23, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 156, 77);
$pdf->TextField('a_iii_residence_address_date_from2', 23, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 156, 84);
$pdf->TextField('a_iii_residence_address_date_from3', 23, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 156, 91);
$pdf->TextField('a_iii_residence_address_date_from4', 23, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 156, 98);
$pdf->TextField('a_iii_residence_address_date_from5', 23, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 156, 105);
//.........
$pdf->TextField('a_iii_residence_address_date_to1', 24, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 179, 77);
$pdf->TextField('a_iii_residence_address_date_to2', 24, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 179, 84);
$pdf->TextField('a_iii_residence_address_date_to3', 24, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 179, 91);
$pdf->TextField('a_iii_residence_address_date_to4', 24, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 179, 98);
$pdf->TextField('a_iii_residence_address_date_to5', 24, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 179, 105);
//.........page 4 table 2 ends ----------------------------
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_education_name_of_school1', 43, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 129);
$pdf->TextField('a_iii_education_name_of_school2', 43, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 136);
$pdf->TextField('a_iii_education_name_of_school3', 43, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 143);
$pdf->TextField('a_iii_education_name_of_school4', 43, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 150);
//.........

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_education_type_of_school1', 48, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 56, 129);
$pdf->TextField('a_iii_education_type_of_school2', 48, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 56, 136);
$pdf->TextField('a_iii_education_type_of_school3', 48, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 56, 143);
$pdf->TextField('a_iii_education_type_of_school4', 48, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 56, 150);
//.........

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_education_location_address1', 47, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 104, 129);
$pdf->TextField('a_iii_education_location_address2', 47, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 104, 136);
$pdf->TextField('a_iii_education_location_address3', 47, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 104, 143);
$pdf->TextField('a_iii_education_location_address4', 47, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 104, 150);
//.........

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_education_attend_from1', 27, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 129);
$pdf->TextField('a_iii_education_attend_from2', 27, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 136);
$pdf->TextField('a_iii_education_attend_from3', 27, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 143);
$pdf->TextField('a_iii_education_attend_from4', 27, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 151, 150);
//.........
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_education_attend_to1', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 178, 129);
$pdf->TextField('a_iii_education_attend_to2', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 178, 136);
$pdf->TextField('a_iii_education_attend_to3', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 178, 143);
$pdf->TextField('a_iii_education_attend_to4', 25, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 178, 150);
//......... page 4 table 3 end -------------------------------------------------------------------------------------------------
...
//..........
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_name_and_address_employer1', 78, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 174);
$pdf->TextField('a_iii_name_and_address_employer2', 78, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 181);
$pdf->TextField('a_iii_name_and_address_employer3', 78, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 188);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_your_employment_occupation1', 58, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 91, 174);
$pdf->TextField('a_iii_your_employment_occupation2', 58, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 91, 181);
$pdf->TextField('a_iii_your_employment_occupation3', 58, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 91, 188);
//............

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_your_employment_date_from1', 28, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 149, 174);
$pdf->TextField('a_iii_your_employment_date_from2', 28, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 149, 181);
$pdf->TextField('a_iii_your_employment_date_from3', 28, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 149, 188);
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_your_employment_date_to1', 26, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 177, 174);
$pdf->TextField('a_iii_your_employment_date_to2', 26, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 177, 181);
$pdf->TextField('a_iii_your_employment_date_to3', 26, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 177, 188);
...
//..........
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('a_iii_full_name_mother', 46, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 25, 210);
$pdf->TextField('a_iii_full_name_father', 46, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 25, 217);
$pdf->TextField('a_iii_full_name_sibling1', 46, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 25, 224);
//............
$pdf->TextField('a_iii_full_name_sibling2', 46, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 25, 231);
//............
$pdf->TextField('a_iii_full_name_sibling3', 46, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 25, 238);
//............
$pdf->TextField('a_iii_full_name_sibling4', 46, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 25, 245);
//............

$pdf->TextField('a_iii_city_town_country_of_birth_mother', 62, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 71, 210);
$pdf->TextField('a_iii_city_town_country_of_birth_father', 62, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 71, 217);
$pdf->TextField('a_iii_city_town_country_of_birth_sibling1', 62, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 71, 224);
//............
$pdf->TextField('a_iii_city_town_country_of_birth_sibling2', 62, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 71, 231);
//............
$pdf->TextField('a_iii_city_town_country_of_birth_sibling3', 62, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 71, 238);
//............
$pdf->TextField('a_iii_city_town_country_of_birth_sibling4', 62, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 71, 245);
//............

$pdf->TextField('a_iii_current_location_mother', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 153, 210);
$pdf->TextField('a_iii_current_location_father', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 153, 217);
$pdf->TextField('a_iii_current_location_sibling1', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 153, 224);
//............
$pdf->TextField('a_iii_current_location_sibling2', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 153, 231);
//............
$pdf->TextField('a_iii_current_location_sibling3', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 153, 238);
//............
$pdf->TextField('a_iii_current_location_sibling4', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 153, 245);
//............page number 4 end -------------------------------------------------------------------------------------------------------
...
$pdf->writeHTMLCell(182, 45, 19, 208, "", 1, 1, false, true, 'L', true);  // table box --------------
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('partd_print_your_complete_name', 90, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 12, 103);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('partd_write_your_name_alphabet', 97, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 105, 103);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('partd_name', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 12, 117);
$pdf->TextField('partd_relation_ship', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 60, 117);
$pdf->TextField('partd_name2', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 107, 117);
$pdf->TextField('partd_relation_ship2', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 157, 117);
//............
...
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('partd_date_of_signature', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 120, 147);
//................
$pdf->SetFont('times', '', 9);
...
//............
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_e_print_complete_name_of_preparer', 117, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 86, 193);
...
//................
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_e_daytime_telephone_code', 7, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 16, 204);
$pdf->TextField('part_e_daytime_telephone_number', 42, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 26, 204);
$pdf->TextField('part_e_address_of_preparer_street', 132, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 204);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_e_preparer_address_aptnumber', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 214);

$pdf->TextField('part_e_preparer_address_city', 52, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 55, 214);
$pdf->TextField('part_e_preparer_address_state', 50, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 110, 214);

$pdf->TextField('part_e_preparer_address_zipcode', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 162, 214);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_e_attorney_state_bar_number', 45, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 85, 235);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_e_attorney_online_account_number', 65, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 134, 235);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_date', 100, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 104, 21);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_alien_registration_number', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 63);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_passport_idcard_number', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 63);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_marital_status', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 112, 63);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>4. </b> U.S. Social Security Number<br>&nbsp; &nbsp;<i>(if any)</i></div>';
$pdf->writeHTMLCell(80, 7, 159, 55, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_us_social_security_number', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 159, 63);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_complete_last_name', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 73);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_first_name', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 73);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>7. </b> Middle Name</div>';
$pdf->writeHTMLCell(80, 7, 112, 68, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_middle_name', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 112, 73);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>8. </b> Date of Birth <i>(mm/dd/yyyy)</i></div>';
$pdf->writeHTMLCell(80, 7, 159, 68, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_date_of_birth', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 159, 73);
//............
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_city_country_birth', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 83);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_nationality_citizen', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 83);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>11. </b>Race, Ethnic, or Tribal Group</div>';
$pdf->writeHTMLCell(80, 7, 112, 78, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_race_ethnic_tribal', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 112, 83);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_specify_location', 70, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 133, 90);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_place_last_entry_in_us', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 104);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_date_last_entry_us', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 104);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>16. </b> I-94 Number <i>(If any)</i></div>';
$pdf->writeHTMLCell(80, 7, 112, 96, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_I_94_number_if_any', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 112, 104);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_status_when_last_submited', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 159, 104);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_your_child_current_status', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 118);
//..........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_authorized_expire_date', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 75, 118);
//..........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_alien_registration_number', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 148);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_passport_idcard_number', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 148);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>3. </b> Marital Status <i>(Married, Single,<br>&nbsp; &nbsp; Divorced, Widowed)  </div>';
$pdf->writeHTMLCell(80, 7, 112, 140, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_marital_status', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 112, 148);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>4. </b> U.S. Social Security Number<br>&nbsp; &nbsp;<i>(if any)</i></div>';
$pdf->writeHTMLCell(80, 7, 159, 140, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_us_social_security_number', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 159, 148);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_complete_last_name', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 158);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_first_name', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 158);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>7. </b> Middle Name</div>';
$pdf->writeHTMLCell(80, 7, 112, 153, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_middle_name', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 112, 158);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>8. </b> Date of Birth <i>(mm/dd/yyyy)</i></div>';
$pdf->writeHTMLCell(80, 7, 159, 153, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_date_of_birth', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 159, 158);
//............
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_city_country_birth', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 168);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_nationality_citizen', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 168);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>11. </b>Race, Ethnic, or Tribal Group</div>';
$pdf->writeHTMLCell(80, 7, 112, 163, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_race_ethnic_tribal', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 112, 168);
//............
$pdf->SetFont('times', '', 9);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_specify_location', 70, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 133, 175);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_place_last_entry_in_us', 55, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 189);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_date_last_entry_us', 40, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 70, 189);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>16. </b> I-94 Number <i>(If any)</i></div>';
$pdf->writeHTMLCell(80, 7, 112, 181, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_I_94_number_if_any', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 112, 189);
//............
$pdf->SetFont('times', '', 9);
$html ='<div><b>17. </b>Status when last admitted<br> &nbsp; &nbsp; <i>(Visa type, if any)</i> </div>';
$pdf->writeHTMLCell(80, 7, 159, 181, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_status_when_last_submited', 45, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 159, 189);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_your_child_current_status', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 13, 203);
//..........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part_g_child2_authorized_expire_date', 60, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 75, 203);
//..........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_asylum_date', 100, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 104, 31);
...
//.........
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_asylum_part', 30, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 30, 60);
$pdf->writeHTMLCell(29.5, 1, 30, 60, '', "B", 1, false, true, 'L', true);
$pdf->TextField('additional_asylum_question', 30, 6, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 30, 68);
$pdf->writeHTMLCell(29.5, 1, 30, 68, '', "B", 1, false, true, 'L', true);
//.........................

//$pdf->TextField('additional_claim_to_asylum', 190, 170, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v' => showData('i_539_additional_info_6d')), 14, 80);
//............
$pdf->SetFont('courier', 'B', 10);
$html = <<<EOD
<textarea cols="44" rows="45" name="i_589_aditional_info1"></textarea>
EOD;
$pdf->writeHTMLCell(90, 50, 14, 79, $html, 0, 0, false, 'L');
...
var fields = {
    ...
    'part_e_attorney_online_account_number':' ',
    'part_e_attorney_state_bar_number':' ',
