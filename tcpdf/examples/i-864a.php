...
class MyPDF extends TCPDF {
    ...
    public function Footer() {
		...
		$this->Cell(40, 6, "Form I-864A   12/08/21", 0, 0, 'L');
...
immigrant</div>';
$pdf->writeHTMLCell(30, 7, 12, 45, $html, 0, 1, false, true, 'J', true);
//.......
...
$pdf->SetFont('times', 'B', 10);	// set font
$pdf->MultiCell(80, 15, "IS NOT ", 0, 'L', 0, 1, 58, 45, true);

$pdf->SetFont('times', '', 10);
$html ='<div>the  intending 
immigrant</div>';
$pdf->writeHTMLCell(20, 7, 58, 49, $html, 0, 1, false, true, 'J', true);
//............
...
$pdf->writeHTMLCell(91, 7, 13, 101, $html, 0, 1, true, false, 'L', true);
//.............
...
$html = '<select name="about_your_mailing_state" size="0.25">';
foreach($allDataCountry as $record){
	$html .= '<option value="'.$record->state_code.'">'.$record->state_code.' </option>';
}
$html .= '</select>';

$pdf->writeHTMLCell(25, 0, 29, 186, $html, '', 0, 0, true, 'L');
...
physical address.';
$pdf->writeHTMLCell(90, 7, 21, 235, $html, '', 0, 0, true, 'L');
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('about_your_physical_city_town', 58, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 145, 112);
//............
...
$html = '<select name="about_your_physical_state" size="0.25">';
foreach($allDataCountry as $record){
	$html .= '<option value="'.$record->state_code.'">'.$record->state_code.' </option>';
}
$html .= '</select>';

$pdf->writeHTMLCell(25, 0, 128, 121, $html, '', 0, 0, true, 'L');
$html= '<div><b>4.e.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ZIP Code</div>';
$pdf->writeHTMLCell(30, 3, 145, 121, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('about_your_physical_zipcode', 32, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 171, 121);
//..............
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('other_info_city_or_town', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 185);
//..............
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('other_info_state_province', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 197);
//..............
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('other_info_Country', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 121, 210);
//..............
