...
$y_position = 33;
addYesNoQuestion($pdf, '<b>38.</b> &nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> knowingly aided, abetted, assisted, conspired, or colluded with others in trafficking in<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;persons for commercial sex acts or involuntary servitude, peonage, debt bondage, or slavery?', 12, $y_position, 'criminal_38', 'i_485_criminal_38');
$y_position += 14;

addYesNoQuestion($pdf, '<b>39.</b> &nbsp;&nbsp;&nbsp;&nbsp;Are you the spouse, son, or daughter of an alien who engaged in the trafficking in persons and have received<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;or obtained, within the last 5 years, any financial or other benefits from this activity of your spouse or your<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;parent?', 12, $y_position, 'criminal_39', 'i_485_criminal_39');
$y_position += 14;

addYesNoQuestion($pdf, '<b>40.</b> &nbsp;&nbsp;&nbsp;&nbsp;If your answer is "Yes" to <b>Item Number 39</b>, did you know or reasonably should have known that this<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;benefit resulted from this activity of your spouse or parent?', 12, $y_position, 'criminal_40', 'i_485_criminal_40');
$y_position += 10;

addYesNoQuestion($pdf, '<b>41.</b> &nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> engaged in money laundering or have you <b>EVER</b> knowingly aided, assisted, abetted,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;conspired, or colluded with others in money laundering or do you seek to enter the United States to engage<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;in such activity?', 12, $y_position, 'criminal_41', 'i_485_criminal_41');
$y_position += 14;
$pdf->SetFontSize(12);
$html = "<div><b><i>Security and Related</i></b></div>";
$pdf->writeHTMLCell(192, 6, 13, $y_position+3, $html, 0, 1, true, 'L');
$y_position += 7;

$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(191, 6, 12, $y_position+3, 'Do you intend to:', 0, 1, false, true, 'L', true);
$y_position += 10;

addYesNoQuestion($pdf, '<b>42.a.</b>&nbsp;&nbsp;Engage in any activity that violates or evades any law relating to espionage (including spying) or sabotage<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;in the United States?', 12, $y_position, 'security_42a', 'i_485_security_42a');
$y_position += 10;

addYesNoQuestion($pdf, '<b>42.b.</b>&nbsp;&nbsp;Engage in any activity in the United States that violates or evades any law prohibiting the export from the<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;United States of goods, technology, or sensitive information?', 12, $y_position, 'security_42b', 'i_485_security_42b');
$y_position += 10;

addYesNoQuestion($pdf, '<b>42.c.</b>&nbsp;&nbsp;Engage in any activity whose purpose includes opposing, controlling, or overthrowing the U.S. Government<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;by force, violence, or other unlawful means while in the United States?', 12, $y_position, 'security_42c', 'i_485_security_42c');
$y_position += 11.5;

addYesNoQuestion($pdf, '<b>42.d.</b>&nbsp;&nbsp;Engage in any other unlawful activity?', 12, $y_position, 'security_42d', 'i_485_security_42d');
$y_position += 8;

$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(190, 6, 12, $y_position, 'Have you <b>EVER</b>:', 0, 1, false, true, 'L', true);
$y_position += 7;

addYesNoQuestion($pdf, '<b>43.a.</b>&nbsp;&nbsp;Received any weapons training, paramilitary training, or other military-type training?', 12, $y_position, 'security_43a', 'i_485_security_43a');
$y_position += 7;

addYesNoQuestion($pdf, '<b>43.b.</b>&nbsp;&nbsp;Committed kidnapping, assassination, or hijacking or sabotage of a conveyance (including an aircraft,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vessel, vehicle, or train)?', 12, $y_position, 'security_43b', 'i_485_security_43b');
$y_position += 10;

addYesNoQuestion($pdf, '<b>43.c.</b>&nbsp;&nbsp;Used a weapon or explosive or any dangerous device with the intent to endanger the safety of another<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;person or people or cause damage to property?', 12, $y_position, 'security_43c', 'i_485_security_43c');
$y_position += 10;

addYesNoQuestion($pdf, '<b>43.d.</b>&nbsp;&nbsp;Threatened, attempted, conspired, prepared, or planned to do any of the things described in <b>Item Numbers<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 43.b. - 43.c.</b>?', 12, $y_position, 'security_43d', 'i_485_security_43d');
$y_position += 10;

addYesNoQuestion($pdf, '<b>43.e.</b>&nbsp;&nbsp;Incited, under circumstances indicating an intention to cause death or serious bodily harm/injury, any of<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;the activities described in <b>Item Numbers 43.b. - 43.c.</b>?', 12, $y_position, 'security_43e', 'i_485_security_43e');
$y_position += 10;

addYesNoQuestion($pdf, '<b>43.f.</b>&nbsp;&nbsp;&nbsp;Participated in, or been a member of, a group or organization that did any of the activities described in<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Item Numbers 43.b. - 43.c.</b>?', 12, $y_position, 'security_43f', 'i_485_security_43f');
$y_position += 10;

addYesNoQuestion($pdf, '<b>43.g.</b>&nbsp;&nbsp;Recruited members or asked for money or things of value for a group or organization that did any of the<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;activities described in <b>Item Numbers 43.b. - 43.c.</b>?', 12, $y_position, 'security_43g', 'i_485_security_43g');
$y_position += 10;

addYesNoQuestion($pdf, '<b>43.h.</b>&nbsp;&nbsp;Provided money, a thing of value, services or labor, or any other assistance or support for any of the<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;activities described in <b>Item Numbers 43.b. - 43.c.</b>?', 12, $y_position, 'security_43h', 'i_485_security_43h');
$y_position += 10;

addYesNoQuestion($pdf, '<b>43.i.</b>&nbsp;&nbsp;&nbsp;Provided money, a thing of value, services or labor, or any other assistance or support for an individual,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;group, or organization who did any of the activities described in <b>Item Numbers 43.b. - 43.c.</b>?', 12, $y_position, 'security_43i', 'i_485_security_43i');
$y_position += 10;

addYesNoQuestion($pdf, '<b>44.</b> &nbsp;&nbsp;&nbsp;&nbsp;Do you intend to engage in any of the activities listed in any part of <b>Item Numbers 43.b. - 43.c.</b>?', 12, $y_position, 'security_44', 'i_485_security_44');
$y_position += 7;

addYesNoQuestion($pdf, '<b>45.</b> &nbsp;&nbsp;&nbsp;&nbsp;Do you intend to engage in any activity that could endanger the welfare, safety, or security of the United<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;States?', 12, $y_position, 'security_45', 'i_485_security_45');
$y_position += 10;

$pdf->SetFont('times', '', 10);
$html = '<b>NOTE:</b> If you answered "Yes" to any part of <b>Item Numbers 42.a. - 45.</b>, explain what you did, including the dates and location<br>of the circumstances, or what you intend to do in the space provided in <b>Part 14. Additional Information.</b>';
...
$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(190, 0, 12, $y_position, "<b>65.</b>", 0, 1, false, true, 'L', true);
$html = 'If your answer to <b>Item Number 63,</b> is "Yes," list the specific benefit(s) you received, the start and end dates of each period of receipt, the dollar amount of benefits received, and whether you received the benefits while you were in an immigration<br>category exempt from the public charge ground of inadmissibility.';
$pdf->writeHTMLCell(190, 0, 20, $y_position, $html, 0, 1, false, true, 'L', true);
$y_position += 14;

// Table header for question 65
$pdf->SetXY(21, $y_position);
$pdf->SetFont('times', 'B', 9);
$pdf->Cell(60, 7, 'Benefit Received', 1, 0, 'C', false);
$pdf->Cell(30, 7, 'Start Date', 1, 0, 'C', false);
$pdf->Cell(30, 7, 'End Date', 1, 0, 'C', false);
$pdf->Cell(35, 7, 'Dollar Amount', 1, 0, 'C', false);
$pdf->Cell(28.4, 7, '', 1, 0, 'C', false);
$pdf->SetFont('times', 'B', 7.5);
$pdf->writeHTMLCell(190, 0, 177, $y_position-.4, "<div>In a Category Exempt</div>", 0, 1, false, true, 'L', true);
$pdf->writeHTMLCell(190, 0, 178.6, $y_position+2.7, "<div>from Public Charge</div>", 0, 1, false, true, 'L', true);
$y_position += 7;

// Table rows for question 65
for ($i = 1; $i <= 4; $i++) {
    $pdf->SetFont('times', '', 9);
    
    // Text fields for each column
    $pdf->TextField('benefit_65_'.$i, 60, 6.8, array('strokeColor'=>array(64,64,64),'lineWidth'=>1,'borderStyle'=>'solid'), array(), 20.8, $y_position);
    $pdf->TextField('start_date_65_'.$i, 30.4, 6.8, array('strokeColor'=>array(64,64,64),'lineWidth'=>1,'borderStyle'=>'solid'), array(), 80.7, $y_position);
    $pdf->TextField('end_date_65_'.$i, 30.3, 6.8, array('strokeColor'=>array(64,64,64),'lineWidth'=>1,'borderStyle'=>'solid'), array(), 110.8, $y_position);
    $pdf->TextField('amount_65_'.$i, 35.1, 6.8, array('strokeColor'=>array(64,64,64),'lineWidth'=>1,'borderStyle'=>'solid'), array(), 141, $y_position);
    
    // Yes/No checkboxes
    
    $pdf->SetFont('times', '', 14);
    $html = '<div><input type="checkbox" name="exempt_yes_65_'.$i.'" value="Y" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="exempt_no_65_'.$i.'" value="N" /></div>';
    $pdf->writeHTMLCell(28.3,6.8, 176.1, $y_position,   $html, 1, 1, false,  false, 'J', false);
      $pdf->SetFont('times', '', 10);
      $pdf->writeHTMLCell(28.3, 7, 182, $y_position + 1, "Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No", '', 0, 0, true, 'L');
    $y_position += 6.7;
}
//.....................
$y_position += 2;
$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(190, 0, 12, $y_position, "<b>66.</b>", 0, 1, false, true, 'L', true);
$html = 'If your answer to <b>Item Number 64,</b> is " list the name, city, and state for each institution, the start and end dates of each<br>
period of institutionalization, the reason you were institutionalized, and whether you were institutionalized while you were in an<br>
immigration category exempt from the public charge ground of inadmissibility.';
$pdf->writeHTMLCell(190, 0, 20, $y_position, $html, 0, 1, false, true, 'L', true);
$y_position += 14;

// Table header for question 66
$pdf->SetXY(21, $y_position);
$pdf->SetFont('times', 'B', 9);
$pdf->Cell(50, 7, 'Institution Name/City/State', 1, 0, 'C', false);
$pdf->Cell(30, 7, 'Date From', 1, 0, 'C', false);
$pdf->Cell(30, 7, 'Date To', 1, 0, 'C', false);
$pdf->Cell(45, 7, 'Reason', 1, 0, 'C', false);
$pdf->Cell(28.4, 7, '', 1, 0, 'C', false);
$pdf->SetFont('times', 'B', 7.5);
$pdf->writeHTMLCell(190, 0, 177, $y_position-.4, "<div>In a Category Exempt</div>", 0, 1, false, true, 'L', true);
$pdf->writeHTMLCell(190, 0, 178.6, $y_position+2.7, "<div>from Public Charge</div>", 0, 1, false, true, 'L', true);
...
// Table rows for question 66
for ($i = 1; $i <= 4; $i++) {
    $pdf->SetFont('times', '', 9);
    
    // Text fields for each column
    $pdf->TextField('institution_66_'.$i, 50.1, 6.8, array('strokeColor'=>array(64,64,64),'lineWidth'=>1,'borderStyle'=>'solid'), array(), 20.8, $y_position);
    $pdf->TextField('date_from_66_'.$i, 30.1, 6.8, array('strokeColor'=>array(64,64,64),'lineWidth'=>1,'borderStyle'=>'solid'), array(), 70.9, $y_position);
    $pdf->TextField('date_to_66_'.$i, 30.1, 6.8, array('strokeColor'=>array(64,64,64),'lineWidth'=>1,'borderStyle'=>'solid'), array(), 100.9, $y_position);
    $pdf->TextField('reason_66_'.$i, 45, 6.8, array('strokeColor'=>array(64,64,64),'lineWidth'=>1,'borderStyle'=>'solid'), array(), 131, $y_position);
    
    // Yes/No checkboxes
    $pdf->SetFont('times', '', 14);
    $html = '<div><input type="checkbox" name="exempt_yes_66_'.$i.'" value="Y" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="exempt_no_66_'.$i.'" value="N" /></div>';
    $pdf->writeHTMLCell(28.3,6.8, 176, $y_position, $html, 1, 1, false, false, 'J', false);
...
$pdf->SetFontSize(12);
$html = "<div><b><i>Illegal Entries and Other Immigration Violations</i></b></div>";
$pdf->writeHTMLCell(191.5, 6, 13, $y_position, $html, 0, 1, true, 'L');
$y_position += 7;

addYesNoQuestion($pdf, '<b>67.</b>&nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> failed or refused to attend or to remain in attendance at any removal proceeding filed<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;against you on or after April 1, 1997?', 12, $y_position, 'immigration_67', 'i_485_immigration_67');
$y_position += 10;

$pdf->SetFont('times', '', 10);
$html = '<b>NOTE:</b> If your answer to <b>Item Number 67,</b> is "Yes," attach a written statement explaining why you failed or refused to attend <br>or remain in attendance at the removal proceeding, including any explanation of a reasonable cause for that failure or refusal.';
$pdf->writeHTMLCell(190, 6, 20, $y_position, $html, 0, 1, false, true, 'L', true);
$y_position += 11;

addYesNoQuestion($pdf, '<b>68.</b>&nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> submitted altered, fraudulent, or counterfeit documentation to any U.S. Government<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;official to obtain or attempt to obtain any immigration benefit, including a visa or entry into the United<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;States?', 12, $y_position, 'immigration_68', 'i_485_immigration_68');
$y_position += 14;

addYesNoQuestion($pdf, '<b>69.</b>&nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> lied about, concealed, or misrepresented any information on an application or petition<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to obtain a visa, other documentation required for entry into the United States, admission to the United States,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;or any other kind of immigration benefit?', 12, $y_position, 'immigration_69', 'i_485_immigration_69');
$y_position += 14;

addYesNoQuestion($pdf, '<b>70.</b>&nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> falsely claimed to be a U.S. citizen (in writing or any other way)?', 12, $y_position, 'immigration_70', 'i_485_immigration_70');
$y_position += 7;

addYesNoQuestion($pdf, '<b>71.</b>&nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> been a stowaway on a vessel or aircraft arriving in the United States?', 12, $y_position, 'immigration_71', 'i_485_immigration_71');
$y_position += 7;

addYesNoQuestion($pdf, '<b>72.</b>&nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> knowingly encouraged, induced, assisted, abetted, or aided any alien to enter or to try<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to enter the United States illegally (alien smuggling)?', 12, $y_position, 'immigration_72', 'i_485_immigration_72');
$y_position += 10;

addYesNoQuestion($pdf, '<b>73.</b>&nbsp;&nbsp;&nbsp;&nbsp;Are you under a final order of civil penalty for violating INA section 274C for use of fraudulent<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;documents?', 12, $y_position, 'immigration_73', 'i_485_immigration_73');

$y_position += 15;

$pdf->SetFontSize(12);
$html = "<div><b><i>Removal, Unlawful Presence, or Illegal Reentry After Previous Immigration Violations</i></b></div>";
$pdf->writeHTMLCell(191.5, 6, 13, $y_position, $html, 0, 1, true, 'L');
$y_position += 7;

addYesNoQuestion($pdf, '<b>74.</b>&nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> been excluded, deported, or removed from the United States or have you ever departed the<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;United States on your own after having been ordered excluded, deported, or removed from the United<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;States?', 12, $y_position, 'immigration_74', 'i_485_immigration_74');
$y_position += 14;

addYesNoQuestion($pdf, '<b>75.</b>&nbsp;&nbsp;&nbsp;&nbsp;Have you <b>EVER</b> entered the United States without being inspected and admitted or paroled?', 12, $y_position, 'immigration_75', 'i_485_immigration_75');
...
//page 20
    ...
    'benefit_65_1':' " . showData('example') . "',
    'benefit_65_2':' " . showData('example') . "',
    'benefit_65_3':' " . showData('example') . "',
    'benefit_65_4':' " . showData('example') . "',
    'start_date_65_1':' " . showData('example') . "',
    'start_date_65_2':' " . showData('example') . "',
    'start_date_65_3':' " . showData('example') . "',
    'start_date_65_4':' " . showData('example') . "',
    'end_date_65_1':' " . showData('example') . "',
    'end_date_65_2':' " . showData('example') . "',
    'end_date_65_3':' " . showData('example') . "',
    'end_date_65_4':' " . showData('example') . "',
    'amount_65_1':' " . showData('example') . "',
    'amount_65_2':' " . showData('example') . "',
    'amount_65_3':' " . showData('example') . "',
    'amount_65_4':' " . showData('example') . "',
