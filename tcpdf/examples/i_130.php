...
$pdf->writeHTMLCell(90, 7, 19, 175, $html, 0, 1, false, false, 0, true);
$pdf->writeHTMLCell(20, 5, 23, 173.5, 'Spouse', 0, 1, false, false, 0, true);

$html = '<div><input type="checkbox" name="i_130_petition_filing_for_parent" value="parent" checked="' . $checked_parent . '" /></div>';
$pdf->writeHTMLCell(90, 7, 36, 175, $html, 0, 1, false, false, 0, true);
$pdf->writeHTMLCell(20, 5, 40, 173.5, 'Parent', 0, 1, false, false, 0, true);

$html = '<div><input type="checkbox" name="i_130_petition_filing_for_brother" value="brother" checked="' . $checked_brother . '" /></div>';
$pdf->writeHTMLCell(90, 7, 53, 175, $html, 0, 1, false, false, 0, true);
$pdf->writeHTMLCell(25, 5, 58, 173.5, 'Brother/Sister', 0, 1, false, false, 0, true);
...
$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(95, 7, 12, 180.5, '<div><b>2.</b></div>', 0, 1, false, false, 'J', true);
$html = '<div>If you are filing this petition for your child or parent,<br>
select the box that describes your relationship (Select <b>only<br>
one</b> box):</div>';
$pdf->writeHTMLCell(95, 11, 19, 180.5, $html, '', 0, false, true, 'L', true);
...
$pdf->writeHTMLCell(90, 5, 18, 197, $html, 0, 1, false, false, 'J', true);

$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(80, 7, 25, 196, 'Child was born to parents who were married to each<br>
...
$pdf->writeHTMLCell(90, 5, 18, 207, $html, 0, 1, false, false, 'J', true);

$pdf->SetFont('times', '', 10);
$html = '<div>Stepchild/Stepparent</div>';
$pdf->writeHTMLCell(90, 5, 25, 207, $html, 0, 1, false, false, 'J', true);
...
$pdf->writeHTMLCell(90, 5, 18, 215, $html, 0, 1, false, false, 'J', true);

$pdf->SetFont('times', '', 10);
$html = '<div>Child was born to parents who were not married to<br>
each other at the time of the child\'s birth</div>';
$pdf->writeHTMLCell(85, 5, 25, 215, $html, 0, 1, false, false, 'J', true);
...
$pdf->writeHTMLCell(30, 5, 18, 227, $html, 0, 1, false, false, 'J', true);

$pdf->SetFont('times', '', 10);
$html = '<div>Child was adopted (not an Orphan or Hague<br>Convention adoptce)</div>';
$pdf->writeHTMLCell(80, 5, 25, 227, $html, 0, 1, false, false, 'J', true);
...
$pdf->writeHTMLCell(90, 7, 113, 206.5, $html, 0, 0, true, false, 'J', true);
//................
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('info_about_you_family_lastname', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 142, 216.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('info_about_you_family_firstname', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 142, 226.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('info_about_you_family_middlename', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 142, 235.5);
...
$pdf->writeHTMLCell(60, 0, 11, 163, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('mailing_country', 80, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 23, 211);

//............

$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(90, 5, 12, 219, '<b>11. </b>', 0, 1, false, true, 'L', false);
$html = '<div>Is your current mailing address the same as your  physical<br>address? </div>';
$pdf->writeHTMLCell(90, 5, 22, 219, $html, 0, 1, false, true, 'L', false);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('address1_province', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 143.5, 88);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('address1_postal_code', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 143.5, 96.5);

$pdf->SetFont('Times', '', 10); // set font
$html = '<b>12.h.</b> &nbsp;&nbsp;Country';
$pdf->writeHTMLCell(50, 0, 112, 102, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('address1_country', 80, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122.5, 108);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part2_14h_country', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122.5, 199);
...
$pdf->writeHTMLCell(70, 10, 12, 146, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
...
$pdf->writeHTMLCell(70, 10, 12, 191, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('parent2_last_name', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 144, 70);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('parent2_first_name', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 144, 79);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('parent2_middle_middle', 61, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 144, 88);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('parent2_date_of_birth', 37, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 168, 97);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_39a_certification', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 124, 236);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_39b_place', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 124, 249);
...
// $pdf->Ln(3);
$html = '<div><b>Part 2. Information About You </b> (Petitioner) (Continued) </div>';
$pdf->writeHTMLCell(92, 7, 13, 17, $html, 1, 1, true, false, 'L', true);
...
$pdf->writeHTMLCell(90, 12, 12, 30, $html, 0, 1, false, true, 'L', true);

//.........
$pdf->SetFont('times', '', 10.5);
$html = '<div><b>40.a. </b> &nbsp;Class of Admission</div>';
$pdf->writeHTMLCell(90, 7, 12, 40, $html, 0, 1, false, true, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_40a_admission', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 23, 45.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_40b_admission_date', 31, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 74, 54);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part2_40c_city_town', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22.5, 72);
...
$pdf->writeHTMLCell(100, 0, 12, 86, $html, '', 0, 0, true, 'L');
...
//..........
$pdf->SetFont('times', '', 10);
$html = '<div>Provide your employment history for the last five years, whether<br>
inside or outside the United States. Provide your current<br>
employment first. If you are currently unemployed, type or print<br>
"Unemployed" in <b>Item Number 42.</b></div>';
$pdf->writeHTMLCell(100, 7, 12, 110, $html, 0, 1, false, true, 'L', true);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('employer1_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22, 139);
//...........
$pdf->SetFont('times', '', 10.5);
$html = '<b>43.a.</b>&nbsp;&nbsp;Street Number<br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and Name';
$pdf->writeHTMLCell(50, 7, 12, 146, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('employer1_address', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 47, 147.5);
//..........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('employer1_apt_ste_flr_value', 37, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 67, 156);
//..........
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer1_city_or_town', 58.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 164.5);
...
$pdf->TextField('employer1_zip_code', 34, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 69.5, 173);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer1_province', 58.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 182);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer1_postal_code', 58.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 191);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer1_country', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22.5, 203);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer1_occupation', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22.5, 216);

$pdf->SetFont('times', '', 10); // set font
$html = '<b>45.a.</b> &nbsp;&nbsp;Date From (mm/dd/yyyy)';
$pdf->writeHTMLCell(50, 0, 12, 225,  $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer1_date_from', 31, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 72.5, 225);
//............
$pdf->SetFont('times', '', 10); // set font
$html = '<b>45.b.</b> &nbsp;&nbsp;Date To (mm/dd/yyyy)';
$pdf->writeHTMLCell(50, 0, 12, 235, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer1_date_to', 31, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 72.5, 235);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('employer2_name', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 26);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('employer2_address', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 147, 35);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('employer2_apt_ste_flr_value', 37, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 167, 43.5);
//..........
...
$pdf->writeHTMLCell(50, 0, 112, 52, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer2_city_or_town', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 145, 52);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer2_zip_code', 34.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 169.5, 60.5);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer2_province', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 145, 69);

$pdf->SetFont('Times', '', 10); // set font
$html = '<b>47.g.</b> &nbsp;&nbsp;Postal Code';
$pdf->writeHTMLCell(50, 0, 112, 77.5, $html, '', 0, 0, true, 'L');
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer2_postal_code', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 145, 77.5);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer2_country', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 90);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer2_occupation', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 103);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer2_date_from', 31.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 172.5, 112);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('employer2_date_to', 31.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 172.5, 121);
...
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>U.S. Social Security Number (if any)</div>';
$pdf->writeHTMLCell(80, 7, 12, 86, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
...
$pdf->SetFont('times', 'I', 10); // set font
$pdf->setCellHeightRatio(1.3);
$pdf->setCellPaddings(0.5, 0.5, 0.5, 0.5); // set cell padding
$pdf->SetFontSize(11.6); // set font
$html = '<div><b> Other Names Used </b>(if any)</div>';
$pdf->writeHTMLCell(90, 7, 13, 139, $html, 0, 1, true, false, 'L', true);
//...........
$pdf->setCellHeightRatio(1.1);
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(93, 10, 12, 235, $html, 0, 0, false, true, 'L', true);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part4_11h_country', 80, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122.5, 97);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_13c_city_town', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 147, 201);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_13f_provience', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 147, 210);
//...............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_13g_postal_code', 57, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 147, 219);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_13h_country', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 231);
//..........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_14_telephone', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 245);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_28_country_birth', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 99);
//...............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_32_country_birth', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 167);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_36_country_birth', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 234);
...
$pdf->SetFont('times', '', 10.5);
$html = '<div><b>38.</b></div>';
$pdf->writeHTMLCell(20, 10, 12, 61, $html, 0, 1, false, false, 'J', true);
$pdf->writeHTMLCell(30, 5, 22, 58, 'Relationship', 0, 1, false, false, 'J', true);
$pdf->SetFont('courier', 'B', 10);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_40_country_birth', 80, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 23, 82);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_44_country_birth', 80, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 23, 148);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_46a_arrives', 79, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 23, 193);
//..........
...
$pdf->writeHTMLCell(100, 10, 12, 225, $html, 0, 1, false, false, 'J', true);
$pdf->SetFont('courier', 'B', 10);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_47_pasport', 79, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 23, 250);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_50_date_expire_date', 31, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 172, 48);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_51b_street', 56, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 147, 101);
//..........
$pdf->SetFont('times', '', 10.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part4_51c_ste_flr', 36, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 167, 110);
//..........
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part4_51i_country', 79.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 123, 159.5);
...
$pdf->writeHTMLCell(100, 7, 112, 192, $html, '', 0, 0, true, 'L');
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part4_55a_city_town', 80, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122, 232);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part4_58f_country', 80, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22.5, 117);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part4_59h_country', 79.4, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 23, 200);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_4_date_filed', 36, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 167, 164);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part5_5_result', 81, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122, 178);
...
$pdf->writeHTMLCell(78, 7, 26, 189, '', 1, 0, false, 'L');
...
$pdf->writeHTMLCell(78, 7, 26, 210, '', 1, 0, false, 'L');
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part6_3_daytime_telephone', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 121, 30.5);
//.........
$pdf->setFont('Times', '', 10);
$html = '<div><b>4.</b>&nbsp; &nbsp; &nbsp;  Petitioner\'s Mobile Telephone Number (if any) </div>';
$pdf->writeHTMLCell(95, 7, 112, 38.5, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part6_4_telephone', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 121, 44.5);
//......
$pdf->setFont('Times', '', 10);
$html = '<div><b>5. </b> &nbsp; &nbsp;  Petitioner\'s Email Address (if any) </div>';
$pdf->writeHTMLCell(95, 7, 112, 53, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part6_5_email', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 121, 59);
//.....
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_1a_last_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 55);
//.........
$pdf->setFont('Times', '', 10);
$html = '<div><b>1.b.</b>&nbsp; &nbsp;Interpreter\'s Given Name (First Name) </div>';
$pdf->writeHTMLCell(90, 7,  12, 61, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_1b_first_name', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 67);
//......
$pdf->setFont('Times', '', 10);
$html = '<div><b>2. </b> &nbsp; &nbsp; Interpreter\'s Business or Organization Name (if any) </div>';
$pdf->writeHTMLCell(90, 7,  12, 73, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_2_organization', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 79);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part7_3f_province', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 43, 134.5);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part7_3g_postal_code', 60, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 43, 143);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part7_3h_country', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 156);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_4_daytime_telephone', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 180);
//.........
$pdf->setFont('Times', '', 10);
$html = '<div><b>5.</b>&nbsp; &nbsp; &nbsp;  Interpreter\'s Mobile Telephone Number (if any) </div>';
$pdf->writeHTMLCell(95, 7, 12, 187.5, $html, 0, 0, false, 'L');
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_5_telephone', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 193);
//......
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part7_6_email', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 206);
...
$pdf->SetFont('courier', 'B', 10); // set font
$pdf->TextField('part8_3h_country', 82, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 121, 248);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part8_4_daytime_telephone', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 52);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part8_5_telephone', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 65);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('part8_6_email', 83, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 21, 78);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_1a', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 61);
//.......
$pdf->SetFont('times', '', 10);
$html = '<div><b>1.b.  </b>  Given Name <br> &nbsp; &nbsp; &nbsp; &nbsp; (First Name) </div>';
$pdf->writeHTMLCell(90, 7, 12, 68, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_1b', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 70);
//.........
$pdf->SetFont('times', '', 10);
$html = '<div><b>1.c.  </b>  Middle Name  </div>';
$pdf->writeHTMLCell(90, 7, 12, 78, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_1c', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 45, 79);
//..........
$pdf->SetFont('times', '', 10);
...
$pdf->Rotate(-30);
$pdf->SetFont('zapfdingbats', 'B', 10);
$pdf->MultiCell(10, 10, "t", '', 'L', 0, 1, 41, 69.4, false); // angle 1
$pdf->StopTransform();
$pdf->SetFont('times', '', 11);
$html = '<b>A-</b>';
$pdf->writeHTMLCell(90, 7, 51.4, 88.3, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_2', 46, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 57.9, 88);
//............
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.a.  </b> &nbsp;Page Number</div>';
$pdf->writeHTMLCell(90, 7, 12, 98, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_3a', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22, 103);
//.............
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.b.</b> &nbsp;&nbsp;Part Number</div>';
$pdf->writeHTMLCell(90, 7, 45, 98, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_3b', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 54, 103);
//............
$pdf->SetFont('times', '', 10);
$html = '<div><b>3.c.</b> &nbsp;&nbsp;Item Number</div>';
$pdf->writeHTMLCell(90, 7, 75, 98, $html, 0, 1, false, false, 'L', true);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_3c', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 84, 103);
//............
$pdf->SetFont('times', '', 10);
...
$pdf->writeHTMLCell(82,66, 21.5, 112, '', 1,  0, false, false, 'C', true); // all side border
$pdf->TextField('additional_information_3d', 82.5, 66, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_130_additional_info_3d')), 21.5, 112);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_4a', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 22, 185);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_4b', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 54, 185);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_4c', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 84, 185);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->setCellHeightRatio(1.8);
$pdf->writeHTMLCell(82, 1, 21.6, 194, '',  "TLR",  0, false, false, 'C', false); // Top line
$pdf->writeHTMLCell(82, 1, 21.6, 191, '',  "B",  0, false, false, 'C', true); // line 1
$pdf->writeHTMLCell(82, 1, 21.6, 195.1, '',  "BLR",  0, false, false, 'C', true); // line 2
...
$pdf->TextField('additional_information_4d', 82.5, 63.4, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_130_additional_info_4d')), 21.5, 194);
$pdf->setCellHeightRatio(1.2);
//............
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_5a', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122, 22);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_5b', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 154, 22);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_5c', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 184, 22);
...
$pdf->writeHTMLCell(81.6, 1, 122.6, 68.3, '',  "BLR",  0, false, false, 'C', true); // line 9
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_5d', 82, 65, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_130_additional_info_5d')), 122.5, 30.5);
$pdf->setCellHeightRatio(1.2);
//...........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_6a', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122, 100.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_6b', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(),  154, 100.5);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_6c', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 184, 100.5);
...
$pdf->setCellHeightRatio(1.8);
$pdf->writeHTMLCell(81.6, 1, 122.6, 109.7, '',  "TLR",  0, false, false, 'C', false); //Top line
$pdf->writeHTMLCell(81.6, 1, 122.6, 106.7, '',  "B",  0, false, false, 'C', true); // line 1
$pdf->writeHTMLCell(81.6, 1, 122.6, 111.5, '',  "BLR",  0, false, false, 'C', true); // line 2
$pdf->writeHTMLCell(81.6, 1, 122.6, 116.3, '',  "BLR",  0, false, false, 'C', true); // line 3
$pdf->writeHTMLCell(81.6, 1, 122.6, 121.3, '',  "BLR",  0, false, false, 'C', true); // line 4 
$pdf->writeHTMLCell(81.6, 1, 122.6, 126, '',  "BLR",  0, false, false, 'C', true);   // line 5
$pdf->writeHTMLCell(81.6, 1, 122.6, 130.5, '',  "BLR",  0, false, false, 'C', true); // line 6
$pdf->writeHTMLCell(81.6, 1, 122.6, 135, '',  "BLR",  0, false, false, 'C', true);   // line 7
$pdf->writeHTMLCell(81.6, 1, 122.6, 139.6, '',  "BLR",  0, false, false, 'C', true); // line 8 
$pdf->writeHTMLCell(81.6, 1, 122.6, 144, '',  "BLR",  0, false, false, 'C', true);   // line 9
$pdf->writeHTMLCell(81.6, 1, 122.6, 148, '',  "BLR",  0, false, false, 'C', true);   // line 9
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_6d', 82, 66, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_130_additional_info_6d')), 122.5, 109.5);
$pdf->setCellHeightRatio(1.2);
//...........
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_7a', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 122, 181.2);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_7b', 19.5, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(),  154, 181.2);
...
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_7c', 20, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array(), 184, 181.2);
...
$pdf->setCellHeightRatio(1.8);
$pdf->writeHTMLCell(81.6, 1, 122.6, 191.3, '',  "TLR",  0, false, false, 'C', false); // Top line
$pdf->writeHTMLCell(81.6, 1, 122.6, 188.5, '',  "B",  0, false, false, 'C', true); // line 1
$pdf->writeHTMLCell(81.6, 1, 122.6, 193, '',  "BLR",  0, false, false, 'C', true);   // line 2
$pdf->writeHTMLCell(81.6, 1, 122.6, 197.7, '',  "BLR",  0, false, false, 'C', true); // line 3
$pdf->writeHTMLCell(81.6, 1, 122.6, 202, '',  "BLR",  0, false, false, 'C', true);   // line 4 
$pdf->writeHTMLCell(81.6, 1, 122.6, 206.5, '',  "BLR",  0, false, false, 'C', true); // line 5
$pdf->writeHTMLCell(81.6, 1, 122.6, 211, '',  "BLR",  0, false, false, 'C', true);   // line 6
$pdf->writeHTMLCell(81.6, 1, 122.6, 215.5, '',  "BLR",  0, false, false, 'C', true); // line 7
$pdf->writeHTMLCell(81.6, 1, 122.6, 220, '',  "BLR",  0, false, false, 'C', true);   // line 8 
$pdf->writeHTMLCell(81.6, 1, 122.6, 224.5, '',  "BLR",  0, false, false, 'C', true); // line 9
$pdf->writeHTMLCell(81.6, 1, 122.6, 228.9, '',  "BLR",  0, false, false, 'C', true); // line 9
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('additional_information_7d', 82, 65, array('multiline' => true, 'strokeColor' => array(64, 64, 64), 'lineWidth' => 1, 'borderStyle' => 'solid'), array('v' => showData('i_130_additional_info_7d')), 122.5, 191);
