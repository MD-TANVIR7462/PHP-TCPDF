            ...
            <div>
                ...
                <div>
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="information_about_your_qualifying_family_member_residence_street_number" maxlength="28" value="<?php echo showData('information_about_your_qualifying_family_member_residence_street_number') ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="information_about_your_qualifying_family_member_residence_apt_ste_flr_number" maxlength="6" value="<?php echo showData('information_about_your_qualifying_family_member_residence_apt_ste_flr_number') ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-5">5.c. City or Town</label>
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="information_about_you_qualifying_family_member_city_town" maxlength="20" value="<?= showData('information_about_you_qualifying_family_member_city_town') ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <select class="form-control" name="information_about_you_qualifying_family_member_state">
                                ...
                                foreach ($allDataCountry as $record) {
                                    if ($record->state_code == showData('information_about_you_qualifying_family_member_state')) $selected = "selected";
                                    else $selected = "";
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="information_about_your_qualifying_family_member_zip_code" maxlength="5" value="<?php echo showData('information_about_your_qualifying_family_member_zip_code') ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="row  mt-3 border-add">
        ...
        <div class="col-md-6 mt-5">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_your_qualifying_family_member_family_last_name" maxlength="29" value="<?php echo showData('information_about_your_qualifying_family_member_family_last_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">1.b. Given Name(First Name)</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_your_qualifying_family_member_given_first_name" maxlength="29" value="<?php echo showData('information_about_your_qualifying_family_member_given_first_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">1.c. Middle Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_your_qualifying_family_member_middle_name" maxlength="29" value="<?php echo showData('information_about_your_qualifying_family_member_middle_name') ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_your_qualifying_family_member_other_family_last_name" maxlength="29" value="<?php echo showData('information_about_your_qualifying_family_member_other_family_last_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.b. Given Name(First Name)</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_your_qualifying_family_member_other_given_first_name" maxlength="29" value="<?php echo showData('information_about_your_qualifying_family_member_other_given_first_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-5">2.c. Middle Name</label>
                <div class="col-md-7">
                    <input type="text" class="form-control" name="information_about_your_qualifying_family_member_other_middle_name" maxlength="29" value="<?php echo showData('information_about_your_qualifying_family_member_other_middle_name') ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-7 ">
                    <div class="margin">
                        <div class="form-check ">
                            <input type="radio" class="form-check-input" name="i_918a_part1_family_members_relations" value="spouse" <?php echo (showData('i_918a_part1_family_members_relations') == 'spouse') ? 'checked' : '' ?>>
                            <label class="form-check-label" for="spouse">Male</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" class="form-check-input" name="i_918a_part1_family_members_relations" value="parent" <?php echo (showData('i_918a_part1_family_members_relations') == 'parent') ? 'checked' : '' ?>>
