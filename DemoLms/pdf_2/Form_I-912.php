...
$html = <<<EOD
<textarea cols="44" rows="16" name="part6_1_input" multiline="true">
$part6_textarea
</textarea>
EOD;
$pdf->writeHTMLCell(10, 40, 18.5, 50, $html, 0, 0, false, 'L'); */

$pdf->setCellHeightRatio( 1.95 );
$pdf->TextField('part6_1_input', 184.5, 58,array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>0, 'borderStyle'=>'solid'), array('v' => showData('financial_hardship_incur_expenses')), 18.7, 50.4);
$pdf->setCellHeightRatio( 1.2 );
...
$pdf->writeHTMLCell( 76, 1, 119, 188, '',  "B",  0, false, false, 'C', true );
$pdf->writeHTMLCell( 76, 1, 119, 193, '',  "B",  0, false, false, 'C', true );
$pdf->writeHTMLCell( 76, 1, 119, 198, '',  "B",  0, false, false, 'C', true );
$pdf->writeHTMLCell( 76, 1, 119, 203, '',  "B",  0, false, false, 'C', true );
...
if(showData('i_912_part_10_preparer_statment_9a')=="Y") $checked_data = "checked"; else $checked_data = "";
...
if(showData('i_912_part_10_preparer_statment_9b')=="Y") $checked_data = "checked"; else $checked_data = "";
...
$pdf->setCellPaddings(1, 0.5, 1, 1); // set cell padding
$pdf->SetFont('times', '', 12); // set font
$html = '<div><b>Part 10. &nbsp;Additional Information</b></div>';
$pdf->writeHTMLCell(191, 7, 13, 12.5, $html, 1, 1, true, false, 'J', true);
...
$pdf->writeHTMLCell(191, 7, 12, 20.3, $html, 0, 0, false, true, 'L', true);
...
$pdf->SetFont('times', '', 10);
$pdf->writeHTMLCell(70, 7, 12, 40, '<b>1.   </b> &nbsp;Family Name (Last Name)', 0, 0, false, true, 'L', true);
$pdf->writeHTMLCell(50, 7, 95, 40, 'Given Name (First Name)', 0, 0, false, true, 'L', true);
$pdf->writeHTMLCell(50, 7, 156, 40, 'Middle Name', 0, 0, false, true, 'L', true);

$pdf->SetFillColor(220,220,220);
$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_last_name', 75, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 19, 45.3);
$pdf->TextField('i_912_additional_info_first_name', 59, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 96, 45.3);
$pdf->TextField('i_912_additional_info_middle_name', 47, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 156.5, 45.3);

//...........

$pdf->SetFont('times', '', 10);
$html = '<b>2.  </b>  &nbsp;  A-Number (if any)    <b>   &nbsp;  &nbsp; A-</b>';
$pdf->writeHTMLCell(60, 7, 12, 55.5, $html, 0, 0, false, true, 'L', true);
// $pdf->writeHTMLCell(50, 7, 60, 55.5, "", 1, 0, false, true, 'L', true);

$pdf->SetFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_a_number', 45, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 58, 55.5);

$pdf->Image('images/right_angle.jpg', 48, 56.7, 3.3, 3.3);

//..............aditional section.........

$pdf->setFont('Times', '', 10);
$html = '<div><b>3. &nbsp;&nbsp; A.</b> &nbsp; Page Number</div>';
$pdf->writeHTMLCell(60, 7, 12, 64.5, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_3a_page_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 25, 69.5);

$pdf->setFont('Times', '', 10);
$html = '<div><b>B. </b>&nbsp;&nbsp;Part Number</div>';
$pdf->writeHTMLCell(50, 7, 54, 64.5, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_3b_part_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 61, 69.5);

$pdf->setFont('Times', '', 10);
$html = '<div><b>C. </b>&nbsp;&nbsp;Item Number</div>';
$pdf->writeHTMLCell(30, 7, 89.5, 64.5, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_3c_item_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 96.9, 69.5);

//...........

$pdf->setFont('Times', '', 10);
$html= '<div><b>D.</b></div>';
$pdf->writeHTMLCell(10, 7, 18, 77.5, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
...
$pdf->TextField('i_912_additional_info_3d', 178, 26, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v'=>showData('i_912_additional_info_3d')), 25, 78.5);

//...........

$pdf->setFont('Times', '', 10);
$html = '<div><b>4. &nbsp;&nbsp; A.</b> &nbsp; Page Number</div>';
$pdf->writeHTMLCell(60, 7, 12, 107, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_4a_page_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 25, 112);

$pdf->setFont('Times', '', 10);
$html= '<div><b>B. </b>&nbsp;&nbsp;Part Number</div>';
$pdf->writeHTMLCell(50, 7, 54, 107, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_4b_part_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 61, 112);

$pdf->setFont('Times', '', 10);
$html= '<div><b>C. </b>&nbsp;&nbsp;Item Number</div>';
$pdf->writeHTMLCell(30, 7, 89.5, 107, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_4c_item_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 96.9, 112);

$pdf->setFont('Times', '', 10);
$html= '<div><b>D. </b></div>';
$pdf->writeHTMLCell(10, 7, 18, 120, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);

$pdf->TextField('i_912_additional_info_4d', 178, 26, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v'=>showData('i_912_additional_info_4d')), 25, 121);

//...........

$pdf->setFont('Times', '', 10);
$html = '<div><b>5. &nbsp;&nbsp; A.</b> &nbsp; Page Number</div>';
$pdf->writeHTMLCell(60, 7, 12, 149, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_5a_page_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 25, 154);

$pdf->setFont('Times', '', 10);
$html= '<div><b>B. </b>&nbsp;&nbsp;Part Number</div>';
$pdf->writeHTMLCell(50, 7, 54, 149, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_5b_part_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 61, 154);

$pdf->setFont('Times', '', 10);
$html= '<div><b>C. </b>&nbsp;&nbsp;Item Number</div>';
$pdf->writeHTMLCell(30, 7, 89.5, 149, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_5c_item_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 96.9, 154);

$pdf->setFont('Times', '', 10);
$html= '<div><b>D. </b></div>';
$pdf->writeHTMLCell(10, 7, 18, 162, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);

$pdf->TextField('i_912_additional_info_5d', 178, 26, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v'=>showData('i_912_additional_info_5d')), 25, 163);
...
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_6a_page_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 25, 197);

//...........

$pdf->setFont('Times', '', 10);
$html= '<div><b>B. </b>&nbsp;&nbsp;Part Number</div>';
$pdf->writeHTMLCell(50, 7, 54, 192, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_6b_part_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 61, 197);

//...........

$pdf->setFont('Times', '', 10);
$html= '<div><b>C. </b>&nbsp;&nbsp;Item Number</div>';
$pdf->writeHTMLCell(30, 7, 89.5, 192, $html, 0, 0, false, 'L');
$pdf->setFont('courier', 'B', 10);
$pdf->TextField('i_912_additional_info_6c_item_no', 28, 7, array('strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array(), 96.9, 197);
...
$pdf->TextField('i_912_additional_info_6d', 178, 26, array('multiline'=>true, 'strokeColor' => array(64, 64, 64), 'lineWidth'=>1, 'borderStyle'=>'solid'), array('v'=>showData('i_912_additional_info_6d')), 25, 206);
...
'part2-7':' ".showData('i_912_info_about_you_requestor_other_expl')." ',
