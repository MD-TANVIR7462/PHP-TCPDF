...
$pdf->SetFont( 'times', '', 9.7 );
//* set font
$part3_4c_apt = (showData('information_about_you_safe_mailing_apt_ste_flr')=='apt') ? 'checked':'';
$part3_4c_ste = (showData('information_about_you_safe_mailing_apt_ste_flr')=='ste') ? 'checked':'';
$part3_4c_flr = (showData('information_about_you_safe_mailing_apt_ste_flr')=='flr') ? 'checked':'';
...
$single_status = (showData('i_918a_info_about_your_marital_status')=='single') ? 'checked':'';
$married_status = (showData('i_918a_info_about_your_marital_status')=='married') ? 'checked':'';
$divorced_status = (showData('i_918a_info_about_your_marital_status')=='divorced') ? 'checked':'';
$widowed_status = (showData('i_918a_info_about_your_marital_status')=='widowed') ? 'checked':'';
...
$gender_status_m = (showData('i_918a_infor_about_family_member_gender')=='male') ? 'checked':'';
$gender_status_f = (showData('i_918a_infor_about_family_member_gender')=='female') ? 'checked':'';
...
$proceding_status_yes = (showData('i_918a_part_4_other_info_immegration_process')=='Y')?'checked':'';
$proceding_status_no = (showData('i_918a_part_4_other_info_immegration_process')=='N')?'checked':'';
...
// page 2
'part3_4a_care_of_name':' ".showData('information_about_you_safe_mailing_care_of_name')."',
'part3_4b_street_number': ' ".showData('information_about_you_safe_mailing_street_number')."',
'part3_4c_apt_ste' :' ".showData('information_about_you_safe_mailing_number')."',
'part3_4d_city_town':' ".showData('information_about_you_safe_mailing_city_town')."',
'part3_4e_state': ' ".showData('information_about_you_safe_mailing_state')."',
'part3_4f_zip_code':' ".showData('information_about_you_safe_mailing_zip_code')."',
'part3_4g_province':' ".showData('information_about_you_safe_mailing_province')."',
'part3_4h_Postal_code':' ".showData('information_about_you_safe_mailing_postal_code')."',
'part3_4i_Country':' ".showData('information_about_you_safe_mailing_country')."',

'part3_5_A_Number': ' ".showData('information_about_your_qualifying_family_member_other_a_number')."',
'part3_6_social_security': ' ".showData('information_about_your_qualifying_family_member_other_social_security_number')."',
'part3_7_online_account': ' ".showData('information_about_your_qualifying_family_member_other_uscis_online_account_number')."',
'part3_8_date_of_birth': ' ".showData('information_about_your_qualifying_family_member_other_info_date_of_birth')."',
'part3_9_Country_of_birth': ' ".showData('information_about_your_qualifying_family_member_other_country_of_birth')."',
'part3_10_Country_of_Citizenship': ' ".showData('')."',

'part3_13_Arrival_Departure': ' ".showData('information_about_your_qualifying_family_member_other_a_number')."',
'part3_14_Passport_number': ' ".showData('information_about_your_qualifying_family_member_other_passport_number')."',
'part3_15_Travel_Document_Number': ' ".showData('information_about_your_qualifying_family_member_other_travel_document_number')."',
'part3_16_Country_of_Issuance': ' ".showData('information_about_your_qualifying_family_member_other_country_of_issuance')."',
'part3_17_Date_of_Issuance': ' ".showData('information_about_your_qualifying_family_member_other_date_of_issuance_for_passport_travel')."',
'part3_18_Expiration_Date': ' ".showData('information_about_your_qualifying_family_member_other_expiration_date_passport_travel')."',

'part4_1a_Date_of_LastEntry': ' ".showData('additional_information_about_your_qualifying_family_member_date_of_last_entry')."',
'part4_1b_city_or_town': ' ".showData('additional_information_about_your_qualifying_family_member_city_or_town')."',
'part4_1c_state': ' ".showData('additional_information_about_your_qualifying_family_member_state')."',
'part4_1d_Current': ' ".showData('additional_information_about_your_qualifying_family_member_current_immigration_status')."',
'part4_2a_Date_of_LastEntry': ' ".showData('additional_information_about_your_qualifying_family_member_not_in_united_states_date_of_last_entry')."',
'part4_2b_city_or_town': ' ".showData('additional_information_about_your_qualifying_family_member_not_in_united_states_city_or_town')."',
...
// page 7
'part6_1a_lastname': ' ".showData('information_about_family_member_spouse_children_family_last_name')."',
'part6_1b_firstname': ' ".showData('information_about_family_member_spouse_children_given_first_name')."',
'part6_1c_middlename': ' ".showData('information_about_family_member_spouse_children_middle_name')."',
'part6_2': ' ".showData('information_about_family_member_spouse_children_date_of_birth')."',
'part6_3': ' ".showData('information_about_family_member_spouse_children_country_of_birth')."',
'part6_4': ' ".showData('information_about_family_member_spouse_children_relationship')."',
'part6_5a_lastname': ' ".showData('information_about_family_member_spouse_children_family_last_name2')."',
'part6_5b_firstname': ' ".showData('information_about_family_member_spouse_children_given_first_name2')."',
'part6_5c_middlename': ' ".showData('information_about_family_member_spouse_children_middle_name2')."',
'part6_6': ' ".showData('information_about_family_member_spouse_children_date_of_birth2')."',
'part6_7': ' ".showData('information_about_family_member_spouse_children_country_of_birth2')."',
'part6_8': ' ".showData('information_about_family_member_spouse_children_relationship2')."',
'part6_9a_lastname': ' ".showData('information_about_family_member_spouse_children_family_last_name3')."',
'part6_9b_firstname': ' ".showData('information_about_family_member_spouse_children_given_first_name3')."',
'part6_9c_middlename': ' ".showData('information_about_family_member_spouse_children_middle_name3')."',
'part6_10': ' ".showData('information_about_family_member_spouse_children_date_of_birth3')."',
'part6_11': ' ".showData('information_about_family_member_spouse_children_country_of_birth3')."',
'part6_12': ' ".showData('information_about_family_member_spouse_children_relationship3')."',
